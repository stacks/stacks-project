...
$G \to \text{Spec}(k)$ is unramfied we see that
$$
...
unramfied (by the computation of the fibre over the unique image point
above), and of finite type (because $s, t$ are) hence a monomorphism (see
More on Morphisms, Lemma
\ref{more-morphisms-lemma-universally-injective-unramified}).
