...
that the scheme theoretic image alwayss exists.}.
\end{definition}
...
morphsm $W \to \mathcal{X} \times_\mathcal{Y} V$.
...
classes of morphisms producing two $2$-commutive
...
have to show these objects are isomorpic. The isomorphism
$$
