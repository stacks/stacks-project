...
Let $\mathcal{X}$ be an algebraic stack.
We say a point $x \in |\mathcal{X}|$ is a {\it finite type point}
...
$s, t : R \to u$ are locally of finite type.
Since $u$ is the spectrum of a field, it follows that
$s, t$ are flat and locally of finite presentation (details omitted).
...
$$
which is a monomorphism. By construction the diagram
$$
\xymatrix{
u \ar[d] \ar[r] & U \ar[d] \\
...
$u \to \mathcal{Z}$. Hence we conclude that
$\mathcal{Z} \times_\mathcal{X} U \to U$ is locally of finite type
which implies that $f$ is locally of finite type (note that $f$
is representable by algebraic spaces as $f$ is a monomorphism).
In this way we see that (3) holds.
