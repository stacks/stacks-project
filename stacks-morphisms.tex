...
is given as the {\it kernel} $K = K_{f,x}$ of the homomorphism of
...
\item for all morphisms $x : T \to \mathcal{X}$ the associated group
algebraic space $K$ is trivial.
\end{enumerate}
\end{lemma}
...
Lemmas \ref{spaces-morphisms-lemma-etale-unramified},
