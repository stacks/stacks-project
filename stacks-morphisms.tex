...
\medskip\noindent
Let $e : u \to R$ be the identity. Note that $R \subset F$ is a closed
...
Hence $\mathcal{O}_{F, \overline{e}}$ is a regular local ring, a fortiori
Cohen-Macaulay (THIS IS TOO VAGUE -- FIX COMING SOON).
