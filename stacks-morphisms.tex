...
Then $\mathcal{Y} \to \mathcal{Z}$ is locally of finite presentation.
\end{lemma}
...
$\text{Spec}(k) \to \mathcal{Y}$ where $k$ is a field the
space $|\text{Spec}(k) \times_\mathcal{Y} \mathcal{X}|$ is discrete.
\end{enumerate}
\end{lemma}

\begin{proof}
Assume (1). In this case the morphism of algebraic spaces
$\mathcal{X}_k \to \text{Spec}(k)$ is locally quasi-finite as a base change
...
type by assumption. For any morphism $\text{Spec}(k) \to V$ where $k$ is a
field
$$
\text{Spec}(k) \times_V (V \times_\mathcal{Y} \mathcal{X}) =
\text{Spec}(k) \times_\mathcal{Y} \mathcal{X}
$$
...
Let $\mathcal{X} \to \text{Spec}(k)$ be a locally quasi-finite morphism
where $\mathcal{X}$ is an algebraic stack and $k$ is a field.
Let $f : V \to \mathcal{X}$ be a locally quasi-finite morphism where
$V$ is a scheme. Then $V \to \text{Spec}(k)$ is locally quasi-finite.
\end{lemma}

\begin{proof}
By
Lemma \ref{lemma-composition-finite-type}
we see that $V \to \text{Spec}(k)$ is locally of finite type.
Assume, to get a contradiction, that $V \to \text{Spec}(k)$ is not
...
$\text{Spec}(k) \to \mathcal{Z}$ be a morphism.
...
and $\mathcal{Y}_k \to \text{Spec}(k)$ are locally quasi-finite.
...
$$
|\text{Spec}(A_i) \times_{\mathcal{Y}_k} \mathcal{X}_k| =
|\text{Spec}(k_i) \times_{\mathcal{Y}_k} \mathcal{X}_k| =
|\text{Spec}(k_i) \times_\mathcal{Y} \mathcal{X}|
$$
...
Finally, let $k$ be a field and let $\text{Spec}(k) \to \mathcal{Y}$
be a morphism. Then $V \times_\mathcal{Y} \text{Spec}(k)$ is
...
a morphism $\text{Spec}(k') \to V$ such that
$$
\xymatrix{
\text{Spec}(k') \ar[r] \ar[d] & V \ar[d] \\
\text{Spec}(k) \ar[r] & \mathcal{Y}
}
$$
...
$$
we see that $U \times_V \text{Spec}(k') \to \mathcal{X}_{k'}$ is
surjective, flat, and locally of finite presentation (as a base change
of $U \to \mathcal{X} \times_\mathcal{Y} V$). Hence
$|U \times_V \text{Spec}(k')| \to |\mathcal{X}_{k'}|$ is surjective and
open. Thus it suffices to show that $|U \times_V \text{Spec}(k')|$ is
...
gerbe on an algebraic stack with quasi-compact inertia.
