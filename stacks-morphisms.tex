...
\item $\Delta_f$ is universally closed, or
...
Then
\begin{enumerate}
\item $\Delta_{f, 1}$ is separated if and only if
$\Delta_{f, 2}$ is a closed immersion,
\item $\Delta_{f, 1}$ is quasi-separated if and only if
$\Delta_{f, 2}$ is quasi-compact, and
\item $\Delta_{f, 1}$ is locally separated if and only if
$\Delta_{f, 2}$ is an immersion.
\end{enumerate}
\end{lemma}
...
\item We say that $f$ is {\it quasi-separated} if $\Delta_{f, 1}$ and
$\Delta_{f, 2}$ are quasi-compact.
\end{enumerate}
\end{definition}
