...
we obtain a canonical $1$-morphism $[U'/R'] \to [U/R]$. This $1$-morphism
is fully faithful for example by
Groupoids in Spaces, Lemma \ref{spaces-groupoids-lemma-quotient-stack-restrict}
and essentially surjective because $f'$ is flat,
...
Algebraic Spaces, Remark \ref{algebraic-remark-flat-fp-presentation}.
Finally, we can use
Groupoids in Spaces, Lemma
...
the group action in
Groupoids of Spaces, Lemma \ref{spaces-groupoids-lemma-groupoid-from-action}.
