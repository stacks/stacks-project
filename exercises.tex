...
Compute $H^n(X, \mathcal{O}_X)$ for all $n$. Hint: use {\v C}ech cohomology.
\end{exercise}
...
Give an example of an affine scheme $X$ with nontrivial $\text{Pic}(X)$.
...
(2) show any element of $\text{Ext}^1_A(I^n, N)$
maps to zero in $\text{Ext}^1_A(I^{n + m}, N)$ for some $m > 0$
...
the dimensions of
$$
\text{Ext}^i_X(\mathcal{O}_L, \mathcal{O}_P)
$$
for all $i$.
...
$$
\text{Ext}^i_X(\mathcal{O}_Z, \mathcal{O}_Z)
$$
for all $i$.
\end{exercise}
...
$$
\text{Ext}^i_X(\mathcal{G}, \mathcal{H})
\times
\text{Ext}^j_X(\mathcal{F}, \mathcal{G})
\longrightarrow
\text{Ext}^{i + j}_X(\mathcal{F}, \mathcal{H})
$$
...
$$
\text{Ext}^i_X(\mathcal{E}, \mathcal{E}) \to H^i(X, \mathcal{O}_X)
$$
for all $i$. Generalize to a trace map
$$
\text{Ext}^i_X(\mathcal{E}, \mathcal{E} \otimes_{\mathcal{O}_X} \mathcal{F})
\to H^i(X, \mathcal{F})
$$
...
$$
\text{Ext}^i_X(\mathcal{E}, \mathcal{F} \otimes_{\mathcal{O}_X} \omega_{X/k})
\times
\text{Ext}^{d - i}_X(\mathcal{F}, \mathcal{E})
\to
\text{Ext}_X^d(\mathcal{F}, \mathcal{F} \otimes_{\mathcal{O}_X} \omega_{X/k})
\to
H^d(X, \omega_{X/k}) = k
$$
