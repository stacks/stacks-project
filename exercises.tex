...
\item Given an example of a map of $\mathcal{C}$ such that
...
what the kernel and cokernel of $f$ are).
\item Given an example of a Noetherian domain $R$ and a map of
...
Given an example of a category which is additive and has kernels
