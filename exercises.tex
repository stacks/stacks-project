...
It turns out this holds if $A$ has finite residue fields at closed points
and moreover $\Pic(A')$ is finite for every finite $A$-algebra
$A'$ (insert future reference here). For example, if $A = \mathbf{Z}$ or
$A = \mathbf{F}_p[x]$ or a finite extension of these. However, it turns
