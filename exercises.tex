...
$$
\text{Spec}(A) = \{\mathfrak p_i \subset A_i \mid\ 
...
Let $A \subset B$ be an integral ring extension. Use that
$\text{Spec}(B) \to \text{Spec}(A)$ is surjective using the exercises
above, the fact that this holds for a finite ring extension (proved
in the lectures), and by proving that $B = \colim B_i$ is a directed colimit
of finite extensions $A \subset B_i$.
\end{exercise}
