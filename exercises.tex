...
the canonical map $\text{Coim}(f) \to \Im(f)$ is not an isomorphism.\
\end{enumerate}
\end{exercise}
...
$\mathcal{C}$ such that the canonical map $\text{Coim}(f) \to \Im(f)$
...
\big\langle
\text{d}(a_1 + a_2) - \text{d}a_1 - \text{d}a_2,
\text{d}(a_1a_2) - a_1\text{d}a_2 - a_2\text{d}a_1,
\text{d}r
\big\rangle.
$$
