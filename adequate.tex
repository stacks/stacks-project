...
\medskip\noindent
Suppose that
$\varphi : \mathcal{F} \to \mathcal{G}$ is a
morphism of adequate sheaves such that $v\varphi = 0$.
Set $\mathcal{K} = \text{Ker}(\varphi)$ and
$\mathcal{Q} = \text{Coker}(\varphi)$. Since $v$ is exact, this means
that $v\mathcal{K} \to v\mathcal{F}$ and $v\mathcal{G} \to v\mathcal{Q}$
are isomorphisms. Hence $\text{Coker}(\mathcal{K} \to \mathcal{F})$
and $\text{Ker}(\mathcal{G} \to \mathcal{Q})$ are parasitic. This
means that $\mathcal{K} \to \mathcal{F}$ and $\mathcal{G} \to \mathcal{Q}$
are isomorphisms in $\textit{Adeq}(\mathcal{O}_S) / \mathcal{C}$
(see proof of
Homology, Lemma \ref{homology-lemma-serre-subcategory-is-kernel}).
Hence $\varphi$ is zero in $\textit{Adeq}(\mathcal{O}_S) / \mathcal{C}$.
In this way we see that $\overline{v}$ is faithful.
