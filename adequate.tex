...
\begin{enumerate}
\item For any $A$-module $M$ the module $M^\wedge$ is pure injective.
...
$I$ is pure injective. We claim that for any $A$-module $M$ the map
$e : M \to (M^\wedge)^\wedge$ is universally injective. To see this note
that $e^\wedge : ((M^\wedge)^\wedge)^\wedge \to M^\wedge$ has a right
inverse, namely $e' : M^\wedge \to ((M^\wedge)^\wedge)^\wedge$.
