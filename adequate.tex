...
presentation. Then
$\text{Ext}^i_\mathcal{A}(\underline{P}, \underline{M}) = 0$
for $i > 0$ where $\mathcal{A}$ is the category of module-valued
...
any element of $\text{Ext}^i_\mathcal{A}(\underline{P}, \underline{M})$
...
same class in $\text{Ext}^i_\mathcal{A}(\underline{P}, \underline{M})$
...
$\text{Ext}^i_\mathcal{A}(L, \underline{M}) = 0$
for $i > 0$ where $\mathcal{A}$ is the category of module-valued
functors on $\textit{Alg}_A$.
\end{lemma}
...
$\text{Ext}^i_\mathcal{A}(\underline{P}, \underline{M})$
and
$\text{Ext}^i_\mathcal{A}(\underline{A}, \underline{M})$
for $i > 0$.
...
we conclude that
$\text{Ext}^i_\mathcal{A}(K, \underline{M}) = 0$ for $i > 0$.
...
\noindent
The functor $Q$ is a right adjoint hence left exact. Since the inclusion
