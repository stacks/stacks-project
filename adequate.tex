...
The category of adequate $\mathcal{O}$-modules on $(\Sch/S)_\tau$
...
$\mathcal{O}_T$-module on $(\Sch/T)_\tau$.
\end{lemma}
...
=
\SheafHom_{\textit{Adeq}(\mathcal{O}_S)}(u\mathcal{F}, \mathcal{G})
$$
...
Let $S$ be a scheme.
\begin{enumerate}
\item A (pre)sheaf of $\mathcal{O}$-modules $\mathcal{F}$ on $(\Sch/S)_\tau$
is called {\it parasitic}\footnote{This may be nonstandard notation.}
if for every flat morphism $U \to S$ we have $\mathcal{F}(U) = 0$.
\item A sheaf of $\mathcal{O}$-modules $\mathcal{F}$
on $(\Sch/S)_\tau$ is called {\it parasitic for the $\tau$-topology}
...
H^i(U \times_S T, \mathcal{F}|_{(U \times_S T)_{Zar}})
$$
on $(\Sch/S)_\tau$. Hence it suffices to show that
...
\noindent
We finish this section with some general properties of parasitic modules.

\begin{lemma}
\label{lemma-cohomology-parasitic}
Let $S$ be a scheme. Let $\mathcal{G}$ be an $\mathcal{O}$-module
on $(\Sch/S)_{fppf}$ which is parasitic for the fppf topology. Then
$H^p(U, \mathcal{G}) = 0$ for every $U$ flat and locally of finite
presentation over $S$.
\end{lemma}

\begin{proof}
The assumption means that $\mathcal{G}(U) = 0$ for any
$U \to S$ flat and locally of finite presentation.
Apply
...
Let $S$ be a scheme and let $\mathcal{G}$ be a sheaf of
$\mathcal{O}$-modules on $(\Sch/S)_{fppf}$ such that
\begin{enumerate}
\item $\mathcal{G}|_{S_{Zar}}$ is quasi-coherent, and
\item for every flat, locally finitely presented morphism $g : U \to S$
the canonical map
$g^*(\mathcal{G}|_{S_{Zar}}) \to \mathcal{G}|_{U_{Zar}}$
is an isomorphism.
\end{enumerate}
Then $H^p(U, \mathcal{G}) = H^p(U, \mathcal{G}|_{U_{Zar}})$
for every $U$ flat and locally of finite presentation over $S$.
\end{lemma}

\begin{proof}
Let $\mathcal{F} = (\mathcal{G}|_{S_{Zar}})^a$. There is a canonical
comparison map $\varphi : \mathcal{F} \to \mathcal{G}$ which by
assumptions (1) and (2) induces an isomorphism
$\mathcal{F}|_{U_{Zar}} \to \mathcal{G}|_{U_{Zar}}$
...
is an isomorphism
for $g : U \to S$ flat and locally of finite presentation.
...
given $\mathcal{F}^\bullet \in \Ob(K^+(\textit{Adeq}(\mathcal{O}_U)))$
...
\textit{Mod}((\Sch/S)_\tau, \mathcal{O})$
exhibits $\textit{Adeq}(\mathcal{O}_S)$ as a weak Serre subcategory of
...
$\epsilon : (\Sch/S)_\tau \to (\Sch/S)_{\tau'}$, see
...
\to
\Hom_{D_{\textit{QCoh}}(\mathcal{O}_S)}(Rf_*X, Rf_*Y)
$$
