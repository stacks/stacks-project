...
\noindent
We need one more lemma before we can state and prove the
...
\end{reference}
Let $R$ be a Noetherian ring. Let $I = (f_1, \ldots, f_r)$ be
an ideal. Let $K_n$ be the Koszul complex on $f_1^n, \ldots, f_r^n$
viewed as a differential graded algebra.
