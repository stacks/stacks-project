...
$\mathcal{O}_\mathcal{C}$-algebras. Using the composition
$$
...
\mathcal{A}
$$
and the relative cup product, we obtain a multiplication
$$
Rf_*\mathcal{A} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\longrightarrow
Rf_*\mathcal{A}
$$
in $D(\mathcal{O}')$. Moreover, this multiplication
is associative. In exactly the same way, given a right differential
graded $\mathcal{A}$-module $\mathcal{M}$ we obtain a multiplication
$$
Rf_*\mathcal{M} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\longrightarrow
Rf_*\mathcal{M}
$$
in $D(\mathcal{O}')$ and this multiplication
is associative in $D(\mathcal{O}')$. If
$\mathcal{M}_1 \to \mathcal{M}_2$ is a homomorphism of
...
$$
commutes in $D(\mathcal{O}')$. Finally, suppose we have
...
\ar[rr] \ar[d]_{Rf_*\delta \otimes \text{id}} & & 
