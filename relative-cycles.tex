...
Let $f : X \to S$ be a finite type morphism of quasi-compact
and quasi-separated schemes. Let $r \geq 0$. Let $\alpha$
be a constructible family of $r$-cycles on $X/S$.
Then there exist
\begin{enumerate}


a finite, jointly surjective family of morphisms $T_i \to S$
with $T_i$ quasi-compact and closed subchemes $Z_{i, j} \subset T_i \times_S X$


In Definition \ref{definition-constructible} we may assume the morphisms
$Z_i \setminus Z'_i \to T$ are in addition smooth.
\end{lemma}
