...
$U$ towards and object $X$ of $\mathcal{C}$}
...
$$
\text{Mor}(V, U) = \{g_0 : V_0 \to Y \mid
f \circ g_0 \circ d^1_0 = f \circ g_0 \circ d^1_1\}
$$
\end{lemma}

\begin{proof}
Suppose that $g : V \to U$ is a morphism of simplicial
objects. Then the diagram
$$
\xymatrix{
V_1 \ar@<1ex>[r]^{d^1_0} \ar@<-1ex>[r]_{d^1_1} \ar[d]_{g_1} &
V_0 \ar[d]^{g_0} & \\
Y\times_X Y \ar@<1ex>[r]^{pr_1} \ar@<-1ex>[r]_{pr_2} &
Y \ar[r] & X
}
$$
is commutative, which proves that the relation shown in
the lemma holds. Conversely, given a morphism $g_0$
satisfying the equality of the lemma,
we get a unique morphism $g_1$ 
