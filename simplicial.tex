...
$$
d : U \circ V \to \text{id}_\mathcal{A} \quad (\text{unit}\footnote{We
can't use $\epsilon$ here because we want to use $\epsilon$ for the
augmentation of our simplicial obejct.})
\quad\text{and}\quad
\eta : \text{id}_\mathcal{S} \to V \circ U \quad (\text{counit})
$$
...
U \circ V \circ U \circ \ldots \circ V \circ U
$$
...
d^n_j = 1_{X_{j - 1}} \star d \star 1_{X_{n - j - 1}}
\quad\text{and}\quad
s^n_j = 1_{X_{j - 1} \circ F} \star \eta \star 1_{i \circ X_{n - j - 1}}
$$
...
$$
This places us in the sitation of Example \ref{example-godement}.
...
in the sitation of Example \ref{example-godement}.
