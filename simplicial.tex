...
\begin{eqnarray*}
\text{Mor}_{\mathcal{C}}(X, \SheafHom(V, U)_n)
& = &
\text{Mor}_{\text{Simp}(\mathcal{C})}(X \times \Delta[n], \SheafHom(V, U))
\\
& = &
\text{Mor}_{\text{Simp}(\mathcal{C})}(X \times \Delta[n]\times V, U) \\
& = &
\text{Mor}_{\text{Simp}(\mathcal{C})}(X, \SheafHom(\Delta[n] \times V, U))
\\
& = &
\text{Mor}_{\mathcal{C}}(X, \SheafHom(\Delta[n] \times V, U)_0)
\end{eqnarray*}
...
$\mathcal{C}$ such that
$$
\text{Mor}_{\text{Simp}(\mathcal{C})}(W, \Hom(U, V))
=
...
\Hom(V, T) \times_{\Hom(U, T)} \Hom(W, T)) \\
& =
\text{Mor}(X \times \Delta[n], \Hom(V, T))
\times_{\text{Mor}(X \times \Delta[n], \Hom(U, T))}
\text{Mor}(X \times \Delta[n], \Hom(W, T)) \\
& =
...
\begin{eqnarray*}
\text{Mor}(V, \text{cosk}_1 \text{sk}_1 \Hom(\Delta[k], X))
& = &
\text{Mor}(\text{sk}_1 V, \text{sk}_1 \Hom(\Delta[k], X)) \\
& = &
\text{Mor}(i_{1!} \text{sk}_1 V, \Hom(\Delta[k], X)) \\
& = &
...
$\text{Mor}(V \times \Delta[k], X) = \text{Mor}(V, \Hom(\Delta[k], X))$.
\end{proof}
...
\begin{enumerate}
\item we set
$\Hom_\mathcal{C}(U, V)_n = \text{Mor}_\mathcal{C}(U_n, V_n)$, and
...
$$
\text{Mor}_\mathcal{C}(X, \Hom(U, V)_n)
=
...
\medskip\noindent
In particular, consider $\Hom(\Delta[1], V)$.
The morphisms $e_i : \Delta[0] \to \Delta[1]$
produce two morphisms $e_i : \Hom(\Delta[1], V) \to V$.
