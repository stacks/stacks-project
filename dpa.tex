...
$\varphi : (A\langle x_1, \ldots, x_t \rangle, J, \delta) \to (C, K, \epsilon)$ is
...
divided power variables, we have a filtration
$R \subset A(0) \subset A(1) \subset \ldots$
of $A$ such that $A(m + 1)$ is obtained from $A(m)$ by adjoining finitely many
divided power variables of degree $m + 1$.
Then $A(0) \to H_0(A)$ is a surjection from a (usual) polynomial
