...
$\text{Ker}(S/\mathfrak m_R S \to B/\mathfrak m_A B)$.
...
It follows that $\text{Ker}(S/\mathfrak m_R S \to B/\mathfrak m_A B)$
is generated by the same number of elements (see above).
Hence $\text{Ker}(S/\mathfrak m_R S \to B/\mathfrak m_A B)$
...
(More on Algebra, Lemma \ref{more-algebra-lemma-completion-regular}).
Let $f_1, \ldots, f_r$ be a minimal sequence of generators
of $\text{Ker}(S \to B)$. We will use without further mention
that an ideal in a Noetherian local ring is generated by a regular
sequence if and only if any minimal set of generators is a
regular sequence. Observe that $f_1, \ldots, f_r$
...
then $\text{Ker}(S \to B)$ is generated by a regular sequence
if and only if $\text{Ker}(S' \to B)$ is generated by a regular sequence.
...
Set $I = \text{Ker}(S' \to S)$. By flatness of $S$ over $R$ we have
$$
I/\mathfrak m_R I =
\text{Ker}(S'/\mathfrak m_R S' \to S/\mathfrak m_R S) =
...
\medskip\noindent
We conclude that if also $\text{Ker}(S \to B)$ is generated by a
regular sequence, then so is $\text{Ker}(S' \to B)$, see
More on Algebra, Lemmas
\ref{more-algebra-lemma-join-koszul-regular-sequences} and
\ref{more-algebra-lemma-noetherian-finite-all-equivalent}.

\medskip\noindent
Conversely, assume that $J = \text{Ker}(S' \to B)$ is generated
...
form a regular sequence generating $\text{Ker}(S \to B)$.
...
\begin{enumerate}
\item $\text{Ker}(S \to B)$ is generated by a regular sequence, and
