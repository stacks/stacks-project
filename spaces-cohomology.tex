...
$$
0 = \mathcal{F}_0 \subset \mathcal{F}_1 \subset
\ldots \subset \mathcal{F}_m = \text{Coker}(\varphi)
$$
be a filtration as in Lemma \ref{lemma-coherent-filter}. By minimality
of $Z$ and assumption (1) we see that $\text{Coker}(\varphi)$ has
...
$$
where $\mathcal{I}' = \text{Im}((f')^*\mathcal{I} \to \mathcal{O}_W)$.
...
Choose an open immersion $W \subset Y$ with $Y$ projective over
$A$ (this is possible as $W$ is of finite type over $A$;
...
Namely, these morphsms agree over $V$ hence agree over
...
Namely, the image of $X' \to X$ is closed and contains the open
$U$. Denote $T$ the reduced induced algebraic space structure
on $X \setminus U$. Then $T \times_X W$ is a closed subscheme
of $W$, hence affine. Moreover, the morphism $T \times_X W \to T$
is \'etale and every geometric fibre has $< d$ points. By induction
hypothesis there exists a proper surjective morphism $T' \to T$
where $T'$ is a scheme. Thus the lemma follows by taking the
