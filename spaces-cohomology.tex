...
are zero as the target is zero. Using that $\textit{QCoh}(\mathcal{O}_X)$
...
Since $\textit{QCoh}(\mathcal{O}_X) = \textit{QCoh}(U, R, s, t, c)$ (see
...
Properties of Spaces, Proposition
\ref{spaces-properties-proposition-quasi-coherent}
we see that $\textit{QCoh}(\mathcal{O}_X) = \textit{QCoh}(U, R, s, t, c)$.
Hence we reduce to showing the corresponding thing for
$\textit{QCoh}(U, R, s, t, c)$. Thus the result follows from
