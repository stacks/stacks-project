...
Equation (\ref{equation-representable-higher-direct-image}) and
Lemma \ref{lemma-coherent-Noetherian}. Hence we may assume
$Y$ is the spectrum of a Noetherian ring. In this case $X$ is a scheme
...
(Cohomology of Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray})
