...
using discrete valuation rings. A lot more can be added here.
In particular, we should formulate and prove the analogues to
Limits, Lemmas \ref{limits-lemma-limited-base-change},
\ref{limits-lemma-Noetherian-dvr-valuative-separation},
\ref{limits-lemma-Noetherian-dvr-valuative-proper},
\ref{limits-lemma-test-universally-closed}, and
...
closed immersion (\'Etale Morphisms of Schemes, Lemma
...
(Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-universally-closed-local}).
Hence we may assume $Y$ is a Noetherian affine scheme.
