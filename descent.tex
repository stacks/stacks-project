...
of quasi-coherent modules on any of the sites associated to $S$
...
If $\tau = \etale$ then (7) holds because, as mentioned above,
...
ends up in $\QCoh(\mathcal{O}_S) \to \QCoh((\Sch/S)_\tau, \mathcal{O})$.
...
is finite locally free. To show that the value of
$\SheafHom_\mathcal{O}(\mathcal{F}, \mathcal{G})$
is independent on the topology used, we may replace
$S$ by the members of a Zariski open covering of $S$
(details omitted). Hence
we may assume $\mathcal{H} = \mathcal{O}_S^{\oplus n}$ is
finite free. Then $\mathcal{F} = \mathcal{O}^{\oplus n}$
and $\SheafHom_\mathcal{O}(\mathcal{F}, \mathcal{G}) = \mathcal{G}^{\oplus n}$
no matter which topology is used.
\end{proof}
