...
If this is the case for $f$ (and any base change of $f$), then the
...
Topologies, Definition \ref{topologies-definition-fpqc-covering}.
Then $\{T_i \to T\}$ is a family of universal effective epimorphisms
...
the property of being unramified is local for Zariski on source
and target. By
Morphisms, Lemmas \ref{morphisms-lemma-composition-unramified}
and
\ref{morphisms-lemma-etale-smooth-unramified} we see the precomposition
of an unramified morphism by an etale morphism is unramified.
...
such that $X' \to Y$ is unramified. Then $X' \to Y$ is of finite
presentation, and by
Lemma \ref{lemma-flat-finitely-presented-permanence-algebra}
we see that $X \to Y$ is of finite presentation also. By
