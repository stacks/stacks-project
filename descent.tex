...
$i_f : \textit{Sh}(T_\tau) \to \textit{Sh}((\Sch/S)_\tau)$
...
$i_f : \textit{Sh}(T_{Zar}) \to \textit{Sh}(\Sch/S)_{Zar})$
...
\text{each }X_i \in \text{Ob}((\Sch/S)_\tau)
\end{matrix}
\right\}
\leftrightarrow
\left\{
