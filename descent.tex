...
\noindent
We add a few lemmas here that don't seem to fit very well anywhere else.
...
$\mathcal{I} = \text{Ker}(\mathcal{O}_Y \to g_*\mathcal{O}_V)$
and $Z'$ is cut out by
$\mathcal{I}' = \text{Ker}(\mathcal{O}_X \to
