...
we see that we may (uniquely) descent
...
\item Let $\tau = etale$ or $\tau = Zariski$. The
{\it sheaf of $\mathcal{O}$-modules associated to $\mathcal{F}$}
on the small site $S_{etale}$, or $Z_{Zariski}$ is the sheaf of
...
Let $\tau \in \{Zariski,\linebreak[0] fppf,\linebreak[0]
etale,\linebreak[0] smooth,\linebreak[0] syntomic\}$.
The sheaf $\mathcal{F}^a$ is a quasi-coherent
$\mathcal{O}$-module on $(\textit{Sch}/S)_\tau$.
If $\tau = etale$, then the sheaf $\mathcal{F}^a$ is a quasi-coherent
$\mathcal{O}$-module on $S_{etale}$.
\end{lemma}
