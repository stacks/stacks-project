...
\acute{e}etale,\linebreak[0] smooth,\linebreak[0] syntomic\}$.
...
or
$
\text{id}_{X, sites} : (X_{\acute{e}tale}, \mathcal{O}) \to (X_{Zar}, \mathcal{O}).
$
...
\medskip\noindent
Let us prove (3) in case $\tau = \acute{e}tale$. First of all, the statement make
...
Let $\tau \in \{fpqc,\linebreak[0] fppf,\linebreak[0] \acute{e}tale,\linebreak[0]
