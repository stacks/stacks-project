...
to prove this. By
More on Morphisms, Definition \ref{more-morphisms-definition-pseudo-coherent}
...
Lemma \ref{lemma-descending-properties-morphisms}
to prove this. By
More on Morphisms, Definition \ref{more-morphisms-definition-perfect}
...
Lemma \ref{lemma-descending-property-regular-immersion}
...
for every $x \in X$ there exists an \'etale morphism of germs
$a : (U, u) \to (X, x)$, an \'etale morphism $b : V \to Y$, and a morphism
$h : U \to V$ such that $f \circ a = b \circ h$ and such that $h$ has
$\mathcal{P}$\footnote{Note that by (1) the morphism $h|_{U'}$ will also
have property $\mathcal{P}$ for any open $U' \subset U$. Hence this condition
is, in the presence of condition (1), equivalent to requiring there is an
actual \'etale morphism $a : U \to X$, and $u \in U$ with $a(u) = x$, and a
morphism $h : U \to V$ which has property $\mathcal{P}$.}.
\end{enumerate}
\end{definition}
...
morphism of germs $a_x : (U_x, u_x) \to (X, x)$, an \'etale morphism
$b_x : V_x \to Y$, and a morphism $h_x : U_x \to V_x$ such that
$f \circ a_x = b_x \circ h_x$ and $h_x$ has $\mathcal{P}$.
We may and do shrink $U_x$ so that $U_x \to X$ is \'etale, see
footnote in
Definition \ref{definition-local-source-target}.
