...
\begin{proof}
Exactness is Injectives, Lemma \ref{injectives-lemma-vee-exact}
...
$\text{Coker}(F \to M) \otimes_R S$ is zero and hence $\text{Coker}(F \to M)$
...
$\text{Coker}(F \to A) \otimes_R S$ is zero and hence $\text{Coker}(F \to A)$
is zero. This proves (a).
