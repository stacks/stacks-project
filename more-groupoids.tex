...
which is an intersection of quasi-compact opens of $X$. Say
$E = \bigcup_{i \in I} U_i$ with $U_i \subset X$ quasi-compact open.
...
intersection of quasi-compact opens of $X$.
...
to $A \to \Gamma(E, \mathcal{O}_X|_E)$. Choose $E = \bigcap_{i \in I} U_i$
with $U_i \subset X$ quasi-compact open. We may and do assume that for
$i, j \in I$ there exists a $k \in I$ with
...
The final assertion of the lemma follows from the above as well.
\end{proof}
...
$$
of schemes. Let $E \subset Y$ be an intersection of quasi-compact
opens of $Y$. Then
$$
...
an intersection of quasi-compact opens.
