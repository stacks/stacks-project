...
$$
\xymatrix{
{}_tR \times_k R_s \ar[r] \ar[d]_{{}_tj \times j_s} &  R \ar[d]^j \\
{}_tU^2 \times_k U^2_s \ar[r] & U \times_S U
}
$$
By
Varieties, Lemma \ref{varieties-lemma-closure-image-product-map}
we see that the closure of the image of ${}_tj \times j_s$ is
${}_tZ \times_k Z_s$. By the commutativity of the diagram we
conclude that ${}_tZ \times_k Z_s$ maps into $Z$ by the bottom
horizontal arrow.
\end{proof}
