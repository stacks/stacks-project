...
$F'_u = (s')^{-1}(u)$ we have $\dim_{e'(u)}(F'_u) = d_2 - 1$.
\end{enumerate}
\end{lemma}
...
via the morphism $u \to U$. As $u \to U$ is locally of finite type,
we see that $(\text{Spec}(\kappa(u)), R', s', t', c')$ is a groupoid scheme
with $s', t'$ locally of finite type, see
...
Algebra, Lemma \ref{algebra-lemma-reformulate-CM}
again. This implies part (3) of the lemma.
To see part (4) note that by Diagram (\ref{equation-restriction})
