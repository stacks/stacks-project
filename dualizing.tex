...
D_\QCoh^+(\mathcal{O}_Z) \ar[u]_{R\SheafHom(\mathcal{O}_Z, -)}
}
$$
is commutative.
\end{enumerate}
...
\begin{proof}
Let $K$ be an object of $D^+_{\textit{Coh}}(\mathcal{O}_X)$.
By Cohomology of Schemes, Lemma \ref{coherent-lemma-i-star-equivalence}
it suffices to show that $i_*$ applied to
$H^n(R\SheafHom(\mathcal{O}_Z, K))$ produces a coherent module on $X$.
TO BE CONTINUED.
\end{proof}
