...
\noindent
It is clear that this does not conflict with setting
...
$\omega_X^\bullet$ will be the good dualizing complex with respect
to $\omega_S^\bullet$.
...
$\omega_X^\bullet$ the good dualizing complex with respect to $k[0]$
and to refer to
$$
\omega_X = H^{-\dim(X)}(\omega_X^\bullet)
$$
...
$\omega_X^\bullet$ be the good dualizing complex on $X$
with respect to $\omega_A^\bullet$. If $x \in X$ is a closed point
...
and let $\omega_X^\bullet$ be the good dualizing complex
with respect to $\omega_S^\bullet$. For all $x \in X$
$$
