...
Lemma \ref{lemma-when-sheafy} holds for all
quasi-compact opens $V$ of $Y$.
\end{lemma}
...
\begin{enumerate}
\item $\omega_X^\bullet = f^!\omega_Y^\bullet$, and
...
\end{enumerate}
See Lemmas \ref{lemma-upper-shriek-composition} and
...
To finish the proof we need to construct maps
