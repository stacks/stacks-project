...
Noetherian rings. Then $\omega_{A/R}^\bullet = \varphi^!(R)$
is an invertible object of $D(A)$ and
...
Moreover, formation of $\omega_{A/R}$ commutes with
...
\item $\omega_{A/R}^\bullet = \varphi^!(R)$
is an invertible object of $D(A)$.
\end{enumerate}
\end{lemma}
...
\noindent
For a flat and finitely presented ring map we can define the notion
of a relative dualizing complex and show that such complexes exist
and are unique up to (noncanonical) isomorphism. This is different from
the definition given in
Section \ref{section-relative-dualizing-complex-algebraic}
because we do not require our rings to be Noetherian.
...
defined in Section \ref{section-relative-dualizing-complex-algebraic}
