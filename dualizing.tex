...
\noindent
The lemma above allows us to define a function
$$
...
over $A_\mathfrak p$ and the residue field $\kappa(\mathfrak p)$.
...
In this case we will say that the dualizing complex is normalized.

\begin{lemma}
\label{lemma-normalized-quotient}
Let $(A, \mathfrak m, \kappa)$ will be a Noetherian local
ring with a normalized dualizing complex $\omega_A^\bullet$.
...
Let $(A, \mathfrak m, \kappa)$ will be a Noetherian local
ring with a normalized dualizing complex. Let $I \subset \mathfrak m$ be an
...
ring with a normalized dualizing complex. Let $f \in \mathfrak m$ be a
