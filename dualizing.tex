...
Thus we may assume $X$ is integral and $\mathcal{F} = \mathcal{O}_U$.

\medskip\noindent
Assume $X$ is integral and $\mathcal{F} = \mathcal{O}_U$.
We will show that Lemma \ref{lemma-sharp-finiteness-pushforward} applies.
Let $z \in Z$ and set $A = \mathcal{O}_{X, x}$.
