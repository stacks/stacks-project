...
$$
(More Algebra, Lemma \ref{more-algebra-lemma-internal-hom})
and the map
$$
L \to R\Hom(C,  L \otimes^\mathbf{L} C)
$$
(More Algebra, Lemma \ref{more-algebra-lemma-internal-hom-diagonal})
we obtain a map
$$
...
More Algebra, Lemma \ref{more-algebra-lemma-completion-RHom}
...
By More Algebra, Lemma \ref{more-algebra-lemma-completion-RHom}
