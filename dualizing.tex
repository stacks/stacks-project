...
Let $(A, \mathfrak m)$ be a Noetherian local ring. Let $f \in \mathfrak m$
be a nonzerodivisor such that $A$ is $f$-adically complete and such that
$H^0_\mathfrak m(A/fA) = H^1_\mathfrak m(A/fA) = 0$.
Let $U$, resp.\ $U_0$ be the punctured spectrum of $A$, resp.\ $A/fA$.
Then
$$
V \longmapsto V_0 = V \times_U U_0
...
assumption of that lemma holds, note that
$A$ has depth $\geq 3$ by Lemma \ref{lemma-depth}
and apply Algebra, Lemma \ref{algebra-lemma-depth-dim-associated-primes}).
...
\medskip\noindent
The vanishing of $H^0_\mathfrak m(A/fA)$ and $H^1_\mathfrak m(A/fA)$
...
If $m'_n \in B_n$ maps to $m_{n + 1}$ then $f(m'_n) = (m_n)$ in $M$.
...
The image of any irreducible component of $V'$ is an
irreducible component of $U'$ and hence meets $U_0$.
Hence $V'_0$ meets every connected component of $V'$ and
we conclude that $a = b$ by \'Etale Morphisms, Proposition
\ref{etale-proposition-equality}.
\end{proof}
...
Let $(A, \mathfrak m)$ be a Noetherian local ring. Let $f \in \mathfrak m$
be a nonzerodivisor. Assume $A$ is $f$-adically complete and that
