...
is a fully faithful functor, then $\textit{F\'Et}_U \to \textit{F\'Et}_{U_0}$
is a fully faithful functor.
\end{lemma}
...
corresponding to the open and closed subscheme $s'(X')$ of $Y'$.
The image $\overline{e}$ of
$e'$ in $B \otimes_A \kappa(\mathfrak m) = B/\mathfrak mB$
lifts to an idempotent $e$ of
