...
Let $A$ be a ring and let $I$ be a finitely generated ideal.
Let $R\Gamma_Z$ be as in (\ref{lemma-local-cohomology-adjoint}).
...
$$
by More Algebra, Lemma \ref{more-algebra-lemma-derived-completion}.
...
More Algebra, Lemma \ref{more-algebra-lemma-derived-completion-vanishes}.
