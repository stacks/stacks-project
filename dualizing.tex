...
schemes. Let $a$ denote the twisted inverse image. FOr every
...
Let $a$ be the twisted inverse image. Then (\ref{equation-sheafy-trace})
$$
Rf_*R\SheafHom(L, a(K)) \longrightarrow R\SheafHom(Rf_*L, K)
$$
...
Since $a(K)|_U$ is the twisted inverse
