...
that will help us prove some of the results in the following sections.
...
$$
essentially surjective. In this section we try to understand how the question
changes when one passes from $X$ to a hypersurface in $X$. These results
will be used in the proofs of our main results on this question:
...
Note that by Theorem \ref{theorem-finiteness}
...
$\dim(A) \geq 3$, see Lemma \ref{lemma-depth},
