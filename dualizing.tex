...
Lemma \ref{lemma-characterize-gorenstein}.
...
(see Definition \ref{definition-dualizing})
and we conclude $A$ has finite dimension by
Lemma \ref{lemma-universally-catenary} and
is Gorenstein by Lemma \ref{lemma-gorenstein}.
...
Hence the claimed vanishing by Lemma \ref{lemma-sitting-in-degrees}
for example.
\end{proof}
...
\end{enumerate}
These statements are Lemmas \ref{lemma-shriek-dualizing-algebraic} and
