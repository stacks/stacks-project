...
provided we prove the lemma for minimal types.
...
\item $m'_i = m_i$ and $m_E = \sum m_ie_i$ and
...
$$
X'_k = b^{-1}X_k = \sum m_i b^{-1}C_i = \sum m_iC'_i + (\sum m_ie_i) E
$$
which proves that $m_E = \sum m_ie_i$. Thus (2) is true. The inequality
