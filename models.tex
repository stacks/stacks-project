...
by Resolutions of Surfaces, Lemma \ref{resolve-lemma-iso-completions}.
...
$H^0(C, \mathcal{O}_X) = K$. A {\it minimal model}
...
Let $C$ be a smooth projective curve over $K$ with
$H^0(C, \mathcal{O}_X) = K$. A minimal model exists.
\end{proposition}
...
See Resolution of Singularities, Section \ref{resolve-section-minus-one}.
