...
hence $|h|(|X|) \subset |Z|$
is dense (Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image}).
On the other hand $|h|(|X|)$ is closed in $|Y|$
(Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-universally-closed-permanence})
hence $X \to Z$ is surjective.
Thus $Z \to B$ is a proper (Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-image-proper-is-proper}).
Since $|f|^{-1}(\{b\}) \to |g|^{-1}(\{b\})$ and
$|X_k \to Z_k$ are surjective,
we see that (3)(a) and (3)(b) imly that $Z \to B$ is quasi-finite
