...
\section{Formally smooth, etale, or unramified morphisms}
...
locally on $T'_{spaces, etale}$. Namely, it is enough to find a set
of objects $\mathcal{S} \subset \text{Ob}(T'_{spaces, etale})$
such that
\begin{enumerate}
\item[(i)] every object of $T'_{spaces, etale}$ has a covering by objects
of $\mathcal{S}$,
...
$T'_{spaces, etale}$ which are schemes, and such that the composition
