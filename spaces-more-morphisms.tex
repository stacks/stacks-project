...
surjective \'etale morphism $U \to X$. By
Lemma \ref{lemma-thickening-equivalence} there exists a $U' \to X'$
...
$Y_\etale = (Y')_\etale$, see
Lemma \ref{lemma-thickening-equivalence}.
...
Lemma \ref{lemma-thickening-equivalence} there exists a $X'_1 \to X'$
...
$$
is surjective \'etale too. By Lemma \ref{lemma-thickening-equivalence}
...
\item $f$ is quasi-finite at $x_1, \ldots, x_n$.
\end{enumerate}
...
\begin{proof}
We may assume $Y$ is an affine scheme as the question is \'etale local on $Y$.
Let $X' \subset X$ be an open subspace containing $x_1, \ldots, x_n$.
Then it suffices to prove the result for $X' \to Y$. Thus we may assume
$X$ is quasi-compact and separated. Choose an affine scheme $Z$ and
surjective \'etale morphism $Z \to X$ (Properties of Spaces, Lemma
\ref{spaces-properties-lemma-quasi-compact-affine-cover}).
The fibres of $|Z| \to |X|$ are finite, see
Properties of Spaces, Lemma
...
after replacing $(Y, y)$ by an \'etale neighbourhood, we may
assume that $Z = Z_1 \amalg Z_2$ with $Z_1 \to Y$ finite and
$(Z_1)_y = \{z_1, \ldots, z_m\}$. Since $X \to Y$ is separated, the
image $V$ of $Z_1 \to X$ is both open and closed
(Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-universally-closed-permanence}).
Set $W = X \setminus V$ to get a decomposition as in the lemma.
To finish the proof we have to show that $V \to Y$ is finite.
It is clear that $V \to Y$ is separated (by assumption) and locally
quasi-finite (as $Z_1$ is finite over $Y$ and an \'etale cover of $V$).
Hence $V$ is a scheme, see Morphisms of Spaces, Proposition
\ref{spaces-morphisms-proposition-locally-quasi-finite-separated-over-scheme}.
By Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}
we conclude that $V \to Y$ is proper. An application of
More on Morphisms, Lemma \ref{more-morphisms-lemma-characterize-finite}
shows $V \to Y$ is finite, finishing the proof.
\end{proof}
...
\medskip\noindent
Let $x \in |U|$ be arbitrary. We claim that there exists an open
...
\medskip\noindent
By the result of the previous paragraph we may replace $Y$ by an
\'etale neighbourhood of $y = f(x)$ in order to prove the claim.
...
\medskip\noindent
Assume (3). Since $f$ is universally closed it is quasi-compact
(Morphisms of Spaces, Lemma
...
Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of algebraic spaces
over $S$. Let $y \in |Y|$ represented by a morphism $\Spec(k) \to Y$.
Assume that $f$ is proper and $|X_k|$ is either finite or discrete.
Then there exists an open neighbourhood $V \subset Y$ of $y$
such that $f|_{f^{-1}(V)} : f^{-1}(V) \to V$ is finite.
\end{lemma}

\begin{proof}
Since $f$ is quasi-compact, we see that $|X_k|$ is a finite discrete
space if it is discrete. Since $f$ is separated of finite type, we see
that $|X_k|$ is a finite discrete space if it is finite
(because a separated finite type algebraic space over a field
has infinitely many points if it has dimension $> 0$; some details
omitted). Thus in both cases we see that $|X_k|$ is finite discrete.

\medskip\noindent
The morphism $f$ is quasi-finite at all the points of $f^{-1}(\{y\})$ by
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-quasi-finite-at-point}.
By
Morphisms of Spaces, Lemma
...
Let $S$ be a scheme. Let $U \to X$ be a surjective \'etale morphism
of algebraic spaces over $S$. Assume $X$ is a quasi-compact and
quasi-separated algebraic space. Then there exists a surjective
integral morphism $Y \to X$ where $Y$ is a scheme, such that for
every $y \in Y$ there is an open neighbourhood $V \subset Y$
such that $V \to X$ factors through $U$.
\end{lemma}

\begin{proof}
Choose a surjective \'etale morphism $U' \to U$ where $U'$ is a scheme.
It is clear that we may replace $U$ by $U'$ and hence we may assume $U$
is a scheme. Since $X$ is quasi-compact, there exist finitely many
affine opens $U_i \subset U$ such that $U' = \coprod U_i \to X$ is surjective.
...
\begin{lemma}
\label{lemma-there-is-a-scheme-finite-over}
In the the situation of Lemma \ref{lemma-there-is-a-scheme-integral-over}
we may choose $Y$ to be finite and of finite presentation over $X$.
\end{lemma}
...
Limits of Spaces, Lemma
\ref{spaces-limits-lemma-integral-limit-finite-and-finite-presentation}.
...
of $X_{\overline{y}}$. Thus, if $X_{\overline{y}} = T_1 \coprod T_2$
...
\item $V \subset Y$ is scheme theoretically dense, and
\item $f|_{f^{-1}V} : f^{-1}V \to V$ has relative dimension $\leq d$.
\end{enumerate}
...
More on Morphisms, Lemma
\ref{more-morphisms-lemma-flat-finite-presentation-dimension-over-dense-open}.
\end{proof}
...
$\text{Coh}(U_0, \mathcal{I}_0) \to \text{Coh}(U_1, \mathcal{I}_1)$
and
$\text{Coh}(U_1, \mathcal{I}_1) \to \text{Coh}(U_2, \mathcal{I}_2)$
(Cohomology of Schemes, Lemma \ref{coherent-lemma-inverse-systems-pullback}).
The lemma then follows formally from the description of
$\text{Coh}(X, \mathcal{I})$ as a category of descent data.
