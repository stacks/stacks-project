...
X = V \amalg W
$$
into open and closed subschemes where $V \to Y$ is finite and $x \in V$,
...
$f$ is quasi-compact and $\nu : Y' \to Y$ is separated (Morphisms
of Spaces, Lemma \ref{spaces-morphisms-lemma-quasi-compact-permanence}).
