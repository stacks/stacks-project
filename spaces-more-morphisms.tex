...
\begin{proof}
Omitted. Hints: Via Properties of Spaces, Lemma
\ref{spaces-properties-lemma-codimension-0-points}
and \'etale localization
this translates into the case of a morphism of schemes
and generic points of irreducible components.
Here the result follows as generalizations lift
along flat morphisms of schemes, see
Morphisms, Lemma \ref{morphisms-lemma-generalizations-lift-flat}.
\end{proof}

\begin{lemma}
\label{lemma-smooth-over-normal}
Let $S$ be a scheme. Let $X \to Y$ be a smooth morphism of algebraic
spaces over $S$ with $Y$ normal. Then $X$ is normal.
\end{lemma}

\begin{proof}
Omitted. Hint: via \'etale localization this follows from
...
Let $S$ be a scheme. Let $X \to Y$ be a smooth morphism of algebraic spaces
over $S$. Assume $Y$ satisfies the equivalent conditions of
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-prepare-normalization}.
Then the same is true for $X$ and there is a canonical isomorphism
$X^\nu = X \times_Y Y^\nu$ where $X^\nu$, $Y^\nu$ are the normalizations
of $X$, $Y$.
\end{lemma}

\begin{proof}
Choose a surjective \'etale morphism $V \to Y$ where $V$ is a scheme. Choose
a surjective \'etale morphism $U \to X \times_Y V$ where $U$ is a scheme.
By assumption every quasi-compact open of $V$ has a finite number of
irreducible components.
By Descent, Lemma \ref{descent-lemma-locally-finite-nr-irred-local-fppf}
every quasi-compact open of $U$ has finitely many irreducible components.
Thus we see that $X$ satisfies the equivalent conditions of
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-prepare-normalization}.
Hence the normalization of $X$ is defined, see Morphisms of Spaces, Definition
\ref{spaces-morphisms-definition-normalization}.

\medskip\noindent
Consider the composition $X^\nu \to X \to Y$. Every codimension $0$
point of $X^\nu$ maps to a codimension $0$ point of $X$ by
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-normalization-normal}.
By Lemma \ref{lemma-flat-image-point-codimension-0}
(and the fact that smooth morphisms are flat, see
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-smooth-flat})
every codimension $0$ point of $X$ maps to a codimension $0$ point
of $Y$. Hence by Morphisms of Spaces, Lemma
...
$$
Thus we obtain a morphism $g : X^\nu \to X \times_Y Y^\nu$ over $X$.
We will show that $g$ is an isomorphism in the next paragraph.

\medskip\noindent
Let $V \to Y$ and $U \to X \times_Y V$ be as in the first paragraph
of the proof. We will show that the base change of $g$ by
$U \to X$ is an isomorphism. We have
$$
U \times_X (X \times_Y Y^\nu) =
U \times_Y Y^\nu =
U \times_V (V \times_Y Y^\nu) =
U \times_V V^\nu = U^\nu
$$
Here the first and second equalities are formal, the third equality
is the construction of $Y^\nu$ in
Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-normalization} (see
Morphisms of Spaces, Definition
\ref{spaces-morphisms-definition-normalization}), and
the fourth equality is the case of schemes of the
lemma shown in
More on Morphisms, Lemma \ref{more-morphisms-lemma-normalization-and-smooth}.
We omit the verification that these identifications
are compatible with the identification
$U \times_X X^\nu = U^\nu$ on the source of the arrow $g$.
This finishes the proof.
\end{proof}
