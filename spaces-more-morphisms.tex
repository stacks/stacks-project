...
Hence $X' \to B'$ is an isomorphism onto the connected component of $B'$
containing $U$. As $U \subset B'$ is dense $X' = B'$.
\end{proof}
...
Let $f : X \to \Spec(A)$ be a finite type separated morphism of
algebraic spaces. Let $\mathcal{I} = I\mathcal{O}_X$.
