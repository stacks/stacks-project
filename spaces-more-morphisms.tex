...
Let $S$ be a scheme.
Let $f : X \to Y$ be a representable smooth morphism of algebraic spaces
over $S$. Then $f$ is formally smooth as a transformation of functors.
\end{lemma}
...
$$
as in
Definition \ref{definition-formally-smooth}. Then $X \times_Y T'$ is
