...
Descent, Lemma \ref{descent-lemma-etale-local-source-target}
and
Curves, Lemmas \ref{curves-lemma-nodal-family-etale-local-source},
...
Curves, Lemmas \ref{curves-lemma-base-change-nodal-family} and
...
and
Curves, Lemma \ref{curves-lemma-base-change-nodal-family}.
\end{proof}
...
(Curves, Lemma \ref{curves-lemma-locus-where-nodal})
