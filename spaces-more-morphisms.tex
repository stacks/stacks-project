...
spaces over $S$.
\begin{enumerate}
\item We say $i$ is a Koszul-regular immersion if $i$ is representable
...
\item We say $i$ is an $H_1$-regular immersion if $i$ is representable
and the equivalent conditions of
Lemma \ref{lemma-representable-etale-local-target}
hold with $\mathcal{P}(f) =$``$f$ is an $H_1$-regular immersion''.
\item We say $i$ is a quasi-regular immersion if $i$ is representable
and the equivalent conditions of
Lemma \ref{lemma-representable-etale-local-target}
