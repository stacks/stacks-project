...
$\text{id}_{small, \acute{e}tale, Zar} : X_{\acute{e}tale} \to X_{Zar}$
discussed in
...
is equal to $\text{id}_{small, \acute{e}tale, Zar, *}$, since
$\text{id}_{small, \acute{e}tale, Zar}^*$ is left adjoint to
$\text{id}_{small, \acute{e}tale, Zar, *}$ and since
$(\Omega_{X/Y})^a = \text{id}_{small, \acute{e}tale, Zar}^*\Omega_{X/Y}$
...
\noindent
We show that the site $X_{spaces, \acute{e}tale}$ is a ``topological
invariant''. It then follows that $X_{\acute{e}tale}$, which
...
$Y_{\acute{e}tale} \to X_{\acute{e}tale}$.
\end{lemma}

\begin{proof}
This is just the statement that given an object
$V \in Y_{spaces, \acute{e}tale}$ we have $V$ is a scheme if and
...
(\Sh(X'_{spaces, \acute{e}tale}), \mathcal{O}_{X'})
\cong
(\Sh(X_{spaces, \acute{e}tale}), \mathcal{O}_{X'})
\end{equation}
...
(\Sh(X_{spaces, \acute{e}tale}), \mathcal{O}_{X'})
\longrightarrow
(\Sh(Y_{spaces, \acute{e}tale}), \mathcal{O}_{Y'})
$$
...
For each $i$ we may consider the small \'etale site $X_{i, \acute{e}tale}$.
For each morphism $i \to j$ of $\mathcal{I}$ we have the morphism
$X_i \to X_j$ and hence a pullback fuctor
$X_{j, \acute{e}tale} \to X_{i, \acute{e}tale}$.
Hence we obtain a pseudo functor from $\mathcal{I}^{opp}$ into
the $2$-category of categories. Denote
$$
\lim_i X_{i, \acute{e}tale}
$$
...
Then we get a functor $T_{\acute{e}tale} \to \lim X_{i, \acute{e}tale}$.
...
\item the functor $X_{\acute{e}tale} \to \lim X_{i, \acute{e}tale}$
is an equivalence.
\end{enumerate}
...
Then $U_i \to X_i$ forms an object of $\lim X_{i, \acute{e}tale}$. By
...
$Y_{\acute{e}tale} = (Y')_{\acute{e}tale}$, see
...
that lemma there exists an open suspace $U' \subset Y'$ such that
...
\medskip\noindent
Asssume that $Y$ is separated of finite type over $\Spec(\mathbf{Z})$.
...
\begin{proof}
Since $\mathcal{H}$ is a sheaf on $X_{\acute{e}tale}$ and since
...
$$
\text{Mor}_{\textit{Coh}(\mathcal{O}_X)}(\mathcal{F}, \mathcal{G})
\longrightarrow
\text{Mor}_{\textit{Coh}(X, \mathcal{I})}
(\mathcal{F}^\wedge, \mathcal{G}^\wedge)
$$
