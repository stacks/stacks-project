...
mapping to $y'_i$ (Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-enough-finite-type-points}).
We conclude that $\kappa(y'_i)/\kappa(y)$ is finite:
...
\medskip\noindent
Assume that $X_{\overline{y}}$ is connected. We will show that
$Y' \to Y$ is an isomorphism in a neighbourhood of $y$ which
finishes the proof. By cohomology and base change
(more precisely Derived Categories of Spaces, Lemma
...
and the fact that $X_y$ is geometrically connected and geometrically
...
$j : Z \to Y$ with $H^0(Lj^*E)$ invertible. Observe that $y \in Z$.
...
Thus $R\text{pr}_{1, *}\mathcal{O}_{X \times_Y X} = \mathcal{O}_X \oplus E'$
in $D(\mathcal{O}_X)$. It follows that
$H^0(Li^*E') = 0$ for any point $x : \Spec(k) \to X$ of $X$ lying over $y$.
Since $E'$ is perfect (as a summand of a perfect complex)
we conclude that $H^0(E')$ is zero in an \'etale neighbourhood
$U$ of $x$, see More on Algebra, Lemma
\ref{more-algebra-lemma-lift-perfect-from-residue-field}.
Thus the composition $U \to X \to Y$ factors through $Z$ by
the universal property of $Z$. As $X \to Y$ is open
(Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-fppf-open})
the image of $U \to Y$ is an open $V \subset Y$.
Then $\{U \to V\}$ is an fppf covering and we conclude
that $V \subset Z$, i.e., after replacing $Y$ by $V$
we have $Z = Y$. In this case $f_*\mathcal{O}_X$ is an invertible
$\mathcal{O}_Y$-module. We conclude because
