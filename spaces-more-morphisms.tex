...
we obtain (6). Finally, part (9) follows from the fact that any
...
\medskip\noindent
A morphism of algebraic spaces is locally quasi-finite if and only if
it is locally of finite type and the scheme theoretic fibres have
underlying discrete topological spaces, see
Morphisms of Spaces, Lemma
