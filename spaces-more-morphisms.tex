...
algebraic space over $S$. Let $U \to X_1$ and $U \to X_2$ be immersions
...
\begin{proof}
Throughout the proof all the algebraic spaces with be separated of finite
...
(Morphisms of Spaces, Lemma \ref{morphisms-lemma-quasi-compact-immersion}).
