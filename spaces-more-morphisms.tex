...
\section{Push outs in the category of algebraic spaces}
...
$$
the $2$-limit (see insert future reference here). What does this mean in
practice? An object of this limit is a system of \'etale morphisms
...
Let $Y' = Y \amalg_X X'$ be the push out in the category of schemes (see
More on Morphisms, Lemma \ref{more-morphisms-lemma-pushout-along-thickening}).
Then $Y'$ is also a push out in the category of algebraic spaces over $S$.
\end{lemma}
