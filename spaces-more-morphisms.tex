...
In Lemmas \ref{spaces-more-morphisms-lemma-blowup-to-find-embedding} and
\ref{spaces-more-morphisms-lemma-chow-noetherian}
...
$$
is an immersion (because the compostion with the projection
