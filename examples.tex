...
and one where the rank is $\alpha_0$.
...
\cite[0${}_{IV}$, Example 19.10.3(i)]{EGA}
...
\cite[0${}_{IV}$, Example 19.3.10(i)]{EGA},
...
\noindent
In the following we fix a big \'etale site $\textit{Sch}_{\acute etale}$
as constructed in
...
\medskip\noindent
Consider the functor $F : \textit{Sch}_{\acute etale} \to \textit{Ab}$
...
$\textit{Sch}_{\acute etale}$ with the following properties
\begin{enumerate}
...
$F(f)(b) = b \circ f$. Thus $F$ is a presheaf on $\textit{Sch}_{\acute etale}$.
