...
with restriction to the open subscheme $U = \Spec(k[t. 1/t]) \subset Y$.
Namely, the preimage of $U$ in $X$ is empty and hence the scheme theoretic
image of $f|_{f^{-1}(U)} : f^{-1}(U) \to U$ is the empty scheme
(and this is not equal to $X \cap U$).
\end{enumerate}
