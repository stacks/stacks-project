...
\noindent
Let $X \to S$ be any morphism of schemes. Let $G = S \amalg X$.
...
This defines a group law. Thus taking $X \to S$ to be any
nonflat morphism of schemes we get an example of a group scheme
