...
and satisfy the flat base change property (Cohomology on Stacks,
...
Cohomology of Sites, Lemma \ref{sites-cohomology-lemma-K-injective}
...
of $\mathcal{O}_S$ which is not a quasi-coherent $\mathcal{O}_S$-module.
