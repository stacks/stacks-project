...
Thus all the assumptions of Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-O-homology-B-homology-general}
...
\ref{sites-cohomology-lemma-get-it-now}. Let $P_\bullet \to B$ be a
...
\section{Deformations of ring maps and the naive cotangent complex}
\label{section-deformations}

\noindent
This section is the continuation of
More on Algebra, Section \ref{section-deformations}
...
More on Algebra, Lemmas \ref{more-algebra-lemma-huge-diagram} and
\ref{more-algebra-lemma-choices}.

\medskip\noindent
Proof of (1). We will use the results of
More on Algebra, Lemma \ref{more-algebra-lemma-extensions-of-rings}
