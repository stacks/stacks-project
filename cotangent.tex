...
Let $\mathcal{A}$ be the category of $f^{-1}\mathcal{O}_\mathcal{D}$-algebras.
Consider the pair of adjoint functors $(F, i)$ where
$i : \mathcal{A} \to \Sh(\mathcal{C})$ is the forgetful functor and
$F : \Sh(\mathcal{C}) \to \mathcal{A}$ assigns to a sheaf of sets $\mathcal{E}$
the polynomial algebra $f^{-1}\mathcal{O}_\mathcal{D}[\mathcal{E}]$ on
$\mathcal{E}$ over $f^{-1}\mathcal{O}_\mathcal{D}$.
...
(\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})$ is a morphism of ringed
topoi. Then $\mathcal{O}_\mathcal{C}$ is an object of the category
$\mathcal{A}$. Denote $\mathcal{P}_\bullet = X_\bullet(B)$ the resulting
simplicial $f^{-1}\mathcal{O}_\mathcal{D}$-algebra.
Recall that
$\mathcal{P}_0 = f^{-1}\mathcal{O}_\mathcal{D}[\mathcal{O}_\mathcal{C}]$,
$\mathcal{P}_1 = f^{-1}\mathcal{O}_\mathcal{D}[
f^{-1}\mathcal{O}_\mathcal{D}[\mathcal{O}_\mathcal{C}]]$, and so on.
Recall also that there is an augmentation
$$
\epsilon : \mathcal{P}_\bullet \longrightarrow \mathcal{O}_\mathcal{C}
$$
where we view $\mathcal{O}_\mathcal{C}$ as a constant simplicial
$f^{-1}\mathcal{O}_\mathcal{D}$-algebra.

\begin{definition}
\label{definition-standard-resolution-morphism-ringed-topoi}
Let $(f, f^\sharp) : (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \to
(\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})$ be a morphism of ringed
topoi. The {\it standard resolution of $\mathcal{O}_\mathcal{C}$ over
$\mathcal{O}_\mathcal{D}$} is the augmentation
$\epsilon : \mathcal{P}_\bullet \to \mathcal{O}_\mathcal{C}$
with terms
$$
\mathcal{P}_0 = f^{-1}\mathcal{O}_\mathcal{D}[\mathcal{O}_\mathcal{C}],\quad
\mathcal{P}_1 = f^{-1}\mathcal{O}_\mathcal{D}[
f^{-1}\mathcal{O}_\mathcal{D}[\mathcal{O}_\mathcal{C}]],\quad \ldots
$$
and maps as constructed above.
\end{definition}

\noindent
With this definition in hand the cotangent complex is defined as follows.
...
$(f, f^\sharp) : (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \to
(\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})$
is the complex of $\mathcal{O}_\mathcal{C}$-modules associated to the
simplicial module
$$
\Omega_{\mathcal{P}_\bullet/\mathcal{O}_\mathcal{D}}
\otimes_{\mathcal{P}_\bullet, \epsilon} \mathcal{O}_\mathcal{C}
$$
where $\epsilon : \mathcal{P}_\bullet \to \mathcal{O}_\mathcal{C}$
is the standard resolution of $\mathcal{O}_\mathcal{C}$ over
