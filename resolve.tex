...
Duality for Schemes, Lemma \ref{duality-lemma-proper-noetherian-relative}
...
Lemma \ref{duality-lemma-proper-noetherian-relative}).
...
\begin{proof}
Observe that $A$ is Gorenstein (Duality for Schemes,
Lemma \ref{duality-lemma-regular-gorenstein})
...
Gorenstein (Duality for Schemes, Lemma
\ref{duality-lemma-regular-gorenstein}). If $x$ is a singular point of
...
(Duality for Schemes, Lemma \ref{duality-lemma-ubiquity-dualizing}).
