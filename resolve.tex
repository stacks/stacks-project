...
$H^1(X, \mathcal{O}_X)$
(Cohomology of Sites, Lemma \ref{sites-cohomology-lemma-h1-extensions}).
...
(Dualizing, Example \ref{dualizing-example-proper-over-local}).
...
Dualizing, Section \ref{dualizing-section-dualizing-local}.
...
Thus $\omega_X^\bullet = \omega_X[2]$ (Dualizing, Lemma
\ref{dualizing-lemma-dualizing-module-CM-scheme} and the
normalization in Dualizing, Example \ref{dualizing-example-proper-over-local}).
...
Dualizing, Lemma \ref{dualizing-lemma-proper-noetherian-relative}
...
Dualizing, Lemma \ref{dualizing-lemma-shriek-dualizing}).
\end{proof}
