...
of $\Spec(A)$,
\item $f$ is locally of finite type, $X$ is decent, and $|X| \to \Spec(A)$
maps the generic points of irreducible components of $|X|$ to the generic
point of $\Spec(A)$,
\item add more here.
\end{enumerate}
...
$U = \Spec(B)$ and an \'etale morphism $U \to X$. We have to show that
...
\section{Vanishing; under construction}
...
This is permissible, because if the conormal sheaf of $Z$ is trivial,
then so is the conormal sheaf of $e_i Z$.
