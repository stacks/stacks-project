...
In Situation \ref{situation-rational} assume $A$ is Nagata and has a
...
hence (2) holds because $\Gamma(X, \omega_X) = \omega_A$ is used
in Lemma \ref{lemma-dualizing-rational} to define the map.
\end{proof}

\begin{lemma}
\label{lemma-rational-to-gorenstein}
Let $(A, \mathfrak m, \kappa)$ be a local Noetherian normal domain of
...
$$
such that $X_n$ domninates $Y$. By Lemma \ref{lemma-blow-up-normal-rational}
