...
$\Spec(A/_\lambda)$ for all $\lambda$ we find an open subscheme
...
For this it certainly suffices to assume the size of $\mathfrak X$
and $\mathfrak Y$ is at most the size of a scheme contained in $\Sch_\alpha$.
\end{proof}
