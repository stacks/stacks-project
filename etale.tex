...
$(\textit{Sch}/S)_\tau$ and sometimes a small\footnote{The words big and
...
\noindent
Thus the corresponding standard coverings of affines are.
...
\noindent
Another possible definition is to assume the existence of 
strongly inaccessible cardinals and to define $\textit{Sch}_{Zar}$
