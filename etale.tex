...
Let $S$ be a scheme. Given $U, V$ finite \'etale over $S$ there
exists a scheme $W$ finite \'etale over $S$ such that
$$
\Mor_S(S, W) = \Mor_S(U, V)
$$
...
there exists a scheme $W$ representing $\mathit{Mor}_S(U, V)$.
...
To finish the proof we have to show that $W \to S$ is finite \'etale.
This we may do after replacing $S$ by the members of an \'etale
