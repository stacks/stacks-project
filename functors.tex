...
it suffices to show that $F'(L_i) \to F(M_i)$ is the cokernel of
...
$F(L_i) \to F(M_i)$ is the cokernel of
...
functor from the full subcategory of
...
and $F$ the functor (\ref{equation-FM-QCoh}). By the discussion in
