...
any of the assumptions implies the completion functor
$$
...
$$
is fully faithful on the full subcategory of locally free objects.
...
\lim \Gamma(U, \mathcal{O}_U/f^n\mathcal{O}_U)
$$
See Algebraic and Formal Geometry, Lemma
\ref{algebraization-lemma-completion-fully-faithful-general}.
This follows from assumption (2) and Algebraic and Formal Geometry, Theorem
