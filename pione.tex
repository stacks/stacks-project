...
Thus $Y \times_X U \to U$ is \'etale and by
...
$N$ of (2) and (3) is contained in the kernel of
$\text{Gal}(K^{sep}/K) \longrightarrow \pi_1(X)$.
...
Purity of branch locus will tell us (see below) that if $X$ is regular,
then it suffices in
Lemma \ref{lemma-normal-pione-quotient-inertia}
