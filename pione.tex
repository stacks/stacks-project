...
$G$-set corresponing to $X$ has one element which means $X$ is
...
A composition of specialziation maps
...
Dualizing Complexes, Section \ref{dualizing-section-discriminant}.
...
Dualizing Complexes, Lemma \ref{dualizing-lemma-discriminant}
...
we conlude that $Z'$ is the base change of a finite \'etale
