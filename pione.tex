...
\medskip\noindent
Conversely, assume $Y \to X$ is unramified. Since a normal scheme is unibranch
(Properties, Lemma \ref{properties-lemma-normal-geometrically-unibranch}),
we see that the morphism $Y \to X$ is \'etale by More on Flatness, Lemma
\ref{flat-lemma-global-unramified-dominant-unibranch-is-etale}.
