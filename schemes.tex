...
Categories, Lemma \ref{lemma-pasting-law-pullbacks}.
...
\ref{definition-closed-immersion-locally-ringed-spaces}.
...
Lemma \ref{lemma-magic-square} and apply
...
Lemma \ref{lemma-base-change-diagonal-1-cat} plus
