...
of locally ringed spaces. Then $Z$ is a scheme, and the kernel
$\mathcal{I}$
of the map $\mathcal{O}_X \to i_*\mathcal{O}_Z$ is a quasi-coherent
sheaf of ideals. In particular, any sheaf of ideals
locally generated by sections is a quasi-coherent sheaf of ideals,
...
neighbourhood $i(z) \in U \subset X$. Say $U \cong \text{Spec}(R)$.
...
\noindent
Now, let us specialize this to the case of fields.
...
\noindent
Before we prove a bunch of standard results on quasi-compact morphisms
we first do a more interesting lemma.
...
$S = \bigcup U_i$ such that all $f^{-1}(U_i)$ are quasi-compact.
\end{lemma}
