...
Let $X$ be a scheme. Let $x, x' \in X$. The following are equivalent:
\begin{enumerate}
\item $x$ is a specialization of $x'$, and
...
\end{enumerate}
In this case there exists such a morphism such that the induced map
$\kappa(x') \to f.f.(A)$ is an isomorphism.
\end{lemma}
...
\begin{lemma}
\label{lemma-specialization-dvr}
Let $S$ be a scheme.
Let $s' \leadsto s$ be a specialization of points of $S$.
Then
\begin{enumerate}
\item there exists a valuation ring $A$ and a morphism
$\text{Spec}(A) \to S$ such that the generic point $\eta$ of
$\text{Spec}(A)$ maps to $s'$ and the special point maps to $s$, and
...
Lemma \ref{lemma-lift-specializations-valuative}
