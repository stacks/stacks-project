...
By Lemma \ref{lemma-widetilde-constructions} to give a map
...
Using Lemma \ref{lemma-widetilde-constructions} and
Modules, Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves}
...
Modules, Lemmas \ref{modules-lemma-tensor-product-pullback} and
\ref{modules-lemma-pullback-tensor-algebra} and with internal hom
if the first module is finitely presented by
