...
$$
of Cohomoloy, Section \ref{cohomology-section-ext}. Recall that
...
Lemma \ref{lemma-bounded-fibres}. We conclude we can write
$$
K_n[n] = K \oplus C_n
$$
for $n \gg 0$ compatible with transition maps.
