...
For $X \in D^b(\mathcal{A})$ with $H^i(X) = 0$ for $i \not \in [a, b]$
...
Let $\mathcal{A}$ be an abelian category with enough negative objects.
Let $f : X \to X'$ be a morphism of $D^b(\mathcal{A})$ with
$H^i(X) = 0$ for $i \not \in [a, b]$ and $H^i(X') = 0$ for $i \geq b$.
...
The following are equivalent
\begin{enumerate}
\item $H^i(K)_x = 0$ for $i > b$ and
\item $\Hom_X(K, \mathcal{O}_x[-i]) = 0$ for $i > b$.
\end{enumerate}
\end{lemma}
