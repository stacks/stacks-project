...
\item $\mathfrak p \not \in V(I) \cap V(J)$, and
\item for all primes $\mathfrak p' \subset \mathfrak p$
and $\mathfrak q \in V(I + J)$ with $\mathfrak p' \subset \mathfrak q$ we have
$\text{depth}_{A_{\mathfrak p'}}(M_{\mathfrak p'}) +
...
for $i \leq s + d$.
This follows from Lemma \ref{lemma-kill-general}.
\end{proof}
...
Lemma \ref{lemma-kill-completion-general}
goes through in this (degenerate) case also.
\end{proof}
