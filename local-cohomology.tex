...
(and More on Algebra, Lemma \ref{more-algebra-lemma-torsion-near-projective}).
...
\section{A bit of uniformity, bis}
...
\noindent
As in Section \ref{section-uniform-vanishing} we denote $q(A, I) \geq 0$
