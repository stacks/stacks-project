...
$$
0 \to M[x] \to M \to M \to M/xM \to 0
$$
and flatness we see that $M[x] \otimes_{A, F} A \cong M[x]$ and
$M/x M \otimes_{A, F} A \cong M/xM$.
To get a contradiction, assume $M/xM$ is nonzero.
Arguing as above, we find a nonzero element $z \in (M/xM)[\mathfrak m]$.
By Algebra, Lemma \ref{algebra-lemma-annihilator-flat-base-change}
we have $\text{Ann}_A(z \otimes 1) = F(\mathfrak m)A$.
Since $F(\mathfrak m) \subset \mathfrak m^2$,
this implies $x \not \in \text{Ann}_A(M/xM)$ which is absurd.
Thus we see that $M$ is $x$-divisible.
If $\varphi$ is not surjective, then we can choose
$e \in \bigoplus_{j \in J} E$ not in $M$.
Arguing as above we may assume $\mathfrak m e \subset M$,
...
is $\mathfrak m/(x)$-power torsion and satisfies
$M[x] \otimes_{A/xA, F} A/xA \cong M[x]$, see above.
...
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-relative-frobenius-etale}.
