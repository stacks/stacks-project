...
\begin{proof}
Let us first prove the final assertion. To do this we may
assume $A$ is reduced. Observe that $A$ has a dualizing complex
...
If we assume $d > \text{cd}(A, I)$, then we may apply
...
right hand side has a nontrivial idempotent.
