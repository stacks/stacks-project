...
and more precise Lemma \ref{lemma-bound-tor-almost-projective}
(an $I^m$-torsion module is $I^m$-projective by
More on Algebra, Lemma \ref{more-algebra-lemma-torsion-near-projective}).
...
use in a chapter on formal schemes (and formal algebraic spaces)
to solve a lifting problem, see Restricted Power Series, Lemma
...
finite $A$-module $M$ we denote $\mathcal{G}_M$ the quasi-coherent
$\mathcal{O}_X$-module
associated to the graded module $\bigoplus_{n \geq 0} I^nM$ over
the Rees algebra, see Constructions, Definition
\ref{constructions-definition-structure-sheaf}.
Then there is a short exact sequence
$$
0 \to \tau_M \to p^*\widetilde{M} \to \mathcal{G}_M \to 0
$$
where $\tau_M$ is the coherent submodule of sections of $p^*\widetilde{M}$
supported on the exceptional divisor. Namely, the quasi-coherent module
$p^*\widetilde{M}$ is the quasi-coherent module associated to the
graded module $M \otimes_A \bigoplus_{n \geq 0} I^n$ which surjects
onto $\bigoplus_{n \geq 0} I^nM$. We omit the proof of the characterization
of $\tau_M$ (hint: prove we get an isomorphism over the complement of the
exceptional divisor). Given a short exact sequence
$$
0 \to K \to L \to M \to 0
$$
...
In the situation above if $M$ is $I^c$-projective
(see More on Algebra, Section \ref{more-algebra-section-near-projective}),
then $\tau_M$ is annilated by $I^c$.
\end{lemma}
...
\noindent
As in Section \ref{section-uniform-vanishing-bis} we denote $q(A, I) \geq 0$
an integer such that for all $q \geq q(A, I)$ we have
$H^i(X, \mathcal{O}_X(q)) = 0$ for $1 \leq i \leq d$ and
$H^0(X, \mathcal{O}_X(q)) = I^q$. Such an integer exists by
Cohomology of Schemes, Lemmas \ref{coherent-lemma-coherent-on-proj} and
\ref{coherent-lemma-recover-tail-graded-module}.

\medskip\noindent
Also, we denote $d = d(A, I)$ the maximum of the dimensions
of the fibres of $p$. Observe that $d \leq t - 1$ if $I = (a_1, \ldots, a_t)$
since then $X \subset \mathbf{P}^{t - 1}_A$.

\begin{proposition}
\label{proposition-vanishing-coh-almost-projective}
In the situation above with $q(A, I)$ and $d = d(A, I)$ as above, suppose
we have
\begin{enumerate}
\item an integer $c \geq 0$,
\item an $I^c$-projective finite $A$-module $M$,
\item an index $i \in \{0, 1, \ldots, d\}$, and
\item and an integer $q \geq q(A, I) + (d - i)c$.
\end{enumerate}
Then, in case $i > 0$ the map
$H^i(X, \mathcal{G}_M(q)) \to H^i(X, \mathcal{G}_M(q - (d - i)c))$
is zero and in case $i = 0$ the map
$$
...
$H^d(X, \mathcal{G}_M(q)) = 0$ for $q \geq q(A, I)$.
By the surjectivity of the map $\mathcal{O}_X^{\oplus r} \to \mathcal{G}_M$
and the vanishing of cohomology in degrees $> d$ for coherent modules
it suffices to prove that $H^d(X, \mathcal{O}_X(q)) = 0$.
This holds by our choice of $q(A, I)$.
...
H^{i + 1}(X, \mathcal{H}(q - (d - i)c))$
as $q - (d - i)c \geq q(A, I)$ gives the vanishing of the first module
by our choice of $q(A, I)$. Thus it suffices to show that
...
arrow in the diagram. Since $K$ is $I^c$-projective (More on Algebra,
Lemma \ref{more-algebra-lemma-ses-near-projective}) by induction
...
$$
because for $q \geq q(A, I) + dc$ we have
$H^0(X, \mathcal{O}_X^{\oplus r}(q - dc)) = (I^{q - dc})^{\oplus r}$
by our choice of $q(A, I)$. To show the inclusion above, it suffices
...
In the situation above with $q(A, I)$ and $d = d(A, I)$ as above.
For $c \geq 0$, for any $I^c$-projective finite $A$-module $M$, and
any $q \geq q(A, I) + (d + 1)c$, the map
$\text{Tor}_i^A(M, A/I^q) \to \text{Tor}_i^A(M, A/I^{q - (d + 1)c})$
is zero for all $i > 0$.
\end{lemma}
...
0 \to K \to A^{\oplus r} \to M \to 0
$$
Recall that $K$ is $I^c$-projective (More on Algebra,
Lemma \ref{more-algebra-lemma-ses-near-projective}).
The long exact sequence of $\text{Tor}$ gives an isomorphism
$$
...
Proposition \ref{proposition-vanishing-coh-almost-projective}
we find that $\sigma_a'$ comes from an element $a'$ of $I^{q - (d + 1)c}K$.
Then $a$ and $a'$ restrict to the same element of
$\mathcal{O}_{\Spec(A)}^{\oplus r}$ over the open
$U = \Spec(A) \setminus V(I)$. Both $a$ and $a'$
may be viewed as elements of $(I^{q - (d + 1)c})^{\oplus r}$. Now
$I^{q - (d + 1)c} = \Gamma(X, \mathcal{O}_X(q - (d + 1)c))$
because $q - (d + 1)c \geq q(A, I)$ hence we see that $I^{q - (d + 1)c}$
is $I$-torsion free. It follows that $a = a'$ and we conclude
the class of $a$ maps to zero in $\text{Tor}_1^A(M, A/I^{q - (d + 1)c})$
as desired.
\end{proof}
...
factors through a finite free module (see More on Algebra, Lemma
\ref{more-algebra-lemma-factor-through-finite-projective})
and that the cokernel is zero for $M = A$.
\end{proof}
...
and the fact that $M^\vee$ is $I^c$-projective
...
$\alpha$ restrict to the same map between coherent modules
on the open subscheme
$U = \Spec(A) \setminus V(I)$. Observe that $\Hom_A(M, I^{q - dc})$
is $I$-power torsion free as we have $I^{q - dc} = H^0(X, \mathcal{O}_X(q))$
by our choice of $q(A, I)$ and this module of global sections is $I$-power
torsion free. We conclude that $\psi$ and $\alpha$ give the same
element of $\Hom_A(M, I^{q - dc})$ as desired.
\end{proof}

\begin{lemma}
\label{lemma-bound-hom-for-almost-projective-variant}
In the situation above with $q(A, I)$ and $d = d(A, I)$ as above.
For any $c \geq 0$ and for every $I^c$-projective finite $A$-module $M$
and any $q \geq q(A, I) + (d + 1)c$
the map $\Hom_A(M, I^q) \to \Hom_A(M, I^{q - (d + 1)c})$
has image contained in $I^c\Hom_A(M, I^{q - (d + 1)c})$.
\end{lemma}

\begin{proof}
This is just another way to state the result obtained in
Lemma \ref{lemma-bound-hom-for-almost-projective}. Namely, we have
\begin{align*}
\Hom_A(K, I^q)
...
In the situation above with $q(A, I)$ and $d = d(A, I)$ as above.
For any $c \geq 0$ and for every $I^c$-projective finite $A$-module $M$
and any $q \geq q(A, I) + tc$ the map
$\Ext^i_A(M, I^q) \to \Ext^i_A(M, I^{q - tc})$ is zero for all $i > 0$.
\end{lemma}
...
0 \to K \to A^{\oplus r} \to M \to 0
$$
Recall that $K$ is $I^c$-projective (More on Algebra, Lemma
\ref{more-algebra-lemma-ses-near-projective}).
The long exact sequence of $\Ext$ gives a surjection
$$
...
$$
and Lemma \ref{lemma-bound-hom-for-almost-projective-variant}
...
Then
\begin{enumerate}
\item for any integer $c \geq 0$,
\item for any object $K$ of $D(A)$ with $H^i(K) = 0$ for $i \not = -1, 0$
and $H^i(K)$ finite for $i = -1, 0$ such that $\Ext^1_A(K, N)$
is annihilated by $I^c$ for all finite $A$-modules $N$, and
\item for any integer $q \geq q(A, I) + (d + 1)c$,
\end{enumerate}
the map
$\Ext^1_A(K, I^q/I^{2q}) \to \Ext^1_A(K, I^{q - (d + 1)c}/I^{2q - 2(d + 1)c})$
is zero.
\end{lemma}
...
part (5) with respect to the ideal $I^c$.
Observe that in particular $K^{-1}$ is $I^c$-projective
(More on Algebra, Section \ref{more-algebra-section-near-projective}). By
...
$\Ext^1_A(K^{-1}, I^{2q}) \to \Ext^1_A(K^{-1}, I^{2q - (d + 1)c})$ is zero.
Hence there is a map $\psi : K^{-1} \to I^q$ such that
$\psi$ and $\varphi$ have the same image in
$\Hom_A(K^{-1}, I^q/I^{2q - (d + 1)c})$.
On the other hand, by
Lemma \ref{lemma-bound-hom-for-almost-projective-variant}
the image $\psi'$ of $\psi$ in
$\Hom_A(K^{-1}, I^{q - (d + 1)c})$
is contained in $I^c\Hom_A(K^{-1}, I^{q - (d + 1)c})$.
So $\psi' \in I^c\Hom_A(K^{-1}, I^{q - (d + 1)c})$.
However, since multiplication by elements of $I^c$
on $K^{-1}$ factors through $K^0$ we conclude there
is an element $\tilde \psi \in \Hom_A(K^0, I^{q - (d + 1)c})$
such that
$\psi' = \tilde \psi \circ d_K^{-1}$\footnote{Namely, write
$\psi' = \sum a_i \psi_i$ with $a_i \in I^c$ and
$\psi_i : K^{-1} \to I^{q - (d + 1)c}$, choose $h_i : K^0 \to K^{-1}$
such that $a_i \text{id}_{K^{-1}} = h_i \circ d_K^{-1}$ and
set $\tilde \psi = \sum \psi_i \circ h_i$.}.
Combining all of the above we conclude that
$\xi$ maps to zero in $\Ext^1_A(K, I^{q - (d + 1)c}/I^{2q - (d + 1)c})$
and a fortiori in $\Ext^1_A(K, I^{q - (d + 1)c}/I^{2q - 2(d + 1)c})$.
\end{proof}
