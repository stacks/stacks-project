...
\begin{lemma}
\label{lemma-zero}
Let $I \subset A$ be an ideal of a Noetherian ring $A$.
...
$\mathfrak p \in V(I)$ the induced map
$$
H^i_{V(\mathfrak p A_\mathfrak p)}(M_{k, \mathfrak p})
\longrightarrow
H^i_{V(\mathfrak p A_\mathfrak p)}(M_{m, \mathfrak p})
$$
is zero for $k \geq m'(m)$. Then for every $m$ there exists
an integer $m''(m)$ such that the map
$H^i_{V(I)}(M_k) \to H^i_{V(I)}(M_m)$
is zero for all $k \geq m''(m)$.
\end{lemma}

\begin{proof}
Let $d = \dim(A)$. Given $m$ set
$$
m_1 = m'(m), m_2 = m'(m_1), \ldots, m_d = m'(m_{d - 1}).
$$
We claim that $m''(m) = m_d$ works. Namely, start with
$\xi_d \in H^i_{V(I)}(M_{m_d})$. Then we see that
the image $\xi_{d - 1} \in H^i_{V(I)}(M_{m_{d - 1}})$ of
$\xi_d$ maps to zero in
$H^i_{V(\mathfrak p A_\mathfrak p)}(M_{m_{d - 1}, \mathfrak p})$
for all minimal primes in $V(I)$.
Thus we may choose $f \in A$ not contained in any of these
minimal primes which annihilates $\xi_{d - 1}$.
By the spectral sequence of
Dualizing Complexes, Lemma \ref{dualizing-lemma-local-cohomology-ss}
this implies that $\xi_{d - 1}$ is the image of some
$\xi'_{d - 1}$ in $H^i_{V(I, f)}(M_{m_{d - 1}})$.
Clearly either $V(I, f) = \emptyset$ and we're done or
we have $\dim V(I, f) = \dim V(I) - 1$. Since the assumptions
of the lemma remain valid for the ideal $(I, f)$ we conclude
by induction on the dimension. Some details omitted.
\end{proof}
...
$H^i_{V(\mathfrak p A_\mathfrak p)}(M_{0, \mathfrak p})$.
Then for every $m$ there exists an integer $m''(m)$ such that
for $k \geq m''(m)$ the image of $H^i_{V(I)}(M_k) \to H^i_{V(I)}(M_m)$
maps injectively into $H^i_{V(I)}(M_0)$.
\end{lemma}
...
m_1 = m'(m), m_2 = m'(m_1), \ldots, m_d = m'(m_{d - 1}).
$$
We claim that $m''(m) = m_d$ works. Namely, let
$\xi_d \in H^i_{V(I)}(M_{m_d})$ map to zero in $H^0_{V(I)}(M_0)$.
We have to show that $\xi_d$ maps to zero in $H^0_{V(I)}(M_m)$.
By our choice of $m_{d - 1}$ we see that the image
$\xi_{d - 1} \in H^i_{V(I)}(M_{m_{d - 1}})$ of $\xi_d$ maps to zero in
$H^i_{V(\mathfrak p A_\mathfrak p)}(M_{m_{d - 1}, \mathfrak p})$
for all minimal primes in $V(I)$. By the spectral sequence of
Dualizing Complexes, Lemma \ref{dualizing-lemma-local-cohomology-ss}
this implies that $\xi_{d - 1}$ is the image of some
$\xi'_{d - 1}$ in $H^i_{V(I, f)}(M_{m_{d - 1}})$.
Clearly either $V(I, f) = \emptyset$ and we're done or
we have $\dim V(I, f) = \dim V(I) - 1$.
In the latter case we see that the image
$\xi_{d - 2} \in H^i_{V(I)}(M_{m_{d - 2}})$ of $\xi_{d - 1}$ maps to zero in
$H^i_{V(\mathfrak p A_\mathfrak p)}(M_{m_{d - 2}, \mathfrak p})$
for all minimal primes in $V(I, f)$.
Continuing like this we win.
\end{proof}
...
of $A, \mathfrak m, I, M$.
\end{enumerate}
Then $H^i_\mathfrak m(M) \to \lim H^i_\mathfrak m(M/I^nM)$
...
Observe that $\text{cd}(A', I')$ holds by Lemma \ref{lemma-cd-change-rings}.
...
In Situation \ref{situation-bootstrap} for every
$\mathfrak q \in V(\mathfrak a)$ the hypotheses of
Lemma \ref{lemma-algebraize-local-cohomology-bis}
are satisfied for
$(A_\mathfrak q, \mathfrak q A_\mathfrak q, I_\mathfrak q, M_\mathfrak q)$.
\end{lemma}
...
$\text{depth}((M \otimes_A B)_\mathfrak b > s$.

\medskip\noindent
Finally, condition (6) of
Lemma \ref{lemma-algebraize-local-cohomology-bis}
...
For every $m$ there exists an integer $m'(m)$ such that for $k \geq m'(m)$
the image of $H^{s + 1}_\mathfrak a(I^kM) \to H^{s + 1}_\mathfrak a(I^mM)$
maps injectively to $H^{s + 1}_\mathfrak a(M)$.
\end{lemma}

\begin{proof}
Fix $m$. We will find an $m'(m) > m$ such that for all $k \geq m'(m)$
the map $H^i_\mathfrak a(I^kM) \to H^i_\mathfrak a(I^mM)$ is zero
for $i \leq s$ and the image of
$H^{s + 1}_\mathfrak a(I^kM) \to H^{s + 1}_\mathfrak a(I^mM)$
for $k \geq m'(m)$
maps injectively into $H^{s + 1}_\mathfrak a(M)$.
...
$$
we conclude that there exists an integer $m'(m, \mathfrak q)$
which works for the local cohomology groups
$H^i_\mathfrak q(I^nM_\mathfrak q)$ and
$H^{s + 1}_\mathfrak q(M_\mathfrak q)$ (small detail omitted).
...
such that the map
$$
H^i_\mathfrak a(I^kM) \longrightarrow H^i_\mathfrak a(I^nM)
$$
is zero for all $k \geq m''(m)$ which is what we wanted to prove.
For the statement about $H^{s + 1}_\mathfrak a(I^nM)$
...
In Situation \ref{situation-bootstrap} the map
$$
H^i_\mathfrak a(M) \longrightarrow \lim H^i_\mathfrak a(M/I^nM)
$$
is an isomorphism for $i \leq s$ and the systems
$\{H^i_\mathfrak a(M/I^nM)\}_{n \geq 0}$ satisfy the
Mittag-Leffler condition for $i \leq s$.
\end{lemma}
...
and hence $\text{depth}(M_\mathfrak p) \geq 1 > 0$
...
are satisfied for $s = 0$ and $d$.
On the other hand, the hypotheses of
Lemma \ref{lemma-algebraize-local-cohomology-general}
are satisfied for $s = 1$ and $d$ (this is where Serre's condition is used).
By the discussion in
Remark \ref{remark-combine} we find
there exists an ideal
$J_0 \subset \mathfrak a$ with $V(J_0) \cap V(I) = V(\mathfrak a)$
such that for any $J \subset J_0$ with $V(J) \cap V(I) = V(\mathfrak a)$
the map
$$
H^1_J(M) \longrightarrow \lim H^1_\mathfrak a(M/I^nM)
$$
is an isomorphism. In addition observe that
$H^0_J(M) = \lim H^0_\mathfrak a(M/I^nM) = H^0_\mathfrak a(M)$
by combining Lemmas \ref{lemma-algebraize-local-cohomology-general}
and \ref{lemma-final-bootstrap}.
Setting $V = \Spec(A) \setminus V(J)$ we obtain an exact sequence
$$
0 \to H^0_J(M) \to M \to H^0(V, \mathcal{F}) \to H^1_J(M) \to 0
$$
See Lemma \ref{lemma-local-cohomology}. Similarly, we have exact sequences
$$
0 \to H^0_\mathfrak a(M/I^nM) \to M/I^nM \to
H^0(U, \mathcal{F}/I^n\mathcal{F}) \to H^1_\mathfrak a(M/I^nM) \to 0
$$
It follows that the kernels of
$H^0(U, \mathcal{F}/I^n\mathcal{F}) \to H^1_\mathfrak a(M/I^nM)$
form an inverse system with surjective transition maps.
Moreover, since $\{H^0_\mathfrak a(M/I^nM)\}$ satisfies the
Mittag-Leffler condition (by one of the lemmas above)
we see that taking inverse limits we obtain an exact sequence
$$
0 \to \lim H^0_\mathfrak a(M/I^nM) \to M \to
\lim H^0(U, \mathcal{F}/I^n\mathcal{F}) \to
\lim H^1_\mathfrak a(M/I^nM) \to 0
$$
(some details omitted).
Comparing with the first exact sequence we win.
\end{proof}
...
\lim H^i(U, \mathcal{F}/I^n\mathcal{F})
$$
are isomorphisms for $i < s$ and we have an isomorphism
$$
...
Proposition \ref{proposition-application-H0} and we
suggest the reader skip this proof.
Choose a finite $A$-module $M$ such that $\mathcal{F}$ is the restriction
to $U$ of the coherent module associated to $M$, see
Lemma \ref{lemma-finiteness-pushforwards-and-H1-local}.
Set $d = \text{cd}(A, I)$.
...
$$
is an isomorphism. In addition observe that
$H^i_J(M) = \lim H^i_\mathfrak a(M/I^nM) = H^i_\mathfrak a(M)$
for $i \leq s$ by combining
Lemmas \ref{lemma-algebraize-local-cohomology-general}
and \ref{lemma-final-bootstrap}.
Setting $V = \Spec(A) \setminus V(J)$ we obtain
an exact sequence
$$
0 \to H^0_J(M) \to M \to H^0(V, \mathcal{F}) \to H^1_J(M) \to 0
$$
and isomorphisms $H^i_\mathfrak a(M) \to H^{i - 1}(U, \mathcal{F})$
and $H^i_J(M) \to H^{i - 1}(V, \mathcal{F})$ for $i > 1$, see
Lemma \ref{lemma-local-cohomology}. Similarly, we have exact sequences
$$
0 \to H^0_\mathfrak a(M/I^nM) \to M/I^nM \to
H^0(U, \mathcal{F}/I^n\mathcal{F}) \to H^1_\mathfrak a(M/I^nM) \to 0
$$
and isomorphisms
$H^i_\mathfrak a(M/I^nM) \to H^{i - 1}(U, \mathcal{F}/I^n\mathcal{F})$
for $i > 1$.
It follows that the kernels of
$H^0(U, \mathcal{F}/I^n\mathcal{F}) \to H^1_\mathfrak a(M/I^nM)$
form an inverse system with surjective transition maps.
...
\lim H^1_\mathfrak a(M/I^nM) \to 0
$$
(some details omitted) and isomorphisms
$\lim H^i_\mathfrak a(M/I^nM) \to
\lim H^{i - 1}(U, \mathcal{F}/I^n\mathcal{F})$ for $i > 1$.
Comparing with the isomorphisms already produced we win.
\end{proof}
