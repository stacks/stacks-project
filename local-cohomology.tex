...
\begin{enumerate}
\item $A$ has a dualizing complex and $I$ is contained in the radical of $A$,
\item if $\mathfrak p \in V(I)$, then no condition,
\item if $\mathfrak p \not \in V(I)$, $\mathfrak p \in T$, then
$\dim((A/\mathfrak p)_\mathfrak q) \leq d$ for all
...
Since $I$ is contained in the radical of $A$ we can choose
$\mathfrak q_\lambda \in V(\mathfrak p_\lambda) \cap V(I)$.
Since $\mathfrak p_\lambda \in T$ we have
...
Duality, Lemma \ref{duality-lemma-sitting-in-degrees}
we conclude that
$$
\text{depth}(M_\mathfrak p) +
...
Since $I$ is contained in the radical of $A$ we can choose
$\mathfrak q \subset \mathfrak q'$ with $\mathfrak q' \in V(I)$.
Then $\mathfrak q' \in V(J) \cap V(I)$ because $\mathfrak q \in T$.
Thus assumptions (3) and (4) give
$$
