...
Let $A$ be a Noetherian ring. Let $T \subset \Spec(A)$ be a subset
stable under specialization. Let
$$
0 \to K_n \to M \to Q_n \to 0
$$
be an inverse system of short exact sequences of $A$-modules.
Let $i \geq 0$ be an integer. Assume the dimension of $A$
is finite and that for every $m$ there exists an integer $m'(m) \geq m$
such that for all $\mathfrak p \in T$ the composition
$$
H^i_{\mathfrak p A_\mathfrak p}(Q_{k, \mathfrak p}) \to
H^i_{\mathfrak p A_\mathfrak p}(Q_{m, \mathfrak p}) \to
H^{i + 1}_{\mathfrak p A_\mathfrak p}(K_{m, \mathfrak p})
$$
is zero for $k \geq m'(m)$. Then for every $m$ there exists an integer
$m''(m) \geq m$ such that the composition
$$
H^i_T(Q_k) \to H^i_T(Q_m) \to H^{i + 1}_T(K_m)
$$
is zero for $k \geq m''(m)$.
\end{lemma}

\begin{proof}
Recall that $H^i_T(N) = \colim H^i_Z(N)$ for any $A$-module $N$, see
Remark \ref{}.
Thus it suffices to prove the lemma with $T$ replaced by a closed
subset $Z$ of $T$ as long as we can find $m''(-)$ independent of $Z$.
To do this we argue by induction on $\dim(Z)$ which is allowed
as we assumed that the dimension of $A$ is finite.

\medskip\noindent
For example, if $\dim(Z) = 0$, then we have
$$
H^i_T(K_n) \subset
\bigoplus\nolimits_{\mathfrak p \in Z}
H^i_{\mathfrak p A_\mathfrak p}(K_{n, \mathfrak p})
\quad\text{and}\quad
H^i_T(Q_n) \subset
\bigoplus\nolimits_{\mathfrak p \in Z}
H^i_{\mathfrak p A_\mathfrak p}(Q_{n, \mathfrak p})
$$
by Lemma \ref{lemma-filter-local-cohomology}.
Thus in this case the result is clear
with $m''(m) = m'(m)$.

\medskip\noindent
Let $\dim(Z) > 0$ and assume the lemma is proven for all $Z'$
of smaller dimension with some fixed function $m''(-)$.
Take an element $\xi \in H^i_Z(Q_k)$ with $k \geq m'(m''(m))$.
Set $l = m''(m)$.
By assumption $\xi$ maps to zero by the composition
$$
H^i_Z(Q_k) \to H^i_Z(Q_l) \to H^{i + 1}_Z(K_l)
\to \bigoplus\nolimits_{\mathfrak p \in Z \text{ generic}}
H^i_{\mathfrak p A_\mathfrak p}(K_{l, \mathfrak p})
$$
Let $T' \subset Z$ be the set of nongeneric points. By
Lemma \ref{lemma-filter-local-cohomology}
we can find $\xi' \in H^{i + 1}_{T'}(K_l)$
mapping to the image of $\xi$ in $H^{i + 1}_Z(K_l)$.
Consider the diagram
$$
\xymatrix{
0 \ar[r] &
\colim H^1_f(H^i_Z(K_l)) \ar[r] \ar[d] &
H^{i + 1}_{T'}(K_l) \ar[r] \ar[d] &
H^{i + 1}_Z(K_l) \ar[d] \\
0 \ar[r] &
\colim H^1_f(H^i_Z(M)) \ar[r] \ar[d] &
H^{i + 1}_{T'}(M) \ar[r] \ar[d] &
H^{i + 1}_Z(M) \ar[d] \\
0 \ar[r] &
\colim H^1_f(H^i_Z(Q_l)) \ar[r] &
H^{i + 1}_{T'}(Q_l) \ar[r] &
H^{i + 1}_Z(Q_l)
}
$$
where the rows are exact by Lemma \ref{lemma-filter-local-cohomology}
(observe that in our case the colimits are over $f \in A$
with $V(f) \cap Z$ nowhere dense in $Z$).
The image of $\xi'$ in $H^{i + 1}_{T'}(M)$ maps to zero in
$H^{i + 1}_Z(M)$ because $\xi$ maps to zero in that group.
Hence there is an element $\xi'' \in \colim H^1_f(H^i_Z(M))$
mapping to the same element of $H^{i + 1}_{T'}(M)$.
By the injectivity of the arrow
$H^{i + 1}_{T'}(Q_l) \to H^{i + 1}_Z(Q_l)$
we see that $\xi''$ comes from an element $\xi'''$
of $H^1_f(H^i_Z(K_l))$; here we use that
the left column in the diagram is exact in the middle
as.
...
\dim((A/\mathfrak p)_\mathfrak q) > d + s
$$
\item[(6)] given $\mathfrak q \in V(\mathfrak a)$ denoting
...
it suffices to look at triples of primes in (4).
...
$\mathfrak q \in V(\mathfrak a)$. If there does not exist an
$\mathfrak r \in V(I) \setminus V(\mathfrak a)$ with
$\mathfrak p \subset \mathfrak r \subset \mathfrak q$
then $\text{depth}(M_\mathfrak p) > s$.
\end{lemma}

\begin{proof}
Let $\mathfrak p' \subset A_\mathfrak q$ be the prime corresponding to
$\mathfrak p$. We may and do replace $\mathfrak q$ with a generic point
of an irreducible component of $V(\mathfrak p) \cap V(\mathfrak a)$
containing $\mathfrak q$. After doing this we obtain that
...
hold for $A, \mathfrak m, I, M$,
\item[(E)] if $\mathfrak a \subset \mathfrak b$ is a larger ideal, then
$A, I, \mathfrak b, M$ satisfies the assumptions of
...
\item[(G)] the usual $I$-adic completions
...
\medskip\noindent
Condition (3): Let $\mathfrak p \in T$ with $T = \{\mathfrak p \subset A :
...
with $\mathfrak r \in V(I) \setminus V(\mathfrak a)$, then this follows
immedately from assumption (4) in Situation \ref{situation-bootstrap}.
If not, then $\text{depth}(M_\mathfrak p) > s$ by
Lemma \ref{lemma-helper-bootstrap}.

\medskip\noindent
Condition (6): Let $\mathfrak p \in T$ with $T = \{\mathfrak p \subset A :
V(\mathfrak p) \cap V(I) \subset V(\mathfrak a)\}$.
Since $I$ is contained in the radical of $A$ we see
that $V(\mathfrak p) \cap V(I) \not = \emptyset$.
Choose $\mathfrak q \in V(\mathfrak p) \cap V(I) \subset V(\mathfrak a)$.
There does not exist a prime
$\mathfrak p \subset \mathfrak r \subset \mathfrak q$
...
$A, I, \mathfrak b, M$. Enlarging $\mathfrak a$ to $\mathfrak b$
weakens assumption (6) and strengthens assumption (4). However, if we have
$\mathfrak p \subset \mathfrak r \subset \mathfrak q$ with
$\mathfrak p \not \in V(I)$, $\mathfrak r \in V(I) \setminus V(\mathfrak b)$,
$\mathfrak q \in V(\mathfrak b)$ as in assumption (4), then
either we can pick $\mathfrak r \in V(I) \setminus V(\mathfrak a)$ and
condition (4) for $A, I, \mathfrak a, M$ kicks in or we cannot
find such an $\mathfrak r$ in which case we get
$\text{depth}(M_\mathfrak p) > s$ by Lemma \ref{lemma-helper-bootstrap}.
This proves (4) holds for $A, I, \mathfrak b, M$ as desired.
...
with $\mathfrak p' \not \in V(I')$,
$\mathfrak r' \in V(I') \setminus V(\mathfrak a')$,
$\mathfrak q' \in V(\mathfrak a')$ then their images
$\mathfrak p \subset \mathfrak r \subset \mathfrak q$ in $A$
satisfy
$\mathfrak p \not \in V(I)$, $\mathfrak r \in V(I) \setminus V(\mathfrak a)$,
$\mathfrak q \in V(\mathfrak a)$.
Then we have
$$
\text{depth}_{A_\mathfrak p}(M_\mathfrak p) \geq s
\quad\text{or}\quad
...
\dim((A/\mathfrak p)_\mathfrak q) > d + s
$$
by assumption (4) for $A, I, \mathfrak a, M$. We have
...
Thus assumption (4) holds for $A', I', \mathfrak a', M'$.

\medskip\noindent
Assumption (6): Let $\mathfrak q' \in V(\mathfrak a')$ lying over the
prime $\mathfrak q \in V(\mathfrak a)$. Then $A'_{\mathfrak q'}$
and $A_\mathfrak q$ have isomorphic $I$-adic completions
and similarly for $M_\mathfrak q$ and $M'_{\mathfrak q'}$.
Thus assumption (6) for $A', I', \mathfrak a', M'$ is equivalent
to assumption (6) for $A, I, \mathfrak a, M$.
\end{proof}

\begin{lemma}
\label{lemma-algebraize-local-cohomology-bis}
In Situation \ref{situation-bootstrap} assume $A$ is local with maximal ideal
$\mathfrak m = \mathfrak a$. Then
...
by Lemma \ref{lemma-bootstrap-inherited}. Thus
...
for $i \leq s$. The exact same arguments will show that
...
Lemma \ref{lemma-bootstrap-inherited}.
...
independently of $\mathfrak q \in V(\mathfrak a)$.
...
\begin{theorem}
\label{thorem-final-bootstrap}
In Situation \ref{situation-bootstrap} the inverse system
$\{H^i_\mathfrak a(M/I^nM)\}_{n \geq 0}$ satisfies the
Mittag-Leffler condition for $i \leq s$, the map
$$
H^i_\mathfrak a(M) \longrightarrow \lim H^i_\mathfrak a(M/I^nM)
$$
is an isomorphism for $i \leq s$, and $H^i_\mathfrak a(M)$
is annihilated by a power of $I$ for $i \leq s$.
\end{theorem}

\begin{proof}
Let $S = 1 + I$ viewed as a multiplicative subset of $A$.
Observe that $H^i_\mathfrak a(N) = H^i_{S^{-1}\mathfrak a}(S^{-1}N)$
for any $A$-module $N$. Thus we may replace $A, I, \mathfrak a, M$
by $S^{-1}A, S^{-1}I, S^{-1}\mathfrak a, S^{-1}M$ without changing
the assertions of the theorem. Moreover, the hypotheses are preserved
by Lemma \ref{lemma-bootstrap-inherited} (F). After this replacement
we have that $I$ is contained in the Jacobson radical of $A$.
Hence by Lemma \ref{lemma-bootstrap-inherited} (A) we may apply
Lemma \ref{lemma-kill-colimit-support-general}
to see that $H^i_\mathfrak a(M)$ is annihilated by a power of $I$
for $i \leq s$. This proves the last assertion of the theorem.
...
$$
H^s_\mathfrak a(M') \to
H^s_\mathfrak a(M/I^nM) \to
H^s_\mathfrak a(M''/I^nM'') \to
H^{s + 1}_\mathfrak a(M')
$$
Now it is a simple matter to see that if we have Mittag-Leffler
for the system $\{H^s_\mathfrak a(M''/I^nM'')\}_{n \geq 0}$
then we have Mittag-Leffler for the system
$\{H^s_\mathfrak a(M/I^nM)\}_{n \geq 0}$.
...
$$
H^s_\mathfrak a(M') \to
\lim H^s_\mathfrak a(M/I^nM) \to
\lim H^s_\mathfrak a(M''/I^nM'') \to
H^{s + 1}_\mathfrak a(M')
$$
is exact because we have ML in the required spots, see
Homology, Lemma \ref{homology-lemma-apply-Mittag-Leffler}.
Hence, if $H^s_\mathfrak a(M'') \to \lim H^s_\mathfrak a(M''/I^nM'')$
is an isomorphism, then
$H^s_\mathfrak a(M) \to \lim H^s_\mathfrak a(M/I^nM)$
...
Similarly, given $\mathfrak q \in V(\mathfrak a)$ and
$\mathfrak p' \in (A_\mathfrak q)^\wedge$
not contained in $V(I(A_\mathfrak q)^\wedge)$, we have
...
hold for $A, I, \mathfrak a, Q$. (Observe that $Q$ may have
...
be the function found in Lemma \ref{lemma-bootstrap}
...
$m''(m) \geq m$ such that $H^s_\mathfrak a(I^kQ) \to H^s_\mathfrak a(I^mQ)$
is zero for all $k \geq m''(m)$.

\medskip\noindent
Fix $m \geq m_0$. Choose $k \geq m'(m''(m + c))$.
Choose $\xi \in H^{s + 1}_\mathfrak a(I^kM)$
which maps to zero in $H^{s + 1}_\mathfrak a(M)$.
We want to show that $\xi$ maps to zero in $H^{s + 1}_\mathfrak a(I^mM)$.
Namely, this will show that $\{H^s_\mathfrak a(M/I^nM)\}_{n \geq 0}$
is Mittag-Leffler exactly as in the proof of Lemma \ref{lemma-final-bootstrap}.
Picture to help vizualize the argument:
$$
\xymatrix{
&
H^{s + 1}_\mathfrak a(I^kM) \ar[r] \ar[d] &
H^{s + 1}_\mathfrak a(I^k(I^{m_0}M)^{\oplus r}) \ar[d] &
\\
H^s_\mathfrak a(I^{m''(m + c)}Q) \ar[r]_-\delta \ar[d] &
H^{s + 1}_\mathfrak a(F^{m''(m + c)}M) \ar[r] \ar[d] &
H^{s + 1}_\mathfrak a(I^{m''(m + c)}(I^{m_0}M)^{\oplus r}) \\
H^s_\mathfrak a(I^{m + c}Q) \ar[r] &
H^{s + 1}_\mathfrak a(F^{m + c}M) \ar[d] &
\\
&
H^{s + 1}_\mathfrak a(I^mM)
}
$$
The image of $\xi$ in $H^{s + 1}_\mathfrak a(I^k(I^{m_0}M)^{\oplus r})$
maps to zero in $H^{s + 1}_\mathfrak a((I^{m_0}M)^{\oplus r})$
and hence maps to zero in
$H^{s + 1}_\mathfrak a(I^{m''(m + c)}(I^{m_0}M)^{\oplus r})$
by choice of $m'(-)$.
Thus the image $\xi' \in H^{s + 1}_\mathfrak a(F^{m''(m + c)}M)$
maps to zero in $H^{s + 1}_\mathfrak a(I^{m''(m + c)}(I^{m_0}M)^{\oplus r})$
and hence $\xi' = \delta(\eta)$ for some
$\eta \in H^s_\mathfrak a(I^{m''(m + c)}Q)$.
By our choice of $m''(-)$ we find that $\eta$ maps to
zero in $H^s_\mathfrak a(I^{m + c}Q)$.
This in turn means that $\xi'$ maps to zero in
$H^{s + 1}_\mathfrak a(F^{m + c}M)$.
...
\to Q/I^nQ \to 0
$$
We have $\lim H^s_\mathfrak a(M/I^nM) = \lim H^s_\mathfrak a(M/F^nM)$
as these systems are pro-isomorphic. We obtain a commutative diagram
$$
\xymatrix{
H^{s - 1}_\mathfrak a(Q) \ar[r] \ar[d] &
\lim H^{s - 1}_\mathfrak a(Q/I^nQ) \ar[d] \\
H^s_\mathfrak a(M) \ar[r] \ar[d] &
\lim H^s_\mathfrak a(M/I^nM) \ar[d] \\
H^s_\mathfrak a((I^{m_0}M)^{\oplus r}) \ar[r] \ar[d] &
\lim H^s_\mathfrak a((I^{m_0}M)^{\oplus r}/I^n(I^{m_0}M) \ar[d] \\
H^s_\mathfrak a(Q) \ar[r] &
\lim H^s_\mathfrak a(Q/I^nQ)
}
$$
...
Thus we conclude $H^s_\mathfrak a(M) \to \lim H^s_\mathfrak a(M/I^nM)$
...
$(\mathcal{F}_n) \longrightarrow (\mathcal{F}'_n)$
...
$\mathcal{I}_y^\wedge = \mathcal{I}_y\mathcal{O}_{X, y}^\wedge$ and
$\mathcal{F}_y^\wedge$ is a finite module over this ring.

\begin{lemma}
\label{lemma-divide-torsion-formal-coherent-module}
In the situation above. Let $T \subset Y$ be a subset stable under
specialization. Assume for $y \in T$ and
$\mathfrak p \subset \mathcal{O}_{X, y}^\wedge$,
$\mathfrak p \not \in V(\mathcal{I}^\wedge_y)$ we have
$$
...
$\varphi : (\mathcal{F}_n) \longrightarrow (\mathcal{F}_n')$
...
$(\mathcal{F}_n) \longrightarrow (\mathcal{G}_n)$ of
...
a map $\varphi : (\mathcal{F}_n) \longrightarrow (\mathcal{F}_n')$
of inverse systems of coherent $\mathcal{O}_X$-modules.
Property (1) holds by construction.

\medskip\noindent
To prove properties (2) and (3) we may assume that $X = \Spec(A)$ is
affine. Let $I \subset A$ be the ideal corresponding to $Y$.
Let $M$ be the finite $A^\wedge$-module corresponding to
$(\mathcal{F}_n)$, see Cohomology of Schemes, Lemma \ref{}.
Then $\mathcal{F}_n$ corresponds to $M/I^nM$.
Recall that $\mathcal{F}'_n$
corresponds to the quotient $M'_n = M_n / H^0_T(M_n)$,
see Lemma \ref{} and its proof.

\medskip\noindent
Observe that $\bigoplus I^nM/I^{n + 1}M$ is a finite
$S = \bigoplus I^n/I^{n + 1}$-module. We conclude that
$\text{Ass}_S(\bigoplus I^nM/I^{n + 1}M)$ is finite and
hence $\text{Ass}_{A/I}(\bigoplus I^nM/I^{n + 1}M)$ is finite by
Algebra, Lemma \ref{algebra-lemma-ass-functorial-Noetherian}.
This in turn implies that $\bigcup \text{Ass}_A(M_n)$ is finite.
Thus we can find a closed subset $Z \subset T$ such that
$H^0_T(M_n) = H^0_Z(M_n)$ for all $n$.
...
Observe that the transition maps $\mathcal{F}'_{n + 1} \to \mathcal{F}'_n$
are surjective.
...
Assume
\begin{enumerate}
\item for $y \in T$ and $\mathfrak p \subset \mathcal{O}_{X, y}^\wedge$,
$\mathcal{I}_y \not \subset \mathfrak p$ we have
$$
\text{depth}_{(\mathcal{O}_{X, y})_\mathfrak p}
((\mathcal{F}^\wedge_y)_\mathfrak p) +
\dim(\mathcal{O}_{X, y}^\wedge/\mathfrak p) > 1
...
1 + \text{cd}(\mathcal{O}_{X, y}^\wedge, \mathcal{I}_y^\wedge)
$$
\item if $y \leadsto y'$ is an immediate specialization and
$y' \in T'$, then $y \in T$.
\end{enumerate}
Then there exists a canonical map
$\varphi : (\mathcal{F}_n) \longrightarrow (\mathcal{F}_n'')$
...
\item the induced morphism
$(\mathcal{F}_n) \longrightarrow (\mathcal{H}_n)$ of
