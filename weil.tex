...
here we have also used axioms (A)(d) and (A)(c).
...
\begin{proof}
Assume $k$ is infinite for the moment. Suppose $\dim(X) > 1$.
Let $\mathcal{L}$ be an ample invertible sheaf on $X$. Set
$$
...
$$
This map $\int_X : H^{2d}(X)(d) \to F$ is the datum (D4).
