...
that the exact choice of $\textit{Sch}_\alpha$ does not matter
...
$\textit{Sch}_{\acute{e}tale}$ is in some sense induced from the \'etale
...
$(\textit{Sch}/S)_{\acute{e}tale}$, is the site
$\textit{Sch}_{\acute{e}tale}/S$ introduced in
...
that given any covering $\{U_i \to U\}$ of $(\textit{Sch}/S)_{Zar}$
with $U \in \text{Ob}(S_{\acute{e}tale})$ we also have
$U_i \in \text{Ob}(S_{\acute{e}tale})$.
...
In each case the obvious functor into the category $\textit{Sch}$ of
all schemes commutes with taking fibre products. The categories
$(\textit{Sch}/S)_{\acute{e}tale}$, and $S_{\acute{e}tale}$ both have a
...
site containing $S$.
The functor
$(\textit{Aff}/S)_{\acute{e}tale} \to (\textit{Sch}/S)_{\acute{e}tale}$
...
$u : S_{\acute{e}tale} \to (\textit{Sch}/S)_{\acute{e}tale}$,
in addition to the properties seen in the proof of
...
big site and a sheaf $\mathcal{G}$ on the big site that
\begin{align*}
\text{Mor}_{\textit{Sh}(S_{\acute{e}tale})}(
\mathcal{F}|_{S_{\acute{e}tale}},
\mathcal{G})
& =
\text{Mor}_{\textit{Sh}((\textit{Sch}/S)_{\acute{e}tale})}(
\mathcal{F},
i_{S,*}\mathcal{G}) \\
\text{Mor}_{\textit{Sh}(S_{\acute{e}tale})}(
\mathcal{G},
...
$\textit{Sch}_{\acute{e}tale}$.
A sheaf $\mathcal{F}$ on the big \'etale site
$(\textit{Sch}/S)_{\acute{e}tale}$ is given by the following data:
\begin{enumerate}
...
\begin{enumerate}
\item[(\romannumeral1)] given any $f : T' \to T$ and $g : T'' \to T'$ in
$(\textit{Sch}/S)_{\acute{e}tale}$ the composition
$g_{small}^{-1}c_f \circ c_g$ is equal to $c_{f \circ g}$, and
\item[(\romannumeral2)] if $f : T' \to T$ in $(\textit{Sch}/S)_{\acute{e}tale}$
...
Let $S$ be a scheme. Let $\textit{Sch}_{\acute{e}tale}$ be a big smooth
site containing $S$.
The functor
$(\textit{Aff}/S)_{smooth} \to (\textit{Sch}/S)_{smooth}$
is special cocontinuous and induces an equivalence of topoi from
$\textit{Sh}((\textit{Aff}/S)_{smooth})$ to
...
Sites, Lemma \ref{sites-lemma-equivalence}.
Denote the inclusion functor
$u : (\textit{Aff}/S)_{smooth} \to (\textit{Sch}/S)_{smooth}$.
...
site containing $S$.
The functor
$(\textit{Aff}/S)_{syntomic} \to (\textit{Sch}/S)_{syntomic}$
is special cocontinuous and induces an equivalence of topoi from
$\textit{Sh}((\textit{Aff}/S)_{syntomic})$ to
...
Sites, Lemma \ref{sites-lemma-equivalence}.
Denote the inclusion functor
$u : (\textit{Aff}/S)_{syntomic} \to (\textit{Sch}/S)_{syntomic}$.
...
\item $(\textit{Sch}/X)_{fppf} \longrightarrow
(\textit{Sch}/Y)_{\acute{e}tale}$,
...
\item $(\textit{Sch}/X)_{syntomic} \longrightarrow
(\textit{Sch}/Y)_{\acute{e}tale}$,
...
\item $(\textit{Sch}/X)_{smooth} \longrightarrow
(\textit{Sch}/Y)_{\acute{e}tale}$,
\item $(\textit{Sch}/X)_{smooth} \longrightarrow (\textit{Sch}/Y)_{Zar}$,
\item $(\textit{Sch}/X)_{\acute{e}tale} \longrightarrow
(\textit{Sch}/Y)_{\acute{e}tale}$,
