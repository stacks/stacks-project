...
for a sheaf $\mathcal{G}$ on $(\Sch/T)_{Zar}$. Let $U \to S$ be an open
...
$$
\xymatrix{
\Sh(T_{Zar}) \ar[d]_{f_{small}} &
\Sh((\Sch/T)_{Zar}) \ar[d]^{f_{big}} \ar[l]^{\pi_T}\\
\Sh(S_{Zar}) &
\Sh((\Sch/S)_{Zar}) \ar[l]_{\pi_S}
}
$$
...
$$
\xymatrix{
\Sh((\Sch/S)_{\acute{e}tale}) \ar[r]^-{\pi_S} &
\Sh(S_{\acute{e}tale}) &
\Sh(S_{\acute{e}tale}) \ar[r]^-{i_S} &
\Sh((\Sch/S)_{\acute{e}tale})
}
$$
such that $\pi_S \circ i_S = \text{id}$. Moreover, $i_S = i_{\text{id}_S}$
...
\medskip\noindent
To see (3) we compute $\pi_{S, *} f_{big, *}(\mathcal{G})$ and
$f_{small, *} \pi_{T, *}\mathcal{G}$ for a sheaf $\mathcal{G}$ on
$(\Sch/T)_{\acute{e}tale}$. Let $U \to S$ be an object of
$S_{\acute{e}tale}$. According to
(2) above we have
$$
(f_{small, *}(\pi_{T, *}\mathcal{G}))(U/S) =
\pi_{T, *}\mathcal{G}(U \times_S T/T) = \mathcal{G}(U \times_S T/T)
$$
On the other hand,
$$
...
\mathcal{G}(U \times_S T/T)
$$
by construction of $f_{big}$.
Hence the functors $\pi_{S, *} f_{big, *}$ and $f_{small, *} \pi_{T, *}$
are isomorphic and (3) follows.
...
$$
\xymatrix{
\Sh(T_{\acute{e}tale}) \ar[d]_{f_{small}} &
\Sh((\Sch/T)_{\acute{e}tale}) \ar[d]^{f_{big}} \ar[l]^{\pi_T}\\
\Sh(S_{\acute{e}tale}) &
\Sh((\Sch/S)_{\acute{e}tale}) \ar[l]_{\pi_S}
}
$$
In general $i_S \circ f_{small} \not = f_{big} \circ i_T$.
