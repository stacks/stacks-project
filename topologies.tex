...
$\textit{Sh}(\Sch_{Zar})$ only depends on the choice of
...
$(\Sch/S)_{Zar}$ with $U \in \text{Ob}(S_{Zar})$.
...
of schemes with $U, V, W \in \text{Ob}(\Sch_{Zar})$.
...
$$
\xymatrix{
\textit{Sh}((\Sch/S)_{Zar}) \ar[r]^-{\pi_S} &
\textit{Sh}(S_{Zar}) &
...
\begin{align*}
\Mor_{\textit{Sh}(S_{Zar})}(\mathcal{F}|_{S_{Zar}}, \mathcal{G})
& =
\Mor_{\textit{Sh}((\Sch/S)_{Zar})}(\mathcal{F},
i_{S,*}\mathcal{G}) \\
\Mor_{\textit{Sh}(S_{Zar})}(\mathcal{G}, \mathcal{F}|_{S_{Zar}})
& =
\Mor_{\textit{Sh}((\Sch/S)_{Zar})}(\pi_S^{-1}\mathcal{G},
\mathcal{F})
\end{align*}
...
immersion of $\Sch_{Zar}$. According to
...
\textit{Sh}((\Sch/T)_{Zar}) \ar[d]^{f_{big}} \ar[l]^{\pi_T}\\
\textit{Sh}(S_{Zar}) &
\textit{Sh}((\Sch/S)_{Zar}) \ar[l]_{\pi_S}
}
$$
...
\begin{enumerate}
\item for every $T/S \in \text{Ob}((\Sch/S)_{Zar})$ a sheaf
$\mathcal{F}_T$ on $T$,
...
\begin{proof}
Given a sheaf $\mathcal{F}$ on $\textit{Sh}((\Sch/S)_{Zar})$
...
we may define a presheaf $\mathcal{F}$ on $\textit{Sh}((\Sch/S)_{Zar})$
...
Let $T \in \text{Ob}(\Sch_{\acute{e}tale})$.
...
$(\Sch/S)_{\acute{e}tale}$ with $U \in \text{Ob}(S_{\acute{e}tale})$.
...
Sets, Lemma \ref{sets-lemma-what-is-in-it}.
Suppose we have $U \to S$, $V \to U$, $W \to U$ morphisms
of schemes with $U, V, W \in \text{Ob}(\Sch_{\acute{e}tale})$.
...
$$
\xymatrix{
\textit{Sh}((\Sch/S)_{\acute{e}tale}) \ar[r]^-{\pi_S} &
...
big site and a sheaf $\mathcal{G}$ on the big site that
\begin{align*}
\Mor_{\textit{Sh}(S_{\acute{e}tale})}(
\mathcal{F}|_{S_{\acute{e}tale}},
\mathcal{G})
& =
\Mor_{\textit{Sh}((\Sch/S)_{\acute{e}tale})}(
\mathcal{F},
i_{S,*}\mathcal{G}) \\
\Mor_{\textit{Sh}(S_{\acute{e}tale})}(
\mathcal{G},
...
immersion of $\Sch_{\acute{e}tale}$. According to
(2) above we have $(f_{small, *}(\pi_{T, *}\mathcal{G}))(U/S) =
\pi_{T, *}\mathcal{G}(U \times_S T/T) = \mathcal{G}(U\times_S T/T)$.
On the other hand,
$(\pi_{S, *}(f_{big, *}\mathcal{G}))(U/S) =
...
\textit{Sh}((\Sch/T)_{\acute{e}tale}) \ar[d]^{f_{big}} \ar[l]^{\pi_T}\\
\textit{Sh}(S_{\acute{e}tale}) &
\textit{Sh}((\Sch/S)_{\acute{e}tale}) \ar[l]_{\pi_S}
}
$$
In general $i_S \circ f_{small} \not = f_{big} \circ i_T$.
...
\begin{enumerate}
\item for every $T/S \in \text{Ob}((\Sch/S)_{\acute{e}tale})$ a sheaf
...
\begin{proof}
Given a sheaf $\mathcal{F}$ on $\textit{Sh}((\Sch/S)_{\acute{e}tale})$
we set $\mathcal{F}_T = i_p^{-1}\mathcal{F}$ where $p : T \to S$
is the structure morphism. Note that
...
Sets, Lemma \ref{sets-lemma-what-is-in-it}.
Suppose we have $U \to S$, $V \to U$, $W \to U$ morphisms
of schemes with $U, V, W \in \text{Ob}(\Sch_{fppf})$.
...
$\text{Ob}(\Sch_\tau) \subset \text{Ob}(\Sch'_{\tau'})$
and
...
\begin{eqnarray*}
g : \textit{Sh}((\Sch/S)_\tau) &
\longrightarrow &
\textit{Sh}((\Sch'/S)_\tau) \\
f : \textit{Sh}((\Sch'/S)_\tau) &
\longrightarrow &
\textit{Sh}((\Sch/S)_\tau)
\end{eqnarray*}
