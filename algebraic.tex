...
The corresponding morphism $\mathcal{S}_F \to \mathcal{S}_G$
of categories fibred in groupoids has propery $\mathcal{P}$ if
and only if $a$ has property $\mathcal{P}$.
\end{lemma}
...
representable by an algebraic spaces every morphism
...
is trivial ``is'' an algebraic space. We will see later (insert future
reference here) that this holds more generally for algebraic stacks.
...
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-representable-diagonal}
...
Finally, we apply
Morphisms of Spaces, Theorem \ref{spaces-morphisms-theorem-bootstrap}
