...
Let $S$ be a scheme contained in $\textit{Sch}_{fppf}$.
Let $p : \mathcal{X} \to \mathcal{C}$ be a category fibred in groupoids.
...
have no nontrivial automorphisms.}, and
...
over $S$ is said to be a {\it stack in groupoids} if and only if
\begin{enumerate}
