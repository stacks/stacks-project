...
gives rise to a morphism $U \to V$ and conversely, give a morphism
...
$$
\item the projection $\text{pr}_{02}$ induces via (3) a $1$-morphism
$$
\text{pr}_{02} :
\mathcal{R} \times_{\text{pr}_1, \mathcal{U}, \text{pr}_0} \mathcal{R}
\longrightarrow
...
\begin{proof}
Ad (1). This holds as by definition $\Delta_{\mathcal{X}}$ is representable
