...
Lemma \ref{lemma-stalk-sheafification}).A section $s \in \Pi(\mathcal{F})(U)$ is in $\mathcal{F}^\#$ if and
...
presheaves of algebraic structures.
\end{lemma}
...
\medskip\noindent
The proof in the case of a presheaf of algebraic structures is exactly
the same, with repeated application of
Lemma \ref{lemma-image-contained-in}.
\end{proof}
...
psuhforward on sheaves. In other words,
$$
...
\section{Functoriality of abelian sheaves}
\label{section-functoriality-abelian-sheaves}
