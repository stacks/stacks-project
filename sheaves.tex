...
separated (see Sites, Definiton \ref{sites-definition-separated}).
By Lemma \ref{lemma-limits-colimits} above we have
$(\mathcal{F}')^\# = \text{colim}_i\ \mathcal{F}_i$.
By Sites, Theorem \ref{sites-theorem-plus} we see that
