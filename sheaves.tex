...
neighbourhoods is a directed system (compare Categories, Definition
\ref{categories-definition-directed-system}). Namely, the coproduct
...
=
\Mor_{\textit{Sh}(X)}(\mathcal{F}^\#, \mathcal{G})
$$
...
$V$ of $f(U)$ in $Y$. The colimits are over directed partially ordered
sets. (The restriction mappings of $f_p\mathcal{G}$ are explained in the
proof.)
\end{lemma}

\begin{proof}
The colimit is over the partially ordered set consisting of open subset
...
$$
\Mor_{\textit{Sh}(X)}(f^{-1}\mathcal{G}, \mathcal{F})
=
\Mor_{\textit{Sh}(Y)}(\mathcal{G}, f_*\mathcal{F}).
$$
...
\Mor_{\textit{Sh}(X, \mathcal{C})}(f^{-1}\mathcal{G}, \mathcal{F})
& = &
\Mor_{\textit{Sh}(Y, \mathcal{C})}(\mathcal{G}, f_*\mathcal{F}).
\end{eqnarray*}
...
=
\Mor_{\textit{Sh}(X)}(\mathcal{F}, i_{x, *}A).
$$
...
${}^\# : \textit{PSh}(X) \to \textit{Sh}(X)$ commutes with all
...
Let $X$ be a topological space. Let $I$ be a directed partially ordered set.
...
$\mathcal{F}' : V \mapsto \colim_i \mathcal{F}(V)$ is
...
in a formula
$$
\Mor_{\textit{Sh}(X)}(j_!\mathcal{F}, \mathcal{G})
=
\Mor_{\textit{Sh}(U)}(\mathcal{F}, j^{-1}\mathcal{G})
=
\Mor_{\textit{Sh}(U)}(\mathcal{F}, \mathcal{G}|_U)
$$
...
in a formula
$$
\Mor_{\textit{Sh}(X, \mathcal{C})}(j_!\mathcal{F}, \mathcal{G})
=
\Mor_{\textit{Sh}(U, \mathcal{C})}(\mathcal{F}, j^{-1}\mathcal{G})
=
\Mor_{\textit{Sh}(U, \mathcal{C})}(\mathcal{F}, \mathcal{G}|_U)
$$
bifunctorially in $\mathcal{F}$ and $\mathcal{G}$.
