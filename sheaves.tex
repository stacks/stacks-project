...
$a$ is a map of sheaves if and only if corresponding family of maps
...
\begin{proof}
For each $U \subseteq X$ open subset define
$$
\varphi_U :
s \in \mathcal{F}(U)
\longrightarrow
\varphi_U(s) \in \mathcal{G}(U)
$$
...
Let $V \subseteq U \subseteq X$ open subsets then
$$
(\varphi_U(s))|_V
= \varphi_V(s|_V)
$$
...
since given $U \subseteq X$ open subset
