...
Then, for $s\in \mathcal{G}(V)$, we have
\begin{equation}
\label{equation-adjunct-and-inverse-image-section}
\varphi^\sharp_V(s)=\varphi^\flat_{f^{-1}(V)}(f^{-1}s).
\end{equation}
...
Since a morphism of sheaves is determined by the induced morphisms on stalks,
from Lemma \ref{lemma-inverse-image-section-germ} it follows that $\varphi^\flat$
is the unique map satisfying \eqref{equation-adjunct-and-inverse-image-section}
for every $s\in\mathcal{G}(V)$ and every open $V\subset Y$.
...
Then, for $s\in \mathcal{G}(V)$, we have
\begin{equation}
\label{equation-adjunct-and-pullback-section}
\varphi^\sharp_V(s)=\varphi^\flat_{f^{-1}(V)}(f^*s)
\end{equation}
This follows from the fact that
$$
...
Since a morphism of sheaves is determined by the induced morphisms on stalks,
from Lemma \ref{lemma-pullback-section-germ} it follows that $\varphi^\flat$
is the unique map satisfying \eqref{equation-adjunct-and-pullback-section}
for every $s\in\mathcal{G}(V)$ and every open $V\subset Y$.
