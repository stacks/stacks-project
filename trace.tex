...
that $j_!$ is exact and \'Etale Cohomology,
Lemma \ref{etale-cohomology-lemma-jshriek-constructible}.
\end{proof}
...
\begin{proof}
This follows as $f^{-1} = f^*$ is exact and \'Etale Cohomology,
...
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-colimit-constructible}
...
\begin{proof}
This follows from Lemma \ref{lemma-bounded-above-c} and
...
of flat constructible sheaves of $\Lambda$-modules
where the result follows from \'Etale Cohomology,
Lemma \ref{etale-cohomology-lemma-jshriek-constructible}.
\end{proof}
...
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-pullback-constructible}.
\end{proof}
