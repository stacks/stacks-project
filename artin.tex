...
$$
\text{Mod}(A) \longrightarrow \textit{Sets},\quad
...
Let $M \in \text{Mod}(A)$, $N \in \text{Mod}_{fg}(B)$
...
$$
of $A$-modules. Note that in this case the map $A_1' \to A_3'$
...
$$
\mathcal{O}_x : \text{Mod}(A) \to \text{Mod}(A)
$$
of {\it obstruction modules},
\item for $(x, A)$ as in (1), a ring map $A \to B$,
$M \in \text{Mod}(A)$, $N \in \text{Mod}(B)$, and an $A$-linear
