...
\medskip\noindent
Conversely, suppose given an element $(Z, u', \hat x)$ of $F(V)$.
We claim there is a unique morphism $x : V \to X$ such that
the procedure of the previous paragraph recovers $(Z, u', \hat x)$.
FIXME.
\end{proof}
