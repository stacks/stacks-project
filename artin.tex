...
The proof of Lemma \ref{lemma-formal-object-effective} is the only place
in our proof of Theorem \ref{theorem-contractions} where we need to
use that $X' \to S$ is separated. We use the assumption only to obtain
the morphism $x' : V' \to X'$. It turns out that it suffices if
$X' \to S$ is quasi-separated. To see how to prove this using
results in the literature, please see
