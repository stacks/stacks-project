...
\item $\Lambda_{\mathfrak m} \to A_{\mathfrak m_A}$
is formally smooth in the $\mathfrak m_A$-adic topology, and
\item there exists a $\Lambda$-algebra map $C \to A$.
\end{enumerate}
This implies that $\Lambda \to A$ is smooth at $\mathfrak m_A$, see
