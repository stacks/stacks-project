...
the ring map
$$
g : A' \times_{A} A' \longrightarrow k[I],\quad
(x, y) \longmapsto \overline{x} \oplus (y - x)
$$
Assume $\mathcal{F}$ satisfies (S2).
If there exists a morphism $x_1 \to g_*(y)$, then there exists
a morphism $b: x_1 \to x_2$ such that $a_1 =  a_2 \circ b$.
\end{lemma}
