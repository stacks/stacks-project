...
We will simply say
``{\it let $(\underline{U}, \underline{R}, s, t, c)$ be a groupoid in functors
on $\mathcal{C}$}''
to mean
``$U$ and $R$ are objects of $\mathcal{C}$, there are morphisms
$s, t : U \to R$ such that the pushout $R \amalg_{s, U, t} R$ exists,
there is a morphism $c : R \to R \amalg_{s, U, t} R$ such that
$(\underline{U}, \underline{R}, s, t, c)$ is a
representable groupoid in functors on $\mathcal{C}$.''
\end{remark}
...
In Section \ref{section-prorepresentable-groupoids-in-functors}
