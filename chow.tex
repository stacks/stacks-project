...
(Divisors, Definition \ref{divisors-definition-associated-embedded})
...
$\mathcal{O}_X(D)|_{Z} \cong \mathcal{O}_W(D')|_Z$
...
supports. Having obtained this one can find anlogues of the lemmas of Section
...
resp.\ $\mathcal{E}\otimes \mathcal{L}$. Consider the canonical morphsm
$$
\xymatrix{
P \ar[rd]_\pi \ar[rr]_g
&
&
P' \ar[ld]^{\pi'}
\cr
...
Assuem $r_1 > 1$. Let $(\pi : P \to X, \mathcal{O}_P(1))$
...
In order to prove polynomial relations amoing chern classes of
...
\ldots
$$
We have made the appropriate remaks about denominators
...
Here
$$
T_{X/Y} = \textit{Hom}_{\mathcal{O}_X}(\Omega^1_{X/Y}, \mathcal{O}_X)
$$
