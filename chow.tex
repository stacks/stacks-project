...
Denote $\xi_i \in Z_i$ the generic point. For each $i \in I$ we
choose a filtration
$$
...
field at $\xi_i$. For $p > n_i$ set $\mathcal{F}_i^p = 0$.
For $p \geq 0$ we denote
$$
\mathcal{F}^p =
...
(if $n_i \leq p$) in an open neighbourhood of $\xi_i$.
