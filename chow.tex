...
\noindent
In this section and the next the we will use the polynomials
$P_p \in \mathbf{Z}[r, c_1, c_2, c_3, \ldots]$
...
for $\alpha_2 \in A_k(X_2)$ and after any base change by $X' \to X$
...
for all $\alpha \in A_k(X)$ and after any base change by
...
for $\alpha \in A_k(X)$ and after any base change by
$X' \to X$ locally of finite type.
\end{lemma}
...
for $\alpha \in A_k(X)$ and after any base change by $X' \to X$
locally of finite type.
\end{lemma}
