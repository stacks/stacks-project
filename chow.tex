...
(More on Morphisms, Lemma \ref{more-morphisms-definition-cd-morphism}).
\end{definition}
...
Lemma \ref{lemma-bivariant-zero}. By Lemma \ref{lemma-chern-classes-computed}
we may assume that $X$ is integral and that $E$ is represented
