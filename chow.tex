...
where $n = \dim_\kappa(V)$. We want to generalize this definition slightly.
...
\begin{definition}
\label{definition-quasi-basis}
Let $(R, \mathfrak m, \kappa)$ be a local ring.
Let $M$ be an $R$-module of length $l = \text{length}_R(M) < \infty$.
A {\it quasi-basis} of $M$ is an $l$-tuple of elements
$(e_1, \ldots, e_l)$ of $M$ such that
$\langle e_1, \ldots, e_i\rangle = Re_1 + \ldots + Re_i$
is an $R$-submodule of length $i$ for $i = 1, \ldots, l$.
Given an element $x \in M$ a {\it reduced representation} of $x$
with respect to the quasi-basis is vector $(r_1, \ldots, r_l) \in R$
such that $x = \sum r_i e_i$ and such that $r_{i + 1} = 0$ if
$x \in \langle e_1, \ldots, e_i\rangle$.
\end{definition}
