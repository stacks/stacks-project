...
$$
by Definition \ref{definition-cap-c1}.
The right hand side matches Definition \ref{definition-gysin-homomorphism}.
Hence we win.
\end{proof}
...
of effective Cartier divisors on $X$. Let $n_j > 0$
and set $D = \sum_{j \in J} n_j D_j$.
Let $\alpha \in Z_k(X)$. Then
$$
\coprod\nolimits_{j \in J} D_j \longrightarrow D
$$
is proper and 
Choose representatives
$\alpha_i \in Z_{k - 1}(X)$ of $c_1(\mathcal{O}_X(D_i)) \cap \alpha$
...
\begin{proof}
The linear combination is a cycle because given any
locally finite families of closed subsets $\{Z_{i, j}\}_{j \in J_i}$
of $D_i$ the family $\{Z_{i, j}\}_{i \in I, j \in J_i}$ is
locally finite in $X$.
\end{proof}
