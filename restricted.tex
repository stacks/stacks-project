...
$X = \text{Spf}(A)$, in other words, $X$ is McQuillan.
A natural condition to consider is:
\begin{itemize}
...
However, it is not clear that we can recover
...
formal algebraic space. If you can prove this, or if you have a counter
example, please email
\href{mailto:stacks.project@gmail.com}{stacks.project@gmail.com}.
\end{remark}

\begin{example}
\label{example-completion-quotient-restricted-power-series}
Let $A$ be a weakly admissible topological ring. Let
$A \to A'$ be a finite type ring map. Then
$(A')^\wedge = \lim_{I \subset A\ w.i.d.} A'/IA'$
(see Formal Spaces, Example
\ref{formal-spaces-example-representable-morphism-from-completion})
is isomorphic to a quotient of the restricted power series
ring $A\{x_1, \ldots, x_n\}$ by a closed ideal.
\end{example}

\noindent
In the case of weakly admissible topological rings with a countable basis
for the topology, the two notions mentioned in
Remark \ref{remark-finite-type} are equivalent.
...
\begin{enumerate}
\item[(a)] $B \to A$ satisfies the equivalent conditions (a), (b) of
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}
and $B/J \to A/I$ is of finite type for every weak ideal of definition
$J \subset B$ and $I \subset A$ the closure of $JA$,
\item[(b)] $B \to A$ satisfies the equivalent conditions (a), (b) of
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}
and $B/J \to A/I$ is of finite type for some weak ideal of definition
$J \subset B$ and $I \subset A$ the closure of $JA$,
\item[(c)] $A$ is isomorphic to a quotient of $B\{x_1, \ldots, x_n\}$
by a closed ideal.
\end{enumerate}
...
\begin{proof}
It is clear that (a) implies (b) and that (c) implies (a).
Let $J \subset B$ and $I \subset A$ be as in (b).
...
$$
such that $A_{n + 1}/J_nA_{n + 1} = A_n$ and such that $A = \lim A_n$
as in 
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}.
...
be given. By Example \ref{example-completion-quotient-restricted-power-series}
the maps $A \to (A')^\wedge$ and $B \to (B')^\wedge$
satisfy (a), (b), and (c). Moreover, by
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}
...
satisfy the equivalent conditions (a), (b) of
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}.
Now pick a weak ideal of definition $J \subset B$. Let
...
and (2) are equivalent. Write $X = \text{Spf}(A)$ and $Y = \text{Spf}(B)$
...
\medskip\noindent
Assume (1). Then we see that $B \to A$ satisfies the equivalent conditions
(a), (b) of
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-property-rings}
by
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-affine}.
Finally, if $J \subset B$ is a weak ideal of definition,
then $\Spec(B/J) \times_Y X$ is representable by $\Spec(A/I)$
where $I \subset A$ is the closure of $JA$ (Formal Spaces,
Lemma \ref{formal-spaces-lemma-fibre-product-affines-over-separated}).
Now, since $f$ is assumed to be of finite type, we see that
$B/J \to A/I$ is of finite type. Hence (3) is true.

\medskip\noindent
Assume (3). Then $X \to Y$ is representably by algebraic spaces by
Formal Spaces, Lemma \ref{formal-spaces-lemma-representable-affine}.
Finally, let $T \to Y$ be a morphism, where $T$ is a quasi-compact
scheme. Then $T \to Y$ factors through $\Spec(B/J)$ for some
weak ideal of definition $J \subset B$. Let $I \subset A$ be
the closure of $JA$. As above we have $\Spec(B/J) \times_Y X = \Spec(A/I)$.
Then $T \times_Y X$ is isomorphic to
$T \times_{\Spec(B/J)} \Spec(A/I)$. Thus it is clear that
$T \times_Y X \to T$ is of finite type as the base change of
the morphism $\Spec(A/I) \to \Spec(B/J)$ which is of finite
type by assumption. Thus (1) is true.
\end{proof}

\begin{lemma}
\label{lemma-representable-local-property}
Let $P$ be the property of morphisms of $\textit{WAdm}^{count}$ defined by the
equivalent conditions (a), (b), and (c) of
