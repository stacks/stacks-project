...
$B\{x\}$. Simiarly the bottom horizontal arrow is flat.
...
is the completion of a localization of the Noetherian ring
$B'_f$. Simiarly the bottom horizontal arrow is flat.
Hence it suffices to prove that the right vertical arrow is flat.
...
\item $f$ is rig-\'etale and rig-surjective,
\item $g \circ f$ is rig-\'etale
\end{enumerate}
then $g$ is rig-\'etale.
\end{lemma}
...
$V \to W$ corresponds to a rig-\'etale map of adic Noetherian topological
rings, see Definition \ref{definition-rig-etale}.
...
is rig-\'etale and rig-surjective, see
Lemmas \ref{lemma-base-change-rig-etale} and
\ref{lemma-base-change-rig-surjective}.
Also, the composition $X \times_Y V \to V \to W$ is rig-\'etale
since $g \circ f$ is rig-\'etale.

\medskip\noindent
Assume $C \to B$ is not rig-\'etale to get a contradiction.
Let $I \subset C$ be an ideal of definition. The
the module $H^{-1}(\NL_{B/C}^\wedge) \oplus H^0(\NL_{B/C}^\wedge)$
is a finite $B$-module not annihilated by any power of $I$, see
Lemma \ref{lemma-equivalent-with-artin}. Hence we can find a prime ideal
$\mathfrak p \subset B$ with $IB \not \subset \mathfrak p$
such that $H^i(\NL_{B/C}^\wedge) \otimes_B \kappa(\mathfrak p)$
is nonzero for either $i = -1$ or $i = 0$. We may choose a maximal ideal
$IB + \mathfrak p \subset \mathfrak m$. By
Algebra, Lemma \ref{algebra-lemma-exists-dvr}
we can find a complete discrete valuation ring $R$ and an injective
local ring homomorphism $(B/\mathfrak p)_\mathfrak m \to R$.
...
C \to B \to A_i \to R
$$
We know that $C \to A_i$ and $B \to A_i$ are rig-\'etale.
Consider the associated exact sequence
$$
\xymatrix{
A_i \otimes_B H^0(\NL_{B/C}^\wedge) \ar[r] &
H^0(\NL_{A_i/C}^\wedge) \ar[r] &
H^0(\NL_{A_i/B}^\wedge) \ar[r] & 0 \\
H^{-1}(\NL_{B/C}^\wedge \otimes_B A_i) \ar[r] &
H^{-1}(\NL_{A_i/C}^\wedge) \ar[r] &
H^{-1}(\NL_{A_i/B}^\wedge) \ar[llu]
}
$$
of Lemma \ref{lemma-exact-sequence-NL}. FIXME.
\end{proof}
