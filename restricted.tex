...
$I$-adically complete unless $I$ is finitely generated. We think
of the topology on $A\{x_1, \ldots, x_r\}$ as the limit topology
(which is always complete) whereas we often think of the topology on
...
type over $A$. For continuous maps of weakly admissible topological rings,
...
$Y$ is McQuillan by Formal Spaces, Lemma
\ref{formal-spaces-lemma-closed-immersion-into-McQuillan}.
Hence $f$ corresponds to a continuous map
$\varphi : A \to B$ of weakly admissible topological rings
(Formal Spaces, Lemma
\ref{formal-spaces-lemma-morphism-between-formal-spectra}).
We see that $\varphi$ is taut, the kernel $K \subset A$ of $\varphi$
is a closed ideal, and the image of $\varphi$ is dense in $B$.
