...
(as $V \not = \emptyset$) we can find a maximal ideal $\mathfrak m_R$
of $A$ lying over $\mathfrak m_R$. Setting $R' = A_\mathfrak m^\wedge$
we find the desired complete discrete valuation ring
equipped with a morphism $\text{Spf}(R') \to Z \to X$.
\end{proof}
