...
(Formal Spaces, Definition \ref{formal-spaces-definition-finite-type}
...
finite type
(by Formal Spaces, Definition \ref{formal-spaces-definition-finite-type}).
...
for some $\mu \geq \lambda$ (use Formal Spaces, Lemma
\ref{formal-spaces-lemma-factor-through-thickening} two times). Since
