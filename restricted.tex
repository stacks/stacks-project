...
Formal Algebraic Spaces, Section \ref{formal-spaces-section-finite-type}.)
...
Formal Algebraic Spaces, Section
...
Formal Algebraic Spaces, Section \ref{formal-spaces-section-proper}.)
By the same argument as in the proof of
Lemma \ref{lemma-map-completions-finite-type} this follows from
...
Formal Algebraic Spaces, Section \ref{formal-spaces-section-quasi-compact}.)
We have to show that $(X'_{/T'})_{red} \to (X_{/T})_{red}$ is a quasi-compact
morphism of algebraic spaces. By
Formal Algebraic Spaces, Lemma \ref{formal-spaces-lemma-reduction-completion}
...
formal algebraic spaces. By Formal Algebraic Spaces, Lemma
...
\section{Completions and morphisms}
...
spaces and formal algebraic spaces will be Noetherian.
...
on $g^{-1}T \subset Y$, see Formal Algebraic Spaces, Lemma
...
Recall that $(X_i)_{/T_i} = (X_i)_{/T} = X_i \times_X X_{/T}$ and
$W_i = X_i \times_X W = (X_i)_{/T} \times_{X_{/T}} W$.
Observe that we obtain isomorphisms
$$
\alpha_{ij} :
W_i \times_{X_{/T}} (X_j)_{/T}
\longrightarrow 
(X_i)_{/T} \times_{X_{/T}} (X_i)_{/T}
$$
...
\section{Algebraization of formal modifications}
\label{section-algebraize-dilatations}
