...
\end{enumerate}
Of course this is equivalent to $M \to R^{\oplus r}$ has vanishing
cohomology over $\Spec(R) \setminus V(I)$ which in turn is equivalent
to (A). This finishes the proof.
\end{proof}
