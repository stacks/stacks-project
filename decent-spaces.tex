...
If $X$ is very reasonable, then $X \cong \Spec(k')$
...
we see that $\Spec(k) \to X$ factors as
$\Spec(k) \to \Spec(k') \to X$ where
$\Spec(k') \to X$ is a monomorphism. But since $\Spec(k) \to X$
is a surjection of sheaves on $(\textit{Sch}/S)_{fppf}$, we see that
also $\Spec(k') \to X$ is surjective (as a map of sheaves). But a
map of sheaves which is both injective and surjective is an isomorphism.
Finally, the fact that $\Spec(k) \to X$ is \'etale means that
