...
(see Remark \ref{remark-recall}). After shrinking $V$
...
\begin{lemma}
\label{lemma-universally-catenary-dimension-function-extends}
...
By Lemma \ref{lemma-locally-Noetherian-decent-quasi-separated}
...
(see Lemma \ref{lemma-conditions-on-fibre-and-qf}).
...
By Lemma \ref{lemma-decent-space-closed-point} we can represent
$b_0$ by a closed immersion $b_0 : \Spec(k) \to B$.
By Lemma \ref{lemma-construct-glueing} we can find a factorization
$$
Y \to Y' \to X
$$
