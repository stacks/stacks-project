...
\item either $f$ is quasi-separated and quasi-compact or $f$ is separated.
\end{enumerate}
...
Then the fibre over $y$ is finite, hence the case where $f$ is
quasi-compact and quasi-separated follows from
Lemma \ref{lemma-generically-finite}.
To finish assume that $f$ is separated. Choose $V \subset Y$
...
the fibre of $f$ over $y$ is consists of
...
\begin{enumerate}
\item either $f$ is quasi-separated and quasi-compact or $f$ is separated, and
