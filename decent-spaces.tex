...
Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-quasi-compact-existence-universally-closed}.
For the converse, assume $f$ is quasi-separated, quasi-compact, and
universally closed and assume given a diagram
$$
\xymatrix{
\Spec(K) \ar[r] \ar[d] & X \ar[d] \\
\Spec(A) \ar[r] & Y
...
\medskip\noindent
Another and perhaps better way to say all of this is that the morphism
$f : X \to Y$ is birational if there exist dense open subspaces
