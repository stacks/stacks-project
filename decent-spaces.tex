...
field in the equivalence class of $x$. Then $\Spec(k) \times_X \Spec(k')$
is nonempty and $\Spec(k) \times_X \Spec(k') \to \Spec(k')$ is a
monomorphism of schemes. By
Schemes, Lemma \ref{schemes-lemma-mono-towards-spec-field}
we see that $\Spec(k) \times_X \Spec(k') = \Spec(k')$, in other words
