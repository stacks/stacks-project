...
\begin{proof}
Choose a scheme $U$ and a surjective \'etale morphism $U \to Z$.
Set $R = U \times_Z U$ so that $Z = U/R$ is a presentation (see
...
Groupoids, Lemma \ref{groupoids-lemma-quotient-groupoid-restrict}.
Since $Z \to X$ is a monomorphism we see that $|Z| \to |X|$ is injective. By
Properties of Spaces, Lemma \ref{spaces-properties-lemma-points-cartesian}
we see that
$$
