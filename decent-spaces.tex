...
\begin{proof}
Here $Y^\nu \to Y$ is the normalization of $Y$, see
Morphisms of Spaces, Definition
\ref{spaces-morphisms-definition-normalization}.
It follows from Lemma \ref{lemma-birational-etale-localization}
(and its proof) that $X$ and $Y$ satisfy the equivalent
conditiosn of Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-prepare-normalization}
and hence their normalizations $X^\nu$ and $Y^\nu$ are defined. By
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-normalization-normal}
we obtain a factorization $X^\nu \to Y^\nu$.
By Lemma \ref{lemma-finite-birational-over-normal}
this map is an isomorphism. Thus we obtain $Y^\nu = X^\nu \to X$
as desired.
