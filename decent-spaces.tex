...
Any localy Noetherian decent algebraic space is quasi-separated.
\end{lemma}
...
conclude that $R = e(U) \amalg W$ for some open and closed subscheme
...
\begin{proof}
Let $V \to Y$ be an \'etale morphism with $V$ affine. By
Lemma \ref{lemma-birational-etale-localization} applied to
$\text{id} : Y \to Y$ we see
that $V$ has finitely many irreducible components.
Hence $Y$ satisfies the equivalent conditions of
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-prepare-normalization}
and $Y^\nu \to Y$ is defined. Similarly for $X$. By
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-normalization-normal}
the algebraic space $X^\nu$ is normal and maps generic points
to generic points (Lemma \ref{lemma-decent-generic-points}). Hence by
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-normalization-normal}
we obtain a factorization of the composition $X^\nu \to X \to Y$ through
$Y^\nu$.
