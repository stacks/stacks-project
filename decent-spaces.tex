...
over $x$, and the induced morphism $\Spec(\kappa(u)) \to X$ is a monomorphism.
\end{lemma}

\begin{proof}
Every $x \in |X|$ can be represented by a quasi-compact morphism
from a field (by definition of decent spaces). Thus the
