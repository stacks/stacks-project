...
Modules on Sites, Section \ref{sites-modules-section-local}.
However, for any nonempty algebraic stack $\mathcal{X}$ the category of
...
\item for any morphism $f : U \to \mathcal{X}$ where $U$ is a
locally Noetherian algebraic space, the pullback $f^*\mathcal{F}|_{U_\etale}$
is coherent,
