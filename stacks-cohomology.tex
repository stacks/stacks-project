...
is a short exact sequence in $\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$.
Let $\mathcal{E} = \Coker(Q(\mathcal{G}) \to Q(\mathcal{H}))$ in
...
is exact in $\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$. Using
