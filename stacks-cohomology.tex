...
Hence (3) shows we may assume that $\mathcal{X}$ is representable by a scheme
(an algebraic stack has a smooth covering by a scheme).
...
Since the sheaves $g_p^*\mathcal{F}$ are in
$\mathcal{M}_{\mathcal{V}_p}$ by (2) it suffices to prove that the
higher direct images of $\mathcal{M}_{\mathcal{V}_p}$ under the morphisms
$$
\mathcal{V}_p =
