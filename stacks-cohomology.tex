...
introduced in the proof of Lemma \ref{lemma-lisse-etale-structure-sheaf}.
We are going to use
...
(resp.\ $\mathcal{X}_{flat,fppf}$). Exactly the same argument that proves
...
$W \to \mathcal{X}$ is smooth (resp.\ flat). By
