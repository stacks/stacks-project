...
However, since the vertical arrows $V' \to U'$ and
$V \to U$ are surjective and \'etale, this implies formally
...
\begin{proof}
We will prove (1). By the exact same arguments used in the proof of
...
\ref{stacks-sheaves-lemma-base-change-higher-direct-images} and
