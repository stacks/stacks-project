...
is quasi-coherent on $\mathcal{X}_{lisse,\acute{e}tale}$
...
we may assume that the site $\mathcal{X}_{lisse,\acute{e}tale}$
...
$g_! : \textit{Mod}(\mathcal{O}_{\mathcal{X}_{lisse,\acute{e}tale}}) \to
\textit{Mod}(\mathcal{X}_{\acute{e}tale}, \mathcal{O}_\mathcal{X})$
(resp.\ $g_! :
