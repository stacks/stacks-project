...
$$
for $a$ and $m$ homogeneous. To see that this works we compute for
...
(m \cdot_{opp} a) \cdot_{opp} b
\end{align*}
The same calculation as in Section \ref{section-conventions}
shows that the Leibniz rule holds for $M$ viewed as
a right $A^{opp}$-module.
With these conventions, the category of left differential graded
...
\end{enumerate}
In (6), the condition may be more succinctly stated by saying
