...
of $\text{Ker}(R \to A)$. We will use without further mention
...
Observe that the condition on vanishing of Tor's applies in
particular if $B$ has finite tor dimension over $A$ and
...
such that $\text{Tor}^A_p(B, A/\mathfrak m_A)$ is nonzero for only
finitely many $p$. Then the following are equivalent
\begin{enumerate}
...
$$
In this way we see that the condition on the local ring map $A \to B$ is
inherited by the local ring map $A^\wedge \to B^\wedge$.
...
Let $I = \text{Ker}(R \to A)$ and $J = \text{Ker}(S \to B)$.
...
if and only if $S_\mathfrak q$ is acomplete
