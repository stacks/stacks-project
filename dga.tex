...
$$
\text{DifferntialGradedBilinear}_A(M \times N, Q) =
...
\medskip\noindent
Let $A$ and $B$ be $R$-algebras. Let $N$ is a $(A, B)$-bimodule
(this means: the induced $R$-module structures are the same and
the $A$ and $B$ actions commute) then $M \otimes_A N$ is a right $B$-module.

\medskip\noindent
If $A$ and $B$ are graded algebras,
...
\medskip\noindent
If $(A, \text{d})$ and $(B, \text{d})$ are differential graded algebras,
...
\medskip\noindent
If we have $R$-algebras $A$, $B$, and $C$, a right $A$-module $M$,
