...
0 = F_{-1}P \subset F_0P \subset F_1P \subset \ldots \subset P
$$
by differential graded $(A, B)$-sub bimodules such that
\begin{enumerate}
\item $P = \bigcup F_pP$,
...
\begin{proof}
Via Lemma \ref{lemma-hom} and Remark \ref{remark-shift-hom-no-sign}
...
\begin{proof}
Via Lemma \ref{lemma-tensor} and Remark \ref{remark-shift-tensor-no-sign}
this follows from the general principle of
Lemma \ref{lemma-functor-between-ABC}.
\end{proof}
...
This is Lemma \ref{lemma-tensor-hom-adjunction}.
\end{proof}
...
\bigoplus\nolimits F_iN_B[1]
$$
in $D(B, \text{d})$. Since $- \otimes_B^\mathbf{L} N'$
