...
\begin{lemma}
\label{lemma-finite-etale-inside-equivalence}
In the situation of Theorem \ref{theorem-topological-invariance}
...
of fundamental groups. See Fundamental Groups, Section
\ref{pione-section-fundamental-groups}.
\end{lemma}

\begin{proof}
Namely, suppose that $V \to Y$ is \'etale and that
$V \times_Y X \to X$ is finite. Then $V \times_Y X \to X$ is proper
hence universally closed. But as $f$ is a universal homeomorphism, it
then follows formally that $V \to Y$ is universally closed.
Hence $V \to Y$ is quasi-compact and universally closed
hence proper. Then $V \to Y$ is proper and locally quasi-finite 
whence finite. Here we used
Morphisms, Lemma \ref{morphisms-lemma-finite-proper},
Morphisms, Definition \ref{morphisms-definition-proper},
Morphisms, Lemma \ref{morphisms-lemma-universally-closed-quasi-compact}, and
...
compute the kernel of $n : \text{Pic}^0(X) \to \text{Pic}^0(X)$.
First we note that the group $\text{Pic}^0(X)$ is the $k$-points of
...
Thus we obtain what we want by applying Groupoids, Proposition
...
Fundamental Groups of Schemes, Lemma
