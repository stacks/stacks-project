...
closed subscheme. Moreover, if $T, T' \subset X$ are locally
...
it suffices to find a finite partition of $Y$ by constructible
...
constructible $T_i$ is a constructible subset of $X$. Namely
if $\mathcal{F}_i$ and $\mathcal{F}$ are locally constant then
also the map between them is locally constant by
Lemma \ref{lemma-morphism-locally-constant}.
...
\begin{lemma}
\label{lemma-category-constructible}
Let $X$ be a quasi-compact and quasi-separated scheme. Every
constructible sheaf $\mathcal{F}$ of sets is a coequalizer
$$
\xymatrix{
\mathcal{F}_1
\ar@<1ex>[r] \ar@<-1ex>[r]
...
\mathcal{F}}
$$
such that $\mathcal{F}_i$ is a finite coproduct of sheaves of
the form $h_U$ with $U$ a quasi-compact and quasi-separated
object of $X_\etale$. In other words, the category of constructible
sheaves of sets is the full subcategory of $\Sh(X_\etale)$ which
have this shape.
\end{lemma}

\begin{proof}
Suppose that for every constructible sheaf of sets $\mathcal{F}$
we can find a surjection $\mathcal{F}_0 \to \mathcal{F}$
