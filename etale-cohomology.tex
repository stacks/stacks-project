...
effect descent with respect to fpqc coverings.
...
$$
i^{-1}Rf'_*K' \to Rf_{\overline{s}, *}(K|_{X_{\overline{s}}})
\quad\text{and}\quad
...
\begin{proof}
This follows immediately from the alternative description
...
R\Gamma(X_{\overline{t}}, K|_{X_{\overline{t}}})
}
$$
...
However, if formation of $Rf_*K$ commutes with any base change, then
we do because then both horizontal maps in the diagram as well as the
the composites
$(Rf_*K)_{\overline{s}} \to R\Gamma(X_{\overline{s}}, K|_{X_{\overline{s}}})$
and
$(Rf_*K)_{\overline{t}} \to R\Gamma(X_{\overline{t}}, K|_{X_{\overline{t}}})$
are isomorphisms.
\end{remark}
...
map (\ref{equation-alpha-K}) is an isomorphism.
