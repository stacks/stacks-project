...
Let $\tau \in \{fppf, syntomic, smooth, \acute{e}etale, Zariski\}$.
...
\item If $\tau \in \{\acute{e}tale, Zariski\}$, then the {\it small $\tau$-site of $S$}
...
of $S$ is the category $\textit{Sh}(S_{\acute{e}tale})$ of sheaves of sets on the
...
Let $S$ be a scheme.
Let $S_{affine, \acute{e}tale}$ denote the full subcategory of $S_{\acute{e}tale}$
...
$\tau \in \{fppf, syntomic, smooth, \acute{e}tale, Zariski\}$ or $S_{\acute{e}tale}$.
Then
$$
...
Actually any morphism between objects of $S_{\acute{e}tale}$ is \'etale, in virtue of
...
exact. A map of sheaves on $S_{\acute{e}tale}$ is an isomorphism if and only if it
...
And, given a covering $\{U_i \to U\}_{i \in I}$ in $S_{\acute{e}tale}$ we see that
...
$$
where $/^p$ denotes the quotient in $\textit{PAb}(S_{\acute{e}tale})$. Taking stalks at
...
is surjective for all geometric points. Fix $U \in \text{Ob}(S_{\acute{e}tale})$
...
$S_{\acute{e}tale}$ of $S$ given by a functor $u : S_{\acute{e}tale} \to \textit{Sets}$.
Then there exists a geometric point $\overline{s}$ of $S$ such that
$p$ is isomorphic to the point of $S_{\acute{e}tale}$ associated to $\overline{s}$ in
Lemma \ref{lemma-stalk-gives-point}.
...
of $S_{\acute{e}tale}$ with $U$ affine. Note that $\varphi$ is separated, and that
...
Let $S$ be a scheme. Let $\mathcal{F}$ be an abelian sheaf on $S_{\acute{e}tale}$.
\begin{enumerate}
...
abelian sheaves on $S_{\acute{e}tale}$, then the support of $\varphi(\sigma)$ is
...
Let $S$ be a scheme. The small \'etale site $S_{\acute{e}tale}$ endowed with its
...
$X_{\acute{e}tale}$. Hence the sheaf condition for $\mathcal{F}$ with respect to
...
is exact on $X_{\acute{e}tale}$, then for every $U/X \in \text{Ob}(X_{\acute{e}tale})$
...
\begin{enumerate}
\item The functor
$f^{-1} : \textit{Ab}(Y_{\acute{e}tale}) \to \textit{Ab}(X_{\acute{e}tale})$ is exact.
\item The functor
$f^{-1} : \textit{Sh}(Y_{\acute{e}tale}) \to \textit{Sh}(X_{\acute{e}tale})$ is exact,
...
It implies part (1) since given an abelian sheaf $\mathcal{G}$ on $Y_{\acute{e}tale}$
...
$$
of sheaves of rings on $Y_{\acute{e}tale}$ such that $(f_{small}, f_{small}^\sharp)$
...
$\mathcal{O}_{X_{\acute{e}tale}}$-modules on $X_{\acute{e}tale}$. But the results of
Descent, Section \ref{descent-section-quasi-coherent-sheaves}
...
of the small \'etale site $X_{\acute{e}tale}$, and similarly for $\mathcal{O}_Y$.
...
$$
(g, g^\#) :
(\textit{Sh}(X_{\acute{e}etale}), \mathcal{O}_X)
\longrightarrow
(\textit{Sh}(Y_{\acute{e}tale}), \mathcal{O}_Y)
$$
be a morphism of locally ringed topoi. Then there exists a
...
Assume (A).
\begin{enumerate}
\item $f_{small, *}: \textit{Ab}(X_{\acute{e}tale}) \to \textit{Ab}(Y_{\acute{e}tale})$
...
Let $f : X \to Y$ be a morphism of schemes.
Denote $f_{small} : \textit{Sh}(X_{\acute{e}tale}) \to \textit{Sh}(Y_{\acute{e}tale})$
...
\end{enumerate}
Then the functor
$f_{small, *} : \textit{Ab}(X_{\acute{e}tale}) \to \textit{Ab}(Y_{\acute{e}tale})$
...
$f_{small, *} : \textit{Sh}(X_{\acute{e}tale}) \to \textit{Sh}(Y_{\acute{e}tale})$ reflects
...
$Y_{\acute{e}tale} \to X_{\acute{e}tale}$, $V \mapsto X \times_Y V$ satisfies the
assumption of
Sites, Lemma \ref{sites-lemma-cover-from-below}.
\end{proof}
...
\end{enumerate}
Then the functor $Y_{\acute{e}tale} \to X_{\acute{e}tale}$, $V \mapsto X \times_Y V$ is
...
$V \to Y$ of $Y_{\acute{e}tale}$ and a surjective morphism $X \times_Y V \to U$ over
$X$. Suppose that for every $u \in U$ we can find an object
$V_u \to Y$ of $Y_{\acute{e}tale}$ and a morphism $h_u : X \times_Y V_u \to U$ over
...
Then
\begin{enumerate}
\item $f_{small, *} : \textit{Sh}(X_{\acute{e}tale}) \to \textit{Sh}(Y_{\acute{e}tale})$
reflects injections and surjections,
\item $f_{small, *} : \textit{Sh}(X_{\acute{e}tale}) \to \textit{Sh}(Y_{\acute{e}tale})$
...
\item $f_{small, *} : \textit{Ab}(X_{\acute{e}tale}) \to \textit{Ab}(Y_{\acute{e}tale})$
is exact, and
\item the functor $Y_{\acute{e}tale} \to X_{\acute{e}tale}$, $V \mapsto X \times_Y V$ is
almost cocontinuous.
\end{enumerate}
\end{lemma}
...
which is a universal homeomorphism, then $X_{\acute{e}tale} \cong Y_{\acute{e}tale}$
...
\textit{Ab}(X_{\acute{e}tale})$. Then $R^pf_*\mathcal{F}$ is the sheaf associated to the
presheaf
$$
...
$\mathcal{F}$ an abelian sheaf on $X_{\acute{e}tale}$, and $\bar s$ a geometric point of
$S$. Then
$$
...
sections functor $\Gamma(S, -): \textit{Ab}(S_{\acute{e}tale})\to \textit{Ab}$ is 
exact. In
particular
$$
...
$$
is a short exact sequence in $\textit{Ab}(S_{\acute{e}tale})$, then the sequence
$$
0 \to \Gamma(S_{\acute{e}tale}, \mathcal{F}_1) \to \Gamma(S_{\acute{e}tale}, \mathcal{F}_2) \to
\Gamma(S_{\acute{e}tale}, \mathcal{F}_3)\to 0
$$
is also exact. Indeed, exactness is clear except possibly at the last step. But
given a section $s \in \Gamma(S_{\acute{e}tale}, \mathcal{F}_3)$, we know that there 
exist
...
$\text{Spec}(K)_{\acute{e}tale}$ of $K$ correspond to surjective families of maps
in $G\textit{-Sets}$.
\end{remark}
...
$$
\textit{Sh}(S_{\acute{e}tale}) \longrightarrow \text{Gal}_{\kappa(s)}\textit{-Sets},
\quad
...
The reason is that in our construction of $\text{Spec}(K)_{\acute{e}tale}$ we chose
a sufficiently large set of schemes \'etale over $\text{Spec}(K)$, whereas
sheaves on $\text{Spec}(K)_{\acute{e}tale}$ form a proper class.
\end{remark}
...
Let $X$ be a scheme and $\mathcal{F}$ an abelian sheaf on $X_{\acute{e}tale}$. We say 
that
...
Let $X$ be a scheme and $\mathcal{F}$ an abelian sheaf on $X_{\acute{e}tale}$. Then the
...
$X_{\acute{e}tale}$ is {\it constructible} if there exists a finite decomposition of $X$
...
Then
$$
\text{Hom}_{\textit{Ab}(\mathcal{U}_{\acute{e}tale})} \left(\underline A_\mathcal{U},
...
$\textit{Ab}(X_{\acute{e}tale})$ and $\mathcal{F}$ is constructible then $\Im(\varphi)$ 
is
...
$j_! : \textit{Ab}(\mathcal{U}_{\acute{e}tale})\to \textit{Ab}(X_{\acute{e}tale})$
...
$$
For $\mathcal{F} \in \textit{Ab}(\mathcal{U}_{\acute{e}tale})$ we consider the presheaf
$$
\begin{matrix}
j_!^{\textit{PSh}}\mathcal{F}: & X_{\acute{e}tale} &\longrightarrow & \textit{Ab}\\
...
$\mathcal{G}\mapsto \mathcal{G}(\mathcal{U})$ on $\textit{Ab}(X_{\acute{e}tale})$, and 
the
...
$\mathcal{F}$ a sheaf on $\mathcal{V}_{\acute{e}tale}$. Consider the cartesian diagram
$$
\xymatrix{
...
Let $X$ be a noetherian scheme and $\mathcal{F}$ a torsion sheaf on $X_{\acute{e}tale}$.
Then $\mathcal{F}$ is a directed (filtered) colimit of constructible sheaves.
\end{lemma}

\begin{proof}[Sketch of proof]
Let $j: \mathcal{U} \to X$ in $X_{\acute{e}tale}$ and $s\in \mathcal{F}(\mathcal{U})$ 
for
...
$\mathcal{F}$ a torsion sheaf on $X_{\acute{e}tale}$. Then $H_{et}^q(X, \mathcal{F}) = 
0$
for all $q\geq 2$.
\end{theorem}
...
locally constant sheaf on $\mathcal{U}_{\acute{e}tale}$. Then for all $q \geq 2$,
...
functors $(f_!,f^{-1})$ and $(f^{-1},f_*)$ on $\textit{Ab}(X_{\acute{e}tale})$. The
...
$X_{\acute{e}tale}$ such that multiplication by $d$ is an isomorphism $\mathcal{F} \cong
...
$\mathcal{F}$ on $X_{\acute{e}tale}$. This can be shown using Serre's Mayer Vietoris
...
nilpotent sheaf of ideals. Then the \'etale sites $X_{\acute{e}tale}$ and $(X_0)_{\acute{e}tale}$ 
are
isomorphic. In particular, for any sheaf $\mathcal{F}$ on $X_{\acute{e}tale}$, $H^q(X,
...
considered will be \'etale, we drop the subscript $_{\acute{e}tale}$. Let us now describe
...
\noindent
Let $\mathcal{F}$ be an abelian sheaf on $X_{\acute{e}tale}$. Consider the cohomology
...
Let $\mathcal{F}$ be an abelian sheaf on $X_{\acute{e}tale}$. Then for all $j\geq 0$,
