...
\label{sections-compact-support}
...
of the support in terms of stalks and Lemma \ref{lemma-stalk-pullback}).
...
Lemma \ref{lemma-shriek-into-star-separated-etale}
...
\ref{etale-lemma-etale-etale-local-technical}.
...
in proof of Lemma \ref{lemma-shriek-into-star-separated-etale},
...
this does not conflict with Definition \ref{definition-extension-zero}
...
by Lemmas \ref{lemma-proper-base-change-f-star} and
\ref{lemma-shriek-base-change}.
...
be checked on stalks (Theorem \ref{theorem-exactness-stalks}).
...
\begin{proof}
This is true because $j_!$ as defined in Section \ref{sections-compact-support}
agrees with $j_!$ as defined in Section \ref{section-extension-by-zero}, see
Lemma \ref{lemma-separated-etale-shriek}. Finally, in
Section \ref{section-extension-by-zero} the functor $j_!$ is defined
...
Section \ref{sections-compact-support} and its adjoint
