...
$$
\Mor_{\textit{Sh}(X_{\acute{e}tale})}(f^{-1}h_V, \mathcal{F}) =
\Mor_{\textit{Sh}(Y_{\acute{e}tale})}(h_V, f_*\mathcal{F}) =
...
(g_*\mathcal{F})(V)
& =
\Mor_{\textit{Sh}(Y_{\acute{e}tale})}(h_V, g_*\mathcal{F}) \\
& =
\Mor_{\textit{Sh}(X_{\acute{e}tale})}(g^{-1}h_V, \mathcal{F}) \\
& =
\Mor_{\textit{Sh}(X_{\acute{e}tale})}(h_{X \times_Y V}, \mathcal{F}) \\
& =
...
\begin{eqnarray*}
\Gamma(S, \mathcal{F}) & = &
\Mor_{\textit{Sh}(S_{\acute{e}tale})}(h_{\Spec(K)},  \mathcal{F})
\\
& = & \Mor_{G\textit{-Sets})}(\{*\}, M) \\
& = & M^G
\end{eqnarray*}
