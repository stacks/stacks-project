...
Thus in the following definition we may work with partitions
(see Topology, Section \ref{topology-section-stratifications})
...
\begin{proof}
Proof of (3). Let $\mathcal{B}$ be the collection of quasi-compact
