...
(Cohomology of Sites, Lemma \ref{sites-cohomology-lemma-apply-Leray}).
...
by Theorem \ref{theorem-colimit} (or Lemma \ref{lemma-colimit}
or Lemma \ref{lemma-direct-sum-bounded-below-cohomology}).
