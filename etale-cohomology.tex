...
The proof of the first statement is omitted.
\end{proof}
...
\noindent
Before stating and proving the following result in its correct
generality we briefly state and prove it for closed immersions.

\begin{lemma}
\label{lemma-closed-immersion-pushforward}
