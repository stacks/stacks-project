...
$\text{Spec}(k) \to S$ where $k$ is separably closed.
...
\noindent
By lemma \ref{lemma-cofinal-etale}, this colimit is directed.
...
if and only if it is exact on all stalks associated to geometric points of
$S$.
\end{theorem}
...
(respectively injective) if and only if it is surjective (resp. injective)
on all stalks. We prove this in the case of surjectivity, and omit the
proof in the case of injectivity.
...
Sites, Section \ref{sites-definition-enough-points}
the proof of
Theorem \ref{theorem-exactness-stalks}
can be modified to show that the small \'etale site of $S$ has enough points.
