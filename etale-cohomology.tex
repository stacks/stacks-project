...
(5) Morphisms, Lemmas \ref{morphisms-lemma-etale-locally-quasi-finite}
and \ref{morphisms-lemma-locally-quasi-finite-rel-dimension-0}.
(6) See Algebra, Lemmas \ref{algebra-lemma-reduced-goes-up} and
...
(7) See Morphisms, Lemma \ref{morphisms-lemma-fppf-open} and
\ref{morphisms-lemma-etale-flat}.
(8) See Morphisms, Lemma \ref{morphisms-lemma-etale-permanence}.
\end{proof}
...
\noindent
Lemma \ref{lemma-kummer-sequence} and general properties of cohomology
give the long exact cohomology sequence
$$
\xymatrix{
0 \ar[r] &
H_{etale}^0(S, \mu_n) \ar[r] &
\Gamma(S, \mathcal{O}_S^*) \ar^{(\cdot)^n}[r] &
\Gamma(S, \mathcal{O}_S^*) \ar@(rd,ul)[rdllllr]
\\
& H_{etale}^1(S, \mu_n) \ar[r] &
\text{Pic}(S) \ar^{(\cdot)^n}[r] &
\text{Pic} (S) \ar@(rd,ul)[rdllllr] \\
& H_{etale}^2(S, \mu_n) \ar[r] &
\cdots
}
$$
...
\noindent
Lemma \ref{lemma-kummer-sequence-syntomic} and general properties of cohomology
give the long exact cohomology sequence
$$
\xymatrix{
0 \ar[r] &
H_{fppf}^0(S, \mu_n) \ar[r] &
\Gamma(S, \mathcal{O}_S^*) \ar^{(\cdot)^n}[r] &
\Gamma(S, \mathcal{O}_S^*) \ar@(rd,ul)[rdllllr]
\\
& H_{fppf}^1(S, \mu_n) \ar[r] &
\text{Pic}(S) \ar^{(\cdot)^n}[r] &
\text{Pic} (S) \ar@(rd,ul)[rdllllr] \\
& H_{fppf}^2(S, \mu_n) \ar[r] &
\cdots
}
$$
for any scheme $S$ and any integer $n$.

\medskip\noindent
Another way to describe the first cohomology group with values in $\mu_n$
is as follows
$$
H_{etale}^1(S, \mu_n) = \left\{(\mathcal{L}, \alpha)\;
\left| \;
\begin{matrix}
...
$$
H_{fppf}^1(S, \mu_n) = \left\{(\mathcal{L}, \alpha)\;
\left| \;
\begin{matrix}
\mathcal{L}\text{ invertible sheaf on } S \\
\text{and }\alpha: \mathcal{L}^{\otimes n} \cong \mathcal{O}_S
...
\begin{enumerate}
\item $u (\text{Cov}(\mathcal{C}_2)) \subset \text{Cov}(\mathcal{C}_1)$ (we
...
exists an isomorphism $\varphi: A \cong R\times A'$ such that $\varphi(\mathfrak n)
= \mathfrak m \times A'\subset R\times A'$.
\end{enumerate}
\end{theorem}
