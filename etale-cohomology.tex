...
$$
and the result follows from Lemma \ref{lemma-directed-colimit-cohomology}.
\end{proof}
...
morphism is finite \'etale over a nonempty open of $Z$ (details
omitted). This finishes the proof of (1).
