...
Sites, Definition \ref{sites-definition-point}
that the stalk functor at a point of a site is exact.
...
Lemma \ref{lemma-stalk-exact}
(for abelian sheaves, for sheaves of sets see
Sites, Lemma \ref{sites-lemma-point-pushforward-sheaf}
and sentence following that lemma) that taking stalks commutes with
sheafification. Now recall that $f^{-1}\mathcal{G}$ is the sheaf
