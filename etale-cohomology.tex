...
\begin{enumerate}
\item The henselization $R^h$ and strict henselization $R^{sh}$
of $R$ are Noetherian,
\item the map of completions $R^\wedge \to (R^h)^\wedge$ is an
isomorphism.
\end{enumerate}
\end{lemma}
...
completion of $\bigoplus_{j \in J} R$ as an $R$-module. Of course
this is the same thing as the completion of $\bigoplus_{j \in J} R^\wedge$.
By
More on Flatness, Lemma \ref{flat-lemma-completed-direct-sum-ML}
we see this is flat over $R^\wedge$ (hence flat over $R$) and we win.
\end{proof}
