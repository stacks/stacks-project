...
Arguing as in the proof of Theorem \ref{theorem-zariski-fpqc-quasi-coherent},
one shows that
$$
H_{fppf}^1(X, \mathbf{G}_m) =
\text{colim}_{\mathcal{U}} \check H^1(\mathcal{U}, \mathbf{G}_m).
$$
Given an fppf covering $\mathcal{U} = \{U_i \to X\}_{i \in I}$
and a \u Cech cocycle
$(f_{ij})_{i,j \in I}$, $f_{ij} \in \Gamma(U_i \times_X U_j, \mathbf{G}_m)$,
we get a descent datum
$$
\left(
\mathcal{O}_{\mathcal{U}_i},
f_{ij} :
\text{pr}_0^*(\mathcal{O}_{\mathcal{U}_i})
\to
\text{pr}_1^*(\mathcal{O}_{\mathcal{U}_j})
\right)
$$
