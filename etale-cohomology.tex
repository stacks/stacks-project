...
Let $X$ be a scheme and let $\mathcal{F}$ be a torsion abelian
sheaf on $X_\etale$. Let $Z \subset X$ be a closed subscheme
...
$$
H^p_\etale(X, \mathcal{F}) \to
H^p_\etale(X', \mathcal{F}) \oplus
H^p_\etale(Z, \mathcal{F}) \to
H^p_\etale(E, \mathcal{F}) \to
H^{p + 1}_\etale(X, \mathcal{F})
$$
\end{lemma}

\begin{proof}
The notation $H^p_\etale(X', \mathcal{F})$ stands for
$H^p(X'_\etale, b_{small}^{-1}\mathcal{F})$ and similarly
for the other cohomology groups. By
Lemma \ref{lemma-compare-cohomology-etale-ph}
these cohomology groups are the cohomology of
$X, X', E, Z$ with values in some abelian sheaf
on the site $(\Sch/X)_{ph}$. (Namely, the sheaf
$a_X^{-1}\mathcal{F}$, see Lemma \ref{lemma-describe-pullback-pi-ph} above.)
