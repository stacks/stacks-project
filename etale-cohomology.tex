...
\Hom_{\textit{Sh}(\mathcal{C})}(\mathcal{F}^\#,\mathcal{G})
$$
...
$$
\Hom_{{\textit{Sh}(X_{\acute{e}tale})}} (f^{-1}\mathcal{G}, \mathcal{F})
=
\Hom_{\textit{Sh}(Y_{\acute{e}tale})} (\mathcal{G}, f_*\mathcal{F})
$$
...
Then
$$
\Hom_{\textit{Ab}(\mathcal{U}_{\acute{e}tale})}
...
$$
\Hom_X(j_!\mathcal{F}, \mathcal{G}) =
\Hom_\mathcal{U}(\mathcal{F}, j^{-1}\mathcal{G})
$$
