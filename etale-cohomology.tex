...
Let $X$ be an affine scheme. There exists an integral surjective morphism
$X' \to X$ such that for every closed subscheme $Z \subset X'$
and every finite abelian group $M$
we have $H^q_\etale(Z, \underline{M}) = 0$ for $q \geq 1$.
\end{lemma}
...
$A' = R/JR$ and set $X' = \Spec(A')$. This works by
