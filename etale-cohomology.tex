...
all $q\geq 1$, $H_{\acute{e}tale}^q(X_{\bar y}^{sh}, \mathcal{G})=0$.
Since $f$ is
...
\item $H_{\acute{e}tale}^p(\mathcal{U}, \mathcal{G})=
H_{\acute{e}tale}^p(\mathcal{U}, j^{-1}\mathcal{G})$
for any $\mathcal{G} \in \textit{Ab}(X_{\acute{e}tale})$
...
and on the other hand
$$
\left(j_* \mathcal{F} \right)_{\bar x} =
H_{\acute{e}tale}^0(\Spec(\mathcal{O}_{X, \bar x}^{sh}) \times_X \mathcal{V},
\mathcal{F}).
$$
