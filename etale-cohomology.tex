...
$$
c_{ij} : text{pr}_{0, small}^{-1} f_{i, small}^{-1}\mathcal{F}
\longrightarrow
...
\begin{lemma}
\label{lemma-glue-etale-sheaf-check-after-integral-surjective-base-change}
Let $f : X \to Y$ be a morphism of schemes. Let $Z \to Y$ be a surjective
integral morphism of schemes. If the functors
$$
\Sh(Z_\etale)
\longrightarrow
...
Lemma \ref{lemma-glue-etale-sheaf-integral-surjective}. Details omitted.
\end{proof}
...
Applying Lemma
\ref{lemma-glue-etale-sheaf-check-after-integral-surjective-base-change}
...
Then we have descent for $\{X \to Y\}$ by
Lemma \ref{lemma-glue-etale-sheaf-fppf-cover}.
