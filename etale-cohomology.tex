...
Proposition \ref{lemma-gabber-for-absolutely-algebraically-closed}.
...
Proposition \ref{lemma-gabber-for-absolutely-algebraically-closed}
it suffices to show vanishing for $H^1$.
...
$$
G(R) \to H(R) \to
H^1(\Spec(R), \mathbf{Z}/\ell\mathbf{Z}) \to
H^1(\Spec(R), G)
$$
Please keep this in mind during the proof.

\medskip\noindent
Let $\xi \in H^1(\Spec(R), \mathbf{Z}/\ell\mathbf{Z})$.
Again using the argument in the proof of
Proposition \ref{lemma-gabber-for-absolutely-algebraically-closed}
we may assume there is an affine open covering $\Spec(R) = U \cup V$
such that $\xi|_U$ and $\xi|_V$ are trivial.
Then we get a section
$\tau \in \Gamma(U \cap V, \mathbf{Z}/\ell\mathbf{Z})$
whose boundary in the Mayer-Vietoris sequence
...
$$
(scheme theoretic unions and intersections as in Morphisms, Section
