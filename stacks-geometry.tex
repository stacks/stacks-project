...
(and even spectral, see
Morphisms of Stacks, Lemma \ref{stacks-morphisms-lemma-spectral-qcqs}),
...
$$
\xymatrix{
|\Spec \mathcal{O}_{U'',u''}| \ar[r]\ar[d] & |U''| \ar[d] \\
...
Now Lemma \ref{lemma-dimension-for-stacks} shows that
$$
