...
$cf(\beta)$ strictly bigger than the cardinality of $S$ then this
is the case.
...
the cofinality of $\beta$ is larger than the cardinality
of $S$, then the result of the lemma is true. Hence the lemma
follows from the fact that there are ordinals with arbitrarily
large cofinality. For example the cofinality of $2^\kappa$
is bigger than $\kappa$.
\end{proof}
