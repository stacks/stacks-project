...
\mathcal{F}^\vee
=
\textit{Hom}(\mathcal{C})}(\mathcal{F}, \mathcal{J})
$$
...
Let $\mathcal{F}$ be a ring. For every $\mathcal{F}$-module $\mathcal{F}$ the
...
=
\text{Hom}_\mathcal{O}(\mathcal{G}, (F(\mathcal{F}^\vee), \mathcal{J}))
