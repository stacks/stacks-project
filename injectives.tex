...
\noindent
Here we can talk in general about generators, (co)limits and all that
good stuff. This will possibly be needed later on anyway. This section
is most interesting for ``big'' abelian categories, i.e., those
...
\medskip\noindent
The existence of a generator implies that given an object $M$ of
$\mathcal{A}$ there is a set of subobjects. (This may not be true for
a general ``big'' abelian category.)
