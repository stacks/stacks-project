...
\begin{proof}
Let $U \in \text{Ob}((\Sch/S)_{fppf})$. Let
...
Let $U \in \text{Ob}((\Sch/S)_{fppf})$, and let
...
\item There exists a scheme $U \in \text{Ob}(\Sch_{fppf})$
...
given a scheme $T \in \text{Ob}((\Sch/S)_{fppf})$
...
$T \in \text{Ob}((\Sch/S)_{fppf})$, that $F$ is an
...
\'etale morphisms, with $U, V \in \text{Ob}((\Sch/S)_{fppf})$,
...
Finally, let $U, V \in \text{Ob}((\Sch/S)_{fppf})$
...
Let $S \in \text{Ob}(\Sch_{fppf})$.
Let $U \in \text{Ob}((\Sch/S)_{fppf})$.
Given a set $I$ and sheaves $F_i$ on $\text{Ob}((\Sch/S)_{fppf})$,
...
\medskip\noindent
Choose a scheme $U \in \text{Ob}((\Sch/S)_{fppf})$
and a surjective
\'etale morphism $U \to \coprod F_i$ (this exist by hypothesis).
...
$$
is a coequalizer diagram in $\textit{Sh}((\Sch/S)_{fppf})$.
\end{enumerate}
\end{lemma}
...
Let $U \in \text{Ob}((\Sch/S)_{fppf})$, and $q : U \to F$
...
\item there exists a $U \in \text{Ob}((\Sch/S)_{fppf})$
...
Given any $V \in \text{Ob}((\Sch/S)_{fppf})$
and a surjective \'etale morphism $q : V \to G$ there exists
a $U \in \text{Ob}((\Sch/S)_{fppf})$
...
\begin{proof}
First choose $W \in \text{Ob}((\Sch/S)_{fppf})$
...
Let $S \in \text{Ob}(\Sch_{fppf})$ be a scheme.
Let $F$ be an algebraic space over $S$.
\begin{enumerate}
...
\begin{align*}
g : \textit{Sh}((\Sch/S)_{fppf})
\longrightarrow
\textit{Sh}((\Sch'/S)_{fppf}),\\
f : \textit{Sh}((\Sch'/S)_{fppf})
\longrightarrow
\textit{Sh}((\Sch/S)_{fppf})
\end{align*}
...
$X \in \text{Ob}((\Sch/S)_{fppf})$ over $S$,
...
\begin{proof}
Let $X \in \text{Ob}((\Sch/S)_{fppf})$. Let us write $h_X$ for the
...
$X' \in \text{Ob}(\textit{Spaces}'/S)$
such that there exists an object
$U \in \text{Ob}((\Sch/S)_{fppf})$
and a surjective \'etale morphism
$U \to X'$ in the category $\textit{Sh}((\Sch'/S)_{fppf})$.
\end{lemma}
...
Suppose that $X' \in \text{Ob}(\textit{Spaces}'/S)$
such that there exists an object $U \in \text{Ob}((\Sch/S)_{fppf})$
...
$R \in \text{Ob}((\Sch/S)_{fppf})$. Now we use
...
because the sheaf $j_!F$ maps to $h_{S}$ (see for example the
...
$j_!F = U'/R'$ as in 
Lemma \ref{lemma-space-presentation}
with $U', R' \in \text{Ob}((\Sch/S')_{fppf})$.
