...
an isomorphism. Note also that $\text{Coim}(f) = V$ and $\Im(f) = W$.
...
is that the canonical map $\text{Coim}(f) \to \Im(f)$
...
and if the natural map $\text{Coim}(f) \to \Im(f)$
...
$$
Now we still have to show that $\text{Coim}(\psi)= \Im(\psi)$.
...
To finish the proof of (3) we have to show that $\text{Coim} = \Im$ in
...
$I = \Im(f - g) \subset C$ is a quotient of $\text{Coker}(s)$
...
\begin{enumerate}
\item $f$ is strict,
\item the morphism $\text{Coim}(f) \to \Im(f)$ of
...
\begin{proof}
Note that $\text{Coim}(f) \to \Im(f)$ is an isomorphism of
...
\begin{enumerate}
\item $f$ is strict,
\item the morphism $\text{Coim}(f) \to \Im(f)$ is an isomorphism,
\item $\text{gr}(\text{Coim}(f)) \to \text{gr}(\Im(f))$ is an
isomorphism,
\item the sequence
...
Lemma \ref{lemma-ses-gr}
and the fact that
$\text{Coim}(\alpha) \cong \Im(\alpha)$ and
$\text{Coim}(\beta) \cong \Im(\beta)$ by
Lemma \ref{lemma-characterize-strict-general}.
\end{proof}
