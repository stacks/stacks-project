...
Let $\mathcal{A}$ be an abelian category. Let $M^\bullet$ be a complex. Let
$$
\ldots \to A_2^\bullet \to A_1^\bullet \to A_0^\bullet \to M^\bullet \to 0
$$
be an exact complex of complexes such that for all $p \in \mathbf{Z}$
the complexes
$$
\text{Ker}(d_{A_2^\bullet}^p) \to \text{Ker}(d_{A_1^\bullet}^p)
