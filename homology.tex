...
Let $x = \text{Ker}(p)$ and $y = \text{Ker}(1 - p)$. There are maps
...
$$
\ldots \to \text{Ker}(d_{A_2^\bullet}^p) \to \text{Ker}(d_{A_1^\bullet}^p)
\to \text{Ker}(d_{A_0^\bullet}^p) \to \text{Ker}(d_{M^\bullet}^p) \to 0
$$
...
Let $x \in \text{Ker}(\text{d}_{T^\bullet}^0)$ represent a
cohomology class $\xi$.
...
$$
Let $x \in \text{Ker}(\text{d}_{T^\bullet}^0)$ represent a cohomology
