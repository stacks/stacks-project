...
$$
\item We say that the spectral sequence {\it collapses at $E_r$}
...
$x : T \to Z_{r + 1}$ and $a : T \to A$ such that
$f \circ x = \alpha^r \circ a$ we have
$$
d_r \circ \overline{x} = \overline{g \circ a}
$$
