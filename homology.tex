...
\item $X = \colim M$ exists and there exists a cofinal subcategory
...
\begin{enumerate}
\item $M$ is essentially constant,
\item $X = \lim M$ exists and there exists an initial subcategory
$\mathcal{I}' \subset \mathcal{I}$ and for $i' \in \Ob(\mathcal{I}')$
...
Lemma \ref{lemma-essentially-constant-into-karoubian} shows
that $F$ is essentially constant with value $X$ and $G$ is essentially
