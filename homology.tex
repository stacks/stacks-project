...
is a quasi-isomorphism $K^\bullet \to j(K^\bullet)$.
...
\medskip\noindent
Properties (1), (2) and (3) are true by construction.
The isomorphism $H^n = H^n \circ j$ comes from the
quasi-isomorphisms $K^\bullet \to j(K^\bullet)$ which
are compatible with morphisms. Also, part (6) follows from part (5).

\medskip\noindent
Let us prove (5). It is clear that if $j(\alpha)$ is invertible,
...
Hence by Definition \ref{definition-distinguished-triangle}
there is a notion of a distinguished triangle, and by
...
such that
\begin{enumerate}
\item the triangle $(G(A), G(B), G(C), G(a), G(b), \delta)$
...
functor $\mathcal{A} \to \mathcal{D}$ is a $\delta$-functor, but one
often does.
