...
$(X, Y, Q_1, f, p_1, d_1)$,
$(Y, Z, Q_2, g, p_2, d_2)$, and
$(X, Z, Q_3, g \circ f, p_3, d_3)$ there exist
morphisms $a : Q_1 \to Q_3$ and $b : Q_3 \to Q_2$ such
that
\begin{enumerate}
\item $(Q_1, Q_3, Q_2, a, b, p_1[1] \circ d_2)$ is a
distinguished triangle,
\item the triple $(\text{id}_X, g, a)$ is
a morphism of triangles
$(X, Y, Q_1, f, p_1, d_1) \to (X, Z, Q_3, g \circ f, p_3, d_3)$, and
\item the triple $(f, \text{id}_Z, b)$ is a morphism of triangles
$(X, Z, Q_3, g \circ f, p_3, d_3) \to (Y, Z, Q_2, g, p_2, d_2)$.
\end{enumerate}
\end{enumerate}
\end{definition}
...
In other words we get a triangle
$$
...
\ref{definition-split-ses} and discussion below it).
\end{definition}

\noindent
This does indeed lead to a triangulated category.
...
are split injections of complexes. Then also
$A^\bullet \to C^\bullet$ is a split injection.
Let us write (loosely)
$(B/A)^\bullet$, $(C/A)^\bullet$ and $(C/B)^\bullet$
for the ``quotient'' complexes.
Then it is clear that
$(A^\bullet, B^\bullet, (B/A)^\bullet)$,
$(B^\bullet, C^\bullet, (C/B)^\bullet)$,
$(A^\bullet, C^\bullet, (C/A)^\bullet)$, and
$((B/A)^\bullet, (C/A)^\bullet, (C/B)^\bullet)$
are distinguished triangles. Moreover the canonical maps
define morphisms of triangles
$$
(A^\bullet, B^\bullet, (B/A)^\bullet) \to
(A^\bullet, C^\bullet, (C/A)^\bullet)
$$
and
$$
(A^\bullet, C^\bullet, (C/A)^\bullet) \to
(B^\bullet, C^\bullet, (C/B)^\bullet).
$$
In other words
this gives a structure as in the conclusion of TR4.
\end{remark}
