...
unique up to isomorphism of functors.
\end{lemma}
...
$$
which is a localization functor.
\end{remark}
...
\begin{remarks}
\label{remarks-right-derived-functor}
(1) It is clear that we can use this definition even if $F$ is just additive
...
\noindent
(2) If $\mathcal{B}$ has enough injectives as well and if
