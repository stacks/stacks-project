...
from the definitions that $\mathcal{F}^a$ is a sheaf for the Zar
topology.
...
$$
\xymatrix{
\Sh(\textit{LC}_{Zar}/X) \ar[r]_j \ar[d]_{\pi_X} &
...
\begin{enumerate}
\item $\pi_Y^{-1} \circ f_* = j_* \circ \pi_X^{-1}$ as functors
$\Sh(X) \to \Sh(\textit{LC}_{Zar}/Y)$,
\item $\pi_Y^{-1} \circ Rf_* = Rj_* \circ \pi_X^{-1}$ as
...
\medskip\noindent
Proof of (5). The morphism of topoi $j$ comes from an application of
...
H^n_{Zar}(X, j^{-1}\pi_Y^{-1}\mathcal{G})$
...
Thus $Rj_*\pi_X^{-1}K$ and $\pi_Y^{-1}Rf_*K$ have the same
cohomology sheaves. We omit the verification that the
canonical base change map $\pi_Y^{-1}Rf_*K \to Rj_*\pi_X^{-1}K$
...
$$
Observe that $\epsilon_{X, *} \circ a_X^{-1} = \pi_X^{-1}$
by Lemma \ref{lemma-describe-pullback-pi}.
...
\vcenter{
\xymatrix{
\Sh(\textit{LC}_{qc}/X) \ar[r]_{j_{qc}} \ar[d]_{\epsilon_X} &
\Sh(\textit{LC}_{qc}/Y) \ar[d]^{\epsilon_Y} \\
\Sh(\textit{LC}_{Zar}/X) \ar[r]^j &
\Sh(\textit{LC}_{Zar}/Y)
}
}
\quad\text{and}\quad
\vcenter{
\xymatrix{
\Sh(\textit{LC}_{qc}/X) \ar[r]_{j_{qc}} \ar[d]_{a_X} &
...
If $f$ is proper, then $a_Y^{-1} \circ f_* = j_{qc, *} \circ a_X^{-1}$.
\end{lemma}

\begin{proof}
The morphism of topoi $j_{qc}$ is the one from
Sites, Lemma \ref{sites-lemma-relocalize}
...
$a_Y^{-1}f_*\mathcal{F} \to j_{qc, *}a_X^{-1}\mathcal{F}$
is an isomorphism, it suffices to show that
$$
\pi_Y^{-1}f_*\mathcal{F} =
\epsilon_{Y, *}a_Y^{-1}f_*\mathcal{F} \to
\epsilon_{Y, *}j_{qc, *}a_X^{-1}\mathcal{F} =
j_* \epsilon_{X, *}a_X^{-1}\mathcal{F} =
j_*\pi_X^{-1}\mathcal{F}
$$
...
$a_Y^{-1}(R^if_*\mathcal{F}) = R^ij_{qc, *}(a_X^{-1}\mathcal{F})$
for $i = 0, \ldots, n$.
\end{enumerate}
Observe that $V_0$ holds trivially and that $C_0$ holds by
Lemma \ref{lemma-push-pull-LC}.

\begin{lemma}
\label{lemma-V-implies_C}
...
$$
R\epsilon_{Y, *}(Rj_{qc, *}(a_X^{-1}\mathcal{F})) =
Rj_*(R\epsilon_{X, *}(a_X^{-1}\mathcal{F}))
$$
Using the spectral sequences of Lemma \ref{lemma-relative-Leray}
on both sides, the description of $R^ij_{qc, *}a_X^{-1}\mathcal{F}$
for $i \leq n - 1$ given to us by $C_{n - 1}$, and
the vanishing furnished to us by $V_n$
(for both $X$ and $Y$) we obtain 
$$
\epsilon_{Y, *}(R^nj_{qc, *}(a_X^{-1}\mathcal{F})) =
R^nj_*(\epsilon_{X, *}(a_X^{-1}\mathcal{F})) =
R^nj_*(\pi_X^{-1}\mathcal{F})
$$
(last equality by Lemma \ref{lemma-describe-pullback-pi}).
We already know the sheaf on the right is equal to
$\pi_Y^{-1} R^nf_*\mathcal{F} = \epsilon_{Y, *}(a_Y^{-1}R^nf_*\mathcal{F})$.
...
Rj_{qc, *}j_{qc}^{-1}a_Y^{-1}\mathcal{F} =
Rj_{qc, *}a_X^{-1}f^{-1}\mathcal{F}
$$
...
$$
a_Y^{-1}\mathcal{F} \longrightarrow
\tau_{\leq n}Rj_{qc, *}a_X^{-1}f^{-1}\mathcal{F}
$$
...
$a_Y^{-1}Rf_*f^{-1}\mathcal{F} \to Rj_{qc, *}a_X^{-1}f^{-1}\mathcal{F}$
induces an isomorphism
$$
a_Y^{-1}K \longrightarrow \tau_{\leq n}Rj_{qc, *}a_X^{-1}f^{-1}\mathcal{F}
$$
...
and $K$ in $D^+(X)$ we have $a_Y^{-1}(Rf_*K) = Rj_{qc, *}(a_X^{-1}K)$.
\end{enumerate}
\end{lemma}

\begin{proof}
Recall that $V_0$ holds trivially and that $C_0$ holds by
Lemma \ref{lemma-push-pull-LC}. Then we get $V_n$ and $C_n$ for all
$n$ by Lemmas \ref{lemma-V-implies_C} and \ref{lemma-induction-step-V-C}.
...
$$
H^q(X, \mathcal{F}) = H^q_{qc}(X, a_X^{-1}\mathcal{F})
$$
Similarly $H^q(X, K) = H^q_{qc}(X, a_X^{-1}K)$ for $K \in D^+(X)$.
In particular, if $A$ is an abelian group, then we have
$H^q(X, \underline{A}) = H^q_{qc}(X, \underline{A})$.
\end{lemma}
