...
The induced map
$\text{colim}_i\ \mathcal{K}_i^\bullet \to \mathcal{G}^\bullet$
is a quasi-isomorphism by construction. Since
$\text{colim}_i\ \mathcal{K}_i^\bullet$ is K-flat by
...
$\mathcal{K}^\bullet = \text{colim}_i\ \mathcal{K}_i^\bullet \to
\mathcal{G}^\bullet$
...
$f^{-1}\mathcal{K}^\bullet  = \text{colim}_i\ f^{-1}\mathcal{K}_i^\bullet$
is K-flat by
...
$$
\lim\nolimits_n \mathcal{I}_n^{m - 2}(U) \to
\lim\nolimits_n \mathcal{I}_n^{m - 1}(U) \to
\lim\nolimits_n \mathcal{I}_n^m(U) \to
\lim\nolimits_n \mathcal{I}_n^{m + 1}(U)
$$
