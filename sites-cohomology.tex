...
\medskip\noindent
Proof of (1).
Assume $\mathcal{K}^\bullet$ is K-flat. Pick a point $p$ of $\mathcal{C}$.
Let $M^\bullet$ be an acyclic complex of $\mathcal{O}_p$-modules.
Then $p_*M^\bullet$ is an acyclic complex of $\mathcal{O}$-modules
because $p_*$ is exact functor on abelian sheaves by
Sites, Lemma \ref{sites-lemma-skyscraper-functor-exact}.
Thus $\text{Tot}(p_*M^\bullet \otimes_\mathcal{O} \mathcal{K}^\bullet)$
is acyclic. Taking stalks at $p$ and using
Modules on Sites, Lemma \ref{sites-modules-lemma-skyscraper-modules-exact}
shows that
$\text{Tot}(M^\bullet \otimes_{\mathcal{O}_p} \mathcal{K}_p^\bullet)$
is acyclic.
\end{proof}
...
and
$$
H^p(R\Hom(K, L)) = \Ext_{D(\mathcal{O})}^p(K, L)
$$
