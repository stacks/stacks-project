...
\noindent
The following lemma tells is in particular that if $U$ is a
quasi-compact object of a site and $\mathcal{F}_i$ is a set
of abelian sheaves, then
$$
(\bigoplus \mathcal{F}_i)(U) = \bigoplus \mathcal{F}_i(U)
$$
...
$$
which commutes with direct sums by the remark following
