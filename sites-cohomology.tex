...
For any morphism of
ringed topoi
$f : (\mathcal{C}, \mathcal{O}) \to (\mathcal{D}, \mathcal{O}')$
we obtain
$$
...
\begin{lemma}
\label{lemma-adjoint}
Let $f : (\mathcal{C}, \mathcal{O}) \to (\mathcal{D}, \mathcal{O}')$
be a morphism of ringed topoi. The functor $Rf_*$ defined above and
