...
Consider the complex $\mathcal{H}^\bullet$ of $\mathcal{O}$-modules with
terms
$$
\mathcal{H}^n =
\prod\nolimits_{n = p + q}
...
$\alpha = \prod_{n = p + q} \alpha_{p, q}$ by the rule
$$
\alpha_{p, q}
\longmapsto
\text{d}_{\mathcal{I}}^p \circ \alpha_{p, q}
...
$$
by Modules, Lemma \ref{modules-lemma-internal-hom}. The signs work out
by the computation given in the proof of
