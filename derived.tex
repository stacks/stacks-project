...
$$
\xymatrix{
\lim\nolimits_{\mathcal{I}} \text{Mor}_{\mathcal{D}'}(F(X''), W) \ar[r] &
\text{Mor}_{\mathcal{D}'}(A, W) \\
\lim\nolimits_{\mathcal{I}} \text{Mor}_{\mathcal{D}'}(F(Y''), W) \ar[u] \ar[r] &
\text{Mor}_{\mathcal{D}'}(B, W) \ar[u] \\
\lim\nolimits_{\mathcal{I}} \text{Mor}_{\mathcal{D}'}(F(Z''), W) \ar[u] \ar[r] &
\text{Mor}_{\mathcal{D}'}(C, W) \ar[u] \\
\lim\nolimits_{\mathcal{I}} \text{Mor}_{\mathcal{D}'}(F(X''[1]), W) \ar[u]
\ar[r] &
\text{Mor}_{\mathcal{D}'}(A[1], W) \ar[u] \\
\lim\nolimits_{\mathcal{I}} \text{Mor}_{\mathcal{D}'}(F(Y''[1]), W) \ar[u]
\ar[r] &
