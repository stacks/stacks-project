...
We say an object $K$ is a {\it derived limit} of the system $(K_n)$ if
...
case, then we indicte this by the notation $K = R\lim K_n$.
\end{definition}

\noindent
By TR3 a derived limit, if it exists, is unique up to (non-unique) isomorphism.
