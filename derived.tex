...
\right\}
$$
In other words it is the smallest strictly full triangulated subcategory
of $\mathcal{D}$ containing any summand of an object of $\mathcal{B}$.
\end{lemma}
...
$\mathcal{D}$ containing any summand of an object of $\mathcal{B}$.
\end{enumerate}
...
and
the (partially ordered) set of ``saturated'' strictly full triangulated
