...
Definition \ref{definition-exact-functor-triangulated-categories}.
...
the functor $j$, see Lemma \ref{lemma-universal-property-localization}.
Consider the commutative square in proof of
Lemma \ref{lemma-j-is-exact}. In this square, if $\alpha$ is a
...
Proposition \ref{proposition-derived-category} the morphism
...
Lemma \ref{lemma-K-injective} it has a left inverse.
...
\begin{proof}
By Lemma \ref{lemma-representable-homological}, this is a particular case
