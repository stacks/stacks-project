...
In
Situation \ref{situation-derived-functor}.
We say $RF$ is {\it right deriveable}, or {\it everywhere defined}
if $RF$ is defined at every object of $\mathcal{D}$.
We say $LF$ is {\it left deriveable}, or {\it everywhere defined}
...
\noindent
The above material suggests the following.
...
is a functor
$$
j : K^{+}(\mathcal{A}) \longrightarrow K^{+}(\mathcal{I})
$$
