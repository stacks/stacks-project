...
by Categories, Lemma \ref{lemma-cofinal-essentially-constant}.
...
isomorphism by Categories, Lemma \ref{lemma-cofinal}.
...
\begin{lemma}
	...
	Categories, Definition \ref{definition-essentially-constant-diagram}
...
\begin{proof}
	...
	satisfying Categories, Definition \ref{definition-essentially-constant-diagram}.
	...
	for $S$ is saturated (Lemma \ref{lemma-what-gets-inverted}).
	...
	(Categories, Remark \ref{remark-essentially-constant-down-the-diagram}.)
...
Lemma \ref{lemma-characterize-essentially-constant-ind}.
