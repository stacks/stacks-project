...
such that the map
$$
(A/\mathfrak m)[[x, y]] \longrightarrow B/\mathfrak m B,
...
This is possible because the residue field of $B$ agree with the
...
and having coordinates $u, v$ equal to zero.
Then finally we can apply More on Morphisms, Lemmas
