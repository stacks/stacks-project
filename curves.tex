...
of degree at most $2g - 2$ such that $X$ aquires a rational point.
...
\begin{proof}
Part (1) is immedate from Lemma \ref{lemma-bound-geometric-genus}.
...
(Picard Groups of Curves, Lemma \ref{pic-lemma-torsion-descends})
