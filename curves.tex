...
as in Duality for Schemes, Example \ref{duality-example-proper-over-local}
...
Duality for Schemes, Lemma \ref{duality-lemma-apply-CM}.
...
as in Duality for Schemes, Example
\ref{duality-example-equidimensional-over-field}.
...
of $X$ as in Duality for Schemes, Example
\ref{duality-example-equidimensional-over-field}.
...
module as in Duality for Schemes, Example
\ref{duality-example-equidimensional-over-field}
we see that
\begin{equation}
...
Duality for Schemes, Lemma \ref{duality-lemma-flat-under-gorenstein}.
...
(Discriminants, Lemma \ref{discriminant-lemma-lci-gorenstein} and
