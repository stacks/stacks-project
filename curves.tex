...
\begin{proof}[Proof not using Artin approximation]
...
is a split node, see Definition \ref{definition-split-node}.
By Lemma \ref{lemma-split-node} we see that there exists an
