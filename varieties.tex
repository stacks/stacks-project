...
a normal scheme. This notion is defined even for non-Noetherian
schemes. Hence the following lemma makes sense.
...
\begin{proof}
By Properties, Lemma \ref{properties-lemma-locally-normal}
this reduces to the case where $X$ is affine.
In this case the result follows from
Algebra, Lemma \ref{algebra-lemma-geometrically-normal}.
\end{proof}
