...
Consider the Leray spectral sequence for $\mathcal{O}_X^*$ and $f$,
see Cohomology, Lemma \ref{cohomology-lemma-Leray}.
...
says exactly that this map is zero. Hence
...
the higher cohomology groups of any abelian sheaf supported
on $T$ is zero. The lemma follows easily from this.
\end{proof}
