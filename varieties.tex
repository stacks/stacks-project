...
sheaves on $\mathbf{P}^n$ over a field. These will be useful later
when discussing Quot and Hilbert schemes.

\medskip\noindent
Let $k$ be a field, $n \geq 1$, $d \geq 1$, and let
$s \in \Gamma(\mathbf{P}_k^n, \mathcal{O}(d))$
be a nonzero section. In this seciton we will write $\mathcal{O}(d)$
...
$s \in \Gamma(\mathbf{P}^n_k, \mathcal{O}(1))$, a coherent
module $\mathcal{G}$ on the hyperplane $H$ associated to $s$
and a short exact sequence
$$
0 \to \mathcal{F}(-1) \to \mathcal{F} \to i_*\mathcal{G} \to 0
$$
where $i : H \to \mathbf{P}^n_k$ is the closed immersion.
\end{lemma}
