...
\begin{proof}
Since $X$ is quasi-compact we can find a finite collections
$(\mathcal{L}_i, s_i)$, $i = 1, \ldots, n$
of pairs as in the statement of the lemma
such that $X = \bigcup X_{s_i}$. Again because $X$ is
quasi-compact we can find, for each $i$, a finite collection
of sections $t_{i, j}$, $j = 1, \ldots, m_i$
...
our cocycle on $U_t \cap U_{t'}$. This finishes the proof.
\end{proof}
