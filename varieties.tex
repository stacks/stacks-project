...
unique). We can find a common field extension $k'''/k$
...
$k'''/k$ (i.e.\ with both $k' \subset k'''$ and $k'' \subset k'''$)
...
of pairs such that $\mathcal{L}_i$ is globally generated, $X_{s_i}$ is affine and $X = \bigcup X_{s_i}$. 
