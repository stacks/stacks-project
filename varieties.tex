...
$\mathcal{L}_1, \ldots, \mathcal{L}_r$ be invertible $\mathcal{O}_X$-modules.
Let $Z \subset X$ be an integral closed subscheme with generic point $\xi$.
Let $\mathcal{F}$ be a coherent $\mathcal{O}_X$-module.
Assume that $\text{Supp}(\mathcal{F}) \subset Z$.
Then
$$
\chi(X, \mathcal{F} \otimes \mathcal{L}_1^{\otimes n_1} \otimes \ldots \otimes
\mathcal{L}_1^{\otimes n_1}) -
\text{length}_{\mathcal{O}_{X, \xi}}(\mathcal{F}_\xi)
\chi(X, \mathcal{O}_Z \otimes \mathcal{L}_1^{\otimes n_1} \otimes \ldots
\otimes \mathcal{L}_1^{\otimes n_1})
$$
is a numerical polynomial in $n_1, \ldots, n_r$ of total degree $< \dim(Z)$.
\end{lemma}

\begin{proof}
Let $\mathcal{P}$ be the property of coherent sheaves on $X$
expressed by the lemma. FIXME
