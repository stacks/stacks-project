...
Then there exists an invertible $\mathcal{O}_X$-module $\mathcal{L}$ with
$\dim_k H^0(X, \mathcal{L}) = 1$ and $H^1(X, \mathcal{L}) = 0$.
\end{lemma}
...
Cohomology on Schemes, Lemma \ref{coherent-lemma-vanshing-gives-ample}
