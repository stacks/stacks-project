...
\medskip\noindent
Assume (4) and let $U \subset X$ be an open subscheme.
...
$\mathcal{O}(U)$ is a normal $k$-algebra by definition.
...
above, if we restrict
ourselves to finitely generated field extensions then this property
is preserved under change of base field. Hence the definition makes sense.
