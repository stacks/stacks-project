...
left to right is a bijection when evaluated on a quasi-compact
...
of all quasi-compact open subschemes of $X$. Then $X = \bigcup U_i$ and for
$i, j \in I$ we have $U_i \cup U_j = U_k$ for some $k \in I$.
...
\begin{proof}
Let $\mathcal{F} = \bigcup \mathcal{F}_i$. To show that the map
