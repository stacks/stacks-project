...
$$
with $f$ anf $f'$ proper and $g$ and $g'$ separated and locally quasi-finite.
For a torsion ring $\Lambda$ and $K$ in $D(U_\etale, \Lambda)$
...
of fibres of $f$ is bounded, see \'Etale Cohomology, Lemma
\ref{etale-cohomology-lemma-morphism-finite-type-bounded-dimension}.
...
$$
of quasi-compact and quasi-separated schemes with $f$
separated and of finite type. Then there is a canonical isomorphism
