...
By Groupoids, Lemma \ref{groupoids-proposition-finite-flat-equivalence}
...
\noindent
For example, if $U$ is isomorphic to an open subscheme of an affine scheme
or isomorphic to an open subscheme of $\text{Proj}(A)$ for some graded
ring $A$, then the third assumption holds by
