...
Let $S$ be a scheme, and let $X$ be an algebraic space
over $S$ which is Zariski locally quasi-separated.
...
it is affine (since $U_i$ was chosen to be affine).
\end{proof}
...
|X|
$$
This map is always injective. If $X$ is reasonable (see
