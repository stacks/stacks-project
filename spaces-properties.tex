...
definition is compabtible with our original notion of a quasi-coherent sheaf
on a scheme
...
\item there exists a surjective etale morphism $f : Y \to X$ of
algebraic spaces over $S$ such that $f^*\mathcal{F}$ is quasi-coherent
on $Y$, and
...
\begin{proof}
By Lemma \ref{lemma-pullback-quasi-coherent} it is clear that (1) implies (2).
...
\begin{proof}
In the statement of the lemma above, and in this proof we think of a
