...
\begin{enumerate}
\item An object of $X_{spaces, \acute{e}tale}$ is a morphism $\varphi : U \to X$
...
the coverings in $X_{\acute{e}tale}$, as in Sets, Lemma \ref{sets-lemma-coverings-site}
...
Let $S$ be a scheme, and let $X$ be an algebraic space over $S$.
Let $\mathcal{F}$ be a sheaf on the small \'etale site $X_{\acute{e}tale}$ of $X$.
...
subcategory $X_{\acute{e}tale}$. If $U \to X$ is an \'etale morphism of algebraic
...
Let $S$ be a scheme.
Let $X$ be an algebraic space over $S$.
Let $X_{affine, \acute{e}tale}$ denote the full subcategory of $X_{\acute{e}tale}$
whose objects are those $U/X \in \text{Ob}(X_{\acute{e}tale})$ with
$U$ affine. A covering of $X_{affine, \acute{e}tale}$ will be a standard
\'etale covering, see
...
$X_{affine, \acute{e}tale} \to X_{\acute{e}tale}$ is a special cocontinuous functor
as in
Sites, Definition \ref{sites-definition-special-cocontinuous-functor}.
\end{proof}
...
{\it small \'etale topos} of $X$ is the category $\textit{Sh}(X_{\acute{e}tale})$
...
we have $\textit{Sh}(X_{\acute{e}tale}) = \textit{Sh}(X_{spaces, \acute{e}tale})$,
...
we see that $\textit{Sh}(X_{\acute{e}tale}) = \textit{Sh}(X_{affine, \acute{e}tale})$.
...
then $f_{small}$ comes from a morphism of sites $X_{\acute{e}tale} \to Y_{\acute{e}tale}$,
...
$$
where $U \in X_{\acute{e}tale}$, $V \in Y_{\acute{e}tale}$ such that whenever given
an extended diagram
$$
\xymatrix{
...
(resp.\ $X_{spaces, \acute{e}tale}$), see Lemma \ref{lemma-compare-etale-sites}.
...
covering $\{U_i \to U\}$ of $j(\varphi : U \to X)$ in $Y_{\acute{e}tale}$ is the
...
to the category $X_{spaces, \acute{e}tale}$. Thus the inner square is commutative.
In fact $j_{spaces}$ can be identified with the
localization functor $j_X : Y_{spaces, \acute{e}tale}/X \to Y_{spaces, \acute{e}tale}$
discussed in
...
\end{equation}
to indicate this. Note that the functor $j : X_{\acute{e}tale} \to Y_{\acute{e}tale}$
...
$X_{space, \acute{e}tale}$ and consider all \'etale neighbourhoods. And there won't
...
the full subcategory of those which are in $X_{\acute{e}tale}$ is a cofinal
...
\'etale neighbourhood $(U'', \overline{u}'')$, $U'' \in \text{Ob}(X_{\acute{e}tale})$
...
$X_{spaces, \acute{e}tale}$ corresponding to $\mathcal{F}$ on $X_{\acute{e}tale}$,
then
\begin{equation}
...
And, given a covering $\{U_i \to U\}_{i \in I}$ in $X_{\acute{e}tale}$ we see that
...
\begin{enumerate}
\item The functor
$f_{small}^{-1} : \textit{Ab}(Y_{\acute{e}tale}) \to \textit{Ab}(X_{\acute{e}tale})$ is exact.
\item The functor
$f_{small}^{-1} : \textit{Sh}(Y_{\acute{e}tale}) \to \textit{Sh}(X_{\acute{e}tale})$ is exact,
...
Since the stalk of $\mathcal{G}'$ (resp.\ $f_{spaces, \acute{e}tale}^{-1}\mathcal{G}'$)
...
for $U$ ranging through the objects of $X_{\acute{e}tale}$. It is clear from the proof
...
\medskip\noindent
Via the equivalence $\textit{Sh}(X_{\acute{e}tale}) = \textit{Sh}(X_{spaces, \acute{e}tale})$
of Lemma \ref{lemma-compare-etale-sites} we may also think of
$\mathcal{O}_X$ as a sheaf of rings on $X_{spaces, \acute{e}tale}$. It is explained
...
$$
where $U \in X_{\acute{e}tale}$, $V \in Y_{\acute{e}tale}$ we have to give a map of
rings
$
(f^\sharp)_{(U, V, g)} :
...
any morphism between objects of $X_{\acute{e}tale}$ is an \'etale morphism of schemes.
\end{proof}
...
$$
of algebraic spaces over $Y$. In terms of sheaves on $Y_{\acute{e}tale}$ the morphism
...
between sheaves on $U_{spaces, \acute{e}tale}$ and sheaves on $U_{\acute{e}tale}$
...
\medskip\noindent
Let $U \in \text{Ob}(X_{\acute{e}tale})$, let $V \in \text{Ob}(Y_{\acute{e}tale})$
...
morphisms $a : U' \to U$ in $X_{\acute{e}tale}$ and $b : V' \to V$ in $Y_{\acute{e}tale}$
...
is a quasi-coherent module on the ringed site $(X_{\acute{e}tale}, \mathcal{O}_X)$
in the sense of
Modules on Sites,
...
As $\mathcal{F}|_{U_{\acute{e}tale}}$ is quasi-coherent there exists an \'etale covering
$\{U_i \to U\}$ such that $\mathcal{F}|_{U_{i, \acute{e}tale}}$ has a
...
Let $V \to X$ be an object of $X_{\acute{e}tale}$. Since $U \to X$ is surjective and
