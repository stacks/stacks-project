...
where $U \in \text{Ob}((\Sch/S)_{\acute{e}tale})$ is a scheme and
...
$\text{Mor}_{\Sch}(U, T) = \prod_{j \in J} \Gamma(U, \mathcal{O}_U)$
...
$\textit{QCoh}(\mathcal{O}_U)$. Let $\mathcal{F}_i$ be a family of
