...
\begin{enumerate}
\item Noetherian, see
More Algebra, Lemma \ref{more-algebra-lemma-Noetherian-etale-extension},
\item dimension $d$, see
More Algebra, Lemma \ref{more-algebra-lemma-dimension-etale-extension},
\item regular, see
More Algebra, Lemma \ref{more-algebra-lemma-regular-etale-extension},
...
\item normal, see
More Algebra, Lemma \ref{more-algebra-lemma-henselization-normal},
\item Noetherian and depth $k$, see
More Algebra, Lemma \ref{more-algebra-lemma-henselization-depth},
\item Noetherian and Cohen-Macaulay, see
More Algebra, Lemma \ref{more-algebra-lemma-henselization-CM},
\end{enumerate}
...
This is the same as the supremu of $\dim(\mathcal{O}_{U, u})$ by
