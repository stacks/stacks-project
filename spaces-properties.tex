...
More Algebra, Lemma \ref{more-algebra-lemma-henselization-dimension}.
\end{proof}
...
is reduced by
More Algebra, Lemma \ref{more-algebra-lemma-henselization-reduced}
...
Lemma \ref{lemma-describe-etale-local-ring}.
Thus by
More Algebra, Lemma \ref{more-algebra-lemma-henselization-regular}
