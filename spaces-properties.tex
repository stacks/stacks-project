...
By Lemma \ref{lemma-dimension-decent-invariant-under-etale}
we see that the numbers in (1) and (2) are the same for $X$ and $U$.
Hence the result follows from the result for schemes which is
Properties, Lemma \ref{properties-lemma-dimension}.
\end{proof}
