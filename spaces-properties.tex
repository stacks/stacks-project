...
reasonable algebraic spaces in
...
\ref{decent-spaces-lemma-decent-point-like-spaces} and
...
$\textit{QCoh}(\mathcal{O}_X)$ or $\textit{QCoh}(X)$.
\end{definition}
...
\item[(i)] {\it finite type},
\item[(j)] {\it quasi-coherent} (see Section \ref{section-quasi-coherent}),
\item[(k)] {\it of finite presentation},
\item[(l)] {\it coherent}, and
\item[(m)] {\it flat}.
\end{enumerate}
...
on $X_{\acute{e}tale}$, and $\mathcal{P}$ any property except ``coherent'' or
``locally free'', then $\mathcal{P}$ for $\mathcal{F}$ on $X_{\acute{e}tale}$
...
quasi-coherent module on $X_{\acute{e}tale}$, then $\mathcal{F}$
is coherent on $X_{\acute{e}tale}$ if and only if
...
Let $S$ be a scheme
Let $X$ be an algebraic space over $S$. The inclusion functor
...
$\textit{QCoh}(\mathcal{O}_X)$ has limits and enough injectives.
\end{proposition}
...
$\textit{QCoh}(\mathcal{O}_X)$ are formal consequences of the existence of
$Q$, the fact that the inclusion is fully faithful, and the fact that
$\textit{Mod}(\mathcal{O}_X)$ has limits (see
...
\medskip\noindent
Choose a presentation $X = U/R$ so that $(U, R, s, t, c)$ is an
...
to one of the $\mathcal{F}_t$.

\medskip\noindent
Given an object $\mathcal{G}$ of $\textit{QCoh}(\mathcal{O}_X)$ we set
$$
...
is a directed colimit of $\mathcal{O}_X$-modules isomorphic to
...
and $U/\coprod\nolimits_{g \in G} R$ is an algebaic space by
