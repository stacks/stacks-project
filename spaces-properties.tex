...
\noindent
Before we can define the small etale site of an algebraic space we need
to do some preliminary work on etale morphisms from schemes to
...
\noindent
Here is the obligatory lemma which tells us this definition makes sense.
...
Let $S$ be a scheme.
Let $X$ be an algebraic space over $S$.
Let $U$ be an affine scheme, and $U \to X$ surjective etale.
...
Of course we just take $f_{(U, V, g)}^\sharp = g^\sharp$.
