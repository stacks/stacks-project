...
equivalence relation on $U$ such that $X = U/R$ as sheaves.
Let $x : \text{Spec}(K) \to X$ be a morphism
...
$$
is commutative. This shows that $|U| \to |X|$ is surjective. By
...
\noindent
Any etale local property of germs gives rise to a corresponding
property of algebraic spaces.
...
if there exists an etale morphism $U \to X$ and $u \in U$ mapping to $x$
such that $(U, u)$ has property $\mathcal{P}$.
\end{definition}
...
Let $\mathcal{P}$ be a property of germs which is etale local.
Let $S$ be a scheme.
Let $X$ be an algebraic space over $S$.
