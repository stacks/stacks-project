...
Let $r'_1, \ldots, r_n'$ be the finite collection of points lying over
$x'$ in $R$; there are finitely many because $s, t$ are quasi-compact
...
\begin{proof}
Write $R = U \times_X U$ so that the projections $s, t : R \to U$
are etale. After replacing $X$ by the open subspace corresponding
to the image of $|U| \to |X|$ we may assume $U \to X$ is etale and
surjective. Let $u \in U$ be a point.
FIXME.
\end{proof}
...
$u_2' = u_2$, see
Lemma \ref{lemma-no-specializations-map-to-same-point}.
