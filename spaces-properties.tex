...
site $(X_{\acute etale}, \mathcal{O}_X)$, or equivalently on the ringed site
$(X_{spaces, \acute etale}, \mathcal{O}_X)$.
...
$X_{\acute etale}$ satisfying one of the properties $\mathcal{P}$ above
and $\varphi : U \to X$ is a surjective \'etale
morphism with $U$ a scheme, then the pullback $\varphi^*\mathcal{F}$
has property $\mathcal{P}$ as a sheaf of modules on $U_{\acute etale}$.
...
is a covering in $X_{spaces, \acute etale}$ and
...
then $\mathcal{P}$ for $\varphi^*\mathcal{G}$ on $U_{\acute etale}$ is
