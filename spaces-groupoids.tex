...
Let $B, U, R \in \textit{Sh}((\Sch/S)_{fppf})$ be algebraic spaces,
...
\begin{proof}
Note that $f^{-1}B, f^{-1}U, f^{-1}R \in \textit{Sh}((\Sch'/S)_{fppf})$
...
$T \in \text{Ob}((\Sch/S)_{fppf})$, $\phi$ is a morphism of schemes
