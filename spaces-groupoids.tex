...
and a groupoid space $(U, R, s, t, c)$ over $B$. Given these data
...
\begin{enumerate}
\item Let $(U, R, s, t, c)$ be a groupoid space over $B$.
...
\item Let $(G, m)$ be a group space over $B$.
...
$$
is the quotient stack associated to the groupoid space
...
of groupoid spaces over $B$. Then $f$ induces a canonical $1$-morphism of
quotient stacks
$$
