...
quasi-separated morphism is quasi-coherent, see Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-pushforward}. Hence $t_*s^*\mathcal{G}$
...
these steps by Cohomology of Spaces, Lemma
\ref{spaces-cohomology-lemma-flat-base-change-cohomology}.
...
is an fpqc covering, see Descent on Spaces, Proposition
...
on locally Noetherian algebraic spaces without further mention. Write
