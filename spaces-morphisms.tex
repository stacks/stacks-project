...
\begin{remark}
\label{remark-radicial}
What should be a {\it radicial} morphism of algebraic spaces?
One possibility is to define it as a morphism whose reduced fibres (over
points) are spectra of purely inseparable residue field extensions.
If you do then it is no longer true that universally injective
is equivalent to radicial. For example the morphism
$$
...
is universally injective, but would not radicial in the sense above.
\end{remark}
