...
existence of course). We say $f$ {\it satisfies the valuative criterion}
...
Assume $f$ satisfies the
existence (resp.\ uniqueness) part of the valuative criterion.
...
making the diagram commute. This proves the lemma.
\end{proof}
...
commute. The proof in the existence case is omitted.
\end{proof}
