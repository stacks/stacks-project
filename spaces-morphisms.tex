...
Let $S$ be a scheme. Let $\mathcal{P}(\psi, u)$ be a property of
pairs $(\psi : U \to V, u)$, where $\psi : U \to V$ is a morphism of schemes
over $S$, and $u \in U$ is a point. Let us say that $\mathcal{P}$ is
{\it etale local on the source and the target} if for any commutative
diagram
$$
\xymatrix{
U' \ar[r]_{\psi'} \ar[d] & V' \ar[d] \\
U \ar[r]^\psi & V
}
$$
...
we have
$$
\mathcal{P}(\psi, u) \Leftrightarrow \mathcal{P}(\psi', u')
$$
\end{definition}
...
Let $\mathcal{P}$ be a property of pointed morphisms which is
etale local on the source and the target as in
...
Given a morphism of schemes $\psi : U \to V$ and $u \in U$ set
$$
\mathcal{P}(\psi, u)=\text{the morphism }\psi\text{ is flat at }u.
$$
Then $\mathcal{P}$ is etale local on the source and target, see
Definition \ref{definition-local-at-point}.
\end{lemma}
...
$$
where $v', u, v$ are the images of $u' \in U'$. Note that
the vertical arrows are localizations of etale ring maps,
...
\mathcal{P}_d(\psi, u) =
\text{the local ring }
\mathcal{O}_{U_{\psi(u)}, u}
\text{ of the fibre has dimension }d
$$
Then $\mathcal{P}_d$ is etale local on the source and target, see
Definition \ref{definition-local-at-point}.
\end{lemma}
...
Properties of Spaces,
Lemma \ref{spaces-properties-lemma-dimension-local-ring-local}.
\end{proof}
...
\Leftrightarrow
\text{we have }
\text{trdeg}_{\kappa(\psi(u))} \kappa(u) = r
$$
Then $\mathcal{P}_r$ is etale local on the source and target, see
Definition \ref{definition-local-at-point}.
\end{lemma}
...
$$
where $v', u, v$ are the images of $u' \in U'$.
...
Properties of Spaces,
Lemma \ref{spaces-properties-lemma-dimension-at-point-local}.
\end{proof}
