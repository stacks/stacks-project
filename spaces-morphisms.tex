...
disjoint union of affine schemes (Properties of Algebraic Spaces,
Lemma \ref{spaces-properties-lemma-cover-by-union-affines}).
...
we conclude that $Z'$ and $f^{-1}Z$ pull back to the same closed
subspace of $X'$. Since $X' \to X$ is surjective \'etale this
implies $Z' = f^{-1}Z$.
\end{proof}
...
Let $S$ be a scheme. Let $X$ be an algebraic space oevr $S$.
