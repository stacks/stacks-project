...
$$
\xymatrix{
V' \ar[r] \ar[rd] & X_{T'} \ar[r] \ar[d] & X \ar[d] \\
& T' \ar[r] & T
}
$$
Assume
...
It is also quasi-compact (as a quasi-affine scheme over an affine scheme). By
Morphisms,
...
the integer $n$ bounding the degree of the fibres of $T' \to T$.
...
As $T' \to T$ is etale we have a decomposition (into affine open subschemes)
$T'' = \Delta(T') \amalg T^*$.
Thus degree of the fibres of the projection $p_1|_{T^*} : T^* \to T'$ is $< n$.
Hence we see by induction hypothesis that $p_1(p_0^{-1}(V') \cap T^*)$ is a
quasi-compact scheme. By
Properties of Spaces, Lemma \ref{spaces-properties-lemma-subscheme}
we conclude that
$p_1(p_0^{-1}(V')) = V' \cup p_1(p_0^{-1}(V') \cap T^*)$
is a quasi-compact scheme. Moreover, it is clear that
$p_1(p_0^{-1}(V'))$ is the inverse image of the quasi-compact open
subspace $U \subset X$ of the lemma. In other words, $T' \times_T U$
is a scheme! Moreover, since $T' \times_T U$ is quasi-compact and
separated and locally quasi-finite over $T'$ (as $T' \times_T X \to T'$
is locally quasi-finite and separated), we see from
More on Morphisms,
