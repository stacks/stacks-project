...
quasi-separated morphism of representable algebraic spacdes $X$
and $Y$ over $S$. By
Descent,
...
Properties of Spaces,
Lemma \ref{spaces-properties-lemma-quasi-compact-affine-cover}.
Note that the morphism $\varphi : U \to X$ is representable, separated
and quasi-compact because $X$ is quasi-separated. Hence the lemma
holds for $\varphi$ (either by the discussion above the lemma or by
applying the reduction in the first paragraph of this proof).
It also holds for $f \circ \varphi : U \to Y$ (as this is a morphism
of affine schemes). Moreover, for an injective $\mathcal{O}_U$-module
$\mathcal{I}$ the module $\varphi_*\mathcal{I}$ is injective (see
Homology, Lemma \ref{homology-lemma-adjoint-preserve-injectives})
whence $Rf_* \circ R\varphi_* = R(\varphi \circ f)_*$.
...
The case $n = 0$ follows from Lemma \ref{lemma-pushforward}.
...
$$
\varphi_*\mathcal{H} \to R\varphi_*\mathcal{H} \to
\tau_{\geq 1}R\varphi_*\mathcal{H} \to \varphi_*\mathcal{H}[1].
$$
Note that $R\varphi_*\mathcal{H}$ and
$Rf_*R\varphi_*\mathcal{H} = R(f \circ \varphi)_*\mathcal{H}$
have quasi-coherent cohomology sheaves (see above). Combined with
the remark above we conclude that $IH_n$ implies that
$R^if_*\varphi_*\mathcal{H}$ is quasi-coherent for $i \leq n + 1$.

\medskip\noindent
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module. Consider
the exact sequence
$$
0 \to \mathcal{F} \to \varphi_*\varphi^*\mathcal{F} \to \mathcal{G} \to 0
$$
where $\mathcal{G}$ is the cokernel of the first map.
Applying the long exact cohomology sequence we obtain
$$
R^nf_*\varphi_*\varphi^*\mathcal{F}
R^nf_*\mathcal{G} \to
R^{n + 1}f_*\mathcal{F} \to
R^{n + 1}f_*\varphi_*\varphi^*\mathcal{F} \to
R^{n + 1}f_*\mathcal{G}
$$
By the above we see that $R^{n + 1}f_*\varphi_*\varphi^*\mathcal{F}$
...
$R^{n + 1}f_*\varphi_*\varphi^*\mathcal{F} \to R^{n + 1}f_*\mathcal{G}$
has to be quasi-coherent too. Hence $R^{n + 1}f_*\mathcal{F}$
is quasi-coherent.
\end{proof}
