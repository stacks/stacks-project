...
Since the property of being quasi-coherent is \'etale local we may assume
...
$$
as in Definition \ref{definition-valuative-criterion} with $K \subset K'$
arbitrary. We have to show that we can find a morphism
$\Spec(A) \to X$ fitting into the diagram.
...
as discussed in More on Morphisms of Algebraic Spaces, Section
\ref{spaces-more-morphisms-section-structure-quasi-finite}.
Namely, More on Morphisms of Algebraic Spaces, Lemma
