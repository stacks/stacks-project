...
conditions: separated, weakly locally separated,
locally separated, quasi-separated, Zariski locally quasi-separated.
The following are equivalent
\begin{enumerate}
\item $f$ is $\mathcal{P}$,
...
base change $Z \times_Y X \to Z$ of $f$ is $\mathcal{P}$, and
\item there exists a scheme $V$ and a surjective etale morphism
