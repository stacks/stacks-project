...
Let $S$ be a scheme.
Let $f : X \to Y$ be a
representable, quasi-compact, surjective, flat morphism of
...
\begin{proof}
Let $V$ be a scheme, and let $g : V \to Y$ be a surjective etale morphism.
By definition the set $|T|$ is closed (resp.\ open) if and only if
$g^{-1}(T) \subset |V|$ is closed (resp.\ open). The same holds for
$f^{-1}(T)$ and its inverse image in $|V \times_Y X|$ (which is a scheme
surjective and etale over $Y$ as $f$ is representable).
Since the base change $V \times_Y X \to V$ is quasi-compact, surjective, 
and flat we win by
Morphisms, Lemma \ref{morphisms-lemma-fpqc-quotient-topology}.
\end{proof}
...
$$
where $U$, $V$ are schemes and the vertical arrows are surjective etale
such that the horizontal arrow is smooth.
\end{enumerate}
\end{lemma}
...
$$
where $U$, $V$ are schemes and the vertical arrows are surjective etale
such that the horizontal arrow is unramified.
\end{enumerate}
\end{lemma}
...
\item there exists a scheme $V$ and a surjective etale morphism
$V \to Y$ such that $V \times_Y X \to V$ is integral (resp. finite).
\end{enumerate}
\end{lemma}
...
\item there exists a scheme $V$ and a surjective etale morphism
$V \to Y$ such that $V \times_Y X \to V$ is finite locally free.
\end{enumerate}
\end{lemma}
