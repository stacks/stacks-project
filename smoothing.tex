...
such that $D \to D'$ is essentially smooth,
the map $D' \to \Lambda_\mathfrak q/\mathfrak q^n\Lambda_\mathfrak q$
is flat and there exist $\delta_1, \ldots, \delta_d \in \Lambda$,
$\delta_i \not \in \mathfrak q$ which map to elements of $D'$
in the quotient by $\mathfrak q^n$, there is a map $B \to \Lambda$ with
$x_i \mapsto \pi'_i = \pi_i \delta_i$ and for $i = 1, \ldots, d$ we have
$$
...
It suffices to find a factorization
$$
