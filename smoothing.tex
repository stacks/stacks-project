...
with ramification index $1$ (More Algebra, Definition
...
\medskip\noindent
To finish the proof we have to show that $N'$ is stricly bigger
...
\begin{proof}
By Lemma \ref{lemma-when-colimit} it suffices to show
...
is smooth at $\mathfrak p$, see Lemma \ref{lemma-neron-when-smooth}.
