...
such that $E$ is the set of congruence classes of
$x_1, \ldots, x_n$.
\end{lemma}
...
$\det(\partial g_j/\partial y_i)_{j = 1, \ldots, d, i = 1, \ldots, d}$
...
$\det(\partial f_j/\partial x_i)_{j = 1, \ldots, c, i = 1, \ldots, c}$
...
$$
1 =
a_0 \det(\partial f_j/\partial x_i)_{j = 1, \ldots, c, i = 1, \ldots, c}
+
...
$$
s_0 = a_0 \det(\partial f_j/\partial x_i)_{j = 1, \ldots, c, i = 1, \ldots, c}
+
\sum\nolimits_{j = 1, \ldots, c} a_jf_j
$$
...
$$
a_0\det(\partial s'_jf_j/\partial x_i)_{j = 1, \ldots, c, i = 1, \ldots, c}
+
...
Then we can find a factorization $A \to C \to \Lambda$ such
that $H_{C/R} \Lambda \not \subset \mathfrak q$.
\end{lemma}
...
$C$ is strictly standard over $R_\mathfrak p$.
Write $A = R[x_1, \ldots, x_n]/(g_1, \ldots, g_t)$ and say
