...
By Lemma \ref{lemma-huber} we can even assume that
...
\noindent
Given a Noetherian local ring $R$ we denote $R^\wedge$ the completion of
$R$ with respect to its maximal ideal. We will use without further mention
that $R^\wedge$ is a Noetherian complete local ring
(Algebra, Lemmas \ref{algebra-lemma-completion-Noetherian-Noetherian} and
\ref{algebra-lemma-hathat-finitely-generated})
and that $R \to R^\wedge$ is flat
(Algebra, Lemma \ref{algebra-lemma-completion-flat}). The fibre rings
$$
(R^\wedge) \otimes_R \kappa(\mathfrak p) =
(R^\wedge)_\mathfrak p/\mathfrak p(R^\wedge)_\mathfrak p
$$
are called the {\it formal fibres} of $R$. Thus $R \to R^\wedge$
