...
\begin{lemma}
\label{lemma-has-P}
Let $\mathcal{C}$ be a site. Let $f : K \to L$ be a morphism of
$\text{SR}(\mathcal{C})$. The continuous and cocontinuous functor
$v : \mathcal{C}/K \to \mathcal{C}/L$
associated to $f$ (see above) has property P of
Sites, Remark \ref{sites-remark-cartesian-cocontinuous}.
\end{lemma}

\begin{proof}
In the notation of the discussion preceding the lemma,
...
It is formal to deduce $P$ for $v$ and we omit the details.
\end{proof}
...
\noindent
Let $\mathcal{C}$ be a site. There are three kinds of hypercoverings
\begin{enumerate}
\item if $\mathcal{C}$ has fibre products, then a hypercovering
of an object $X$ of $\mathcal{C}$ is defined in
Hypercoverings, Definition \ref{hypercovering-definition-hypercovering},
\item if $\mathcal{C}$ has equalizers and fibre products
then we've defined a hypercovering of a presheaf of sets $\mathcal{G}$ in
Hypercoverings, Definition \ref{hypercovering-definition-hypercovering-variant},
\item if $\mathcal{C}$ has equalizers and fibre products then
a hypercovering of $\mathcal{C}$ is simply a hypercovering
of the final presheaf.
\end{enumerate}
As indicated following Hypercoverings, Definition
\ref{hypercovering-definition-hypercovering-variant}
there is an alternative notion of hypercovering of $\mathcal{C}$
which makes sense for an arbitrary site and most of the results
discussed in this section hold for that notion as well.
