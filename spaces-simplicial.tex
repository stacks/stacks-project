...
then $g^{Sh}_!\mathcal{G}$ is the sheaf on $\mathcal{C}_{Zar}$
whose degree $m$ part is the sheaf
$$
\coprod\nolimits_{\varphi : [n] \to [m]\text{ injective}}
f_\varphi^{-1}\mathcal{G}
$$
If $\mathcal{G}$ is an abelian sheaf on $\mathcal{C}_n$,
then $g^{Sh}_!\mathcal{G}$ is the abelian sheaf on $\mathcal{C}_{Zar}$
whose degree $m$ part is the sheaf
$$
\bigoplus\nolimits_{\varphi : [n] \to [m]\text{ injective}}
f_\varphi^{-1}\mathcal{G}
$$
Since these functors satisfy the desired exactness properties
we conclude.
\end{proof}
