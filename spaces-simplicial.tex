...
\noindent
Let $\mathcal{C}$ be a site. We will state and prove our results
for each of the following two kinds of hypercoverings
\begin{enumerate}
\item Here we assume $\mathcal{C}$ has equalizers and fibre products.
We let $K$ be a hypercovering of $\mathcal{C}$ as defined in
...
\item Here we assume $\mathcal{C}$ has fibre products
...
\end{enumerate}
We proceed as in Sections \ref{section-semi-representable} and
\ref{section-simplicial-semi-representable}
first constructing and proving results in the case of
a hypercovering of $\mathcal{C}$ and then working
out what this means applied to the site $\mathcal{C}/X$.
...
this follows from Lemma \ref{lemma-hypercovering-X-descent-sheaves}.
\end{proof}
