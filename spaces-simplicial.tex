...
of $\mathcal{C}$ as defined in Hypercoverings, Definition
...
Let $K$ be a hypercovering of $\mathcal{C}$.
Then
\begin{enumerate}
...
a hypercovering of $\mathcal{C}$. Thus it suffices to prove
...
Let $\mathcal{C}$ be a site with equalizers and fibre products.
Let $K$ be a hypercovering of $\mathcal{C}$. The {\v C}ech complex
...
Let $\mathcal{C}$ be a site with equalizers and fibre products.
Let $K$ be a hypercovering of $\mathcal{C}$. For
...
Cohomology of Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
is the same thing as a hypercovering of $\mathcal{C}/\mathcal{G}$.
...
Cohomology of Sites, Section \ref{sites-cohomology-section-limp}.
We have
$$
R\Gamma(\mathcal{G}, E) = R\Gamma(\mathcal{C}/\mathcal{G}, j^{-1}E)
$$
by the analogue of Cohomology of Sites, Lemma
\ref{sites-cohomology-lemma-cohomology-of-open}
...
and $X \in \Ob(\mathcal{C})$. We let $K$ be a hypercovering
of $X$ in $\mathcal{C}$ as defined in
...
hypercovering of $\mathcal{C}/X$\footnote{The converse may not
be the case, i.e., if $K$ is a simplicial object of
$\text{SR}(\mathcal{C}, X) = \text{SR}(\mathcal{C}/X)$
which defines a hypercovering of the site $\mathcal{C}/X$ as in
Hypercoverings, Definition \ref{hypercovering-definition-hypercovering-variant},
then it may not be true that $K$ defines a hypercovering of $X$ in
$\mathcal{C}$. For example, if $K_0 = \{U_{0, i}\}_{i \in I_0}$
...
Let $K$ be a hypercovering of $X$ in $\mathcal{C}$. Then
\begin{enumerate}
...
Let $K$ be a hypercovering of $X$ in $\mathcal{C}$. For
...
Let $\mathcal{C}$ be a site with fibre products and $X \in \Ob(\mathcal{C})$.
Let $K$ be a hypercovering of $X$ in $\mathcal{C}$.
Then we have a canonical isomorphism
$$
...
coskeleta used in the formulation above exist. Of course, this
terminology exactly means that the simplicial semi-representable
object $\{U_n\}$ is a hypercovering of $X$ in $\mathcal{C}$ in
the sense of Section \ref{section-cohomological-descent-hypercoverings-X}.
...
$$
\textit{LC}_{qc} \xrightarrow{\epsilon} \textit{LC}_{Zar}
\xrightarrow{\pi} X_{Zar}
$$
By Cohomology on Sites, Lemma
...
we see that $a : U \to X$ is a hypercovering in the site
$\textit{LC}_{qc}$ as in Section \ref{section-hypercovering}.
Thus we have
$$
R\Gamma(X, \mathcal{F}) =
R\Gamma(\textit{LC}_{qc}/X, \epsilon^{-1}\pi^{-1}\mathcal{F}) =
R\Gamma((\textit{LC}/X_\bullet)_{total}, a^{-1}\epsilon^{-1}\pi^{-1}\mathcal{F})
$$
...
Finally, the restriction $(a^{-1}\epsilon^{-1}\pi^{-1}\mathcal{F})_p$
...
$$
H^q(\textit{LC}_{qc}/X_p, (a^{-1}\epsilon^{-1}\pi^{-1}\mathcal{F})_p)
...
Let $\mathcal{F}_{U, Zar}$ be the pullback of $\mathcal{F}$
to $U_{Zar}$ via the morphism of topoi $\Sh(U_{Zar}) \to \Sh(X)$
of Lemma \ref{lemma-augmentation}. If $U$ is a proper hypercovering
of $X$, then
$$
H^*(X, \mathcal{F}) = H^*(U_{Zar}, \mathcal{F}_{U, Zar})
$$
\end{lemma}
...
Since the terms on the spectral sequences agree the displayed
...
$$
V \mapsto H^q((V \times_X U)_{Zar}, a^{-1}\mathcal{F}) = H^q(U, \mathcal{F})
$$
The equality holds by Lemma \ref{lemma-compute-via-proper-hypercovering}.
