...
Let $\mathcal{C}$ be a site. Let $K$ be a simplicial object of
$\textit{SR}(\mathcal{C})$. Let $U/U_{n, i}$ be an object of
$\mathcal{C}/K_n$. Let
...
There is a final condition we will need to obtain the result
...
Let $\mathcal{C} = (\textit{Spaces}/X)_{fppf}$ be the big fppf
site of $X$, see Topologies on Spaces, Section
\ref{spaces-topologies-section-fppf}.
...
Let $\mathcal{C} \subset (\textit{Sch}/S)_\etale$
...
Let $L$ be a simplicial object of $\textit{SR}(\mathcal{B})$.
Consider the simplicial object $K = u(L)$ of $\textit{SR}(\mathcal{C})$
