...
\item $g^{-1}$ has a left adjoint $g_!$ which commutes
with finite connected limits,
\item the adjunction maps $\text{id} \to g^{-1}g_!$ and
$g^{-1}g_* \to \text{id}$ are isomorphisms.
\end{enumerate}
\end{lemma}
...
\ref{sites-section-cocontinuous-morphism-topoi}. More precisely,
Lemmas \ref{sites-lemma-cocontinuous-morphism-topoi},
