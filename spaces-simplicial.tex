...
$$
The idea of the proof is to find a topology on $\textit{LC}$
which is stronger than the usual one such that
(A) a surjective proper map defines a covering, and
(B) cohomology of usual sheaves with respect to this stronger
topology agrees with the usual cohomology. This was done in
Cohomology on Sites, Section \ref{sites-cohomology-section-cohomology-LC}.
The following lemma is a first result in this direction.
