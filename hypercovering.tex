...
there is a morphism $\Hom(\Delta[k], Z) \to \Hom(\Delta[k], Y)$
...
Set
$$
L = K \times_{\Hom(\Delta[n], Y)} \Hom(\Delta[n], Z).
$$
The morphism $L_k \to K_k$ sits in to a commutative diagram
$$
\xymatrix{
L_k \ar[r] \ar[d] &
\prod_{\alpha : [k] \to [n]} Z \ar[r]^-{\text{pr}_{\text{id}_{[k]}}} \ar[d] &
Z \ar[d] \\
K_k \ar[r] &
\prod_{\alpha : [k] \to [n]} Y \ar[r]^-{\text{pr}_{\text{id}_{[k]}}} &
Y
}
$$
