...
such that $K_k$ consists of a single weakly contractible object
...
with $U_{n + 1}$ weakly contractible. Since $U_n$ is weakly contractible
the topology is subcanonical, and $\{U_{n + 1} \to X_{n + 1}\}$
is a covering, the morphisms $s_i : U_n \to X_{n + 1}$ lift to maps
...
$K' \to K$ of simplical objects extending the
