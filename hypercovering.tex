...
expressing the cohomogy of an abelian sheaf $\mathcal{F}$
...
$\{U_i\}_{i \in I} \amalg \{V_j\}_{j \in J}$. Similarly for coproducts
...
coskelet of a truncated simplicial object of $\text{SR}(\mathcal{C}, X)$
exists if $\mathcal{C}$ has fibre products. Hence the following
...
\noindent
Condition (2) makes sense since each object of
...
to define the coskelet functors used (see
