...
\noindent
Suppose we are given three finite sets
$S$, $T$, $M$ and two maps $s : M \to S$ and
$t : M \to T$. Suppose given objects $X_i, i\in I$ and
$Y_j$, $j \in J$. Finally, suppose given morphisms
