...
\begin{enumerate}
\item Assume $\mathcal{D}$ and $\mathcal{C}$ have equalizers and
...
\item Assume $\mathcal{D}$ and $\mathcal{C}$ have fibre products
...
\medskip\noindent
Proof of (2). This is easier than the above because the notion
of being a hypercovering of an object is stronger, see
