...
We know that the functors $H^i(X, -)$ form a universal $\delta$-functor,
see Homology, Lemma \ref{homology-lemma-higher-derived-functors}.
...
\medskip\noindent
Finally, we have to verify that $\delta(\xi) = 0$ implies that
...
$V_j = \bigcup_{i\in I,\ \alpha(i) = j} U_i$ is an open
covering (and a covering in the site $\mathcal{T}_X$).
...
$$
is an open covering, and
\item each of the open coverings in (3), (4) and (5) is an element of
$\text{Cov}(\mathcal{T}_X)$ (this is a set theoretic condition, bounding
the size of the index sets of the coverings).
\end{enumerate}
Condition (5) is the generalization of the familiar conditions (3), (4)
to higher degrees.
