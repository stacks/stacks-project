...
endowed with its canonical morphism to the constant simplicial
presheaf $h_X$.
\begin{enumerate}
...
Let $K \to \mathcal{G}$ be a morphism from $K$
into the constant simplicial object $\mathcal{G}$.
Suppose that
\begin{enumerate}
...
We have morphisms
$$
K \longrightarrow \ldots \to K^n \to K^{n - 1} \to \ldots \to K^0.
$$
The morphism $K_1 \to K_0$ comes from 
