...
\noindent
In this situation it is our goal to show
(Lemma \ref{lemma-finite-type-injective-into-flat-mod-m})
that $u$ is $A$-universally injective,
...
(Algebra, Lemma \ref{algebra-lemma-flat-tor-zero}) and $M$ is $A$-flat
...
\begin{proof}
Let $A \to B$, $u : N \to M$ be as in Situaiton \ref{situation-mod-injective}.
...
\begin{proof}
Omitted. Proof will be added soon.
\end{proof}
