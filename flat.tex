...
concept of an {\it impurity} which we will introduce later. First
we present the following lemma. Note the similarity with the condition on
...
Section \ref{section-examples-pure}
