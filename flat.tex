...
\noindent
The following lemma will be superceded by the stronger and more precise
...
$s$ corresponds to the maximal idea. In this case
Algebra, Theorem \ref{algebra-theorem-projective-free-over-local-ring}
...
insures that the prime $\mathfrak q$ corresponding
...
Let $R \to S$ be a essentially of finite type.
Let $N$ be a finite $S$-module flat over $R$.
Let $M$ be an $R$-module.
Then
$$
