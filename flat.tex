...
\begin{proof}
We reduce to the case where $A$ is henselian. This reduction only works
if we assume in addition that $M$ is a $B$-module and $u$ is a $B$-module map.
This is the case that is used in the proof of the theorem below, but we will
add the proof in the general case (due to Gabber) here soon.
