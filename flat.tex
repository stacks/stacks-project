...
Consider an almost blow up square (\ref{equation-almost-blow-up-square}).
Suppose that $W \subset X'$ is a closed subscheme defined by a finite
type quasi-coherent sheaf of ideals such that $X' \setminus E$
is scheme theoretically contained in $W$. Then
$$
\xymatrix{
E \ar[d] \ar[r] & W \ar[d] \\
Z \ar[r] & X
...
\begin{proof}
Observe that the surjection $\mathcal{O}_{X'} \to \mathcal{O}_W$
is an isomorphism over the open $X' \subset E$. Hence the blow up
$X'' \subset X'$ of $X$ in $Z$ is scheme theoretically contained in $W$.
Checking the other conditions of an almost blow up square is
