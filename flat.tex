...
\ref{lemma-complex-and-divisor-blowup-good-T}, and
...
in particular $\infty$ lifts to $\infty : U \to W_\infty$,
...
of finite presentation such that $\infty(U) \subset T$
scheme theoretically and such that $Li^*Q$ has locally free cohomology
sheaves, and
\item for $u \in U$ with image $t = \infty(u) \in T$ we have that the
