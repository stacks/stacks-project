...
$F : \text{QCoh}(\mathcal{O}_\mathcal{X}) \to
\text{QCoh}(\mathcal{O}_\mathcal{Y})$ commuting with all colimits.
\end{lemma}
...
its coherent submodules by Cohomology on Stacks, Lemma
...
Let $A$ be a ring. Let $F : \QCoh(\mathcal{O}_\mathcal{X}) \to \text{Mod}(A)$
be a right exact tensor functor. Let $g : U \to \mathcal{X}$
be a morphism with $U = \Spec(R)$ affine. Then
\begin{enumerate}
\item $B = F(g_{\QCoh, *}\mathcal{O}_U)$ is a commutative $A$-algebra and
\item there is a ring map $R \to B$
\end{enumerate}
such that $F \circ g_{\QCoh, *} : \text{Mod}(R) \to \text{Mod}(A)$
...
$\mathcal{O}_\mathcal{X}$-algebra. Hence $B = F(g_{\QCoh, *}\mathcal{O}_U)$
is a commutative algebra object in $\text{Mod}(A)$, in other words, $B$ is a
commutative $A$-algebra. Observe that we have a map
$c : R \to \text{End}_{\mathcal{O}_\mathcal{X}}(g_{\QCoh, *}\mathcal{O}_U)$
such that for any $r \in R$ the diagram
$$
\xymatrix{
g_{\QCoh, *}\mathcal{O}_U \otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
\ar[d]_{c(r) \otimes 1} \ar[rr]_-\mu & &
g_{\QCoh, *}\mathcal{O}_U \ar[d]^{c(r)} \\
g_{\QCoh, *}\mathcal{O}_U \otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
\ar[rr]^-\mu & &
g_{\QCoh, *}\mathcal{O}_U
...
\medskip\noindent
The statement on functors follows from the fact that $F \circ g_{\QCoh, *}$
...
see that $g$ is affine and hence $g_{\QCoh, *}$ is an exact functor
