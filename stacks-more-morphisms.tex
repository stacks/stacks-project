...
Below we will show that assumption (3) implies there is
a unique dotted arrow up to isomorphism, which shows
there is a unique dashed arrow as desired.

\medskip\noindent
Let $x : \Spec(K) \to \mathcal{X}$ be the composition of
$v$ with $V \to \mathcal{X}$.
Let $y : \Spec(A) \to \mathcal{Y}$ be the composition $\Spec(A) \to U \to
\mathcal{X} \times_\mathcal{Y} \mathcal{X} \to \mathcal{Y}$.
Let $a_i : \Spec(A) \to \mathcal{X}$, $i = 1, 2$ be the composition
of $\Spec(A) \to U \to \mathcal{X} \times_\mathcal{Y} \mathcal{X}$
with the $i$th projection
$\mathcal{X} \times_\mathcal{Y} \mathcal{X} \to \mathcal{X}$.
Let $\gamma : y \circ j \to f \circ x$, $\alpha_i : a_i \circ j \to x$, and
$\beta_i : y \to f \circ a_i$ be the $2$-arrows we get from the
$2$-commutativity of the right hand square in the diagram
above\footnote{To be precise, the morphism
$U \to \mathcal{X} \times_\mathcal{Y} \mathcal{X}$ is given
by objects $x_1, x_2$ of $\mathcal{X}$ over $U$ and an isomorphism
$\delta : f \circ x_1 \to f \circ x_2$. The morphism $V \to \mathcal{X}$
is given by an object $x'$ over $V$. There is an isomorphism
$(x_1 \circ g, x_2 \circ g, \delta \star \text{id}_g) \to (x', x', \text{id})$
over $V$ given by arrows $\epsilon_i : x_i \circ g \to x'$.
In particular
$\text{id}_f \star \epsilon_2^{-1} \circ \epsilon_1 = \delta \star \text{id}_g$.
Then $x$ is the pullback of $x'$ via $v$,
$y$ is the pullback of $f \circ x_1$ via $u$, and
$a_i$ is the pullback of $x_i$ by $u$. The map
$\gamma$ is the pullback of $\epsilon_1$ by $v$,
the maps $\alpha_i$ are the pullbacks of $\epsilon_i$,
the map $\beta_1$ is the identity, and the map $\beta_2$
is given by the pullback of $\delta$.}.
A tedious computation shows that $(a_i, \alpha_i, \beta_i)$
are dotted arrows fitting into the diagram of (3).
By assumption there is a unique isomorphism
$\theta : a_1 \to a_2$ compatible with $\alpha_i$ and $\beta_i$.
This produces and isomorphsm of
$$
(\text{id}, \theta) :
(a_1, a_1, \text{id}) \longrightarrow
(a_1, a_2, \beta_2 \circ \beta_1^{-1})
$$
The target of this $2$-arrow is the composition
$\Spec(A) \to U \to \mathcal{X} \times_\mathcal{Y} \mathcal{X}$
on the bottom of the diagram above. The source is $a_1 \circ \Delta$.
A computation show that we obtain a dotted arrow.
We omit the proof of uniqueness (hint: follows from the
uniqueness of $\theta$).
\end{proof}
