...
in the terminology from Artin's Axiom's, Section \ref{artin-section-inf}.
...
$1$-morphism in categories fibred in groupoids as explained in Criteria for
representability, Section \ref{criteria-section-formally-smooth}.
\end{definition}
