...
\noindent
Let $\mathcal{A}$ and $\mathcal{B}$ be monoidal abelian categories.
A {\it right exact tensor functor} $F : \mathcal{A} \to \mathcal{B}$
is a functor of monoidal categories which is additive and right exact.
(By definition functors of monoidal categories send units to units.)
The aim of this note is to give a short proof of the following theorem.
