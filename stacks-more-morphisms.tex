...
quotient in the category of schemes. Hence $f$ is a
...
\ref{stacks-morphisms-remark-property-automorphism-groups}).
...
induces isomorphisms on automorphism groups as this is true for
...
\begin{proof}
By Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-etale-local-finite-inertia}
we can choose a set $I$\footnote{The reader who is still keeping
track of set theoretic issues should make sure $I$ is not too large.},
for $i \in I$ a well-nigh affine algebraic stack $\mathcal{X}_i$,
and an \'etale morphism $g_i : \mathcal{X}_i \to \mathcal{X}$
such that $\mathcal{I}_{\mathcal{X}_i} \to
\mathcal{X}_i \times_\mathcal{X} \mathcal{I}_\mathcal{X}$ is an isomorphism
and such that $|\mathcal{X}| = \bigcup |g_i|(\mathcal{X}_i|)$.
For later use, we record here that $g_i$ is separated as
$\mathcal{X}_i$ is separated (Lemma \ref{lemma-well-nigh-affine})
the diagonal of $\mathcal{X}$ is separated
(Morphisms of Stacks, Lemma \ref{stacks-morphisms-lemma-diagonal-diagonal})
and Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-compose-after-separated}. Let
$$
...
and $\mathcal{X}_{ij} \to \mathcal{X}_j$ are separated as base
changes of $g_i$ and $g_j$. Of course, these projections are also \'etale
by Morphisms of Stacks, Lemma
...
\ref{stacks-morphisms-remark-property-automorphism-groups}) by
Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-base-change-stabilizer-preserving}.
