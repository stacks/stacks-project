...
$$
\mathcal{P}\!{\it olarized}\mathcal{C}\!{\it urves} =
\Curvesstack
...
The morphism
$\mathcal{P}\!{\it olarized}\mathcal{C}\!{\it urves} \to
...
The morphism
$\mathcal{P}\!{\it olarized}\mathcal{C}\!{\it urves} \to \Curvesstack$
...
of $\mathcal{P}\!{\it olarized}\mathcal{C}\!{\it urves}$ over
$k$ which amps to $X$.
...
Moduli, Lemma \ref{moduli-lemma-pic-curves-smooth}
we win.
\end{proof}
