...
\section{Prestable, semistable, and stable curves}
\label{section-semistable-prestable-stable-curves}
...
Unwinding the definitions we see that $X$ is {\it prestable} if
$X$ has dimension $1$, the singularities of $X$ are at-worst-nodal,
...
\item $X$ has dimension $1$, the singularities of $X$ are at-worst-nodal,
and $k = H^0(X, \mathcal{O}_X)$.
\end{enumerate}
\end{enumerate}
\end{lemma}
...
$\Curvesstack^{nodal}$ and $\Curvesstack^{h0, 1}$.
