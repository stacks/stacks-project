...
\begin{proof}
For a scheme $T$ over $S$ let us denote $\textit{Coh}_{X/B, T}$ the fibre
category of $p$ over $T$. Also, write $B(T)$ for the discrete category whose
...
of $B(T)$ gives us a commutative diagram
$$
\xymatrix{
