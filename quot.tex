...
In fact, we will now show $p$ turns $\textit{Coh}_{X/B}$ into a stack
...
defined in Artin's Axiom's, Section \ref{artin-section-inf}.
...
Since we now this holds for the category $\mathcal{S}_B$
...
$\mathcal{F}_n$ on $X_n$ with support propert over
