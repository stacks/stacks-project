...
construction of $L = Li^*(i_*\mathcal{F})$ and direct
proof of its relationship to the deformation theory of $\mathcal{F}$.
In fact, it suffices to construct $\tau_{\geq -2}L$, as we are only
interested in the three ext groups
$\text{Ext}^i_{X_A}(Li^*(i_*\mathcal{F}), \mathcal{F} \otimes_A M)$
...
\right.
$$
This observation will guide our construction of $L$ below (COMING SOON).
