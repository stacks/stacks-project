...
Let $K$ be a pseudo-coherent object of $D(\mathcal{O}_B)$. If for
all $g : T \to B$ in $(\Sch/B)$ the cohomology sheaf
$H^{-1}(Lg^*K)$ is zero, then the functor
$$
(\Sch/B)^{opp} \longrightarrow \textit{Sets},\quad
(g : T \to B) \longmapsto H^0(T, Lg^*K)
$$
is representable by an algebraic space affine and of finite
presentation over $B$.
\end{lemma}

\begin{proof}
By Bootstrap, Lemma \ref{bootstrap-lemma-locally-algebraic-space-finite-type}
...
For any $B$-scheme $g : T \to B$ we have
$$
H^0(T, Lg^*K) = H^0(T, Lg^*\tau_{\geq 0}K)
$$
...
\noindent
We will show the functor $\mathit{Hom}(\mathcal{F}, \mathcal{G})$ is
representable in a number of situations. All of our results will be
based on the following basic case.
...
$H^{-1}(Lg^*K)$ is $0$ for all $g : T \to B$ as above.
...
Let $\mathcal{F}_i \to \mathcal{Q}_i$ be an element in the equalizer
of $\text{pr}_0^*$ and $\text{pr}_1^*$. By Remark \ref{remark-q-base-change}
