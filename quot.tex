...
\begin{proof}
Consider $\text{Coker}(u)$. Observe that
$\text{Coker}(u_T) = \text{Coker}(u)_T$ for any $T/B$.
...
$$
|B| \setminus |f|(\text{Supp}(\text{Coker}(u)))
$$
...
and $\text{Supp}(\text{Coker}(u))$ is a closed subset of
$\text{Supp}(\mathcal{G})$.
\end{proof}
