...
and $E = (e_0, \ldots, e_n)$ is a multi-index of total degree
...
$$
There is a unique ring map $A \to k$ such that the base change
of $\Psi$ by the corresponding morphism $t : \Spec(k) \to T$
is $\Psi_x$. Then $t \in T_p \setminus T_{p + 1}$ for some $p$ and
