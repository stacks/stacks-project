...
the induced morphism $[Z/R_Z] \to [U/R]$ is fully faithful. Hence by
Algebraic Stacks,
Lemma \ref{algebraic-lemma-characterize-representable-by-algebraic-spaces}
the morphism $[Z/R_Z] \to [U/R]$ is representable by algebraic spaces.
...
$$
\xymatrix{
[U''/R''] \ar[d] \ar[r] & [Z/R_Z] \ar[d] \\
U \ar[r] & [U/R]
}
$$
where $U'' = Z \times_{U, t} R = R_Z$ and
$$
R'' =
R_Z \times_{s, U, t} R =
R_Z \times_{s, Z, t} R_Z
$$
(equality as subspaces of $R \times_{s, U, t} R$).
Moreover, $s'', t'', c''$ can be described by 
$s''(r, r') = r'$, $t''(r, r') = c(r, r')$, and
$c''((r_1, r'_1), (r_2, r'_2)) = (c(r_1, r_2), r'_2)$.
Precomposing with the isomorphism
$R_Z \times_{s, Z, s} R_Z \to R_Z \times_{s, Z, t} R_Z$,
$(r, r') \mapsto (c(r, i(r')), r')$ we see that $t''$ and $s''$ turn
into $\text{pr}_0$ and $\text{pr}_1$ and that $c''$ turns into
$\text{pr}_{02} : R_Z \times_{s, Z, s} R_Z \times_{s, Z, s} R_Z \to
R_Z \times_{s, Z, s} R_Z$. Hence we see that
$[U''/R''] \cong [R_Z/R_Z \times_{s, Z, s} R_Z]$ where as a groupoid
in algebraic spaces $(R_Z, R_Z \times_{s, Z, s} R_Z, s'', t'', c'')$
is the pullback of the trivial groupoid structure
$(Z, Z, \text{id}, \text{id}, \text{id})$ on $Z$ via the smooth
surjective morphism $R_Z \to Z$. Hence it follows from
Groupoids in Spaces,
Lemma \ref{spaces-groupoids-lemma-quotient-stack-restrict-equivalence}
that the morphism $[U''/R''] \to Z$ induced by the obvious maps
$U'' \to Z$ and $R'' \to Z$ is an equivalence. Thus we conclude that
we have a $2$-cartesian square
$$
\xymatrix{
...
$$
(Aside: There should be a more straightforward proof of this fact.
For example you can argue similarly to the proof of
Groupoids in Spaces,
Lemma \ref{spaces-groupoids-lemma-cartesian-square-of-morphism}
to show directly that the square is $2$-cartesian, but in the argument
you do have to use that $Z$ is $R$-invariant and that $Z \to U$ is a
monomorphism.)

\medskip\noindent
Having esthablished the above it follows immediately from
