...
\noindent
This section is to analogue of
...
equivalent conditions of Lemma \ref{lemma-UR-quasi-compact-above-x},
...
Lemma \ref{lemma-UR-quasi-compact-above-x} are satisfied.
\end{definition}

\noindent
A slightly stronger condition would be to ask that any morphism
$\Spec(k) \to \mathcal{X}$ in the equivalence class of $x$ is quasi-compact
and quasi-separated.
...
of $|\mathcal{Y}|$ arises in this manner, see Lemma
\ref{lemma-characterize-surjective}.
...
Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-check-quasi-compact-covering}.
We have
$$
...
Morphisms of Stacks, Lemma \ref{stacks-morphisms-lemma-gerbe-bijection-points}.
...
closed substack corresponding to $T$, see Definition
\ref{definition-reduced-induced-stack}.
...
By Morphisms of Stacks, Proposition
