...
\begin{remark}
\label{remark-disctinct}
We don't know of an example of an algebraic stack satisfying the equivalent
conditions of
Lemma \ref{lemma-unique-point}
which isn't also locally Noetherian. In other words, we don't know an example
where the monomorphism $\mathcal{Z}' \to \mathcal{Z}$ in
Lemma \ref{lemma-improve-unique-point}
isn't an isomorphism. If you do please email
