...
\medskip\noindent
The discussion above applies to the following properties of
...
\begin{proof}
Follows from the general principle of
Algebraic Stacks,
Lemma \ref{algebraic-lemma-representable-transformations-property-implication}
and
Morphisms of Spaces,
...
such that $i$ factors into an equivalent $i' : \mathcal{Z} \to \mathcal{X}'$
...
An {\it algebraic space structure on $Z$} is given by a closed substack
