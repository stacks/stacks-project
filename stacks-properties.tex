...
Decent Spaces, Lemma \ref{decent-spaces-lemma-find-singleton-from-point} and
Definition \ref{decent-spaces-definition-residual-space}.
If $X$ is an algebraic space and if the point $x$ can be represented by a
monomorphism $x : \Spec(k) \to X$ from the spectrum of a field (for example
if $X$ is decent or quasi-separated or locally Noetherian)
then this monomorphism is the residual gerbe/space.
\end{example}
