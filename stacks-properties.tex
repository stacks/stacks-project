...
fppf topology is of this form. In this section we briefly discuss
this notion and the corresponding relative notion.
...
algebraic stacks; but as we will see later this condition has a lot of
geometric consequences. The absolute notion is trickier to parse, because it
...
$$
(\textit{Sch}/S)_{fppf}^{opp} \to \textit{Sets},\quad
U \mapsto \text{Ob}(\mathcal{X}_U)/\!\!\cong
$$
...
$$
In fact it turns out that $\mathcal{Z}_x$ is a regular algebraic stack
