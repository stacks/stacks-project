...
\item there exists a surjective smooth morphism $U \to \mathcal{X}$
with $U$ an algebraic space, and
\item there exists a morphism $\mathcal{U} \to \mathcal{X}$ of algebraic
stacks, which is representable by algebraic spaces and surjective such
that $\mathcal{U}$ is quasi-compact.
\end{enumerate}
\end{lemma}
...
$\mathcal{P}(\mathcal{X}, x)$. If $X$ is an algebraic space then
this is equivalent to $X$ having property $\mathcal{P}$ at $x$.
\end{lemma}
