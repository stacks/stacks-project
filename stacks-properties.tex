...
$\dim_u(U)$ is finite (see Examples, Section
\ref{examples-section-Noetherian-infinite-dimension}).
This is why our invariant is an element of $\mathbf{Z} \cup \{\infty\}$.
...
if $\mathcal{X}$ is a scheme (Properties, Lemma \ref{properties-lemma-dimension})
