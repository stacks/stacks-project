...
\begin{definition}
\label{definition-localization-ringed-site}
Let $(\mathcal{C}, \mathcal{O})$ be a ringed site.
Let $U \in \text{Ob}(\mathcal{C})$.
\begin{enumerate}
...
\end{enumerate}
Moreover, if $\mathcal{F} = h_U^\#$ for some object $U$ of $\mathcal{C}$
...
which identifies $\mathcal{O}_U$ with $\mathcal{O}_{\mathcal{F}}$
...
Sites, Lemma \ref{sites-lemma-localize-topos-properties}.
\end{proof}

\begin{definition}
\label{definition-localization-ringed-topos}
Let $(\textit{Sh}(\mathcal{C}), \mathcal{O})$ be a ringed topos.
...
Lemma \ref{lemma-morphism-ringed-topoi-localization}).
...
\begin{lemma}
\label{lemma-morphism-ringed-topoi-localization}
Let
$$
f :
(\textit{Sh}(\mathcal{C}), \mathcal{O})
...
\begin{proof}
By
Sites, Lemma \ref{sites-lemma-morphism-topoi-localization}
...
\begin{lemma}
\label{lemma-morphism-locally-ringed-topoi-localization}
Localization of locally ringed topoi.
\begin{enumerate}
\item Let $(\textit{Sh}(\mathcal{C}), \mathcal{O})$ be a locally
ringed topos. Let $\mathcal{F}$ be a sheaf on $\mathcal{C}$.
Then the ringed topos
$(\textit{Sh}(\mathcal{C})/\mathcal{F}, \mathcal{O}_{\mathcal{F}})$
constructed in
Lemma \ref{lemma-localize-ringed-topos}
is a locally ringed topos and the morphism
$j_{\mathcal{F}} :
(\textit{Sh}(\mathcal{C})/\mathcal{F}, \mathcal{O}_{\mathcal{F}}) \to
(\textit{Sh}(\mathcal{C}), \mathcal{O})$
is a morphism of locally ringed topoi.
\item  Let $(\textit{Sh}(\mathcal{C}), \mathcal{O})$ be a locally
ringed topos. Let $\mathcal{G} \to \mathcal{F}$ be a map of sheaves
on $\mathcal{C}$. Then the commutative diagram of
Lemma \ref{lemma-relocalize-ringed-topos}
$$
\xymatrix{
(\textit{Sh}(\mathcal{C})/\mathcal{G}, \mathcal{O}_{\mathcal{G}})
...
$$
is a commutative diagram of morphisms of locally ringed topoi.
\item Let
$
f :
(\textit{Sh}(\mathcal{C}), \mathcal{O})
...
Then the commutative diagram of
Lemma \ref{lemma-morphism-ringed-topoi-localization}
$$
\xymatrix{
(\textit{Sh}(\mathcal{C})/\mathcal{F}, \mathcal{O}_{\mathcal{F}})
...
$$
is a commutative diagram of locally ringed topoi.
\end{enumerate}
\end{lemma}

\begin{proof}
Part (1) is clear since $\mathcal{O}_{\mathcal{F}}$ is just the
restriction of $\mathcal{O}$, so
Lemma \ref{lemma-locally-ringed-intrinsic} part (1) applies.
Part (2) is clear as by construction $(j, j^\sharp)$
is a localization of a locally ringed topos.
