...
Moreover, the extension by zero $j^{Mod}_{U!}\mathcal{G}$
...
$\mathcal{O}$-modules $\alpha' : j^{Mod}_{U!}\mathcal{G} \to \mathcal{F}$
by the properties of sheafification of modules
(Lemma \ref{lemma-sheafification-presheaf-modules}).

\medskip\noindent
Conversely, let $\beta : j^{Mod}_{U!}\mathcal{G} \to \mathcal{F}$
...
Moreover, it is the sheaf associated to the presheaf
$$
V
\longmapsto
\coprod\nolimits_{\varphi \in \text{Mor}_{\mathcal{C}}(V, U)}
...
$j^{Sh}_{U!}\mathcal{G} \to j^{Mod}_{U!}\mathcal{G}$ of sheaves of sets.
