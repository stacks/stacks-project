...
be an $\mathcal{O}$-module. The following are quivalent:
\begin{enumerate}
...
of a covering of $U$ is a direct summmand of a free module, which will
...
inverible $\mathcal{O}_\mathcal{D}$-module is invertible.
\end{lemma}
