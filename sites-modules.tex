...
\noindent
This is really just the following lemma.
...
Assume (a), (b), and (c).
We already know that $g_!$ is right exact as it is a left adjoint.
We have $g_! = (g_{p!}\ )^\#$.
Recall that limits of abelian sheaves are equal to the corresponding limits
as presheaves, see
Lemma \ref{}.
And sheafification is exact, see
Lemma \ref{}.
