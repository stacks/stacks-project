...
\begin{remark}[Map from $j_!$ to $j_*$]
...
Let $(\mathcal{C}, \mathcal{O})$ be a ringed site. If every object
of $\mathcal{C}$ has a covering by quasi-compact objects, then
every $\mathcal{O}$-module is a filtered colimit of sheaves
of the form
\begin{equation}
...
\right)
\end{equation}
with $U_i$ and $V_j$ quasi-compact objects of $\mathcal{C}$.
\end{lemma}

\begin{proof}
By Lemmas \ref{lemma-module-quotient-flat} and
\ref{lemma-covering-gives-surjection}
every modules is a quotient of a direct sum of modules of the form
$j_{U!}\mathcal{O}_U$ with $U$ quasi-compact. Thus every module
is a cokernel
$$
\text{Coker}\left(
...
\right)
$$
for some index sets $I$, $J$ and quasi-compact objects $V_j$ and $U_i$.
...
Let $(\mathcal{C}, \mathcal{O})$ be a ringed site. Assume every object
of $\mathcal{C}$ has a covering by quasi-compact objects. Then
...
with $W$ quasi-compact is another module of the same type.
The map $\varphi$ corresponds to $s \in \mathcal{F}(W)$.
Since $W$ is quasi-compact we can find a finite covering
$\{W_k \to W\}$ with $W_k$ quasi-compact such that $s|_{W_k}$
...
\begin{enumerate}
\item every object of $\mathcal{C}$ has a covering by quasi-compact objects,
and
\item if $\{U_i \to U\}$ is a finite covering of a quasi-compact object
by quasi-compact objects, then $U_i \times_U U_j$ is quasi-compact.
\end{enumerate}
Then given a map
$$
\bigoplus\nolimits_{j = 1, \ldots, m} j_{V_j!}\mathcal{O}_{V_j}
...
\bigoplus\nolimits_{i = 1, \ldots, n} j_{U_i!}\mathcal{O}_{U_i}
$$
with $U_i$ and $V_j$ quasi-compact, and finite coverings
$\{U_{ik} \to U_i\}$ by quasi-compact objects $U_{ik}$, there
exist a finite set of quasi-compact objects $W_l$ and
...
finite coverings by quasi-compact objects $\{V_{jm} \to V_j\}$
...
we write $A_U = j_{U!}\mathcal{O}_U$ for $U \in \Ob(\mathcal{C})$
quasi-compact. By Lemma \ref{lemma-change-presentation-towards-constructibles}
we may replace $W_i$ by finite coverings $\{W_{ik} \to W_i\}$ by
quasi-compact objects. Thus we may assume the map
...
quasi-compact objects (permissible by
Lemma \ref{lemma-covering-gives-surjection})
...
by quasi-compact objects, then $U_i \times_U U_j$ is quasi-compact.
\end{enumerate}
Let $\mathcal{C} \subset \textit{Mod}(\mathcal{O})$ be the full subcategory
of modules isomorphic to a cokernel as in
...
\bigoplus\nolimits_{i = 1, \ldots, n} j_{U_i!}\mathcal{O}_{U_i}
$$
with $U_i$ and $V_j$ quasi-compact objects, is in $\mathcal{C}$, then
$\mathcal{C}$ is weak Serre subcategory of $\textit{Mod}(\mathcal{O})$.
\end{lemma}
...
between objects of $\mathcal{C}$ is in $\mathcal{C}$. To prove this
...
In this proof the direct sums are always finite, and
we write $A_U = j_{U!}\mathcal{O}_U$ for $U \in \Ob(\mathcal{C})$
quasi-compact. Using Lemmas \ref{lemma-covering-gives-surjection} and
...
Let $u : \mathcal{C} \to \mathcal{D}$ be a continuous and concontinuous
