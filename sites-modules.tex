...
\mathcal{A})
& =
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{G}, \mathcal{A}), \\
...
\mathcal{F})
=
\prod\nolimits_{i \in I} \Mor_{\textit{Sh}(\mathcal{C})}(\{*\},
\mathcal{F})
$$
...
$$
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{O}_2, j_*\mathcal{F}) =
\Mor_{\textit{Sh}(\mathcal{C}/U)}(j^{-1}\mathcal{O}_2, \mathcal{F})
$$
