...
be a covering of $\mathcal{C}$. Then the map
$\bigoplus j_{U_i!}\mathcal{O}_{U_i} \to j_!\mathcal{O}_U$
is surjective.
\end{lemma}

\begin{proof}
This holds because for any $\mathcal{O}$-module $\mathcal{F}$ the functor
$\Hom_\mathcal{O}(-, \mathcal{F})$ turns our map into the map
$\mathcal{F}(U) \to \prod \mathcal{F}(U_i)$ which is injective.
