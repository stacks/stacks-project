...
\medskip\noindent
The category $\textit{Ab}(\mathcal{C})$ is an abelian category also.
This follows from the results of
Sites, Section \ref{sites-section-sheaves-algebraic-structures}
and Homology, Lemma \ref{homology-lemma-adjoint-get-abelian}.
(We suggest finding a direct proof as a good exercise for students.)
If $\varphi : \mathcal{F} \to \mathcal{F}'$
...
$\varphi$ in $\textit{PAb}(\mathcal{C})$. A sequence of abelian sheaves
$$
