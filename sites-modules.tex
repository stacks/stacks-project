...
$$
\textit{Hom}_{\mathcal{O}}(\colim_i \mathcal{F}_i, \mathcal{G})
=
\lim_i \textit{Hom}_{\mathcal{O}}(\mathcal{F}_i, \mathcal{G}).
$$
\end{enumerate}
...
Hence we have
\begin{align*}
\textit{Hom}_{\mathcal{O}}(\mathcal{F}, \lim_i \mathcal{G}_i)(U)
& =
\text{Hom}_{\mathcal{O}_U}(\mathcal{F}|_U, \lim_i \mathcal{G}_i|_U) \\
& =
\lim_i \text{Hom}_{\mathcal{O}_U}(\mathcal{F}|_U, \mathcal{G}_i|_U) \\
& = \lim_i \textit{Hom}_{\mathcal{O}}(\mathcal{F}, \mathcal{G}_i)(U)
\end{align*}
