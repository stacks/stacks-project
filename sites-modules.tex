...
=
\lim\nolimits_i \textit{Hom}_{\mathcal{O}}(\mathcal{F}_i, \mathcal{G}).
$$
\end{enumerate}
...
Hence we have
\begin{align*}
\textit{Hom}_{\mathcal{O}}(\mathcal{F}, \lim\nolimits_i \mathcal{G}_i)(U)
& =
\text{Hom}_{\mathcal{O}_U}(\mathcal{F}|_U, \lim\nolimits_i \mathcal{G}_i|_U) \\
& =
\lim\nolimits_i \text{Hom}_{\mathcal{O}_U}(\mathcal{F}|_U, \mathcal{G}_i|_U) \\
& = \lim\nolimits_i \textit{Hom}_{\mathcal{O}}(\mathcal{F}, \mathcal{G}_i)(U)
\end{align*}
