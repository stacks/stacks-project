...
\Hom_\mathcal{O}(\mathcal{F}, \mathcal{G}).
$$
provided there exists a subset $\mathcal{B} \subset \Ob(\mathcal{C})$
...
\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G}_\lambda)$.
Recall that
$$
...
Let $\mathcal{C}$ be a site. Let $\mathcal{O} \to \mathcal{O}'$
be a flat homorphism of sheaves of rings. Let $\mathcal{I} \subset \mathcal{O}$
