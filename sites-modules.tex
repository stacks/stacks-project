...
then we define $\mathcal{F} \otimes_{\mathcal{O}} \mathcal{G}$
...
\begin{enumerate}
\item Tensor products of presheaves of modules commutes with arbitrary
colimits.
\item Tensor products of sheaves of modules commutes with arbitrary
colimits.
...
\begin{proof}
Part (1) holds because it is true for tensor products of modules
over rings, see
Algebra, Lemma \ref{algebra-lemma-tensor-products-commute-with-limits}.
Part (3) follows from this and
Algebra, Lemma \ref{algebra-lemma-directed-colimit-exact}
by looking at sections over objects.
Sheafification commutes with arbitrary colimits because it is
a left adjoint (Categories, Lemma \ref{categories-lemma-adjoint-exact}).
Hence (2) follows from (1).
To see part (4), use (2) and the fact that a directed colimit of exact 
...
\begin{lemma}
\label{lemma-flat-tor-zero-presheaves}
Let $\mathcal{C}$ be a category.
Let $\mathcal{O}$ be a presheaf of rings.
Let
$$
...
Assume $\mathcal{F}$ is flat. Then for any presheaf $\mathcal{G}$
...
\begin{matrix}
 ...
 & & \mathcal{F}''\otimes_{p, \mathcal{O}} \mathcal{G} & \to & \mathcal{F}' \otimes_{p, \mathcal{O}} \mathcal{G} & \to & \mathcal{F}\otimes_{p, \mathcal{O}} \mathcal{G} & \to & 0 \\
 & & \uparrow & & \uparrow & & \uparrow & & \\
0 & \to & \mathcal{F}''\otimes_{p, \mathcal{O}} \mathcal{G}' & \to & \mathcal{F}'\otimes_{p, \mathcal{O}} \mathcal{G}' & \to & \mathcal{F}\otimes_{p, \mathcal{O}} \mathcal{G}' & \to & 0 \\
 & & \uparrow & & \uparrow & & \uparrow & & \\
 & & \mathcal{F}''\otimes_{p, \mathcal{O}} \mathcal{G}'' & \to & \mathcal{F}' \otimes_{p, \mathcal{O}} \mathcal{G}'' & \to & \mathcal{F}\otimes_{p, \mathcal{O}} \mathcal{G}'' & \to & 0 \\
 & & & & & & \uparrow & & \\
 & & & & & & 0 & &
...
0 \to \mathcal{F}'' \to \mathcal{F}' \to \mathcal{F} \to 0
$$
be a short exact sequence of sheaves of $\mathcal{O}$-modules.
Assume $\mathcal{F}$ is flat. Then for any sheaf $\mathcal{G}$
of $\mathcal{O}$-modules, the sequence
$$
0 \to
...
\begin{proof}
Exact same proof as Lemma \ref{lemma-flat-tor-zero-presheaves}.
\end{proof}
