...
\label{equation-fibred-groupoids-commutes}
\end{equation}
\end{lemma}
...
\begin{equation}
\label{equation-fibred-groupoids-commutes2}
\xymatrix{
...
\ref{equation-fibred-groupoids-commutes2} (resp.\ 
\ref{equation-fibred-groupoids-commutes}) commute.  If $\phi\colon
