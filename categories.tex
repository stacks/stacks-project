...
% In this file we use 2cell for 2-commutative diagrams.
\xyoption{2cell}
\UseAllTwocells
...
should read \ref{subsection-formal-cat-cat} as
...
\subsection{Opposite Categories and the Yoneda Lemma}
\label{subsection-opposite}
...
\label{subsection-fibre-products}
...
\subsection{Push outs}
\label{subsection-pushouts}
...
free from the discussion in Subsection \ref{subsection-fibre-products}.

\subsection{Equalizers}
\label{subsection-equalizers}
...
limits and colimits of sets in Subsubsection \ref{subsubsection-limit-sets}
...
\subsubsection{Limits and colimits in the category of sets}
\label{subsubsection-limit-sets}
...
\subsubsection{Limits and colimits over partially ordered sets}
\label{subsubsection-posets-limits}
...
\label{subsection-exact-functor}
...
\label{subsection-formal-cat-cat}
...
Subsection \ref{subsection-formal-cat-cat} and Example
...
Subsection \ref{subsection-formal-cat-cat}.
