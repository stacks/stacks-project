...
\subsection{Examples of fibre products}
\label{subsection-example-fibre-products}
...
limits and colimits of sets in Subsection \ref{subsection-limit-sets}
...
\subsection{Limits and colimits in the category of sets}
\label{subsection-limit-sets}
...
\subsection{Limits and colimits over partially ordered sets}
\label{subsection-posets-limits}
...
\section{Definitions}
\label{section-categories-groupoids-definition}
