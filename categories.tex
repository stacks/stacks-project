...
We often write $\lim_i M_i$, $\text{colim}_i M_i$,
$\lim_{i\in \mathcal{I}} M_i$, or $\text{colim}_{i\in \mathcal{I}} M_i$
...
$$
\xymatrix{
\lim\nolimits_{\mathcal{J}} N \ar[d]^{\theta} \ar[r]
&
N_{H(i)} \ar[d]_{t_{H(i)}}
\\
\lim\nolimits_{\mathcal{I}} M \ar[r]
&
M_i
}
$$
...
$$
\lim\nolimits_\mathcal{I} \text{Mor}_{\mathcal{C}}(M_{F(i)}, T)
=
\lim\nolimits_{\mathcal{I}'} \text{Mor}_{\mathcal{C}}(M_{i'}, T)
$$
...
$$
\lim\nolimits_{B \in \text{Ob}(\mathcal{J})} \text{Mor}_{\mathcal{C}}(W, M(F(B)))
=
\lim\nolimits_{A \in \text{Ob}(\mathcal{I})} \text{Mor}_{\mathcal{C}}(W, M(A))
$$
...
$$
\lim\nolimits_{i \in I} M_i = \lim\nolimits_{\mathcal{I}^{opp}} M,
$$
...
\lim\nolimits_i \text{colim}_j\ \text{Mor}_{\mathcal{C}}(F(i), G(j)).
$$
...
\lim\nolimits_j \text{colim}_i\ \text{Mor}_{\mathcal{C}}(F(i), G(j)).
$$
...
& = &
\lim\nolimits_{i \in \mathcal{I}^{\text{opp}}}
