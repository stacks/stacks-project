...
\begin{enumerate}
\item The identity of every object of $\mathcal{C}$ is in $S$.
\item The composition of two composable elements of $S$ is in $S$.
\item Every solid diagram
$$
\xymatrix{
...
$s \in S$.
\item For every pair of morphisms $f, g : X \to Y$ and
...
Condition (2) claims that the relation
...
$$
with $s_i \in S$. First we apply condition (3) of a
left multiplicative system to get a commutative diagram
$$
\xymatrix{
...
Hence by condition (4) of a left multiplicative system
there exists a morphism $s_{44} : Y_4 \to Y'_4$, $s_{44} \in S$ such that
$s_{44} \circ s_{34} = s_{44} \circ a_{14} \circ a_{31}$.
Hence after
replacing $Y_4$ by $Y'_4$,
$a_{14}$ by $s_{44} \circ a_{14}$, and
$s_{24}$ by $s_{44} \circ s_{24}$ we may assume that
$s_{34} = a_{14} \circ a_{31}$. Next, we apply condition (3) of a
left multiplicative system to get a commutative diagram
$$
\xymatrix{
...
Then by condition (3)
of a left multiplicative system we can choose a diagram
$$
\xymatrix{
...
Using condition (3) of a left multiplicative system
we can choose the dotted arrows making the squares commutative
...
$$
with $t \in S$. In particular $u \circ s = v \circ s$. Hence by
condition (4) in the definition of a left multiplcative system there
...
define a functor $F : \mathcal{C} \to S^{-1}\mathcal{C}$.
\item For any $s \in S$ the morphism $F(s)$ is an isomorphism in
$S^{-1}\mathcal{C}$.
\item If $G : \mathcal{C} \to \mathcal{D}$ is any functor such that
$G(s)$ is invertible for every $s \in S$, then there exists a
canonical functor $H : S^{-1}\mathcal{C} \to \mathcal{D}$
...
\begin{remark}
\label{remark-multiplicative-system}
Let $\mathcal{C}$ be a category and let $S$ be a multiplicative
system. In this situation we can construct two categories
$S^{-1}\mathcal{C}$ (namely as left fractions and as right
fractions). However, the two categories so obtained are
canonically isomorphic by the universal properties of
Lemmas \ref{lemma-properties-left-localization} and
\ref{lemma-properties-right-localization}.
We will add the precise argument here if we ever
need this remark.
\end{remark}
