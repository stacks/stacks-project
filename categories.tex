...
\begin{proof}
	...
	then the set $Q(T)$ satisfies LMS2 and LMS3 for $Q$ preserves compositions.
	On the other hand, it satisfies LMS1 for
	$Q$ is bijective on objects and preserves identities.
	The dual assertions are true if $T$ is a right multiplicative system.
