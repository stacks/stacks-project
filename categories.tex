...
Lemma \ref{lemma-directed-commutes}.
% [DG] I think this is direly in need of detail. (In particular, the
%      limit-colimit commutativity needs to be concretized -- we need
%      to know what the isomorphism is, so that we can use it here to
%      show that it is functorial).
\end{proof}
