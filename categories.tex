...
$2$-catgory. Here is the obligatory lemma on $2$-fibre products.
...
below. In other words, presheaves of sets and categories fibred
in sets are the same thing! We formalize this in
Lemmma \ref{lemma-2-category-fibred-sets} below.
...
Let $\mathcal{C}$ be a category.
The only $2$-morphisms between categories fibred in sets 
are identities. In other words, the $2$-category of categories
fibred in sets is a category. Moreover, this category is
equivalent to the category of presheaves of sets
over $\mathcal{C}$.
\end{lemma}

\begin{proof}
The first assertion is clear. For the second
see the discussion following
Definition \ref{definition-category-fibred-sets}.
\end{proof}
