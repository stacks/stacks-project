...
= \Mor_{\mathcal{B}}(x, y)$ for all $x, y \in \text{Ob}(\mathcal{A})$.
...
$$
\lim_{B \in \text{Ob}(\mathcal{J})} \Mor_{\mathcal{C}}(W, M(F(B)))
=
\lim_{A \in \text{Ob}(\mathcal{I})} \Mor_{\mathcal{C}}(W, M(A))
$$
...
of functors $\mathcal{C}^{opp} \times \mathcal{D}
\to \textit{Sets}$ from $\Mor_{\mathcal{D}}(u(-), -)$
to $\Mor_{\mathcal{C}}(-, v(-))$.
...
$$
\xymatrix{
\Mor_{\mathcal{S}}(x, y) \ar[rd]_p \ar[rr]_{G} & &
