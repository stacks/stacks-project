...
$M : \mathcal{I} \to \mathcal{C}$, denote $(M(x_i), M(\varphi_{ii'}))$
...
\item For every category $\mathcal{C}$ and every diagram
$M : \mathcal{I}^{opp} \to \mathcal{C}$, denote
...
Let $\mathcal{A}$ be a category and let $\mathcal{C}$ be a two category.
\begin{enumerate}
...
$$
is commutative,
\item given a second such $1$-morphism
...
$$
in other words, these are the forgetfull functors.
...
Let $\mathcal{C}$ be a category.
Let $p : \mathcal{S} \to \mathcal{C}$ be a category over $\mathcal{C}$.
The composition of two strongly cartesian morphisms
...
Assume $p : \mathcal{S} \to \mathcal{C}$ is a fibred category.
\begin{enumerate}
\item A {\it choice of pullbacks} for $p : \mathcal{S} \to \mathcal{C}$
...
is the sub $2$-category of the category of fibred categories
...
$F \to \mathcal{S}_F$ of Example \ref{example-functor-groupoids}.
...
fibred in groupoids over $\mathcal{C}$ is in a
``full'' sub $2$-category of the category of categories over
$\mathcal{C}$ (see
Definition \ref{definition-categories-fibred-in-groupoids-over-C}).
