...
consisting of categorically compact objects of $\mathcal{C}$ such that every object
of $\mathcal{C}$ is a filtered colimit of objects of $\mathcal{C}'$.
...
For each $i \in I$ since $X_i$ is a categorically compact object of $\mathcal{C}$
we can find a $j \in J$ and a commutative diagram
$$
\xymatrix{
