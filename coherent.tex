...
\item if $P$ holds for $U$, $V$, and $U \cap V$, then
$P$ holds for $U \cup V$.
\end{enumerate}
...
is also a union of $n - 1$ affine open subschemes as, by
Schemes, Lemma \ref{schemes-lemma-characterize-separated}
to the affine opens $U_i$ and $U_n$ of $W$.
...
for example if $S$ is quasi-compact and has affine diagonal, by relating it
...
says that $j$ is an affine morphism. Hence
$H^p(X, j_*j^*\mathcal{F}) = H^p(X_s, j^*\mathcal{F})$ by
Lemma \ref{lemma-relative-affine-cohomology}.
Since also $H^p(X_s, j^*\mathcal{F}) = 0$ for $p > 0$ by
Lemma \ref{lemma-quasi-coherent-affine-cohomology-zero},
we conclude that
$H^p(X, j_*j^*\mathcal{F}) = 0$ for all $p > 0$.
Write
$$
