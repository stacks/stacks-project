...
\section{Generalized Artin-Rees}
...
Let $\mathcal{F}$ be a coherent sheaf on $X$.
\begin{enumerate}
\item For every $p \geq 0$ the graded $S$-module
$\bigoplus_{n \geq 0} H^p(X, I^n\mathcal{F})$ is
of finite type.
\item For every $p \geq 0$ there exists an integer
$c \geq 0$ such that
$H^p(X, I^n\mathcal{F}) = I^{n - c}H^p(X, I^c\mathcal{F})$
for all $n \geq c$.
\end{enumerate}
\end{lemma}

\begin{proof}
Part (2) is a consequence of part (1). See proof of
Algebra, Lemma \ref{algebra-lemma-Artin-Rees}.
Details omitted.

\medskip\noindent
To show (1) we consider the fibre product diagram
$$
\xymatrix{
...
we see that there is a unique $\mathcal{F}'$ on $X'$
such that
$\pi_*\mathcal{O}_{X'} \cong \bigoplus_{n \geq 0} I^n \otimes_A \mathcal{O}_X$
