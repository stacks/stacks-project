...
f'_*\mathcal{F}' \cong Rf'_*\mathcal{F}'
$$
\end{lemma}
...
Rf'_*\mathcal{F}'
$$
in $D^{+}(S')$. Moreover, if $S'$ is also separated, then in fact
$$
g^*\check{\mathcal{C}}^\bullet(\mathcal{U}, f, \mathcal{F})
=
\check{\mathcal{C}}^\bullet(\mathcal{U}', f', \mathcal{F}')
...
This is clear from the case of affine morphisms, see
...
Details and references omitted.
\end{proof}
...
\noindent
Here is a trivial application of cohomology and base change.
