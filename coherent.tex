...
ideal $I \subset A$. Then for every $f, g \in K^t$ there exists a
...
$(\mathcal{F}, a, \beta)$ where $a : \mathcal{F} \to \mathcal{G}$
is an $\mathcal{O}_X$-module map,
$\beta : (\mathcal{F}_n) \to \mathcal{F}^\wedge$ is an isomorphism, and
...
$\textit{Coh}(\mathcal{O}_{X_e})$
with the category of cohernet $\mathcal{O}_X$-modules annihilated by
...
Thus we may apply Lemma \ref{lemma-existence-easy} to conclude.
\end{proof}
