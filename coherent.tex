...
$\beta : (\mathcal{F}_n) \to \mathcal{F}^\wedge$
is an isomorphism, and $\alpha = a^\wedge \circ \beta$.
\end{lemma}
...
\noindent
This is the form of Grothendieck's existence theorem which is most
...
coherent modules annilated by $\mathcal{K}$ and coherent modules
