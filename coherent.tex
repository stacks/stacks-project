...
Finally, it is clear that if $\mathcal{F}_x = 0$, then
$\mathcal{I}_x = \mathcal{O}_{X, x}$ (by
Modules, Lemma \ref{modules-lemma-stalk-internal-hom})
and hence we see $Z \subset \text{Supp}(\mathcal{F})$ as desired.
\end{proof}
...
if $x$ is an associated point and not a generic point of
