...
\medskip\noindent
To finish the proof of (1) we still have to show that $\text{Coim} = \Im$
...
$\Im = \text{Coim}$ holds in the category of modules
this gives $\text{Coim} = \Im$ in $\textit{Coh}(X, \mathcal{I})$.
...
clear that $\Ker(M/JM \to N/JN)$ and $\text{Coker}(M/JM \to N/JN)$
...
a $t \geq 1$ such that
$\Ker(M/I^nM \to N/I^nN)$ and $\text{Coker}(M/I^nM \to N/I^nN)$
...
$\Ker(c)$ and $\text{Coker}(c)$ are supported on $V(\mathcal{K})$
