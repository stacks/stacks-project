...
since $e_*\mathcal{O}_S$ is a skyscraper sheaf supported a the neutral
...
$\mathcal{O}_{G, g} \to \mathcal{O}_{G_K, g'}$ is a flat
local ring map. Hence in order to prove (1) it suffices to
...
In this way we see that (2) implies (1).
...
$Z_1 \times_k Z_2 \subset G \times_k G$ is irreducible too.
Hence $m(Z_1 \times_k Z_2)$ is contained in an irreducible
component of $G$ containing $e$. On the other hand it contains
$Z_1$ and $Z_2$, and we conclude $Z_1 = Z_2$.
\end{proof}
