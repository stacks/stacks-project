...
\begin{lemma}
\label{lemma-quotient-pre-relation-restrict}
Let $\tau \in \{Zariski, etale, fppf, smooth, syntomic\}$.
Let $S$ be a scheme.
...
\begin{proof}
In this proof we will use the abuse of notation (writing $U$ instead
of $h_U$) introduced
...
$U'/R' \to U/R$ is injective. If $U' \to U$ is a surjection
...
Lemma \ref{lemma-quotient-pre-relation-restrict}.
...
Cohen-Macaulay morphisms (and locally of finite presentation).
