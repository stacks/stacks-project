...
\end{equation}
is commutative, the two squares are cartesian and
$t \circ c = t \circ \text{pr}_0$.
\end{lemma}

\begin{proof}
Follows immediately from Lemma \ref{lemma-diagram}.
\end{proof}
...
A \ar[l]^t \\
B \ar[u]_{p_1} &
A \ar@<-1ex>[l]_s \ar@<1ex>[l]^t \ar[u]^s &
C \ar[u] \ar[l]
}
$$
Moreover the tow left squares are cocartesian in the category of rings.
...
B \ar@<-1ex>[l]_-c \ar@<1ex>[l]^-{p_0} &
A \ar[l]^t \\
\bigoplus_{i \in I} B x_i \ar[u]_{p_1} &
\bigoplus_{i \in I} A x_i \ar@<-1ex>[l]_s \ar@<1ex>[l]^t \ar[u]^s &
...
that $C$ is a local ring. By Algebra, Lemma \ref{} we may also assume
that the residue field of $C$ is al
\end{proof}
