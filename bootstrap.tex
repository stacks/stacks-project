...
if for every $U \in \text{Ob}((\Sch/S)_{fppf})$ and
...
we can find an affine $U_i \in \text{Ob}((\Sch/S)_{fppf})$
...
\medskip\noindent
Choose $U' \in \text{Ob}(\Sch/S)_{fppf}$ and a surjective
...
Choose $W \in \text{Ob}((\Sch/S)_{fppf})$
...
of $S$. Choose $U \in \text{Ob}((\Sch/S)_{fppf})$ and a surjective
