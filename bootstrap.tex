...
\noindent
A sheaf which is locally an algebraic space is an algebraic space.
Note that the second condition is equivalent to the condition that
$F|_{(\textit{Sch}/S_i)_{fppf}}$ is an algebraic space, see
Spaces, Lemma \ref{spaces-lemma-rephrase}.
The third condition is a set theoretic condition which may be ignored
