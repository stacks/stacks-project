...
During this proof $u$ will always be a point of finite type of $U$, see
...
Let $u \in U$ be a point of finite type.
We claim that there exists a $g : U' \to U$ such that
\begin{enumerate}
...
\medskip\noindent
Step 3. For each point $u \in U$ of finite type we can find a
$g : U' \to U$ such that
\begin{enumerate}
\item $g$ is an immersion,
\item $u \in U'$,
...
\medskip\noindent
Step 4. For each point $u \in U$ which is of finite type
