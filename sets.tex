...
$|\Gamma(V, \mathcal{O}_T)|
\leq
\max\{\aleph_0, \prod_{i = 1, \ldots , n} |\Gamma(V_i, \mathcal{O}_T)|\}
\leq
\max\{\aleph_0, \prod_{i = 1, \ldots , n} |\Gamma(U_i, \mathcal{O}_S)|\}
\leq
\text{size}(S)^n$.
By Lemma \ref{lemma-bound-affine},
$\text{size}(T)\leq \text{size}(S)^{\aleph_0}$.
