...
$S_0 \subset \text{Ob}(\Sch_\alpha)$.
\label{item-inclusion}
\item For any $S \in \text{Ob}(\Sch_\alpha)$ and any
scheme $T$ with $\text{size}(T) \leq Bound(\text{size}(S))$,
there exists a scheme $S' \in \text{Ob}(\Sch_\alpha)$
such that $T \cong S'$.
\label{item-bounded}
...
\item For any $S \in \text{Ob}(\Sch_{f(\alpha)})$ and any
scheme $T$ with $\text{size}(T) \leq Bound(\text{size}(S))$,
there exists a scheme $S' \in \text{Ob}(\Sch_\beta)$
such that $T \cong S'$.
\item For any countable diagram category $\mathcal{I}$ and
...
$\text{Ob}(\Sch_{f(\alpha)})$ is a set, we see that
$\kappa =
\text{sup}_{S \in \text{Ob}(\Sch_{f(\alpha)})} Bound(\text{size}(S))$
...
$$
Now, let $S \in \text{Ob}(\Sch_\alpha)$. We define
$\beta(S)$ to be the least ordinal $\beta$ such that
$S \in \text{Ob}(\Sch_{f(\beta)})$. By the above we see
that always $\beta(S) < \beta_1$. Since
$\text{Ob}(\Sch_{f(\beta + 1)}) \subset
\text{Ob}(\Sch_\alpha)$, we
see by construction of $f$ above that the second property of the lemma
is satisfied.

\medskip\noindent
Suppose that $\{S_1, S_2, \ldots\} \subset \text{Ob}(\Sch_\alpha)$
...
that $\{S_1, S_2, \ldots\} \subset \text{Ob}(\Sch_{f(\beta)})$.
...
given $X \in \text{Ob}(\Sch_\alpha)$ the reduction of
...
properties:
\begin{enumerate}
\item If $X, Y, S \in \text{Ob}(\Sch_\alpha)$, then
...
of elements of $\text{Ob}(\Sch_\alpha)$, the coproduct
$\coprod_i S_i$ exists in $\text{Ob}(\Sch_\alpha)$ and
is a coproduct in the category of schemes.
\item For any $S \in \text{Ob}(\Sch_\alpha)$ and
any open immersion $U \to S$, there exists a
$V \in \text{Ob}(\Sch_\alpha)$ with $V \cong U$.
\item For any $S \in \text{Ob}(\Sch_\alpha)$ and
any closed immersion $T \to S$, there exists a
$S' \in \text{Ob}(\Sch_\alpha)$ with $S' \cong T$.
\item For any $S \in \text{Ob}(\Sch_\alpha)$ and
...
$S' \in \text{Ob}(\Sch_\alpha)$ with $S' \cong T$.
\item Suppose that $T \in \text{Ob}(\Sch_\alpha)$ is
