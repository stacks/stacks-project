...
with injective terms representing $K$, see Injectives, Theorem
...
K-injective complex of $\mathcal{O}_f$-modules. The proves the first
equality. We also have
$$
R\SheafHom_{\mathcal{O}_f}(\mathcal{F}^\bullet,
\SheafHom_\mathcal{O}(\mathcal{O}_f, \mathcal{I}^\bullet)) =
R\SheafHom_\mathcal{O}(\mathcal{F}^\bullet,
\SheafHom_\mathcal{O}(\mathcal{O}_f, \mathcal{I}^\bullet))
$$
by 
...
because
$\SheafHom_\mathcal{O}(\mathcal{O}_f, \mathcal{I}^\bullet)$
is a K-injective complex of $\mathcal{O}$ and of $\mathcal{O}_f$-modules.
This proves the second equality. The final equality
