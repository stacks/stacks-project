...
\noindent
Let $\Lambda$ be a Noetherian ring complete with respect
to an ideal $I \subset \Lambda$. 
Let $k$ be a field.
Let us compute
$$
...
to cohomology spectral sequence wrt to this covering.
...
$$
|U_n| = G \times \ldots \times G\ (n\text{ factors})
$$
where $G = \text{Gal}(k^{sep}/k)$. The schemes $U_n$ are affine schemes
to which \'Etale Cohomology, Lemma
...
\end{align*}
The first equality because $R\Gamma$ computes with derived limits
and since $\Lambda^\wedge$ is the derived limit of the sheaves
$\underline{\Lambda/I^n}$, see
Proposition \ref{proposition-enough-weakly-contractibles}.
The second equality by Lemma \ref{lemma-compare-cohomology}.
The third by the aforementioned
\'Etale Cohomology, Lemma
\ref{etale-cohomology-lemma-affine-only-closed-points}.
The fourth equality as $\Lambda$ is complete with respect to $I$.
Hence Cohomology on Sites, Lemmas
