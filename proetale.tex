...
be a quasi-coherent sheaf of ideals. Let $\mathcal{F}$ be a coherent
$\mathcal{O}_X$-module. Then the derived completion $\mathcal{F}^\wedge$
is equal to $\lim \mathcal{F}/\mathcal{I}^n\mathcal{F}$.
\end{lemma}

\begin{proof}
Since derived completion commutes with localization
...
hand side is the derived completion with respect to $\mathcal{I}$.
By Lemma \ref{lemma-derived-completion-pseudo-coherent} we see that
$\mathcal{F}^\wedge = \lim \mathcal{F}/f^{-1}\mathcal{I}^n\mathcal{F}$
provided $X$ is Noetherian and $\mathcal{F}$ is coherent.
In this case it also follows that $\mathcal{F}^\wedge$ is
$R\lim \mathcal{F}/f^{-1}\mathcal{I}^n\mathcal{F}$ and hence
the left hand side is equal to
$R\lim Rf_*(\mathcal{F}/f^{-1}\mathcal{I}^n\mathcal{F})$.
If $S$ is Noetherian and $R^pf_*\mathcal{F}$ is coherent for all $p$
and zero for $p \gg 0$, then a slight generalization of
Lemma \ref{lemma-derived-completion-pseudo-coherent} shows that the
cohomology sheaves of $(Rf_*\mathcal{F})^\wedge$ are the ``usual completions''
of $R^pf_*\mathcal{F}$. The assumptions hold if $f$ is a proper
morphism of Noetherian schemes and one indeed recovers the theorem on
formal functions.
\end{remark}
