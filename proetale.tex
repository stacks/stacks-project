...
$H^i(K \otimes \otimes_\mathcal{O}^\mathbf{L} \mathcal{O}/\mathcal{I}^n
...
\medskip\noindent
Proof of (6) and (7). Follows from Lemmas \ref{lemma-bounded} and
\ref{lemma-naive-completion}
computation of homotopy limits in Cohomology on Sites,
Proposition \ref{sites-cohomology-proposition-enough-weakly-contractibles}.
\end{proof}
