...
\noindent
The pro-\'etale site of a scheme has some remarkable properties.
In particular, it has enough w-contractible objects which implies
has a number of useful consequences for the derived category
...
the notion of a pro-\'etale morphism, and on the other,
Proposition \ref{proposition-weakly-etale}
assures us that we obtain the same notion of sheaves with the
