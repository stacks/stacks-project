...
Let $f : (\mathcal{D}, \mathcal{O}') \to (\mathcal{C}, \mathcal{O})$
...
tells us that the category $D_{comp}(\mathcal{C}, \Lambda)$
of derived complete complexes of
$\underline{\Lambda}$-modules is the same as the category of
derived complete complexes of $\underline{\Lambda}^\wedge$.
For notational convenience we often work with the former.
