...
and use
Cohomology of Sites, Lemma \ref{sites-cohomology-lemma-dual-perfect-complex}
...
Hypercovering, Section \ref{hypercovering-section-hyper-cech}.
...
Hypercovering, Lemma \ref{hypercovering-lemma-cech-spectral-sequence}
implies that
$$
...
induces a morphism of sites $f : X_\proetale \to Y_\proetale$, see
Sites, Proposition \ref{sites-proposition-get-morphism}.
