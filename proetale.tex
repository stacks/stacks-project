...
(but with the roles of $u$ and $v$ reversed). Thus (1) holds by the
construction of the morphism of topoi associated to $v$, see
Sites, Lemma \ref{sites-lemma-cocontinuous-morphism-topoi}.

\medskip\noindent
FIXME: Proof existence of $i^{Sh}_!$ and $i_!$ and
isomorphisms in (4) coming soon.
