...
in that the category of sheaves on it depends on the choice of the
underlying category of schemes. Thus we cannot speak of {\it the} pro-\'etale
topos of a scheme, as it depends on this choice.
As a consequence, the same thing is true, a priori, for the pro-\'etale
cohomology of sheaves on the pro-\'etale site. However, we will
see that for many interesting sheaves the cohomology is independent
of the choice of the pro-\'etale site.
...
\begin{lemma}
\label{lemma-recognize-pro-etale-covering}
...
Lemma \ref{lemma-recognize-pro-etale-covering}, and
...
\begin{definition}
\label{definition-standard-pro-etale}
...
\begin{lemma}
\label{lemma-w-contractible-pro-etale-cover}
...
\begin{proof}
Assume $A$ is w-contractible. By Lemma \ref{lemma-pro-etale-affine}
...
\begin{definition}
\label{definition-big-pro-etale-site}
...
Definition \ref{definition-big-pro-etale-site}.
...
By Lemma \ref{lemma-w-contractible-pro-etale-cover}
...
(Lemma \ref{lemma-etale-pro-etale}) we conclude that
...
with each $T_i$ weakly contractible in $\Sch_\proetale$.
\end{lemma}
...
of $\Sch_\proetale$ in Definition \ref{definition-big-pro-etale-site}
...
Definition \ref{definition-big-pro-etale-site} we win.
\end{proof}
