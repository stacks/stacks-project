...
commutes with all limits and colimits. It follows among other things, that
we can check exactness of a complex of abelian sheaves by evaluation at the
quasi-compact, weakly contractible objects of $S_\proetale$.
...
Sketch: Reduce to the case $r = 1$. If $r = 1$ and $f = f_1$, define
