...
immediate from the results of the lemma.
\end{proof}
...
for $\mathfrak m \subset D$ maximal ideal lying over the
maximal ideal $\mathfrak m' \subset C$
the ring map $C_{\mathfrak m'} \to D_\mathfrak m$ is an isomorphism.
As every point specializes to a closed point we conclude that
