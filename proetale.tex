...
Local Cohomology, Section \ref{local-cohomology-section-derived-completion};
...
\ref{local-cohomology-lemma-restriction-derived-complete-equivalence}
tells us that
$$
...
of Local Cohomology, Proposition
\ref{local-cohomology-proposition-derived-completion} sends $K$ to
$$
...
Local Cohomology, Lemma \ref{local-cohomology-lemma-derived-completion-koszul}
we have
$$
K^\wedge = 
...
Local Cohomology, Lemma
\ref{local-cohomology-lemma-pushforward-derived-complete-adjoint}.
Part (3) follows from
Local Cohomology, Lemma
\ref{local-cohomology-lemma-pushforward-commutes-with-derived-completion}.
...
(see Local Cohomology, Section
\ref{local-cohomology-section-derived-completion} and
...
Local Cohomology, Definition
\ref{local-cohomology-definition-derived-complete}).
...
H^i_{cont}(G, \Lambda)
$$
where the right hand side is continuous group cohomology as defined by
Tate in \cite{Tate}, see \'Etale Cohomology, Section
