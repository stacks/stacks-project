...
Let $S$ be a scheme.
Let $\mathcal{F}$ be a finite type, quasi-coherent $\mathcal{O}_S$-module.
Let $Z_0 \subset X$ be the closed subscheme cut out by
$\text{Fit}_0(\mathcal{F})$.
Let $Z \subset X$ be the scheme theoretic support of $\mathcal{X}$.
Then
\begin{enumerate}
\item $Z \subset Z_0 \subset X$ as closed subschemes,
\item $Z = Z_0 = \text{Supp}(\mathcal{X})$ as closed subsets,
