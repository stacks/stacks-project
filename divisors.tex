...
is an effective Cartier divisor. In this case we sometimes denote it
$f^*D$ and we call it the {\it pullback of the effective Cartier
divisor}.
\end{definition}
...
Let $X$ be a ringed space. Let $f \in \Gamma(X, \mathcal{O}_X)$.
The following are equivalent:
\begin{enumerate}
