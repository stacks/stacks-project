...
is the cokernel in $\mathcal{C}$. Moreover $\mathcal{C}$ inherts
a tensor product
$$
...
Since a finite locally free module is reflexive,
we see (3) implies (1) by Lemma \ref{lemma-reflexive-S2-extend}.
...
and hence $\mathcal{F}$ is trivial too, see
Lemma \ref{lemma-reflexive-S2-extend}.
...
Lemma \ref{lemma-reflexive-S2-extend} and we find that $D$ is
