...
$f_1, \ldots, f_r$ of a ring $R$ is {\it regular} if for each
...
J^n/J^{n + 1}
$$
which maps $T_i$ to $f_i \bmod J^2$ is an isomorphism, see
...
\begin{proof}
This follows as such a sheaf of ideals is locally generated by sections.
And any sheaf of ideals locally generated by sections on a scheme is
quasi-coherent, see
...
$$
\widetilde{\ } : \text{Mod}_A \longrightarrow \textit{QCoh}
$$
