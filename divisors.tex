...
X
$$
be the inclusion of these generic points back into $X$ (using the
canonical maps of Schemes, Section \ref{schemes-section-points}).
We claim that in this case $\mathcal{K}_X = f_*\mathcal{O}_Y$.
...
$Q(A) = \prod R_{\mathfrak q_i} = \prod \kappa(\mathfrak q_i)$
