...
effective Cartier divisor. Let $\xi \in D$ be a generic point of
an irreducible component of $D$. Then $\dim(\mathcal{O}_{X, \xi}) = 1$.
\end{lemma}
...
\noindent
As in the case of pricipal divisors we have the following lemma.
