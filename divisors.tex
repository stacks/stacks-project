...
Morphisms, Lemma \ref{morphisms-lemma-affine-permanence}.
This allows us to disregard the condition on the
inclusion morphisms $X_i \to X$.
...
open subscheme of $X$. The morphism $U \to X$ is affine
as each $X_i \to X$, $i \in I'$ is affine by the same reasoning.
...
schemes affine over $U$; some details omitted.
It follows that
$$
U = \coprod\nolimits_{i \in I} (U_i \cap Z) \amalg
\coprod\nolimits_{(i, j) \in I \times J} (U_i \cap W_j)
$$
is a finite affine stratification with an obvious
partial ordering on $I \amalg I \times J$; some details omitted.
