...
Let $i : Z \to Y$ and $j : Y \to X$ be morphisms of schemes. Assume
that the sequence
$$
0 \to i^*\mathcal{C}_{Y/X} \to
\mathcal{C}_{Z/X} \to
...
affine. Write $S = \text{Spec}(A)$. Then $j : Y \to S$ defines an
isomorphism of $Y$ to the closed subscheme $\text{Spec}(A/I)$ for
some ideal $I \subset A$. The map
$i : Y = \text{Spec}(A/I) \to
\mathbf{A}^n_S = \text{Spec}(A[x_1, \ldots, x_n])$
