...
Let $\mathcal{F}$ be a quasi-coherent sheaf on $X$ which is flat over $Y$.
...
\section{Relative assasin}
\label{section-relative-assasin}
...
\begin{lemma}
\label{lemma-base-change-relative-assasin}
Let $f : X \to S$ be a morphism of schemes.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module.
...
\begin{lemma}
\label{lemma-relative-assasin-in-neighbourhood}
Let $f : X \to S$ be a morphism of schemes.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module.
...
\section{Relative weak assasin}
\label{section-relative-weak-assasin}
...
\begin{lemma}
\label{lemma-relative-weak-assasin-assassin-finite-type}
