...
$\mathcal{O}_{X'}(1)$ the canonical invertible $\mathcal{O}_{X'}$-module
which exists because $X'$ is the relative Proj of a quasi-coherent graded
...
$X'$ comes equipped with a closed immersion into $\mathbf{P}(\mathcal{I}_Z)$.
...
Let $X$ be a scheme. Let $\mathcal{I} \subset \mathcal{O}_X$ be a
quasi-coherent sheaf of ideals. If $\mathcal{I}$ is of finite type, then
the blowing up $b : X' \to X$ of $X$ in the ideal sheaf $\mathcal{I}$ is
