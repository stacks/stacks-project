...
The condition on $i$ means that the ideal sheaf of $Z$ in $\mathcal{O}_X$
...
$\mathcal{I}|_U = \mathcal{A}|_U$. Since $U$ is quasi-compact we
...
(Lemma \ref{lemma-blowing-up-gives-effective-Cartier-divisor})
we see that $\text{pr}_{S'}^{-1}E \subset X \times_S  \times_S S''$ is locally principal
...
of $S$ in $Z$ is the quotient $\mathcal{F}'$ of $\text{pr}_X^{-1}\mathcal{F}$
...
\begin{proof}
Let $\mathcal{I} \subset \mathcal{O}_X$ be the finite type ideal
such that $X'$ is the blowup of $X$ in $\mathcal{I}$ and such that
$U \cap V(\mathcal{I}) = \emptyset$.
Write $\mathcal{A} = \bigoplus_{n \geq 0} \mathcal{I}^n$ so that
$X' = \underline{\text{Proj}}(\mathcal{A})$.
Let $Z \subset X'$ be the finitely presented closed subscheme such that $X''$
is the blowup of $X'$ in $Z$ and such that $U \cap Z = \emptyset$.
...
are supported on $X \setminus U$ we see that
$V(\mathcal{J})$ is contained in $X \setminus U$. Thus also
$V(\mathcal{I}\mathcal{J}) \subset X \setminus U$. Moreover,
...
$\mathcal{I}\mathcal{J}$ which finishes the proof of the lemma.
...
$$
b^{-1}\mathcal{J} \mathcal{O}_{X'} = \mathcal{I}_E^d \mathcal{I}_Z
$$
...
blow up of $V$ in $\mathcal{I}$. By
Properties, Lemma \ref{properties-lemma-extend}
there exists a finite type quasi-coherent sheaf of ideals
$\mathcal{J} \subset \mathcal{O}_X$ whose restriction to $V$ is
$\mathcal{I}$. Thus the lemma is clear.
\end{proof}
...
$b$ factors through $b_i$ for $i = 1, \ldots, n$.
\end{lemma}
