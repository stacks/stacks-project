...
in Dualizing Complexes, Lemma \ref{dualizing-lemma-depth-dualizing-module},
...
is nonzero. Using Dualizing Complexes, Lemma
\ref{dualizing-lemma-dualizing} and the fact that
...
(in the form of Dualizing Complexes, Lemma
...
\begin{proof}
Follows immediately from Dualizing Complexes, Lemma
\ref{dualizing-lemma-local-CM}.
\end{proof}
...
(use Dualizing Complexes, Lemma
\ref{dualizing-lemma-dualizing-localize} and
...
(see Dualizing Complexes, Lemma \ref{dualizing-lemma-normalized-finite}
and Lemmas \ref{lemma-apply-CM} and \ref{lemma-gorenstein-CM}).
Thus we see that
