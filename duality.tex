...
the complexes
$$
R\Hom_X(L, a(K)) = R\Gamma(X, R\SheafHom(L, a(K))) =
R\Gamma(Y, Rf_*R\SheafHom(L, a(K)))
$$
and $R\Hom_Y(Rf_*L, K) = R\Gamma(Y, R\SheafHom(Rf_*L, a(K)))$
...
$\omega_{X/S} = a(\mathcal{O}_S)$. The second equality by
Lemma \ref{lemma-compare-with-pullback-flat-proper-noetherian}.
