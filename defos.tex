...
\item  the class
$\omega(K_0) \in
\text{Ext}^2_{\mathcal{O}_0}(K_0, K_0 \otimes_{\mathcal{O}_0} \mathcal{I})$
...
$$
o(\alpha_0) \in \text{Ext}^1_{\mathcal{O}_0}(K_0,
...
$$
\text{Ext}^{-1}_{\mathcal{O}_0}(K_0, K_0)
\longrightarrow
