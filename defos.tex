...
to $B'_2$ as $A$-algebra extensions of $B$ by $N$. Thus it suffices to
show that $B'_1$ corresponds via the bijection of
...
\begin{proof}
Special case of Lemmas \ref{lemma-extensions-of-algebras} and
\ref{lemma-extensions-of-algebras-functorial}.
\end{proof}
