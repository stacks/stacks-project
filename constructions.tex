...
$\mathfrak p' \subset S'$ is a graded prime ideal not containing
some homogeneous element $f \in S'_+$, then
$\mathfrak p = \{g \in S \mid g^d \in \mathfrak p'\}$
is a graded prime ideal of $S$ not containing $f$ (we omit the
verification that the formula defines a prime ideal)
whose image under $j$ is $\mathfrak p'$. In this way we see that
$j$ induces a homeomorphism $i : X \to X'$.
...
case the statement above translates into the statment that
the elements
$$
