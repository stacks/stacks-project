...
$\bigoplus_n \mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n)$, and
\item a morphism of graded $\mathcal{O}_S$-algebras
$$
\mathcal{A} \longrightarrow 
\pi_*\left(\bigoplus\nolimits_{n \geq 0}
\mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n)\right)
$$
\end{enumerate}
with the following properties:
\begin{enumerate}
...
and isomorphisms
$\varphi^*\mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n) \to
...
from $T$ into $\underline{\text{Proj}}_S(\mathcal{A})$ correspond
...
\medskip\noindent
This allows us to construct $\underline{\text{Proj}}_S(\mathcal{A})$
...
scheme $\underline{\text{Proj}}_S(\mathcal{A}) \to S$ is identified
...
\medskip\noindent
We omit the definition of the multiplication maps which turn
$\bigoplus_n \mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n)$
