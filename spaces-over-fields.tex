...
\noindent
Here are the obligatory lemmas connecting this with the corresponding
property for schemes over a field.
...
\medskip\noindent
If $X$ is geometrically irreducible and geometrically reduced
(or equivalently geometrically integral by
Lemma \ref{lemma-geometrically-integral}), then
...
for $p > 0$, see Cohomology on Spaces,
