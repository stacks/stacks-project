...
be locally of finite type. Assume $f$ is dominant (Morphisms of
Spaces, Definition \ref{spaces-morphisms-definition-dominant}).
The following are equivalent:
\begin{enumerate}
...
There exists an open $U \subset X$ such that $f^{-1}(U) \to U$
is an isomorphism.
\end{lemma}
