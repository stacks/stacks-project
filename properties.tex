...
Schemes, Section \ref{schemes-section-quasi-coherent}
and
Cohomology, Section \ref{cohomology-section-unbounded}.
...
$U = \bigoplus_{t \in T} \mathcal{F}_t$. We omit the detailed proof
that $U$ is a generator.
The assertions on limits and injectives follow from
Injectives, Lemmas
...
this uniquely identifies $Q(\mathcal{F})$.
The fact that $Q(\mathcal{F}) \to \mathcal{F}$ is an isomorphism
when $\mathcal{F}$ is quasi-cohernet is a formal consequences of the fact
