...
$$
T = \Spec(A[x_1, \ldots, x_n, x_{n + 1}]/(f_1 x_1 + \ldots + f_n x_n - 1))
$$
...
$A'[x_1, \ldots, x_n, x_{n + 1}]/(f'_1 x_1 + \ldots + f'_n x_n - 1)$.
We claim there is an isomorphism
$$
A'[y_1, \ldots, y_n] \longrightarrow
A'[x_1, \ldots, x_n, x_{n + 1}]/(f'_1 x_1 + \ldots + f'_n x_n - 1)
$$
The claim finishes the proof of the lemma.
To see the claim is true consider the $A'$-algebra homomorphism
sending $y_i$ to $x_i + a'_ix_{n + 1}$ for $i = 1, \ldots, n$.
It is an isomorphism with inverse given by the map sending $x_{n + 1}$ to
$f'_1 y_1 + \ldots + f'_n y_n$ and sending $x_i$ to
