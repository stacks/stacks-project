...
Since $\dim(\mathcal{O}_{S, s}) < \infty$ for any $s \in S$, see
Algebra, Proposition \ref{algebra-proposition-dimension}, we see that
every $t \in T$ is the specialization of an element of $T'_0$.
If $T'_0$ is infinite, then we choose a countable subset
$E' \subset T'_0$. By the argument in the first paragraph, the
generic points of the irreducible components of the closure of $E'$
are in $T'$. However, since one of these points specializes to
