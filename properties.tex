...
$U \subset X$ of $x$ such that $\mathcal{O}_X(U)$ is a
Noetherian Cohen-Macaulay ring.
\end{definition}

\begin{lemma}
\label{lemma-characterize-Cohen-Macaulay}
A locally Noetherian scheme is Cohen-Macaulay if and only if all of
