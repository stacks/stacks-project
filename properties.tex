...
\begin{lemma}
\label{lemma-normal-connected-irreducible}
Let $X$ be a locally Noetherian normal scheme.
The following are equivalent:
\begin{enumerate}
\item $X$ is connected,
\item $X$ is irreducible, and
\item $X$ is integral.
\end{enumerate}
\end{lemma}

\begin{proof}
Assume $X$ is connected. Let $Z_1, Z_2 \subset X$ be two closed
subsets such that $X = Z_1 \cup Z_2$. To be continued...
\end{proof}
