...
For a general $X$, let $X = \bigcup_{i = 1, \ldots, n} X_i$ be
a finite affine open covering. Let $T \subset X$ be an irreducible component.
...
which are integral normal schemes. There are only finitely
many (by Lemma \ref{lemma-Noetherian-topology} and
...
\noindent
These notions are not prominently defined in EGA.
