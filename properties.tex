...
$\mathcal{F} = \text{colim}_i\ \mathcal{F}_i$ as a directed
...
\begin{proof}
First we write $\mathcal{A} = \text{colim}_i\ \mathcal{F}_i$ as a directed
colimit of finitely presented quasi-coherent sheaves as in
Lemma \ref{lemma-directed-colimit-finite-presentation}.
...
$\mathcal{I}_i = \text{colim}_j\ \mathcal{F}_{i, j}$ where
...
Then it is clear that $\mathcal{A} = \text{colim}_{i, j}\ \mathcal{A}_{i, j}$.
\end{proof}
