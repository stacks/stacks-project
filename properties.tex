...
$\mathcal{F}'$ is a quasi-coherent sheaf of $\mathcal{O}_X$-modules.
\end{lemma}

\begin{proof}
The rule defining $\mathcal{F}'$ defines sub module of $\mathcal{F}$.
Hence we may work locally on $X$ to verify the other statements.
In other words we may assume $X = \Spec(A)$ and $\mathcal{F} = \widetilde{M}$.
