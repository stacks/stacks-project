...
\medskip\noindent
$f^*\mathcal{L}$ corresponds to an $A$-module $M$ and
...
$s$.  The $A$-modules $M$ and $N$ are locally free of rank
...
separated by Schemes, lemma
\ref{schemes-lemma-affine-separated}, and we conclude $f = g$.
\end{proof}

\begin{remark}
\label{remark-affine-s-opens-cover-family}
The proof of Lemma
\ref{lemma-affine-s-opens-cover-quasi-separated} reduces to
the case where the only line bundle of interest is
$\mathcal{L}$.  This may appear to be just a convenience,
but actually it is vital.  Consider a weaker set of
hypotheses: $X$ is a scheme, $\{\mathcal{L}_i\}_{i \in I}$
is a family of invertible $\mathcal{O}_X$-modules, and for
every point $x$ of $X$, there exists $i_1, \ldots, i_r \in
I$, $n_1, \ldots, n_r \ge 1$, and $s \in \Gamma(X,
\mathcal{L}_{i_1}^{\otimes n_1} \otimes \cdots \otimes
\mathcal{L}_{i_r}^{\otimes n_r})$ such that $x \in X_s$ and
$X_s$ is affine.  Then it is {\it not} the case that $X$
must be separated.

\medskip\noindent
Let $X$ be Example
\ref{schemes-example-affine-space-zero-doubled} with $n =
1$, the affine line with zero doubled.  We use the notation
...
$X_s = X_1$ and $X_t = X_2$.  Therefore this scheme
satisfies the hypotheses of the previous paragraph; but it
is not separated.
\end{remark}
