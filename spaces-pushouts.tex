...
Let $S$ be a scheme. Let $B$ be an algebraic space over $S$.
Let $\mathcal{I} \to (\Sch/S)_{fppf}$, $i \mapsto X_i$
be a diagram of algebraic spaces over $B$. Let $(W, X_i \to W)$
...
If there exists a fpqc covering $\{W_a \to W\}_{a \in A}$ such that
\begin{enumerate}
...
\end{enumerate}
then $W = \colim X_i$ in the category of algebraic spaces over $B$.
\end{lemma}

\begin{proof}
Namely, for an algebraic space $Y$ over $B$ a morphism $W \to Y$ over $B$
is the same thing as a collection of morphism $W_a \to Y$ which agree on
the overlaps $W_a \times_W W_b$ for all $a, b \in A$, see
...
\'Etale Cohomology, Section \ref{etale-cohomology-section-glueing-etale}
with the flexibility of algebraic spaces to get some descent statements
for \'etale morphisms of algebraic spaces.
...
Y_{spaces, \etale}
\longrightarrow
Y'_{spaces, \etale} \times_{E_{spaces, \etale}} \Sh(Z_{spaces, \etale})
$$
is an equivalence of categories.
\end{lemma}
