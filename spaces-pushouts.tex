...
algebraic space over $S$. Let $U$ be a separated algebraic space
of finite type over $B$. Let $V \to U$ be an \'etale morphism.
...
Let $U$ be a separated algebraic space of finite type over $B$.
...
extending $A$. Since $W$ is separated, we see that the choice
...
\end{reference}
Let $S$ be a scheme. Let $B$ be a quasi-compact and quasi-separated
algebraic space over $S$. Let $X \to B$ be a separated, quasi-compact morphism.
