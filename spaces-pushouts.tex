...
In order to single out those that are we need a lemma.
...
if and only if $A \to B$ have $P'$.
By More on Algebra, Lemmas \ref{more-algebra-lemma-faithful-descent}
and \ref{more-algebra-lemma-BL-flat} this is true for $P'$ equal to
``finite'' or ``flat''.
...
\ref{more-algebra-lemma-BL-faithful}.
...
is surjective by the previous result.
...
we conclude that $I$ is a finitely
generated ideal and we conclude $A \to B$ is flat and of finite
presentation.
...
We have to show the equalizer $E \to Y_1$ of $f$ and $g$ is an isomorphism.
...
$Y \to E$ over $Y$ and since $E \to Y$ is a monomorhism we conclude
