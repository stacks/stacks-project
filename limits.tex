...
Let $S = \lim_{i \in I} S_i$ be a limit of a directed
system of schemes over $S$ with affine transition morphisms
$f_{i'i} : S_{i'} \to S_i$
(Lemma \ref{lemma-directed-inverse-system-has-limit}).
...
by Lemma \ref{lemma-limit-affine}. To show that $S_i$ is affine
