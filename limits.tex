...
schemes over $S$ with affine transition morphisms. Assume $X_i$
quasi-compact and $X$ locally of finite type
over $S$. Then $X \to X_i$ is a closed immersion for $i$ large enough.
\end{lemma}

\begin{proof}
Choose $0 \in I$ and a finite affine open covering
$X_0 = V_{0, 1} \cup \ldots \cup V_{0, m}$ with the property that
$V_{0, j}$ maps into an affine open $U_j \subset S$.
Let $V_j \subset X$, resp.\ $V_{i, j} \subset X_i$ be the inverse image
of $V_{0, j}$ (for $i \geq 0$). It suffices to prove that $V_j \to V_{i, j}$
...
we see that $X' \to Y$ is proper. By
Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}
