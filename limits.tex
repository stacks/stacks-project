...
$X_s$ is affine and $\Spec(A) \to W$ factors through $X_s$
\end{lemma}
...
On the other hand, the extension $\kappa(x)/f.f.(R)$ is
a finitely generated field extension as $f$ is of finite type.
...
Cohomology on Schemes, Lemma \ref{coherent-lemma-relative-affine-vanishing}
