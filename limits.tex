...
\medskip\noindent
Assume $S$ is affine and (3) holds. Since $S$ affine we can apply
...
$X \times \mathbf{A}^n \to S \times \mathbf{A}^n$ is closed. By
Morphisms, Lemma \ref{morphisms-lemma-base-change-proper} the morphism
$$
...
$K$ of $X_0'$ that sits in the solid commutative diagram:
\begin{equation}
\xymatrix{
...
arrow lifts to a morphism into $X'$ over $S$.  By further composing
