...
\noindent
In this section we collect results of the following type:
Let $S = \lim S_i$ as in Lemma \ref{lemma-directed-inverse-system-has-limit}.
...
Notation and assumptions as in Situation \ref{situation-descent-property}.
If $f_0$ is separated, then $f_i$ is separated for some $i \geq 0$.
\end{lemma}
...
Is there an example to show that the finite type condition
for the morphisms $X_i \to S$ is necessary? Email
...
If $R \otimes_{R_i} A_i \to R \otimes_{R_i} B_i$ is flat, then
...
is a morphism of schemes of finite presentation over $S_i$.
...
Let $0 \in I$. Suppose that $\varphi_0 : X_0 \to Y_0$
is a morphism of schemes of finite presentation over $S_0$.
If the base change of $\varphi_0$ to $S$ is a monomorphism
then there exists an index $i \geq 0$ such that
the base change of $\varphi_0$ to $S_i$ is a monomorphism.
\end{lemma}

\begin{proof}
Recall that a morphism of schemes $V \to W$ is a monomorphism if and
only if the diagonal $V \to V \times_W V$ is an isomorphism
(Schemes, Lemma \ref{schemes-lemma-monomorphism}). Observe that
$X_0 \times_{Y_0} X_0$ is of finite presentation over $S_0$ because
morphisms of finite presentation are preserved under base change and
composition, see
Morphisms, Section \ref{morphisms-section-finite-presentation}.
...
\begin{proof}
The morphism $\varphi_0$ is of finite presentation, see
Morphisms, Lemma \ref{morphisms-lemma-finite-presentation-permanence}.
Hence $E = \varphi_0(X_0)$ is a constructible subset of $Y_0$, see
Morphisms, Lemma \ref{morphisms-lemma-chevalley}.
Since $\varphi_i$ is the base change of $\varphi_0$ by
$Y_i \to Y_0$ we see that the image of $\varphi_i$ is the
...
colimit of finite type $\mathcal{O}_S$-modules. Let
$\mathcal{A}_i \subset \mathcal{A}$ be the $\mathcal{O}_S$-subalgebra
generated by $\mathcal{F}_i$. Since the map of algebras
$\mathcal{O}_S \to \mathcal{A}$ is integral, we see that each $\mathcal{A}_i$
...
Let $S = \lim S_i$ be a directed limit of schemes with affine transition
morphisms. Let $0 \in I$ and let $X_0$ be a scheme over $S_0$.
Set $X = X_0 \times_{S_0} S$ and $X_i = X_0 \times_{S_0} S_i$. Assume
\begin{enumerate}
\item $S_0$ is quasi-compact and quasi-separated,
\item $X_0$ is quasi-compact and quasi-separated,
\item $X_0 \to S_0$ is locally of finite type,
\item $X$ is proper over $S$.
\end{enumerate}
Then there exists an $i$ such that $X_i$ is proper over $S$.
\end{lemma}

\begin{proof}
By Lemma \ref{lemma-eventually-separated} we see that $X_i \to S_0$
is separated for some $i$. It follows that $X_i \to S_i$ is separated
(Schemes, Lemma \ref{schemes-lemma-compose-after-separated}). Replacing
$0$ by $i$ we may assume that $X_0$ is separated over $S_0$.
Observe that $X_0 \to S_0$ is quasi-compact, see
Schemes, Lemma \ref{schemes-lemma-quasi-compact-permanence}.
By Lemma \ref{lemma-chow-finite-type} we can choose a diagram
$$
\xymatrix{
X_0 \ar[rd] & X_0' \ar[d] \ar[l]^\pi \ar[r] & \mathbf{P}^n_{S_0} \ar[dl] \\
& S_0 &
}
$$
where $X_0' \to \mathbf{P}^n_{S_0}$ is an immersion, and
$\pi : X_0' \to X_0$ is proper and surjective. Introduce
$X' = X_0' \times_{S_0} S$ and $X_i' = X_0' \times_{S_0} S_i$.
By Morphisms, Lemmas \ref{morphisms-lemma-composition-proper} and
\ref{morphisms-lemma-base-change-proper}
we see that $X' \to S$ is proper. By
Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}
it suffices to prove that $X'_i \to S_i$ is proper for some $i$.
By Lemma \ref{lemma-descend-closed-immersion-finite-presentation}
we find that $X'_i \to \mathbf{P}^n_{S_i}$ is
a closed immersion for $i$ large enough. Then $X'_i \to S_i$
...
Set $X = X_0 \times_{S_0} S$ and $X_i = X_0 \times_{S_0} S_i$.
Denote $\mathcal{F}$ and $\mathcal{F}_i$ the pullbacks of
$\mathcal{F}_0$ to $X$ and $X_i$. Assume
\begin{enumerate}
\item $S_0$ is quasi-separated,
\item $X_0$ is quasi-compact and quasi-separated,
\item $X_0$ is locally of finite type over $S_0$,
\item $\mathcal{F}_0$ is of finite type,
\item the scheme theoretic support of $\mathcal{F}$ is proper over $S$.
\end{enumerate}
Then the scheme theoretic support of $\mathcal{F}_i$ is proper over $S_i$
for some $i$.
\end{lemma}
...
homeomorphism. We conclude that $X \to S$ is proper as this is true for
$Z \to S$ by assumption, see
Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}.
By Lemma \ref{lemma-eventually-proper} we see that $X_i \to S$ is proper
for some $i$. Then it follows that the scheme theoretic support $Z_i$ of
$\mathcal{F}_i$ is proper over $S$ by
