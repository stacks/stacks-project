...
We have to show: (a) given morphisms $g_i, g'_i : T_i \to X$ over $S$ such that
...
again (applied to the rings corresponding to the affine schemes
$U_j, V_j, W_{j, i}$ and $W_j$
we can find for each $j$ an index $i_j \in I$ and a morphism
