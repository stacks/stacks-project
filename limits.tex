...
be a closed immersion. Assume $X_i$ quasi-compact and $Y$ locally of
finite type over $S$. Then $Y \to X_i$ is a closed immersion for $i$
large enough.
\end{lemma}
...
Let $V_j \subset Y$, resp.\ $U_{i, j} \subset X_i$ be the inverse image
of $U_{0, j}$ (for $i \geq 0$). It suffices to prove that $V_j \to U_{i, j}$
...
there is a closed immersion $X \to Y$ with $Y/S$ of
