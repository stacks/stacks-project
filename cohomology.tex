...
$$
\check{\mathcal{C}}(\mathcal{U}, \colim_i \mathcal{I}_i)
=
\colim_i \check{\mathcal{C}}(\mathcal{U}, \mathcal{I}_i)
$$
...
The induced map $\colim_i \mathcal{K}_i^\bullet \to \mathcal{G}^\bullet$
