...
$M_n = H^p(X, \mathcal{F}_n)$ satisfies the Mittag-Leffler condition.
\end{lemma}
...
$\bigoplus E_n \to F^n/F^{n + 1}$ is a homomorphism of graded modules;
details omitted. By assumption $\bigoplus E_n$ is generated by finitely many
homogeneous elements over $\bigoplus I^n/I^{n + 1}$.
