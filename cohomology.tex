...
\xrightarrow{\hbox{Lemma \ref{lemma-cech-cohomology}}}
H^p(X, \mathcal{F})
$$
...
\begin{proof}
In the proof of Topology, Lemma \ref{topology-lemma-make-spectral-space}
it was shown that $W = \lim U$ where the limit is over the quasi-compact
...
\medskip\noindent
The same proof works for part (2).
\end{proof}
...
Hence $X = U \coprod (X \setminus U)$ as a topological space
...
\alpha_{p, q}
\longmapsto
d_{\mathcal{I}}^p \circ \alpha_{p, q}
- (-1)^{p + q} \alpha_{p, q} \circ d_{\mathcal{L}}^{-q - 1}
$$
as in
...
$$
by Modules, Lemma \ref{modules-lemma-internal-hom}. The signs work
out by the computation given in the proof of
More on Algebra, Lemma \ref{more-algebra-lemma-compose}.
Since $\mathcal{L}^\bullet$ is K-flat, the complex
$\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{L}^\bullet)$
