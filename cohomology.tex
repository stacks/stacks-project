...
derived functor, is applied to a sheaf $\mathcal{F}$ or a complex
...
injective resolution of $\mathcal{F}$. In the same vein the phrase
...
$\mathcal{O}_X$-modules. This presheaf is customarily denote
...
with vanishing higher Cech cohology vanishes for all open coverings.
...
$$
R\Gamma(Y, Rf_*\mathcal{F}^\bullet) = R\Gamma(X, \mathcal{F}^\bullet)
$$
in $D^{+}(\text{Mod}(\mathcal{O}_Y(Y)))$.
