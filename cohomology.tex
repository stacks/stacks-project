...
\medskip\noindent
Let ${\mathcal F}^\bullet$ be a bounded below complex of sheaves of abelian
groups on $X$. We can often compute $H^n(X, {\mathcal F}^\bullet)$
using {\v C}ech cocycles. Namely, let ${\mathcal U} = \{U_i\}_{i\in I}$
be an open covering of $X$. Consider the associated total complex
to ${\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet)$ with degree $n$
term
$$
\text{Tot}^n({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))
=
...
$U_{i_0 \ldots i_{p + 1}}$. To check this is a complex, let $\alpha$ be an
element of degree $n$ in
$\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))$.
We compute:
\begin{align*}
...
(-1)^{j'}
\alpha_{i_0 \ldots \hat i_{j'} \ldots \hat i_j \ldots i_{p + 2}}
+ \\
&
\sum\nolimits_{j = 0}^{p + 2}
(-1)^j
...
(-1)^{j' - 1}
\alpha_{i_0 \ldots \hat i_j \ldots \hat i_{j'} \ldots i_{p + 2}}
+ \\
&
\sum\nolimits_{j = 0}^{p + 2}
(-1)^{j + (p + 1)}
...
a trivial sign change between the third and fourth terms, and
the usual argument for the first two double {\v C}ech terms.
...
$$
T_t : \text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))
\longrightarrow
\text{Tot}({\mathcal C}^\bullet({\mathcal V}, {\mathcal F}^\bullet)).
$$
defined by the rule
$$
...
Cech hypercohomology as the limit of the {\v C}ech cohomology groups
over all refinements via the maps $H^\bullet(T_t)$.

\medskip\noindent
Let ${\mathcal I}^\bullet$ be a bounded below complex of injectives.
Consider the map (\ref{equation-global-sections-to-cech}) for
the $\mathcal{I}^\bullet$ which is a map
$\Gamma(X, {\mathcal I}^\bullet) \to
\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal I}^\bullet))$.
This is a quasi-isomorphism of complexes of abelian groups
as follows from a spectral sequence argument on the double complex
${\mathcal C}^\bullet({\mathcal U}, {\mathcal I}^\bullet)$ using
...
The cohomology $H^n(X, {\mathcal F}^\bullet)$ is defined
to be $H^n(\Gamma(X, {\mathcal I}^\bullet))$. Thus
the map
$$
\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))
\longrightarrow
...
$$
induces maps
$H^n(\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet)))
\to H^n(X, {\mathcal F}^\bullet)$.
In the limit (over all open coverings of $X$) this induces a map of
{\v C}ech cohomology into the cohomology, which is often an isomorphism
and is always an isomorphism if we use hypercoverings.

\medskip\noindent
Consider the map
$\tau : \text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))
\to
\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))$
defined by
$$
...
\end{equation}
when $\alpha$ and $\beta$ are homogenous, see
Homology, Definition \ref{homology-definition-associated-simple-complex}.
...
\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}^\bullet))
\otimes_{\mathbf Z}
\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal G}^\bullet))
\right)
\longrightarrow
\text{Tot}(
{\mathcal C}^\bullet({\mathcal U},
...
$\text{Tot}(
{\mathcal C}^\bullet({\mathcal U}, {\mathcal F}_3^\bullet))$,
resp.\ $\text{Tot}(
{\mathcal C}^\bullet({\mathcal U}, {\mathcal G}_1^\bullet))$
representing $a_3$, resp.\ $b_1$. After refining $\mathcal{U}$ if necessary,
we can find cochains $\alpha_2$, resp.\ $\beta_2$ of
degree $n$, resp.\ $m$ in
$\text{Tot}(
{\mathcal C}^\bullet({\mathcal U}, {\mathcal F}_2^\bullet))$,
resp.\ $\text{Tot}(
{\mathcal C}^\bullet({\mathcal U}, {\mathcal G}_2^\bullet))$
...
$$
This means that $\alpha_1 = d(\alpha_2)$ is a degree $n + 1$ cocycle
in $\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal F}_1^\bullet))$
repesenting $\partial a_3$. Similarly, $\beta_3 = d(\beta_2)$ is
a degree $m + 1$ cocycle in
$\text{Tot}({\mathcal C}^\bullet({\mathcal U}, {\mathcal G}_3^\bullet))$
