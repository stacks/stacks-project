...
To prove the final assertion, we may choose $\mathcal{N}^\bullet$ to be
a shift of the cone on the map of complexes
$\mathcal{M}^\bullet \to \mathcal{K}^\bullet[1]$
and if we do so then the terms are direct sums of the terms of
$\mathcal{M}^\bullet$ and $\mathcal{K}^\bullet$,
whence we get the desired flatness
...
the south-east arrow factors uniquely over the south-west arrrow and
