...
$$
in $D(A)$. We omit the proof of commutativity. Thus the naive cup products
...
\medskip\noindent
More generally, suppose we have complexes of $\mathcal{O}_X$-modules
$\mathcal{K}^\bullet$ and $\mathcal{M}^\bullet$ and an open covering
$\mathcal{U} : X = \bigcup_{i \in I} U_i$. Then we have the following
huge diagram
$$
\xymatrix{
...
The diagram commutes in $D(A)$. If we ever need this,
we will carefully state and prove it here.
