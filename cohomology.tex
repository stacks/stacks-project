...
where $\mathcal{F}^\bullet$ be a bounded below complex of
...
\noindent
Our cup product is defined using the (more general) relative cup product
described in Remark \ref{remark-cup-product}. Let us explain this when
given a ringed space $(X, \mathcal{O}_X)$ and two objects
$K$ and $M$ of $D(\mathcal{O}_X)$. Set $A = \Gamma(X, \mathcal{O}_X)$.
...
$$
in $D(A)$. Consider the map of ringed spaces
$f : (X, \mathcal{O}_X) \to (pt, A)$ and use the construction of
Remark \ref{remark-cup-product}. Thus, via $D(pt, A) = D(A)$ and
$Rf_*(-) = R\Gamma(X, -)$ our map $\mu$ is adjoint to the map
$$
...
\medskip\noindent
Why do these two constructions give the same answer? Well, note that
if we think of $\xi$ and $\eta$ as maps $\xi : A[-i] \to R\Gamma(X, K)$
and $\eta : A[-j] \to R\Gamma(X, M)$, then
the tensor $\xi \otimes \eta$ given above is really the map
$$
A[-i - j] = A[-i] \otimes_A^\mathbf{L} A[-j]
\xrightarrow{\xi \otimes \eta}
R\Gamma(X, K) \otimes_A^\mathbf{L} R\Gamma(X, M)
$$
By the first definition above the cup product $\xi \cup \eta$ is the map
...
\medskip\noindent
In the situation above, suppose $K$ and $M$ are represented by complexes
$\mathcal{K}^\bullet$ and $\mathcal{M}^\bullet$ of $\mathcal{O}_X$-modules.
...
$$
This naive cup product is related to the cup product above by the
...
$$
in $D(A)$ (see lemma below). Thus the naive cup products
$H^i(X, \mathcal{K}^\bullet) \times H^j(X, \mathcal{M}^\bullet) \to
H^{i + j}(X,
\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{M}^\bullet))$
are compatible with the cuproducts defined above.

\medskip\noindent
More generally, suppose we have bounded below complexes of
$\mathcal{O}_X$-modules $\mathcal{K}^\bullet$ and $\mathcal{M}^\bullet$
and an open covering $\mathcal{U} : X = \bigcup_{i \in I} U_i$.
Then we have the following huge diagram
$$
\xymatrix{
...
$$
The horizontal arrows are the ones in Lemma \ref{lemma-cech-complex-complex}.
The diagram commutes in $D(A)$ (see lemma below).

\begin{lemma}
\label{lemma-diagrams-commute}
The diagram relating the cup product and the naive cup product
commutes. The diagram relating the cup product with the cup product
(\ref{equation-needs-signs}) on {\v C}ech complexes commutes.
\end{lemma}

\begin{proof}
Consider the diagram relating the cup product and the naive cup product.
Recall that $f : (X, \mathcal{O}_X) \to (pt, A)$ is the projection
to a point. By construction of $\mu$ the composition clockwise
$$
\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
\Gamma(X, \mathcal{M}^\bullet)
\to
R\Gamma(X, \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet))
...
$$
a : Lf^*\left(\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
\Gamma(X, \mathcal{M}^\bullet)\right)
\to
\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet)
...
$$
b :
Lf^*\Gamma(X, \mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{M}^\bullet)
\to
\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet)
$$
Hence it suffices to see that $a$ is the composition of $b$ with
$Lf^*$ applied to the composition of
$\Gamma(X, \mathcal{K}^\bullet) \otimes_A^\mathbf{L}
\Gamma(X, \mathcal{M}^\bullet) \to \Gamma(X, \mathcal{K}^\bullet)
\otimes_A \Gamma(X, \mathcal{M}^\bullet)$ with $\mu'$.
We omit the details.

\medskip\noindent
Consider the diagram relating the cup product with the cup product
(\ref{equation-needs-signs}) on {\v C}ech complexes. Choose
...
Lemma \ref{lemma-flasque-acyclic},
Derived Categories, Lemma \ref{derived-lemma-leray-acyclicity},
Lemma \ref{lemma-flasque-acyclic-cech}, and finally
Homology, Lemma \ref{homology-lemma-double-complex-gives-resolution}
applied to the double complex
$\check{\mathcal{C}}^\bullet({\mathcal U}, \mathcal{K}^\bullet)$.
Hence the commutativity of the diagram involving
(\ref{equation-needs-signs}) follows from the already
commutativity proven in the first paragraph of the proof.
\end{proof}
