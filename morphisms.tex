...
\begin{proof}
Let $f : X \to S$ be flat of finite presentation.
To show $f$ is open it suffices to show that for any
affine opens $U \subset X$, $V \subset S$ with $f(U) \subset V$
the induced morphism $U \to V$ is open. This follows
from Algebra, Proposition \ref{algebra-proposition-fppf-open}.
\end{proof}
