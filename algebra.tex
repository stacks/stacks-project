...
\item If $M$ is an $R$-module and $M_{\mathfrak p}$ is a flat
$R_{\mathfrak p}$-module for all $\mathfrak p$, then $M$ is a flat
$R$-module.
...
(with $\mathfrak p = A \cap \mathfrak q$) for all primes $\mathfrak q$ of $A$.
\end{enumerate}
\end{lemma}
...
(with $\mathfrak p = A \cap \mathfrak q$) for all primes $\mathfrak q$ of $A$.
Let $I \subset R$ is an ideal.
Consider the map $I \otimes_R M \to M$.
