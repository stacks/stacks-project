...
\begin{enumerate}
\item[(a)] $k' \otimes_k A$ is a normal ring
for every field extension $k \subset k'$,
\item[(b)] $k' \otimes_k A$ is a normal ring
for every finitely generated field extension $k \subset k'$, and
\item[(c)] $k' \otimes_k A$ is a normal ring
...
\begin{proof}
It is clear that (a) $\Rightarrow$ (b) $\Rightarrow$ (c).

\medskip\noindent
Assume (b) and let $k \subset k'$ be any field extension.
...
\medskip\noindent
Assume (c) and let $k \subset K$ be a finitely generated field extension.
...
Step 1: $k' \otimes_k A$ is a normal ring because we assumed (c).
