...
for all primes $\mathfrak q$ of $A$ (with notation as in the last
statement of the lemma). Let $I \subset R$ be an ideal.
...
\medskip\noindent
The other statements follow from the last statement.
\end{proof}
