...
Then the base change $R' \to S' = R' \otimes_R S$ is smooth as well.
\end{lemma}
...
$S = S'_{g'}$ for some element $g' \in S'$, see
Lemma \ref{lemma-disjoint-decomposition}. Note that the determinant
$$
g =
\det 
\left(
...
\item the $S \otimes_R \kappa(\mathfrak p)$ is smooth
