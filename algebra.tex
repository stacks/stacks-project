...
Let $R$ be a ring. Let $f \in R[x]$ be a monic polynomial.
Let $\mathfrak p$ be a prime of $R$.
Let $f \bmod \mathfrak p = \overline{g} \overline{h}$
be a factorization of the image of $f$ in $\kappa(\mathfrak p)[x]$.
If $\gcd(\overline{g}, \overline{h}) = 1$, then there exists
an etale ring map $R \to R'$, a prime $\mathfrak p' \subset R'$
lying over $\mathfrak p$, and a factorization $f = g h$ in
$R'[x]$ such that $\kappa(\mathfrak p) = \kappa(\mathfrak p')$ and
$\overline{g} = g \bmod \mathfrak p'$,
...
Claim: (a) $\mathfrak q'_1, \ldots, \mathfrak q'_n$
are pairwise distinct, and (b) there exists an ideal $I \subset S'$
not contained in $\mathfrak q_i$ (any $i$)
such that any prime $\mathfrak q$ of $S$ lying
over $\mathfrak p$ at which $R \to S$ is not quasi-finite we have
$I \subset \mathfrak q$.
...
$\mathfrak q'_1 \not = \mathfrak q'_2$ as desired. Thus (a) holds.
To prove (b) let $I = (g_1, \ldots, g_n) \subset S'$.
Then $I \subset S'$ is
not contained in $\mathfrak q_i$ for any $i$.
