...
$g \not \in \mathfrak q$ such that $R'_g \cong S_g$.
Since $S$ is finitely generated over $R$ we may
pick finitely many elements $y_1,\ldots,y_N$ of $R'$ such that
the $R$-sub algebra $R'' \subset R'$ generated by $x_1,\ldots,x_{n-1},
y_1,\ldots,y_N,g$ has the property $R''_g \cong S_g$. (Surjectivity
because of picking enough $y_i$, injectivity because
