...
maps injectively into $f.f.(S) = K[x]/(g)$.
...
to constructible sets. Hence $f(E \cap V)$ is
constructible in $U$ and contains $\xi$.
...
the image of $f$ in the localization $R_{\mathfrak p}$ is zero. In other
