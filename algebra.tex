...
\item $(S/\mathfrak p)_{\mathfrak p} \not = 0$, and
...
$\mathfrak p$ of $R$. We define the {\it relative dimension
of $S/R$ at $\mathfrak q$}, denoted
$\dim_{\mathfrak q}(S/R)$, to be the dimension
of the local ring at $\mathfrak q$ of the
fibre $S \otimes_R \kappa(\mathfrak p)$. We let
$\dim(S/R)$ be the maximum of $\dim_{\mathfrak q}(S/R)$
...
$$
R \to R[y_1,\ldots, y_n] \to B \to S
$$
\end{lemma}

\begin{proof}
The ring $\overline{S} = S \otimes_R \kappa(\mathfrak p)$ is of finite
type over $\kappa(\mathfrak p)$. Let $\{ \mathfrak q_j \}$ be
the finite set of minimal primes of this ring, see
Lemma \ref{lemma-Noetherian-irreducible-components}.
Let $\overline{\mathfrak q}$ be the prime of $\overline{S}$
corresponding to $\mathfrak q$. Note that
$\overline{S}_{\overline{\mathfrak q}}$, which has dimension
$\leq n$ by assumption, surjects onto
$(\overline{S}/\mathfrak q_i)_{\overline{\mathfrak q}}$
for those $i$ such that $\mathfrak p$


Write $S = R[x_1,\ldots,x_N]/I$ for some ideal $I$. 
