...
\begin{lemma}
\label{lemma-artinian-product-local}
Any Artinian ring is the product of its localizations
...
as in the proof of \ref{lemma-artinian-radical-nilpotent}.
...
By Lemma \ref{lemma-artinian-product-local}
...
\begin{remark}
If $S$ is still Noetherian bu $S$ is not generated in degree $1$,
...
we denote $d(M)$ the degree of any of the numerical polynomials
$\varphi_{I,M}$ above.
\end{definition}
