...
Property (1) is clear.
By Lemma \ref{lemma-criterion-normal} we see that $R$
has property $(S_2)$. Hence $R/xR$ has property $(S_1)$
(use Lemma \ref{lemma-depth-in-ses}).
Thus $R/xR$ has no embedded primes by
Lemma \ref{lemma-criterion-no-embedded-primes}.
Thus property (2) holds. This also implies each associated
