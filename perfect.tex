...
Hence parts (2) and (3) follow from
...
\noindent
Now we come to characterizations of pseudo-coherent complexes
...
is $(b, c)_*\mathcal{O}_W$ by Lemma \ref{lemma-compare-base-change}.
...
Using Lemma \ref{lemma-cohomology-base-change}
we can rewrite this as
$$
...
By Lemma \ref{lemma-pseudo-coherent-on-projective-space}
...
almost by definition (for a precise statement see
More on Morphisms, Lemma
