...
$$
is commutative where the top horzontal arrow is the map from the lemma,
$\mu$ is the multplication map, and $a$ comes from the adjunction map
...
Since $X$ and $S'$ are tor indepdent over $S$, we can apply
...
\ref{more-morphisms-lemma-geometrically-reduced-constructible} and
\ref{more-morphisms-lemma-nr-geom-irreducible-components-constructible}
the set $E \subset S_i$ of points where the fibres of
$f_i$ are geometrically integral is constructible.
Since $S \to S_i$ maps into $E$ by assumption (and
More on Morphisms, Lemmas
\ref{more-morphisms-lemma-base-change-fibres-geometrically-reduced} and
...
By Lemma \ref{lemma-flat-proper-perfect-direct-image-general}
