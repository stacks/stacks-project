...
\begin{proof}
Since $X$ is Noetherian, it is in particular quasi-compact.
Hence being bounded can be checked on the members of a finite
affine open covering of $X$. This remark, plus similar remarks
on having coherent cohomology sheaves and being perfect, shows
that it suffices to prove the lemma when $X$ is affine.
This case translated via Lemma \ref{lemma-perfect-affine}
into More on Algebra, Lemma \ref{more-algebra-lemma-regular-perfect}.
\end{proof}
...
\medskip\noindent
The discusion preceding the lemma shows that we have an equivalence of
ringed topoi
