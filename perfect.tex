...
\begin{proof}
Using Cohomology of Sheaves, Lemma \ref{cohomology-lemma-dual-perfect-complex}
...
we obtain (1) by setting $L_n = E_n^\vee$, see Cohomology of Sheaves,
Lemma \ref{cohomology-lemma-dual-perfect-complex}.
