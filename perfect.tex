...
\begin{proof}
In this proof we will denote $i_X : D(\textit{QCoh}(\mathcal{O}_X))
\to D_{\textit{QCoh}}(\mathcal{O}_X)$ the functor of the lemma.
...
functor $\textit{QCoh}(\mathcal{O}_X) \to \textit{Mod}(\mathcal{O}_X)$
...
$j_* : \textit{QCoh}(\mathcal{O}_X) \to \textit{QCoh}(\mathcal{O}_Y)$
fits into a commutative diagram
$$
\xymatrix{
D(\textit{QCoh}(\mathcal{O}_U)) \ar[d]_\Phi \ar[r]_{i_U} &
D_{\textit{QCoh}}(\mathcal{O}_U) \ar[d]^{Rj_*} \\
