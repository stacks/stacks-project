...
Assume that
\begin{enumerate}
\item for any morphism of schemes $S' \to S$ which is
flat, flat of finite presentation, etale, smooth or syntomic
depending on whether $\tau$ is fpqc, fppf, etale, smooth, or syntomic
property $\mathcal{P}$ for $S$ implies property $\mathcal{P}$ for $S'$,
\item the property is local in the Zariski topology, and
