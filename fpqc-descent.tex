...
if and only if it holds for any arrow $S'$ isomorphic to $S$.
...
\medskip\noindent
First we prove assumption (1) of Lemma \ref{lemma-descending-properties}
holds for ``being reduced'', i.e., we show this property is local
in the Zariski topology. This is clear from the definition,
see Schemes, Definition \ref{schemes-definition-reduced}.

\medskip\noindent
Next, we have to show that if $S' \to S$ is a smooth morphism of affines
and $S$ is reduced, then $S'$ is reduced. This is
Algebra, Lemma \ref{algebra-lemma-reduced-goes-up}.
This proves (2) of Lemma \ref{lemma-descending-properties}.
...
This proves (3) of Lemma \ref{lemma-descending-properties} and we win.
\end{proof}
...
\medskip\noindent
First we prove assumption (1) of Lemma \ref{lemma-descending-properties}
holds for ``being normal'', i.e., we show this property is local
in the Zariski topology. This is clear from the definition,
