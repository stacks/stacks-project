...
$\NL_{\mathcal{C}/\mathcal{A}} \to \NL_{\mathcal{C}/\mathcal{A}}$.
...
$$
and the zero map. For $c_1$ we use the functoriality described
...
which produces a canonical six term exact sequence
$$
H^{-1}(f^*\NL_{Y/Z}) \to H^{-1}(\NL_{X/Z}) \to H^{-1}(\NL_{X/Y}) \to
H^0(f^*\NL_{Y/Z}) \to H^0(\NL_{X/Z}) \to H^0(\NL_{X/Y}) \to 0
$$
of cohomology sheaves.
\end{lemma}
