...
\begin{lemma}
\label{lemma-union-finite-type}
Let $X$ be a ringed space.
Let $I$ be a directed partially ordered set and
...
be the colimit. Assume (a) $\mathcal{F}$
is a finite type $\mathcal{O}_X$-module and (b) $X$ is quasi-compact.
