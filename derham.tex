...
in addition that $Z \to X$ and
$Z' \to X'$ are Koszul regular immersions.
Then the diagram
$$
\xymatrix{
...
fibres are nonempty and equidimensional of dimension $d$.
\end{situation}
...
$$
t : Rf_*\Omega^d_{X/S}[d] \longrightarrow \mathcal{O}_S
$$
unique up to precomposing by multiplication by a unit of
...
there exists an isomorphism $\omega^\bullet_{X/S} \cong \Omega^d_{X/S}[d]$
...
$\Omega^p_{X/S} \otimes_{\mathcal{O}_X} \Omega^{d - p}_{X/S} \to
\Omega^d_{X/S}$ exhibits an isomorphism $\Omega^p_{X/S} \cong
\SheafHom_{\mathcal{O}_X}(\Omega^{d - p}_{X/S}, \Omega^d_{X/S})$
...
$$
Rf_*\Omega^d_{X/S}[d] \cong
R\SheafHom_{\mathcal{O}_S}(f_*\mathcal{O}_X, \mathcal{O}_S)
\oplus R\SheafHom_{\mathcal{O}_X}(P, \mathcal{O}_X)
$$
This shows that $R^df_*\Omega^d_{X/S}$ is finite locally free and
that we obtain a perfect $\mathcal{O}_S$-bilinear pairing
$$
f_*\mathcal{O}_X \times R^df_*\Omega^d_{X/S} \longrightarrow \mathcal{O}_S
$$
using $t$.
This implies that any $\mathcal{O}_S$-linear map
$t' : R^df_*\Omega^d_{X/S} \to \mathcal{O}_S$ is of the form
$t' = t \circ g$ for some
...
$\text{d} : R^df_*\Omega^{d - 1}_{X/S} \to R^df_*\Omega^d_{X/S}$
is zero.
\end{lemma}
...
The $\mathcal{O}_S$-module $R^df_*\Omega^d_{X/S}$ is finite locally free
...
$$
\text{d} :
H^d(X_\eta, \Omega^{d - 1}_{X_\eta/\kappa(\eta)})
\longrightarrow
H^d(X_\eta, \Omega^d_{X_\eta/\kappa(\eta)})
$$
...
$\text{d} : R^df'_*\Omega^{d - 1}_{X/S'} \to R^df'_*\Omega^d_{X/S'}$.
...
of $D(A)$ is perfect of tor amplitude in $[1, d]$. As in the proof
of Lemma \ref{lemma-relative-duality-hodge} we see that
$H^d(X, \Omega^d_{X/S})$ is a locally free $A$-module of rank $1$
...
Of course $Z \to X$ has codimension $d$. Thus by
Remark \ref{remark-how-to-use}
we can consider the map
$$
\gamma^{0, 0} : H^0(Z, \Omega^0_{Z/S}) \longrightarrow H^d(X, \Omega^d_{X/S})
$$
and we set $\xi = \gamma^{0, 0}(1) \in H^d(X, \Omega^d_{X/S})$.
...
\ref{limits-lemma-higher-direct-images-zero-above-dimension-fibre})
we see that
$H^d(X, \Omega^d_{X/S}) \otimes_A k = H^d(X_k, \Omega^d_{X_k/k})$
for any ring map $A \to k$. By the compatibility of
the construction of $\xi$ with base change,
see Lemma \ref{lemma-gysin-transverse},
we see that the image of $\xi$ in $H^d(X_k, \Omega_{X_k/k})$
...
\medskip\noindent
Let $\theta \in H^d(X, \Omega^{d - 1}_{X/S})$. We have to show that
$\text{d}(\theta)$ is zero in $H^d(X, \Omega^d_{X/S})$.
...
and hence a regular and Koszul immersion of codimension $d$ as well.
Thus we can consider the maps
$$
\gamma^{p, q} :
H^q(X, \Omega^p_{X/S})
\longrightarrow
H^{q + d}(X \times_S X, \Omega^{p + d}_{X \times_S X/S})
$$
of Remark \ref{remark-how-to-use}. Consider the image
$$
\gamma^{d - 1, d}(\theta) \in
H^{2d}(X \times_S X, \Omega^{2d - 1}_{X \times_S X})
$$
By Lemma \ref{lemma-de-rham-complex-product} we have
$$
\Omega^{2d - 1}_{X \times_S X} =
\Omega^{d - 1}_{X/S} \boxtimes \Omega^d_{X/S} \oplus
\Omega^d_{X/S} \boxtimes \Omega^{d - 1}_{X/S}
$$
...
we see that
$$
H^{2d}(X \times_S X, \Omega^{d - 1}_{X/S} \boxtimes \Omega^d_{X/S}) =
H^d(X, \Omega^{d - 1}_{X/S}) \otimes_A H^d(X, \Omega^d_{X/S})
$$
and
$$
H^{2d}(X \times_S X, \Omega^d_{X/S} \boxtimes \Omega^{d - 1}_{X/S}) =
H^d(X, \Omega^d_{X/S}) \otimes_A H^d(X, \Omega^{d - 1}_{X/S})
$$
...
we can write
$$
\gamma^{d - 1, d}(\theta) = \theta_1 \otimes \xi + \xi \otimes \theta_2
$$
with $\theta_1, \theta_2 \in H^d(X, \Omega^{d - 1}_{X/S})$.
Arguing in exactly the same manner we can write
$$
\gamma^{d, d}(\xi) = b \xi \otimes \xi
$$
in
$H^{2d}(X \times_S X, \Omega^{2d}_{X \times_S X/S}) =
H^d(X, \Omega^d_{X/S}) \otimes_A H^d(X, \Omega^d_{X/S})$
...
Namely, by Lemma \ref{lemma-gysin-differential-global}
we have
$$
\gamma^{d, d}(\text{d}(\theta)) = \text{d}(\gamma^{d - 1, d}(\theta))
$$
...
a \xi \otimes \xi + (-1)^d a \xi \otimes \xi
$$
The right most equality comes from the fact that the map
$\text{d} : \Omega^{2d - 1}_{X \otimes_S X/S} \to \Omega^{2d}_{X \times_S X/S}$
by Lemma \ref{lemma-de-rham-complex-product}
is the sum of the differential
$\text{d} \boxtimes 1 : \Omega^{d - 1}_{X/S} \boxtimes \Omega^d_{X/S}
\to \Omega^d_{X/S} \boxtimes \Omega^d_{X/S}$
and the differential
$(-1)^d 1 \boxtimes \text{d} : \Omega^d_{X/S} \boxtimes \Omega^{d - 1}_{X/S}
\to \Omega^d_{X/S} \boxtimes \Omega^d_{X/S}$. Please see discussion in
...
we conclude
$$
a = a + (-1)^d a \Rightarrow a = 0
$$
as desired.

\medskip\noindent
In the rest of the proof we prove the claim above. Let us denote
$\eta = \gamma^{0, 0}(1) \in H^d(X \times_S X, \Omega^d_{X \times_S X/S})$.
Since $\Omega^d_{X \times_S X/S} =
\bigoplus_{p + p' = d} \Omega^p_{X/S} \boxtimes \Omega^{p'}_{X/S}$
we may write
$$
\eta = \eta_0 + \eta_1 + \ldots + \eta_d
$$
where $\eta_p$ is in
$H^d(X \times_S X, \Omega^p_{X/S} \boxtimes \Omega^{d - p}_{X/S})$.
For $p = 0$ we can write
\begin{align*}
H^d(X \times_S X, \mathcal{O}_X \boxtimes \Omega^d_{X/S})
& =
H^d(R\Gamma(X, \mathcal{O}_X) \otimes_A^\mathbf{L}
R\Gamma(X, \Omega^d_{X/S})) \\
& =
A \otimes_A H^d(X, \Omega^d_{X/S}) \oplus
H^d(P \otimes_A^\mathbf{L} R\Gamma(X, \Omega^d_{X/S}))
\end{align*}
...
Lemma \ref{lemma-gysin-transverse}. This means that
$$
...
$$
with $\eta'_0 \in H^d(P \otimes_A^\mathbf{L} R\Gamma(X, \Omega^d_{X/S})$.
In exactly the same manner for $p = d$ we can write
\begin{align*}
H^d(X \times_S X, \Omega^d_{X/S} \boxtimes \mathcal{O}_X)
& =
H^d(R\Gamma(X, \Omega^d_{X/S}) \otimes_A^\mathbf{L}
R\Gamma(X, \mathcal{O}_X)) \\
& =
H^d(X, \Omega^d_{X/S}) \otimes_A A \oplus
H^d(R\Gamma(X, \Omega^d_{X/S}) \otimes_A^\mathbf{L} P)
\end{align*}
and we can write
$$
\eta_d = \xi \otimes 1 + \eta'_d
$$
with $\eta'_d \in H^d(R\Gamma(X, \Omega^d_{X/S}) \otimes_A^\mathbf{L} P)$.
...
$$
(P \otimes_A^\mathbf{L} R\Gamma(X, \Omega^d_{X/S}))[-d]
\xrightarrow{\theta \otimes 1}
R\Gamma(X, \Omega^{d - 1}_{X/S}) \otimes_A^\mathbf{L}
R\Gamma(X, \Omega^d_{X/S})
$$
...
$$
\theta : P[-d] \to R\Gamma(X, \Omega^{d - 1}_{X/S})
\quad\text{and}\quad
1 : R\Gamma(X, \Omega^d_{X/S}) \to R\Gamma(X, \Omega^d_{X/S})
$$
...
a perfect complex of tor amplitude in $[d + 1, 2d]$ to a complex
with cohomology only in degrees $0, 1, \ldots, d$, see
More on Algebra, Lemma \ref{more-algebra-lemma-splitting-unique}.
A similar argument works to show the vanishing of
$(1 \otimes \theta) \cup \eta'_d$. Finally, 
in exactly the same manner we obtain
$$
b \xi \otimes \xi = \gamma^{d, d}(\xi) = (\xi \otimes 1) \cup \eta_0
$$
...
and equidimensional of dimension $d$. There exists an
$\mathcal{O}_S$-module map
$$
t : R^{2d}f_*\Omega^\bullet_{X/S} \longrightarrow \mathcal{O}_S
$$
unique up to precomposing by multiplication by a unit of
...
$$
(Section \ref{section-hodge-to-de-rham}), the vanishing
of $\Omega^i_{X/S}$ for $i > d$, the vanishing in for example Limits, Lemma
\ref{limits-lemma-higher-direct-images-zero-above-dimension-fibre}
...
and $R^df_*\Omega^d_{X/S} = R^{2d}f_*\Omega^\bullet_{X/S}$.
More precisesly, these identifications come from the maps
of complexes
$$
\Omega^\bullet_{X/S} \to \mathcal{O}_X[0]
\quad\text{and}\quad
\Omega^d_{X/S}[-d] \to \Omega^\bullet_{X/S}
$$
Let us choose $t : R^{2d}f_*\Omega_{X/S} \to \mathcal{O}_S$
...
\Omega^\bullet
$$
For every integer $p = 0, 1, \ldots, d$ this map annihilates the subcomplex
$\text{Tot}(\sigma_{> p} \Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq d - p} \Omega^\bullet)$ for degree reasons.
Hence we find that the restriction of $\wedge$ to the subcomplex
$\text{Tot}(\Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\geq_{d - p}\Omega^\bullet)$ factors through a map of complexes
$$
\gamma_p :
...
\otimes_{\mathcal{O}_S}^\mathbf{L}
Rf_*\sigma_{\geq d - p}\Omega^\bullet
\longrightarrow
Rf_*\Omega^\bullet
$$
We will prove by induction on $p$ that these cup products via $t$
induce perfect pairings between $Rf_*\sigma_{\leq p} \Omega^\bullet$
and $Rf_*\sigma_{\geq d - p}\Omega^\bullet[2d]$. For $p = d$
this is the assertion of the proposition.
...
\quad\text{and}\quad
Rf_*\sigma_{\geq d - p}\Omega^\bullet[2d] = Rf_*(\Omega^d[-d])[2d] =
Rf_*\Omega^d[d]
$$
In this case we simply obtain the pairing
between $Rf_*\mathcal{O}_X$ and $Rf_*\Omega^d[d]$ of
...
\xymatrix{
Rf_*\sigma_{\geq d - p}\Omega^\bullet \\
Rf_*\Omega^{d - p - 1}[-d + p + 1] \ar[u]_{a'} \\
Rf_*\sigma_{\geq d - p - 1}\Omega^\bullet \ar[u]_{b'} \\
Rf_*\sigma_{\geq d - p}\Omega^\bullet \ar[u]_{c'} \\
Rf_*\Omega^{d - p - 1}[-d + p + 1] \ar[u]_{d'}
}
$$
