...
By Derived Categories of Schemes, Lemma
\ref{perfect-lemma-extended-alternating-represented}
...
$\text{d}f'_1 \wedge \ldots \wedge \text{d}f'_c$.
\end{proof}
...
for $i = 0, \ldots, c - 1$. This holds for example if $X \to S$ is smooth
and $Z \to X$ is a regular immersion (or a Koszul regular immersion).
Then we can use the maps $\gamma^p$ of the lemma to construct maps
$$
...
\begin{proof}
The map $\gamma^0$ is adjoint to a map
$$
...
Hence the $k$-linear dual of the composition of the maps in the statement
...
This we may do in any neighbourhood $U$ of the points $x$. Choose $U$
