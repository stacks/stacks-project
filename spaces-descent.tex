...
to prove this. Assumptions (1) and (2) of that lemma follow from
Morphisms of Spaces,
Lemma \ref{spaces-morphisms-lemma-characterize-closed-immersion}.
...
to prove this. Assumptions (1) and (2) of that lemma follow from
Morphisms of Spaces,
Lemmas \ref{spaces-morphisms-lemma-characterize-closed-immersion} and
\ref{spaces-morphisms-lemma-characterize-quasi-compact}.
Consider a cartesian diagram
$$
\xymatrix{
X' \ar[r] \ar[d] & X \ar[d] \\
