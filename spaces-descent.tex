...
\item[(d)] there exists a smooth covering $\{Y_i \to Y\}_{i \in I}$ such
that each base change $Y_i \times_Y X \to Y_i$ has $\mathcal{P}$,
\item[(e)] there exists a smooth covering $\{X_i \to X\}_{i \in I}$ such
that each composition $X_i \to Y$ has $\mathcal{P}$,
\item[(f)] there exists a smooth covering $\{Y_i \to Y\}_{i \in I}$ and
...
As (a) is now equivalent to (d) and (e) it follows that
(a) equivalent to (f).
