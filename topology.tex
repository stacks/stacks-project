...
\begin{proof}
Proof of (1). Assume $E$ is stable under specialization. Let
$x \in \overline{E}$. Let $\{U_i\}$ be the set of quasi-compact open
neighbourhoods of $x$. A finite intersection of the $U_i$ is another one.
The intersection $U_i \cap E$ is nonempty for all $i$. Since $E$ is a
spectral space itself,
Lemma \ref{lemma-constructible-hausdorff-quasi-compact}
applies to it. Since $U_i \cap E$ is closed in the constructible
topology, we see that $\bigcap (U_i \cap E)$ is nonempty
(Lemma \ref{lemma-intersection-closed-in-quasi-compact}).
...
$x$ is a specialization of a point of $E$, hence $x \in E$
by assumption.

\medskip\noindent
Proof of (2). Assume $E$ is stable under generalization.
...
Hence the complement is closed by (1), i.e., $E$ is open.
\end{proof}
