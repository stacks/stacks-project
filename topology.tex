...
$X_0$ is quasi-compact (Lemma \ref{lemma-closed-points-quasi-compact})
and $\pi_0(X)$ is profinite (Lemma \ref{lemma-spectral-pi0}).
Picture
$$
\xymatrix{
...
a homeomorphism by Lemma \ref{lemma-bijective-map}.
Given an open covering $X = \bigcup U_i$, we get an open covering
$\pi_0(X) = \bigcup f(X_0 \cap U_i)$. By
Lemma \ref{lemma-profinite-refine-open-covering}
...
has at most one closed point. By Lemma \ref{lemma-quasi-compact-closed-point}
...
point of $X_0$. Then $X_0$ is a spectral space (Lemma \ref{lemma-spectral-sub})
consisting of closed points, hence profinite
(Lemma \ref{lemma-characterize-profinite-spectral}).
...
$X_0 \subset U \cup V$ (use Lemma \ref{lemma-quasi-compact-closed-point}).
...
surjective by Lemma \ref{lemma-quasi-compact-closed-point} and the
fact that connected components are closed.
