...
$S \subset E$ is finite. With this topology the action of
$\text{Map}(E, E) \times E \to E$ and the composition
$\text{Map}(E, E) \times \text{Map}(E, E) \to \text{Map}(E, E)$
are continuous. Finally, if $\text{Aut}(E) \subset \text{Map}(E, E)$
...
\item $G$ is a limit of a diagram finite discrete topological groups,
