...
and $V_{j_0} \cap \ldots \cap V_{j_p}$
...
obviously satisfy $V_{j_0, k} \cap V_{j_1} \ldots \cap V_{j_p} \subset
W_{\alpha(j_0) \ldots \alpha(j_p), k}$.
Set $J' = J \cup K$. For $j \in J$ set $V'_j = V_j$ if $j \not = j_0$
and set $V'_{j_0} =
V_{j_0} \setminus  \overline{V_{j_1}} \cup \ldots \cup \overline{V_{j_p}}$.
...
$i_0, \ldots, i_p \in I$ with pairwise distinct entries, such that
for some $(p + 1)$-tuples $j_0, \ldots, j_p \in J$ with
$i_0 = \alpha(j_0), \ldots, i_p = \alpha(j_p)$ and
