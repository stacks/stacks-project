...
\ref{lemma-sober-subspace}. Suppose $X_i$ is Kolmogorov for every
...
\ref{lemma-sober-subspace}. Suppose $X_i$ is quasi-sober for every
...
Let $X$ and $Y$ be as in \ref{example-quasi-sober-not-kolmogorov} and
\ref{example-kolmogorov-not-quasi-sober}. Then, $X\amalg Y$ is neither
...
then the colimi $G = \colim G_n$ as a topological group
