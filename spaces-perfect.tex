...
distinguished square of algebraic spaces over $S$. If $V' \subset V$ and
...
Let $S$ be a scheme. Let $X$ be a quasi-compact and separated
algebraic space over $S$. Let $P$ be a property of the quasi-compact
and separated objects of $X_{spaces, \acute{e}tale}$. Assume that
\begin{enumerate}
\item $P$ holds for every affine object of $X_{spaces, \acute{e}tale}$,
\item for every elementary distinguished square $(U \subset W, f : V \to W)$
such that
\begin{enumerate}
\item $W$ is a quasi-compact and separated object of
$X_{spaces, \acute{e}tale}$,
\item $U$ is quasi-compact,
\item $V$ is affine, and
\item $P$ holds for $U$, $V$, and $U \times_W V$,
...
then $P$ holds for $W$.
\end{enumerate}
Then $P$ holds for every quasi-compact and separated object
of $X_{spaces, \acute{e}tale}$ and in particular for $X$.
\end{lemma}
...
The only remark one needs to add here and there
is that an open subspace of a separated
algebraic space is separated.
\end{proof}
