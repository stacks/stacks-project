...
\begin{proof}
Since the assumptions are preserved by base change it suffices to show
that $f_*\mathcal{O}_X = \mathcal{O}_Y$. It suffices to prove this
\'etale locally on $Y$, thus we may and do assume $Y$ is an affine scheme.
By cohomology and base change
(more precisely Lemma \ref{lemma-flat-proper-perfect-direct-image-general})
...
and the fact that $X_y$ is geometrically connected and geometrically reduced.
