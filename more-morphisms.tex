...
Let $g_1, \ldots, g_n \in A$ be elements such that $V(g_1, g_2)$ is nonempty
and $V(g_1, g_2)$ has an irreducible component of dimension $\dim(A) - 2$.
...
The fibre of $T \to S$ over $s$ is in a neighbourhood of $t$
cut out by
$$
x_1 - 1, x_2, \ldots, x_n, g_1, g_2
$$
and hence has an irreducible component of dimension $d - 2$.
\end{proof}
...
\begin{enumerate}
\item $X$ is a finite type over $k$,
