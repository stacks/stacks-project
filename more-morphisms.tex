...
Then $\text{Ker}(\psi)$ is of finite type (see Modules, Lemma
\ref{modules-lemma-kernel-surjection-finite-free-onto-finite-presentation})
and $\text{Ker}(\psi)_x = 0$. Whence after shrinking $U$ once more
...
over $\text{Im}(U \to S)$ which is an open neighbourhood of $s$
(Morphisms, Lemma \ref{morphisms-lemma-etale-open}).
...
$\mathcal{O}_X$-module $\text{Im}(g : \mathcal{O}_X \to \mathcal{O}_X)$.
...
After base changing the situation to $B$ as above, we see that we may assume
...
section first. In particular, we assume the reader is
familiar with the notion of relative $m$-pseudo-coherence
as defined in More on Algebra, Definition
\ref{more-algebra-definition-relatively-pseudo-coherent}.

\medskip\noindent
Below we will frequently use the fact that for an affine scheme
$U = \Spec(A)$ the functor $R\Gamma(U, -)$ induces an equivalence
between $D_{\textit{QCoh}}(\mathcal{O}_U)$ and $D(A)$, see
Derived Categories of Schemes, Lemma
\ref{perfect-lemma-affine-compare-bounded}.
This functor is compatible with pullbacks:
if $E$ is an object of $D_{\textit{QCoh}}(\mathcal{O}_U)$
...
$R\Gamma(U_{ij}, E)$ is $m$-pseudo-coherent relative to $\mathcal{O}_S(V_i)$.
...
$\mathcal{F}$ viewed as an object of $D_{\textit{QCoh}}(\mathcal{O}_X)$ is
...
\noindent
If $X$ is quasi-compact and $E$ is $m$-pseudo-coherent for some $m$,
then $E$ is bounded above. We first prove the condition of relative
pseudo-coherence localizes well.
...
it suffices to find a standard open covering $U = \bigcup U_k$ of $U$
such that $R\Gamma(U_k, E)$ is $m$-pseudo-coherent relative to
$\mathcal{O}_S(V)$. In other words, for every $u \in U$ it suffices
to find a standard affine open $u \in U' \subset U$ such that
$R\Gamma(U', E)$ is $m$-pseudo-coherent relative to $\mathcal{O}_S(V)$.
Pick $i$ such that $f(u) \in V_i$ and then pick $j$ such that
...
Thus $U'$ is also a standard affine open of $U$ and $U_{ij}$.
By More on Algebra, Lemma
\ref{more-algebra-lemma-localize-relative-pseudo-coherent}
the assumption that $R\Gamma(U_{ij}, E)$ is $m$-pseudo-coherent
relative to $\mathcal{O}_S(V_i)$ implies that
$R\Gamma(U', E)$ is $m$-pseudo-coherent relative to $\mathcal{O}_S(V_i)$.
(We use the remarks preceding
Definition \ref{definition-relative-pseudo-coherence} to identify
the value of $R\Gamma(U', E)$ as a base change.)
Since $\mathcal{O}_X(U') =
\mathcal{O}_X(U') \otimes_{\mathcal{O}_S(V_i)} \mathcal{O}_S(V')$
and since $\mathcal{O}_S(V_i) \to \mathcal{O}_S(V')$ is flat,
we see from More on Algebra, Lemma
\ref{more-algebra-lemma-base-change-relative-pseudo-coherent}
that $R\Gamma(U', E)$ is $m$-pseudo-coherent relative to $\mathcal{O}_S(V')$.
Applying More on Algebra, Lemma
\ref{more-algebra-lemma-localize-relative-pseudo-coherent}
again we conclude that
$R\Gamma(U', E)$ is $m$-pseudo-coherent relative to $\mathcal{O}_S(V)$.
...
$D_{\textit{QCoh}}(\mathcal{O}_X)$. Then $E$ is $m$-pseudo-coherent
...
maps $D_{\textit{QCoh}}(\mathcal{O}_X)$ into $D_{\textit{QCoh}}(\mathcal{O}_Y)$
...
$D_{\textit{QCoh}}(\mathcal{O}_X)$. Let $m \in \mathbf{Z}$.
\begin{enumerate}
...
Translation of the result of
More on Algebra, Lemma
\ref{more-algebra-lemma-cone-relatively-pseudo-coherent}
into the language of schemes.
\end{proof}
...
$\mathcal{F}$ is a finitely presented relative to $S$.
\end{enumerate}
\end{lemma}
...
Let $X \to S$ be a morphism of schemes which is locally of finite type.
Let $m \in \mathbf{Z}$. Let $E, K$ be objects of
$D_{\textit{QCoh}}(\mathcal{O}_X)$.
If $E \oplus K$ is $m$-pseudo-coherent relative to $S$
so are $E$ and $K$.
\end{lemma}
...
Translation of the result of
More on Algebra, Lemma
\ref{more-algebra-lemma-summands-relative-pseudo-coherent}
into the language of schemes.
\end{proof}
...
above complex of quasi-coherent $\mathcal{O}_X$-modules such that
$\mathcal{F}^i$ is $(m - i)$-pseudo-coherent
relative to $S$ for all $i$. Then $\mathcal{F}^\bullet$ is as an
...
Translation of the result of
More on Algebra, Lemma
\ref{more-algebra-lemma-complex-relative-pseudo-coherent-modules}
into the language of schemes.
\end{proof}
...
Let $X \to S$ be a morphism of schemes which is locally of finite type.
Let $m \in \mathbf{Z}$. Let $E$ be an object of
$D_{\textit{QCoh}}(\mathcal{O}_X)$. If $E$ is (locally) bounded above and
$H^i(E)$ is $(m - i)$-pseudo-coherent relative to $R$ for all $i$,
then $E$ is $m$-pseudo-coherent relative to $S$.
\end{lemma}
...
Translation of the result of
More on Algebra, Lemma
\ref{more-algebra-lemma-cohomology-relative-pseudo-coherent}
into the language of schemes.
\end{proof}
...
over a base $S$. Let $m \in \mathbf{Z}$.
Let $E$ be an object of $D_{\textit{QCoh}}(\mathcal{O}_Y)$.
Assume
\begin{enumerate}
...
over a base $S$. Let $m \in \mathbf{Z}$.
Let $E$ be an object of $D_{\textit{QCoh}}(\mathcal{O}_X)$.
Assume $\mathcal{O}_Y$ is pseudo-coherent relative to $S$\footnote{This
means $Y \to S$ is pseudo-coherent, see
...
Translation of the result of
More on Algebra, Lemma
\ref{more-algebra-lemma-composition-relative-pseudo-coherent}
into the language of schemes.
\end{proof}
...
be an object of $D_{\textit{QCoh}}(\mathcal{O}_X)$. Then the following
are equivalent
\begin{enumerate}
\item $E$ is $m$-pseudo-coherent relative to $S$,
