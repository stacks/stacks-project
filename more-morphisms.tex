...
\noindent
Unfortunately, in order to understand the material in this
...
These properties follow from
More on Algebra,
Lemmas \ref{more-algebra-lemma-flat-base-change-finite-tor-dimension}
(because a localization is flat) and
