...
Let $(f, f') : (X \subset X') \to (S \subset S')$ be a morphism of first
order thickenings. Let $\mathcal{F}$ be a quasi-coherent
$\mathcal{O}_X$-module. Assume $X = S \times_{S'} X'$ and $\mathcal{F}$
flat over $S$. If there exists a pair $(\mathcal{F}', \alpha)$ consisting
of a quasi-coherent $\mathcal{O}_{X'}$-module
$\mathcal{F}'$ flat over $S'$ and an isomorphism
...
order thickenings. Let $\mathcal{F}$ be a quasi-coherent
$\mathcal{O}_X$-module. Assume $X = S \times_{S'} X'$ and $\mathcal{F}$
flat over $S$. There exists a quasi-coherent $\mathcal{O}_{X'}$-module
$\mathcal{F}'$ flat over $S'$ with $\mathcal{F}'|_X \cong \mathcal{F}$,
if and only if
\begin{enumerate}
\item the canonical map $
f^*\mathcal{C}_{S/S'} \otimes_{\mathcal{O}_X} \mathcal{F} \to
