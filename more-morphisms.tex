...
It is clear from Lemma \ref{lemma-first-order-thickening}
...
Let $X$ be a scheme. There is a notion of a {\it short exact sequence}
of first order thickenings
$$
X'_1 \to X'_2 \to X'_3
$$
of $X$. Namely, we ask the corresponding maps between the conormal sheaves
$\mathcal{C}_i = \mathcal{C}_{X/X'_i}$ give a short exact sequence
$$
0 \to \mathcal{C}_3 \to \mathcal{C}_2 \to \mathcal{C}_1 \to 0
$$
of $\mathcal{O}_X$-modules (note reversal of arrows). In this
case we have $X'_1 = X'_2 \times_{X'_3} X$ and the projection
$\pi : X'_1 \to X$ determines a factorization $X'_1 \to X \to X'_3$
of the composition $X'_1 \to X'_2 \to X'_3$. In other words, in this
situation the first order thickening $X'_1$ comes
with a canonical trivialization.
\end{remark}
