...
More Algebra, Definition \ref{more-algebra-definition-weakly-etale}.
...
\begin{lemma}
\label{lemma-weakly-etale-identifies-strictly-henselian-local-rings}
Let $f : X \to Y$ be a morphism of schemes.
The following are equivalent
\begin{enumerate}
...
Hence the lemma follows from
Lemma \ref{lemma-weakly-etale-identifies-strictly-henselian-local-rings}.
\end{proof}
