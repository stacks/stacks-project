...
Let $X \to S$, $Y \to S$, $x$, $s$, $y$, $t$, $\sigma$, $y_\sigma$, and
...
Let $A$ be a ring. Let $X$ be a scheme separated and of finite presentation over $A$. Let 
...
$E \in D(\mathcal{O}_X)$. By Derived Categories of
Schemes, Proposition
\ref{perfect-proposition-detecting-bounded-above} and Theorem \ref{perfect-theorem-bondal-van-den-Bergh}, it
follows that $K \in D^-_\QCoh (\mathcal{O}_X)$. Now the
...
$D(A)$ for every perfect $E \in D( \mathcal{O}_X)$, then $K$ is $A$-perfect.
\end{lemma}
...
$K$ is pseudo-coherent in $D( \mathcal{O}_X)$. Let
$\mathfrak{p}$ be a prime ideal of $A$ and denote 
$i : X_{\kappa (\mathfrak{p})} \to X$ the inclusion
of the fibre over $\mathfrak{p}$. By Derived
Categories of Schemes, Lemma \ref{perfect-lemma-bounded-on-fibres},
we will be done if we can show 
$Li^*(K) \in D^b(\mathcal{O}_{X_{\kappa(\mathfrak{p})}})$. 
Let $G\in D_{perf} (\mathcal{O}_X)$ be a perfect
complex which generates $D_\QCoh (\mathcal{O}_X)$ 
(see Derived Categories of Schemes, Theorem \ref{perfect-theorem-bondal-van-den-Bergh}). 
By Derived Categories of Schemes, Lemma
\ref{perfect-lemma-flat-base-change-tor-independent},
we have
$$
R \Hom _{\mathcal{O}_{X_{\kappa(\mathfrak{p})}}} (Li^*(G), Li^*(K)) = R \Gamma (X_{\kappa(\mathfrak{p})}, Li^*(G ^\vee \otimes ^\mathbf{L} K)) = R \Gamma (X, G ^\vee \otimes ^{\mathbf{L}} K) \otimes^\mathbf{L} _A \kappa(\mathfrak{p})
$$
and it follows from our hypothesis that this is a
perfect object of $D(\kappa(\mathfrak{p})).$
Since 
$Li^*(G) \in D_{perf}(\mathcal{O}_{X_{\kappa(\mathfrak{p})}})$ 
generates 
$D_\QCoh(\mathcal{O}_{X_{\kappa(\mathfrak{p})}})$
(see Derived Categories of Schemes, Remark \ref{perfect-remark-pullback-generator}), Derived Categories of Schemes, Proposition \ref{perfect-proposition-detecting-bounded-below} now implies that $Li^*(K)$ is bounded and we win.
\end{proof}
