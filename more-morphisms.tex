...
the category of pairs $(U, a)$ is filtered. Hence we may assume we have
a pair $s_1, s_2 \in \mathcal{F}(X \times_Y V)$ such that
$a^*s_1 = a^*s_2$ and we have to show that there exists an etale
a pair $(V', a')$ mapping to $(V, a)$ such that the restrictions
$s_1|_{X \times_Y V'}$ and $s_2|_{X \times_Y V'}$ are equal.
Note that $a(U) \subset X \times_Y V$ is an open subscheme, and that
