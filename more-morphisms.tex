...
we consider morphisms $f : X \to S$ which locally factor as
$$
\xymatrix{
...
going to be true if $* = Koszul$. Hence we will define a
{\it local complete intersection morphism} or
{\it Koszul morphism} to be a morphism of schemes $f : X \to S$
that locally on $X$ has a
factorization as above with $i$ a Koszul regular immersion.
