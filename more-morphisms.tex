...
Then there exist
\begin{enumerate}
\item an etale neighbourhood $(U, u) \to (S, s)$
with $\kappa(s) = \kappa(u)$,
\item a unique point $x' \in U \times_S X = X_U$ lying over $x$ and $u$,
\item an open neighbourhood $V \subset X_U$ of $x'$
\end{enumerate}
such that $V \to U$ is a finite morphism. Diagram:
$$
\xymatrix{
x' \ar[d] & V \ar[d] \ar@{^{(}->}[r] &
