...
$D_\QCoh(\mathcal{O}_X)$. Let $m \in \mathbf{Z}$.
\begin{enumerate}
...
$D_\QCoh(\mathcal{O}_X)$. If $E$ is (locally) bounded above and
...
Let $E$ be an object of $D_\QCoh(\mathcal{O}_Y)$.
Assume
\begin{enumerate}
...
be an object of $D_\QCoh(\mathcal{O}_X)$. Then the following
are equivalent
\begin{enumerate}
\item $E$ is $m$-pseudo-coherent relative to $S$,
