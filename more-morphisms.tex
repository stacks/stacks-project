...
\ref{perfect-lemma-perfect-affine}). Simlarly, we may assume $E'$
...
Derived Categories of Schemes, Lemmas
\ref{perfect-lemma-affine-compare-bounded} and
\ref{perfect-lemma-perfect-affine}). Simlarly, we may assume $E_i$
is represented by a complex
$$
...
\medskip\noindent
By Lemma \ref{lemma-control-graded} we can assume that any $\sigma'$
...
argrees modulo $\mathfrak m_s^{c + 1}$ with $\tilde \sigma$.
