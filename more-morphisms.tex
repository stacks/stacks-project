...
$$
\xymatrix{
T_2 \ar[r] \ar[d]_h & T_2' \ar[rr]_{a_1'} \ar[d]^{h'} & &
X_2 \ar[dd] \ar[ld]^\psi \\
T_1 \ar[r] & T_1' \ar[r]_{a_2'} & X_1 \ar[d] & \\
& & Y_1 \ar[r] & Y_2
}
$$
and assume that
...
\end{enumerate}
Write $a_i = a'_i \circ i_i$, $i = 1, 2$.
Let $\theta_1 : a_1^*\Omega_{X_1/Y_1} \to \mathcal{I}_1$ be
$\mathcal{O}_{T_1}$-linear. Then
$\psi^*\Omega_{X_1/Y_1} = \Omega_{X_2/Y_2}$, and
if, using this isomorphism we set
$\theta_2 = (h^*\mathcal{I}_1 \to \mathcal{I}_2) \circ h^*\theta :
a_2^*\Omega_{X_2/Y_2} \to \mathcal{I}_2$, then the diagram
$$
\xymatrix{
T_2' \ar[r]_{\theta_2 \cdot a_2'} \ar[d] & X_2 \ar[d] \\
T_1' \ar[r]^{\theta_1 \cdot a_1'} & X_1
}
$$
