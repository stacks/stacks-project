...
\section{Ample families of invertible modules and blowing up}
...
\begin{lemma}
\label{lemma-blowing-up-with-resolution-property}
\begin{reference}
\cite[Proposition 1.3.1]{Gross-thesis}
\end{reference}
Let $X$ be a Noetherian scheme. There exists a dense open $U \subset X$
and a $U$-admissible blowing up $X' \to X$ such that the scheme $X'$
has an ample family of invertible modules.
\end{lemma}
...
Lemma \ref{lemma-blowing-up-with-resolution-property}.
