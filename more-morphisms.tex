...
and flat,
\item $f^{-1}(U) \to U$ is an isomorphism, and
\item $U \subset S$ is retrocompact and schematically dense,
\end{enumerate}
...
(Morphisms, Lemma \ref{morphisms-lemma-fppf-open})
hence we may replace $X$ by $f(X)$. Thus we have to prove that
...
By Descent, Lemma
\ref{descent-lemma-flat-morphism-scheme-theoretically-dense-open}
