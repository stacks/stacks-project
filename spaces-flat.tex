...
and the second from Cohomology on Spaces, Lemma
...
Lemma \ref{lemma-F-zero-closed-pure} or Lemma \ref{lemma-F-zero-closed-proper}
...
Lemma \ref{lemma-iso-limits} combined with Limits of Spaces, Proposition
