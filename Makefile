...
LIJST = introduction conventions sets categories topology sheaves algebra sites homology simplicial modules injectives cohomology hypercovering schemes constructions properties morphisms etale spaces stacks stacks-groupoids algebraic flat desirables coding
