...
LIJST = introduction conventions sets categories topology sheaves algebra sites homology simplicial modules injectives cohomology hypercovering schemes constructions properties morphisms limits varieties topologies groupoids fpqc-descent etale spaces stacks stacks-groupoids algebraic flat exercises desirables coding
