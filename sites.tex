...
$i \not \in \text{Im}(\beta)$. For such an $i$ we may use the
isomorphisms $U_i \cong V_{\alpha(i)} \to U_{\beta(\alpha(i))}$
over $U$ to see that also necessarily $s_i = s|_{U_i}$ in this case.
\end{proof}
