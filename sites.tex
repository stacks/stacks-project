...
$U \mapsto h_U^\#$ satisfies the assumptions of
...
induced by a cocontinuous functor $u : \mathcal{C} \to \mathcal{C}'$
as in Lemma \ref{lemma-equivalence} such that
$\mathcal{C}'$ is a site having fibre products and a final object
...
Notation as in Lemma \ref{lemma-morphism-topoi-comes-from-morphism-sites}
above. If the site $\mathcal{D}$ has a final object and fibre products
...
\textit{Sh}(\mathcal{D})
$$
where the first and  the last arrow are equivalences given by cocontinuous
functors $\mathcal{C} \to \mathcal{C}'$ and
$\mathcal{D} \to \mathcal{D}'$
as in Lemma \ref{lemma-equivalence} and the middle arrow comes from
