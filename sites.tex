...
\medskip\noindent
Proof of (1). We have to check conditions (1) -- (5) of
Lemma \ref{lemma-equivalence}.
...
u^sg_*\mathcal{F}(V)
=
g_*\mathcal{F}(f^{-1}h_V^\sharp)
=
\text{lim}_{U, \psi : h_U^\sharp \to f^{-1}h_V^\sharp}\ \mathcal{F}(U)
$$
where the $\psi$'s are maps of sheaves on $\mathcal{C}$.
Pick $U$ an object of $\mathcal{C}$. Then
$$
(g^{-1} \circ u_s)(\mathcal{G})(U)
= u_s(\mathcal{G})(v(U))
$$
This is the sheaf associated to the presheaf
