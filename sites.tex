...
\begin{proof}
First we show that $\mathcal{I}_Y$ is nonempty.
Namely, let $X$ be the final object of $\mathcal{C}$ and
let $Y \to u(X)$ be the morphism coming from the fact
that $u(X)$ is final in $\mathcal{D}$.
