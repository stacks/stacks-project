...
\smallskip\noindent
Let $\mathcal{A}$ be a category. If $\mathcal{A}$ has products
of objects indexed by $I$, $I\times I$, then the formulation of
the definition still makes sense.

is arbitrary, the condition means that for any
