...
For example, in Sets, Subsubsection
\ref{sets-subsubsection-coverings-site} we show how
...
fibred product, see Categories, Subsubsection
\ref{categories-subsubsection-example-fibre-products}.
...
Subsubsection \ref{sets-subsubsection-sets-with-group-action} for a suitable
...
H^0(\mathcal{U}, \mathcal{F})
$$
See Categories, Subsection \ref{categories-subsection-limits} for
...
Subsubsection \ref{categories-subsubsection-limit-sets}
...
to the inclusion functor $i$. We finish this subsection with a couple
of lemmas.
...
\subsection{Injective and surjective maps of sheaves}
\label{subsection-sheaves-injective}
...
are representable\footnote{In french ``quarrable''.},
...
Subsubsection \ref{sets-subsubsection-coverings-site}.
...
see Subsection \ref{subsection-limits-colimits-PSh}). 
