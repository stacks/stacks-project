...
\end{enumerate}
Then the index categories $(\mathcal{I}^u_V)^{opp}$ of are filtered (see
...
=
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}^\#, \mathcal{G}).
$$
...
$$
\Mor_{\textit{Sh}(\mathcal{C})}(\underline{U}, \mathcal{F})
=
\mathcal{F}(U)
$$
...
$\Mor_{\textit{Sh}(\mathcal{C})}(h_U^\#, \mathcal{F}) =
...
\begin{eqnarray*}
\Mor_{\textit{Sh}(\mathcal{D})}(u_s(\mathcal{G}^\#), \mathcal{F})
& = &
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{G}^\#, u^s\mathcal{F}) \\
& = &
...
& = &
\Mor_{\textit{Sh}(\mathcal{D})}((u_p\mathcal{G})^\#, \mathcal{F})
\end{eqnarray*}
...
$$
\Mor_{\textit{Sh}(\mathcal{D})}(f^{-1}\mathcal{G}, \mathcal{F})
=
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{G}, f_*\mathcal{F})
$$
...
that the rule
$U \mapsto \Mor_{\textit{Sh}(\mathcal{D})}(\Phi(U), \mathcal{F})$
...
\begin{eqnarray*}
\Mor_{\textit{Sh}(\mathcal{C})}((u^p(\mathcal{G}^\#))^\#, \mathcal{F})
& = &
\Mor_{\textit{Sh}(\mathcal{D})}(\mathcal{G}^\#, {}_su\mathcal{F}) \\
& = &
\Mor_{\textit{PSh}(\mathcal{D})}(\mathcal{G}^\#, {}_pu\mathcal{F}) \\
& = &
\Mor_{\textit{PSh}(\mathcal{D})}(\mathcal{G}, {}_pu\mathcal{F}) \\
...
equalities
\begin{eqnarray*}
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, g^{-1}\mathcal{G})
& = &
\Mor_{\textit{PSh}(\mathcal{C})}(\mathcal{F}, u^p\mathcal{G})
\\
& = &
...
\\
& = &
\Mor_{\textit{Sh}(\mathcal{D})}(g_{!}\mathcal{F}, \mathcal{G})
\end{eqnarray*}
...
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, \mathcal{G})
\longrightarrow
\Mor_{\textit{Sh}(\mathcal{D})}(f^{-1}\mathcal{F}, f^{-1}\mathcal{G})
$$
is bijective. But the right hand side is equal to
\begin{align*}
\Mor_{\textit{Sh}(\mathcal{D})}(f^{-1}\mathcal{F}, f^{-1}\mathcal{G})
& =
\Mor_{\textit{Sh}(\mathcal{C})}(f_*f^{-1}\mathcal{F}, \mathcal{G}) \\
& =
\Mor_{\textit{Sh}(\mathcal{C})}(g^{-1}f^{-1}\mathcal{F}, \mathcal{G}) \\
& =
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, \mathcal{G})
\end{align*}
...
$u^ph_V(U) = \Mor_{\mathcal{D}}(u(U), V) =
\Mor_{\mathcal{C}}(U, v(V))$ by assumption.
...
(g_*\mathcal{F})(V)
& = &
\Mor_{\textit{Sh}(\mathcal{D})}(h_V^\#, g_*\mathcal{F}) \\
& = &
\Mor_{\textit{Sh}(\mathcal{C})}(g^{-1}(h_V^\#), \mathcal{F}) \\
& = &
\Mor_{\textit{Sh}(\mathcal{C})}(h_{v(V)}^\#, \mathcal{F}) \\
& = &
\mathcal{F}(v(V))
\end{eqnarray*}
...
$$
is $\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, \mathcal{G}).$
...
g_*h_U^\#(\mathcal{F})
& =
\Mor_{\textit{Sh}(\mathcal{C}')}(h_{\mathcal{F}}, g_*h_U^\#) \\
& =
\Mor_{\textit{Sh}(\mathcal{C})}(g^{-1}h_{\mathcal{F}}, h_U^\#) \\
& =
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, h_U^\#) \\
& =
...
$\mathcal{C}_1 \subset \textit{Sh}(\mathcal{C})$ consisting of all
...
g_*h_U^\#(f^{-1}h_V^\#) \\
& =
\Mor_{\textit{Sh}(\mathcal{C})}(f^{-1}h_V^\#, h_U^\#) \\
& =
\Mor_{\textit{Sh}(\mathcal{D})}(h_V^\#, f_*h_U^\#) \\
& = f_*h_U^\#(V)
\end{align*}
...
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}^\#, u^sE) =
\text{Map}(\mathcal{F}^\#_p, E)
$$
...
$$
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{F}, p_*E)
=
\text{Map}(\mathcal{F}_p, E)
$$
...
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{G}, f_*\mathcal{F})
\ar[d]_{t \circ -} \ar@{=}[r] &
\Mor_{\textit{Sh}(\mathcal{C})}(f^{-1}\mathcal{G}, \mathcal{F})
\ar[d]^{- \circ t}
\\
\Mor_{\textit{Sh}(\mathcal{C})}(\mathcal{G}, g_*\mathcal{F})
\ar@{=}[r] &
\Mor_{\textit{Sh}(\mathcal{C})}(g^{-1}\mathcal{G}, \mathcal{F})
}
$$
...
$\mathcal{F}(U) = \Mor_{\textit{Sh}(\mathcal{C})}(h_U^\#, \mathcal{F})$.
...
=
\Mor_{\textit{Sh}(\mathcal{C}, \mathcal{A})}(\mathcal{G}^\#, \mathcal{F})
$$
...
\left\{
\begin{matrix}
\varphi \in \Mor_{\textit{Sh}(\mathcal{C})}
