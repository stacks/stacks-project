...
$\mathcal{G}$ such that $\mathcal{F} \times_{*} \mathcal{G} \to \mathcal{F}$
...
sheaf property for all coverings of $\mathcal{D}$.
...
$\mathcal{F} \times_{*} \mathcal{G} \to \mathcal{F}$ is an isomorphism.
...
\medskip\noindent
By Lemma \ref{lemma-exactness-properties} it follows that
