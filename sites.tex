...
$$
The bijectivity in (2) garantees there exists an element $z \in u(W)$
which maps to $((y, y), y)$.
...
This satisfies (1) and (2), but the corresponding stalk functor
...
\begin{proof}
Since $\text{Mor}_{\Sh(\mathcal{C})}(h_U^\#, \mathcal{F}) = \mathcal{F}(U)$
