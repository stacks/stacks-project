...
\ref{section-cocontinuous-adjoint}.
...
In fact it will turn out that there is a one to one correspondence
between points $q$ of $\mathcal{C}/U$ lying over $p$ (as in the
lemma) and elements $x$ of $u(U)$. We will insert this here when
we need it.
