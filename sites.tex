...
$\mathcal{V} : \{V_j \to V\}_{j\in J}$ be families of morphisms
with the same target.
\begin{enumerate}
\item 
A {\it morphism of families of maps with the same target}
...
\noindent
A trivial but important remark is that if $\{U_i \to U\}_{i \in I}$
...
that the resriction of the pushforward and the restriction
