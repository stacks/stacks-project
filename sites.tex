...
Let $\mathcal{C}$ be a site.
Let $U \in \text{Ob}(\mathcal{C})$.
If the topology on $\mathcal{C}$ is weaker than the canonical
topology, see Definition \ref{definition-weaker-than-canonical},
...
\noindent
Now we have to repeat some of the material on localization to
the slightly more general case of topoi. In reality this is not
