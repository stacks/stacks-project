...
Let $\phi \in \text{Mor}_{\mathcal{S}_V}(f^\ast x, f^\ast y)$.
Then we have
\begin{eqnarray*}
& &
...
$$
V/U \longmapsto
\text{Mor}_{\mathcal{X}_V}(x|_V, x'|_V)
\times_{\text{Mor}_{\mathcal{Z}_V}(f(x)|_V, f(x')|_V)}
\text{Mor}_{\mathcal{Y}_V}(y|_V, y'|_V)
$$
