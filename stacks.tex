...
\noindent
In this very short chapter we introduce stacks in groupoids. See \cite{DM}.
...
Let $p : \mathcal{S} \to \mathcal{C}$ be a fibred category.
Choose pullbacks as in Categories, Lemma \ref{categories-lemma-fibred}.
Let $\{f_i : U_i \to U\}_{i \in I}$ be a family of morphisms of $\mathcal{C}$.
...
$$
in the category $\mathcal{S}_{U_i \times_U U_j \times_U U_k}$-modules
