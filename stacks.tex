...
\section{Explanation}
\label{section-definition-explanation}
...
Sites, Definition \ref{sites-definition-presheaf}. Namely, for 
$f : V \to U$ we set 
$$
...
$$
By Lemma
\ref{categories-lemma-fibred-groupoids} there are pullback functors 
...
\noindent
Alternatively we can argue with Lemma \ref{categories-lemma-fibred-strict}
