...
\begin{lemma}
\label{lemma-smoothing-at-point}
...
By Lemma \ref{lemma-smoothing-affine} we can find a
...
\begin{lemma}
\label{lemma-smooth-proper-curve-isolated}
...
This is possible by Lemma \ref{lemma-smoothing-at-point}.
...
\begin{lemma}
\label{lemma-smooth-curve-isolated}
...
\begin{proof}
Choose an embedding $X \subset \overline{X}$ as in
...
Thus we may apply Lemma \ref{lemma-smooth-proper-curve-isolated}
...
from $\overline{Y}$ to obtain $Y$. Some details omitted.
\end{proof}
