...
with $\kappa(\mathfrak p) \subset \kappa_1$ purely inseparable and
$\kappa(\mathfrak p) \subset \kappa_2$ Galois, see
...
For $\sigma \in I$ write $\sigma(\pi_C) = u_\sigma \pi_C$ for some
unit $u_\sigma$ in $C$. Then we have
$$
...
we see that $u_\sigma$ maps to an $e$th root of unity in $\kappa_C$.
We obtain a homomorphism
$$
\chi : I \longrightarrow \mu_e(\kappa_C)
$$
Since $\kappa_C$ has characteristic $p$, the group $\mu_e(\kappa_C)$
is cyclic of order at most the prime to $p$ part of $e$ (see
Fields, Section \ref{fields-section-roots-of-1}).
...
over $\kappa_A$ (with group $G/I$), in particular separable.
By Algebra, Lemma \ref{algebra-lemma-characterize-etale}
we find that $A \to B^I$ is \'etale. (In particular,
$L^I/K$ is unramified with respect to $A$.)
...
\end{enumerate}
Then there exists a Galois extension $K_1/K$
totally ramified with respect to $A$
...
\end{enumerate}
Then there exists a Galois extension $K_1/K$ totally ramified
...
(b) totally ramified with respect to $B^j$ and Galois of degree $p$,
(c) totally ramified with respect to $B^j$ and Galois cyclic of
order prime to $p$, or
(d) Galois and unramified with respect to $B^j$.
...
each of these extensions is unramified over $M$ with respect to $B$.
...
factor of $M_1$ is unramified over $L_1$ with respect to $B_1$ as well.
...
Write $\pi_B^e = u\pi$ for some unit $u \in B$. Let $K_1/K$ be
be the extension obtained by adjoining an $e$th root of
...
$$
and using multiplicativity of ramification indices, it follows that each
factor of $L_1$ is unramified over $K_1$ with respect to $A_1$ as well.
This finishes the proof
