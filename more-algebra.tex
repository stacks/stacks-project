...
$Q \otimes_A M = \lim Q \otimes_A M_n$ for every finite $A$-module $M$.
\end{lemma}
...
by constuction of the derived tensor product. By flatness we see that
$$
...
by constuction of the derived tensor product. Similarly for
...
is a bounded above complexe of free $R$-modules (see
Derived Categories, Lemma \ref{derived-lemma-subcategory-left-resolution}).
...
Lemma \ref{lemma-compute-Rlim-modules} and Remark \ref{remark-how-unique}.
...
$K \otimes_A^\mathbf{L} A/I^n \to K_n$ is an isomorphism for all $n$.
Thus it suffices to show that $H^i(K \otimes_A \kappa) = 0$ for every
...
Hence
$$
K \otimes_A^\mathbf{L} \kappa = K \otimes_A^\mathbf{L} A/I \otimes_{A/I}^\mathbf{L} \kappa = K_1 \otimes_{A/I}^\mathbf{L} \kappa
$$
