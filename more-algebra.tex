...
$$
K(A, f_1, \ldots, f_n, g_1, \ldots, g_m) =
\text{Tot}(K(A, f_1, \ldots, f_n) \otimes_A K(A, g_1, \ldots, g_m)).
$$
\end{lemma}

\begin{proof}
We first show that $K(A, f_1, \ldots, f_n, g_1, \ldots, g_m)$ is
isomorphic to the tensor product
$K(A, f_1, \ldots, f_n) \otimes_A K(A, g_1, \ldots, g_m)$
...
\begin{proof}
Our assumptions say that $K(A, f_1, \ldots, f_n)$ is a finite free resolution
of $A/I$ and $K(A/I, \overline{g}_1, \ldots, \overline{g}_m)$ is a
finite free resolution of $A/(f_i, g_j)$ over $A/I$. Then
\begin{align*}
K(A, f_1, \ldots, f_n, g_1, \ldots, g_m)
& = \text{Tot}(K(A, f_1, \ldots, f_n) \otimes_A K(A, g_1, \ldots, g_m)) \\
& \cong \text{Tot}(A/I \otimes_A K(A, g_1, \ldots, g_m)) \\
& = K(A/I, \overline{g}_1, \ldots, \overline{g}_m) \\
& \cong A/(f_i, g_j)
\end{align*}
...
$\alpha : K(R, f_1, \ldots, f_r) \to K(R, g_1, \ldots, g_r)$, see
Lemma \ref{lemma-functorial}.
This map becomes an isomorphism on inverting $\det(a_{ij})$.
Since the cohomology modules of both $K(R, f_1, \ldots, f_r)$ and
$K(R, g_1, \ldots, g_r)$ are annihilated by $I$, see
...
Let $R$ be a ring of finite global dimension. Then
\begin{enumerate}
\item every module has finite tor dimension, and
...
resolution, in particular every module has finite tor dimension.
...
Lemma \ref{lemma-perfect}
and the translation into the statement above uses
Lemma \ref{lemma-perfect-module}.
