...
Let $(A, I)$ be a pair. If $I$ is locally nilpotent, then
...
the map $A \to A'$ is an isomorphism.
\end{proof}
...
Dualizing, Lemma \ref{dualizing-lemma-neighbourhood-extensions}
...
is Dualizing, Section \ref{dualizing-section-local-cohomology}.
...
in Dualizing, Section \ref{dualizing-section-torsion-and-complete}.
