...
$$
\dim \Ker(\alpha) - \dim \text{Coker}(\alpha)
-\dim \Ker(\beta) + \dim \text{Coker}(\beta)
=
...
$$
\dim \Ker(\alpha) - \dim \Ker(\beta) + \dim \text{Coker}(\beta) = 0
$$
...
$$
H^p(K_n^\bullet) =
\frac{\Ker(K_n^p \to K_n^{p + 1})}{\text{Im}(K_n^{p - 1} \to K_n^p)}
$$
