...
index $1$ and separable extension of residue fields. However, we cannot
use the term ``unramified'' itself because there alread exists a notion of an
unramified ring map, see Algebra, Section \ref{algebra-section-unramified}.
We will often simply say ``$A \subset B$ is formally smooth'' to indicate
this situation.
...
is totally ramified we have $\pi_1^e = u_1 \pi$ for some unit $u_1$ in $A_1$.
