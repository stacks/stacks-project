...
\begin{lemma}
\label{lemma-Noetherian-complete-G-ring}
...
fibres over the minimal prime $(0)$ of $B$. Thus we may assume
...
\medskip\noindent
Assume that $A$ is a a power series ring over a field or a Cohen ring.
...
\medskip\noindent
We are left with the case $A = k[[x_1, \ldots, x_d]]$ where
$k$ is a field of characteristic $p > 0$. To be added soon.
\end{proof}
