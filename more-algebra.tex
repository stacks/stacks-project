...
\medskip\noindent
We will discuss {\it flattening stratifications} in a scheme theoretic
...
flattening stratification of the quasi-coherent module
...
$M = \Sigma^{-1}N$ for some finitely presented $C$-module $N$. At this
point we introduce $C_\lambda$, $C'$, $N_\lambda$, $N'$. Then in
