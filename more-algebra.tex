...
\item $\mathfrak p \not \in \text{Ass}(M)$ (for example if
...
$\mathfrak p \not \in \text{Ass}(N)$ (for example if
...
the image of $M$. Then
$\text{Ass}(N_\mathfrak p) = \emptyset$ implies
$\text{Ass}(N'_\mathfrak p) = \emptyset$
(and $\text{depth}(N_\mathfrak p) \geq 1$ implies
$\text{depth}(N'_\mathfrak p) \geq 1$).
