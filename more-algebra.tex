...
be a maximial ideal of the integral closure of $A$ in $L$.
...
encourage the reader to read the original. See also
...
Algebra, Section \ref{algebra-section-galois-theory}.
...
extension of $L$ (Algebra, Lemma \ref{algebra-lemma-Artin-Schreier}).
...
(Algebra, Lemma \ref{algebra-lemma-Kummer}) $M$ is obtained
...
Algebra, Lemma \ref{algebra-lemma-normal-closure}.
...
inseparable of degree $p$, (b) Galois of degree $p$, (c) Galois
cyclic of order prime to $p$, or (d) Galois and unramified.
Namely, since $M/L$ is normal we can write it as a compositum of
a Galois extension and a purely inseparable extension
(Algebra, Lemma \ref{algebra-lemma-normal-case}).
...
and let $I \subset G$ be the inertia group. Then $I$ is solvable
by Lemma \ref{lemma-galois-inertia}. TO BE CONTINUED SOON.
\end{proof}
