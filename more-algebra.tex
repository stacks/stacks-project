...
\section{Deformations and the naive cotangent complex}
...
for syntomic ring maps we will later prove a rather strong lifting
result in Smoothing, Proposition \ref{smoothing-proposition-lift-smooth}.
...
By Lemma \ref{lemma-conormal-sequence-H1-regular-ideal} we have
