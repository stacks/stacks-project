...
It is clear that $B$ is geometrically regular over $k$. Hence
...
in this case only the topology on $S$ is relevant (see
Lemma \ref{lemma-formally-smooth}). In this case we simply say
{\it $R \to S$ is formally smooth for the $\mathfrak n$-adic topology}.
