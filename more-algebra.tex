...
if $A$ and $R'$ are Tor independent over $R$, then the
comparison map (\ref{equation-comparison-map}) is an isomorphism.
\end{lemma}

\begin{proof}
To prove this we choose a free resolution $F^\bullet \to R'$
of $R'$ as an $R$-module. Because $A$ and $R'$ are Tor independent over $R$
we see that $F^\bullet \otimes_R A$ is a free $A$-resolution of $A'$
