...
\begin{enumerate}
\item $A$ and $B$ are Tor independent over $R$, and
...
\begin{proof}
Omitted. Hints: Let $\mathfrak s$ be a prime of $A \otimes_R B$.
Then we have
$$
...
and $\mathfrak r = R \cap \mathfrak s$. To see this use the results of
Algebra, Section \ref{algebra-section-functoriality-tor}.
Since we can test the vanishing of modules by localizing at primes
(Algebra, Lemma \ref{algebra-lemma-characterize-zero-local})
we conclude that (2) implies (1). For the converse, use that
$$
