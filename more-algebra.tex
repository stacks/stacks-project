...
\item[(B)] $P(k \to R_1 \times R_2) \Rightarrow P(k \to R_1)$,
...
the fibres of the lower horizontal arrow have $P$.
...
\ref{proposition-finite-type-over-P-ring}).
...
Part (B) follows too: if a product of rings is reduced, then each of
the factors is reduced.
...
Part (B) follows too: if a product of rings is normal, then each of
the factors is normal. This is clear because a ring is normal
if and only if all of its local rings are normal.
...
Part (B) follows too: if a product of Noetherian rings has $(S_n)$,
then each of the factors has $(S_n)$. This is clear because a
Noetherian ring has $(S_n)$
if and only if all of its local rings have $(S_n)$.
...
This proves (A).
Part (B) follows too: if a product of Noetherian rings has $(R_n)$,
then each of the factors has $(R_n)$. This is clear because a
Noetherian ring has $(R_n)$ if and only if all of its local rings have $(R_n)$.
