...
It follows that if we have a category
$p : \mathcal{X} \to (\Sch/S)_{fppf}$ fibred in groupoids, then
$\mathcal{X}_{affine}$ inherits a Zariski, \'etale, smooth, syntomic, and
fppf topology from $(\textit{Aff}/S)_{Zar}$,
$(\textit{Aff}/S)_\etale$, $(\textit{Aff}/S)_{smooth}$,
$(\textit{Aff}/S)_{syntomic}$, and $(\textit{Aff}/S)_{fppf}$, see
Stacks, Definition \ref{stacks-definition-topology-inherited}.
...
Having said this we omit the proof; hint: argue in exactly
