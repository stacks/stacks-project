...
by a scheme $X$. For $\tau \in \{Zar,\linebreak[0] \acute{e}tale,\linebreak[0]
...
that $\mathcal{F}$ is a sheaf on $\mathcal{X}_{\acute{e}tale}$,
...
c_\varphi : a_{small}^{-1}(g^{-1}\mathcal{F}|_{V_{\acute{e}tale}})
\longrightarrow
f^{-1}\mathcal{F}|_{U_{\acute{e}tale}}
\end{equation}
...
$$
g^{-1}\mathcal{F}|_{V_{\acute{e}tale}}
\longrightarrow
a_{small, *}(f^{-1}\mathcal{F}|_{U_{\acute{e}tale}}) =
(a_*f^{-1}\mathcal{F})|_{V_{\acute{e}tale}}
$$
...
c_\varphi : a_{small}^*(g^*\mathcal{F}|_{V_{\acute{e}tale}})
\longrightarrow
f^*\mathcal{F}|_{U_{\acute{e}tale}}
\end{equation}
of $\mathcal{O}_{U_{\acute{e}tale}}$-modules.
Note that the properties (1), (2), (3), and (4) of
Lemma \ref{lemma-comparison}
...
is denoted $\textit{QCoh}(\mathcal{O}_\mathcal{X})$ or
$\textit{QCoh}(\mathcal{X})$.
\end{definition}
...
$\mathcal{F}_{(W, u)} = x^*\mathcal{F}|_{W_{\acute{e}tale}}$
...
The map
$$
\text{Hom}_{\mathcal{O}_\mathcal{X}}(\mathcal{F}, \mathcal{H})
\longrightarrow
\text{Hom}_{\mathcal{O}_U}(x^*\mathcal{F}|_{U_{\acute{e}tale}},
x^*\mathcal{H}|_{U_{\acute{e}tale}}),
\quad
\phi \longmapsto x^*\phi|_{U_{\acute{e}tale}}
$$
is injective and its image consists of exactly those
$\varphi : x^*\mathcal{F}|_{U_{\acute{e}tale}} \to
x^*\mathcal{H}|_{U_{\acute{e}tale}}$ which give rise to a commutative
diagram
$$
\xymatrix{
s_{small}^*(x^*\mathcal{F}|_{U_{\acute{e}tale}})
\ar[r] \ar[d]^{s_{small}^*\varphi} &
(x \circ s)^*\mathcal{F}|_{R_{\acute{e}tale}} =
(x \circ t)^*\mathcal{F}|_{R_{\acute{e}tale}} &
t_{small}^*(x^*\mathcal{F}|_{U_{\acute{e}tale}})
\ar[l] \ar[d]_{t_{small}^*\varphi} \\
s_{small}^*(x^*\mathcal{H}|_{U_{\acute{e}tale}})
\ar[r] &
(x \circ s)^*\mathcal{H}|_{R_{\acute{e}tale}} =
(x \circ t)^*\mathcal{H}|_{R_{\acute{e}tale}} &
t_{small}^*(x^*\mathcal{H}|_{U_{\acute{e}tale}})
\ar[l]
}
$$
of modules on $R_{\acute{e}tale}$
...
Let $\mathcal{X}$ be an algebraic stack over $S$. The inclusion functor
$\textit{QCoh}(\mathcal{O}_\mathcal{X}) \to
...
$Q(\mathcal{F}) \to \mathcal{F}$ is an isomorphism. Moreover, the category
$\textit{QCoh}(\mathcal{O}_\mathcal{X})$ has limits and enough injectives.
\end{proposition}
...
We urge the reader to read either of those proofs first.

\medskip\noindent
The two assertions about $Q(\mathcal{F}) \to \mathcal{F}$ and limits in
$\textit{QCoh}(\mathcal{O}_\mathcal{X})$ are formal consequences of the
existence of $Q$, the fact that the inclusion is fully faithful, and the
fact that $\textit{Mod}(\mathcal{O}_\mathcal{X})$ has limits (see
Modules on Sites, Lemma \ref{sites-modules-lemma-limits-colimits}).
The existence of injectives follows from the existence of injectives
in $\textit{Mod}(\mathcal{O}_\mathcal{X})$ (see
...
Thus it suffices to construct $Q$.
...
above we have
$\textit{QCoh}(\mathcal{O}_\mathcal{X}) = \textit{QCoh}(U, R, s, t, c)$.
...
\medskip\noindent
Given an object $\mathcal{G}$ of $\textit{QCoh}(\mathcal{O}_\mathcal{X})$
we set
$$
Q(\mathcal{G}) = \colim_{(t, \psi)} \mathcal{F}_t
$$
The colimit is over the category of pairs $(t, \psi)$ where
$t \in T$ and $\psi : \mathcal{F}_t \to \mathcal{G}$ is a
morphism of $\mathcal{O}_\mathcal{X}$-modules. A morphism
$(t, \psi) \to (t' ,\psi')$ is given by a morphism
$\beta : \mathcal{F}_t \to \mathcal{F}_{t'}$ such that
$\psi' \circ \beta = \psi$. By
Lemma \ref{lemma-quasi-coherent-algebraic-stack}
the colimit is quasi-coherent. Note that there is a canonical
map $Q(\mathcal{G}) \to \mathcal{G}$ by definition of the colimit.
The formula
$$
\Hom(\mathcal{H}, Q(\mathcal{G})) = \Hom(\mathcal{H}, \mathcal{G})
$$
holds for $\mathcal{H} = \mathcal{F}_t$ by construction.
It follows formally from this and the fact that every $\mathcal{H}$
is a directed colimit of $\mathcal{O}_\mathcal{X}$-modules isomorphic to
$\mathcal{F}_t$ that this equality holds for any quasi-coherent
module $\mathcal{H}$ on $X$. This finishes the proof.
\end{proof}
