...
sites $a_{small} : U_{\acute{e}tale} \to V_{\acute{e}tale}$, see
...
\longrightarrow
a_{small, *}(\mathcal{F}|_{U_{\acute{e}tale}})
\end{equation}
...
$$
\xymatrix{
a_{small, *}(\mathcal{F}|_{U_{\acute{e}tale}})(V') &
\mathcal{F}|_{U_{\acute{e}tale}}(U') \ar@{=}[l] &
\mathcal{F}(x') \ar@{=}[l] \\
\mathcal{F}|_{V_{\acute{e}tale}}(V') \ar@{=}[rr] \ar[u]^{c_\varphi} &
&
...
c_\varphi : a_{small}^{-1}(\mathcal{F}|_{V_{\acute{e}tale}})
\longrightarrow
\mathcal{F}|_{U_{\acute{e}tale}}
\end{equation}
...
$$
a_{small}^{-1}(b_{small}^{-1} (\mathcal{F}|_{W_{\acute{e}tale}}))
\xrightarrow{a_{small}^{-1}c_\psi}
a_{small}^{-1}(\mathcal{F}|_{V_{\acute{e}tale}})
\xrightarrow{c_\varphi}
\mathcal{F}|_{U_{\acute{e}tale}}
$$
is equal to $c_{\psi \circ \varphi}$ via the identification
$$
(b \circ a)_{small}^{-1}(\mathcal{F}|_{W_{\acute{e}tale}}) =
a_{small}^{-1}(b_{small}^{-1} (\mathcal{F}|_{W_{\acute{e}tale}})).
$$
...
$f^{-1}\mathcal{F}|_{U_{\acute{e}tale}} = \mathcal{F}|_{U_{\acute{e}tale}}$.
\item Moreover, given $\psi : y' \to y$ in $\mathcal{Y}$ lying over
$a : U' \to U$ the comparison map
$c_\psi : a_{small}^{-1}(F^{-1}\mathcal{F}|_{U_{\acute{e}tale}}) \to
F^{-1}\mathcal{F}|_{U'_{\acute{e}tale}}$ is equal to the
comparison map $c_{f(\psi)} : a_{small}^{-1}\mathcal{F}|_{U_{\acute{e}tale}}
\to \mathcal{F}|_{U'_{\acute{e}tale}}$ via the indentifications in (3).
\end{enumerate}
\end{lemma}
...
c_\varphi : a_{small}^*(\mathcal{F}|_{V_{\acute{e}tale}})
\longrightarrow
\mathcal{F}|_{U_{\acute{e}tale}}
\end{equation}
