...
$$
\xymatrix{
\Sh(\mathcal{X}_{\acute{e}tale}) \ar[r]^-{\pi_F} &
\Sh(F_{\acute{e}tale}) &
\Sh(F_{\acute{e}tale}) \ar[r]^-{i_F} &
\Sh(\mathcal{X}_{\acute{e}tale})
}
$$
such that $\pi_F \circ i_F = \text{id}$.
\end{enumerate}
\end{lemma}
...
\noindent
Assume $\mathcal{X}$ is represented by the algebraic space $F$.
...
$\mathcal{F}|_{F_{\acute{e}tale}}$ in stead of $i_F^{-1}\mathcal{F}$
in this situation.
