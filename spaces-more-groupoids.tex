...
when $f$ is separated and locally of finite type.
...
\noindent
Note that the sheaf $(X/Y)_{fin}$ comes with a morphism
$(X/Y)_{fin} \to Y$ by mapping the pair $(a, Z) \in (X/Y)_{fin}(T)$
to the element $a \in Y(T)$. Thus the following lemma makes sense.
