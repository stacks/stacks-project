...
\section{Algebras topologically of finite type over pre-adic topological rings}
\label{section-tft-pre-adic}

\noindent
In the following subsections we develop a bit of theory dealing with
algebras topologically of finite type over a pre-adic
topological ring $A$
...
$B$ is $I$-adically complete, and
$B$ is a quotient of the restricted power series
ring $A\{x_1, \ldots, x_r\}$.
We find the terminology ``topologically of finite type''
too awkward to use. On the other hand, there does not seem to be
a good alternative, so for the moment we will not give a name to
...
\label{subsection-two-categories}
...
\subsection{A naive cotangent complex}
\label{subsection-naive-cotangent-complex}
...
\subsection{Rig-\'etale maps}
\label{subsection-rig-etale}
...
\subsection{Glueing rings along a principal ideal}
\label{subsection-approximation-principal}

\noindent
In this situation we prove some results about the categories
$\mathcal{C}$ and $\mathcal{C}'$ of
Subsection \ref{subsection-two-categories}
...
\subsection{Glueing rings along an ideal}
...
\noindent
In Subsection \ref{subsection-over-G-ring} we will give a simpler
...
\subsection{In case the base ring is a G-ring}
\label{subsection-over-G-ring}
