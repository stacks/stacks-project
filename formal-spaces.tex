...
\noindent
As in Section \ref{section-etale-sites} the motivation for the discussion
...
(see Lemma \ref{lemma-when-isomorphism}).
...
Lemmas \ref{lemma-affine-formal-completion-types} and
