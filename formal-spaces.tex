...
The following are equivalent
\begin{enumerate}
\item[(a)] for every weak ideal of definition $J \subset B$ the closure of the
ideal $JA$ is a weak ideal of definition of $A$ and these ideals
form a fundamental system of weak ideals of definition of $A$,
...
\medskip\noindent
Assume (a) holds for $\varphi$. Let $J \subset B$ be a weak ideal
...
& = \bigcap (JA + I_0)
\end{align*}
which is the closure of $JA$. The intersections are over
weak ideals of definition $I_0 \subset A$.
...
Thus the closure of $JA$ is open. As $B \to A$ is continuous the
elements of $J$ map to topologically nilpotent elements of
$A$, hence every element of $JA$ and its closure is topologically
nilpotent (some details omitted). Thus the closure of $JA$
...
equivalent conditions (a) and (b) of
Lemma \ref{lemma-representable-property-rings}. Then under the assumptions of
...
\begin{proof}
By Lemma \ref{lemma-representable-affine} the condition on morphisms
of $\textit{WAdm}^{count}$ translates into morphisms of affine formal
algebraic spaces being representable by algebraic spaces.
