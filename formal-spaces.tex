...
two ideals of defintion, hence is an ideal of definition itself.
\end{proof}

\begin{lemma}
\label{lemma-adic-taut}
Let $\varphi : A \to B$ be an adic ring map between pre-adic
topological rings. Then $\varphi$ is taut.
\end{lemma}
...
\noindent
Let us characterize weakly pre-adic rings.
...
\medskip\noindent
The final statement follows immediately from the equivalence
of (1) and (3) and the definitions.
\end{proof}
...
\section{Descent of properties of topological rings}
