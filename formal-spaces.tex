...
over $S$. Then $Y$ is a McQuillan affine formal algebraic space.
\end{lemma}
...
a closed subscheem of $\Spec(A/I_\lambda)$
and hecne  affine (Definition \ref{definition-closed-immersion}).
