...
\noindent
We prove a few results that will be usefull later.
...
of defintion $I \subset A$. Let $X$ be a scheme over $S$. Then
the natural map
$$
\Mor_S(\Spec(A), X)
\longrightarrow
...
maps into $U$ for every ideal of defintion $J$. Hence we may
...
Let $S$ be a scheme. Let $R$ be a complete local Noetherian ring.
